...
public class PDFViewGeneration extends AbstractPdfViewBuilder {
	...
	protected void buildPdfDocument(Map<String, Object> model,Document document, PdfWriter writer, HttpServletRequest request,
		  ...
		  PurchaseOrderBean purchaseOrderBeanObj = (PurchaseOrderBean) model.get("orderBean");
		 writer.setPageEvent(new pageEvents("TechnoLabs"));//watermark
	...
	/*	  for (WHPurchaseOrderItems item : purchaseOrderBeanObj.getItemDetails()) {
		...
		/* img.scaleToFit(100,100);  
		 ...
		 /* String str = "<html>"
		  		...
		  		+ "<h3 style=\"margin-left:5px;margin-top:40px\">First</h3>"
		  		+ "<div style=\"margin-left:15px;margin-top:15px\">"
		  		+ "<title>t</title><p>sdasdasd shshshshdffgdfgd</p>"
		  		+ "</div><h3 style=\"margin-left:5px;margin-top:40px\">The dream</h3>"
		  		+ "<div style=\"margin-left:15px;margin-top:15px\"></div>"
		  		+ "</div>"
		  		+ "</body>"
		  		+ "</html>";
		 ...
		 /* PdfPTable table = new PdfPTable(2);
			...
			cell.setBackgroundColor(new BaseColor(229,230,230));
			cell.setPadding(5);
