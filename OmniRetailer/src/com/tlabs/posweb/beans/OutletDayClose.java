...
//@Entity
//@Table(name = "outlet_day_close_master")
public class OutletDayClose {
	

	//@EmbeddedId
	private OutletDayCloseCompositeBean dayClose;
...
//	private Date createdDate;
	...
	//})
	private List<OutletDayCloseChild> dayCloseChilds;
	
	public List<OutletDayCloseChild> getDayCloseChilds() {
		return dayCloseChilds;
	}

	public void setDayCloseChilds(List<OutletDayCloseChild> dayCloseChilds) {
		this.dayCloseChilds = dayCloseChilds;
	}
	...
	public OutletDayCloseCompositeBean getDayClose() {
		return dayClose;
	}

	public void setDayClose(OutletDayCloseCompositeBean dayClose) {
