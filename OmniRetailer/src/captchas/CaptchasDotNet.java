...
public class CaptchasDotNet {
  ...
  final String ALPHABET_RECOMMENDED = "abcdefghkmnopqrstuvwxyz1234567890";
  ...
  final int WIDTH_DEFAULT = 215;
  final int HEIGHT_DEFAULT = 65;
  ...
  public String image() {
    ...
    imageCode.append("<a ><img style=\"border: none; vertical-align: bottom\" ");
