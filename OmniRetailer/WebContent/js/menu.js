...
function getMenuCategories() {
	...
	URL = contextPath + "/inventorymanager/getMenuCategories.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
function getMenuNames() {
	...
	URL = contextPath + "/inventorymanager/getMenuNames.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
//	var outlet_name = $('#outlet_name').val();
	...
	var contextPath = $("#contextPath").val();
	URL = contextPath + "/inventorymanager/getMenuCategoryNames.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
function getMenuItems(test) {
	...
	if($("#tab_2").html().trim() == "" || test == "cancel"){
		...
		var contextPath = $("#contextPath").val();
		URL = contextPath + "/inventorymanager/getMenuItems.do";
		$.ajax({
			type : "GET",
			url : URL,
			data : {
...
function newMenuCategory() {
	...
	var contextPath = $("#contextPath").val();
	URL = contextPath + "/inventorymanager/newMenuCategory.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
function newMenuItems() {
	var outlet_name = $("#outletname").val();
	var contextPath = $("#contextPath").val();
	URL = contextPath + "/inventorymanager/newMenuItems.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
function viewEditMenuCategory(menu_name) {
	...
	var outlet_name = $('#outletname').val();
	var contextPath = $("#contextPath").val();
	URL = contextPath + "/inventorymanager/editMenuCategory.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
function viewMenuItems(menu_name) {
	...
	URL = contextPath + "/inventorymanager/viewMenuItems.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
function viewEditMenuItems(menu_name) {
	...
	var contextPath = $("#contextPath").val();
	URL = contextPath + "/inventorymanager/editMenuItems.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
function viewMenuCategory(menu_name) {
	...
	URL = contextPath + "/inventorymanager/viewMenuCategory.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
//	{
	...
	/*if(storeLocation == "all")
		storeLocation=""*/
	URL = contextPath + "/inventorymanager/searchProductsForMenu.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
function getProductDetails(skuId) {
	...
	/*var contextPath = $("#contextPath").val();
	URL = contextPath + "/inventorymanager/getProductDetails.do";
	$.ajax({
		type : "GET",
		url : URL,
		data : {
...
//	console.log("OBJ "+formData);
	var contextPath = $("#contextPath").val();
	if (operation == "new")
		URL = contextPath + "/inventorymanager/createMenu.do";
	else
		URL = contextPath + "/inventorymanager/updateMenu.do";
	$.ajax({
		type : "POST",
		url : URL,
...
//		finalObj.menu_item_details.push(obj);
	...
	var contextPath = $("#contextPath").val();
	if (operation == "new")
		URL = contextPath + "/inventorymanager/addItemsToMenu.do";
	else
		URL = contextPath + "/inventorymanager/updateMenuItems.do";
	$.ajax({
		type : "POST",
		url : URL,
		contentType : "application/json",
...
function searchMenuCategories(name,searchCategory,index){
	...
	var outlet_name = $("#outletname").val();
	 var contextPath = $("#contextPath").val();
	 URL = contextPath + "/inventorymanager/searchMenuCategories.do";
	 $.ajax({
			type: "GET",
			url : URL,
			data : {
...
function getCategoryDetailsBasedOnCategory(categoryName,menu_name){
	...
	var menu_name = $("#menuName").val();
	 ...
	 $("#Error").html("");
	 $("#Success").html("");
	 URL = contextPath + "/inventorymanager/getCategoryDetailsBasedOnCategory.do";
	 $.ajax({
			type: "GET",
			url : URL,
			data : {
...
function searchMenuItems(name,searchCategory,index){
	var outlet_name = $("#outletname").val();
	 ...
	 URL = contextPath + "/inventorymanager/searchMenuCategoriesinMenuItem.do";
	 $.ajax({
			type: "GET",
			url : URL,
			data : {
