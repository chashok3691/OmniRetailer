 ...
 * Written By		        : Manojj
 * file name		        : Inventory Manager/settings/editWhatsAppSettings.jsp
 * file type		        : JSP
...
<script
	src="${pageContext.request.contextPath}/js/cusomerSettings/whatsAppSettings.js"></script>
	...
	<section class="content">
		<div class="row">
			...
			<div class="col-xs-12">
               ...
               <h3  class="box-title" style="border:1px solid #ccc;padding:7px;font-weight: 600;"><spring:message code="whatsapp.settings.label" /></h3>
           </div>
						...
						<div class="box-body">
							...
							<div class="row">
								...
								<legend  class="scheduler-border"style="text-align:center;"><b>Configure WhatsApp Gateway</b></legend>
									<div class="form-group col-lg-4">
									<br>
										<div class="row">
											<div class="col-lg-12">
												<label><spring:message code="whatsapp.gateway.label" />
													<span style="color: red; font-size: 2">*</span></label> <input
													type="text" class="form-control" id="whatsAppGateway"
													value="${whatsappSettings.gateWay}"
													placeholder="<spring:message code="enter.gateway" />" /> 
													<span
													id="whatsAppGatewayError"
										...
										<div class="row" style="padding-top: 0px;">
											...
											<div class="col-lg-1">
												...
												<c:if test="${whatsappSettings.enabled == true}">
										...
										<div class="col-lg-12">
													<label><spring:message code="whatsapp.url.label" /></label> <input
														type="text" class="form-control" disabled id="whatsAppURL"
														value="" /> 
												</div>
									...
									<div class="form-group col-lg-8">
										...
										<!-- <div class="row"> -->
											...
											<input type="text" class="form-control" id="mobileKey" value="${whatsappSettings.mobileKey}"/> 
											...
											<input type="text" class="form-control" id="mobilenumber" value="${whatsappSettings.mobileNumber}"/> 
											...
											<input type="text" class="form-control" id="templateId" value="${whatsappSettings.templateId}"/> 
											...
											<input type="text" class="form-control" id="messageKey" value="${whatsappSettings.messageKey}"/>
											<span id="messageKeyError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span> 
											</div>
											<!-- <div class="col-lg-1"></div> -->
											<div class="col-lg-4">
											<label>Text Message</label>
											<textarea rows="3" cols="3" id="textmessage" style="width:110px;"></textarea>
											</div>
											
											<div class="col-lg-4">
											<%-- <a  data-toggle="modal" data-target="#myModal" class="button"><spring:message code="validate.label" /></a> --%>
											<input type="button" value="Validate" style="margin-top:22px;" class="btn btn-primary"  onclick="validateWhatsAppMsgSetting('edit')">	
											</div>
											</div>
													...
													<div class="row">
														<div class="col-lg-12">
															...
															<input type="text" class="form-control" id="mobileKey"
																value="${whatsappSettings.mobileKey}"/> 
																</div>
														...
														<div class="col-lg-12">
															...
															<input type="text" class="form-control" id="messageKey"
																value="${whatsappSettings.messageKey}" /> </div>
													</div>
												...
												<c:if
													test="${accessControl.appDocument == 'WhatsAppSettings' && accessControl.write == true}">
														...
														<input type="button" id="submit"
															...
															<input type="button" id="submit"
															style="" class="btnCls" onclick="whatsAppSettingreset();"
 ...
 --%>
										...
										<div style="padding-left: 0px;" class="col-lg-12">
											...
											<div class="row" style="">
												...
												<c:if
													test="${billDetailsdataUrl ne null and billDetailsdataUrl ne '' }">
