   ...
   <div class="row">
         <div class="col-xs-12">
           ...
           <div class="box-header">
 				...
 				<h3 class="box-title" style="padding :5px;  border:1px solid  #808080;font-weight: bold;">Batch Operations - Edit</h3>
 				</div>
                 ...
                 <div class="box-body">
	        	  ...
	        	  <div id="Error2" class="Error2" style="text-align: center;color: red;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${Error}</div>
	        	  <div id="Success2" class="Error2" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${Success}</div>
                           ...
                           <%-- <div class="row batchName">
                                <div class="col-lg-2 col-sm-2 nopadding"; style="margin-bottom: 5px;margin-top: 0px;" >
                                 <label>Batch ID</label>
                                      <input type="text" class="form-control" id="batchName" value="${batchOperationList.batch_title}" placeholder='<spring:message code="batchOperations.batch_name.placeholder"></spring:message>' style=" width: 100%" >
                              ...
                              <div class="row batchDesc">
                                 ...
                                 <label>Batch Description</label>
                                    <textarea class="form-control" id="batchDescription" value="${batchOperationList.batch_description}" placeholder='<spring:message code="batchOperations.batch_description.placeholder"></spring:message>'>${batchOperationList.batch_description}</textarea>
                                 </div>
                               </div> --%>
                                 ...
                                 <div class="row batchSubOperation">
                                  ...
                                  <div class="row BatchOperation">
                                      <div class="col-lg-8 col-sm-8 col-xs-10"  style="margin-right: 10px;padding-right: 0px;padding-left: 0px; margin-top: 10px;">
                                         <section class="form-control form-group" id="batchesList"  multiple="multiple" >
                            ...
                            <div class="col-lg-4 col-sm-12 nopadding" style="">
                                 <div class="row">
                                ...
                                <div class="row startTimeandDate">
                                     <div class="form-group col-lg-5 col-sm-4 columnpadding" style="padding-left: 1px; padding-right: 10px;">
                                         <input class="form-control calendar_icon startDateBatchOperations" value="${batchOperationList.startDateStr}" style="background-color: white;" id="from" size="20" type="text" onfocus="callCalender('from')" onclick="callCalender('from')" placeholder='<spring:message code="batchOperations.batch_timings.start_date.label"></spring:message>'>
			                          </div>
			                     	
			                          <div class="form-group col-lg-5 col-sm-4 columnpadding bootstrap-timepicker" style="padding-left: 0px;padding-right: 0px;">
                                            <input type="text" class=" form-control timepicker" value="${batchOperationList.batchTimeStr}" id="startTime" placeholder="<spring:message code="batchOperations.batch_timings.start_time.label"></spring:message>">
                                       <input type="hidden" id="startTimeforEmpty" value="${batchOperationList.batchTimeStr}">
                                        </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="form-group col-lg-5 col-sm-4 columnpadding bootstrap-timepicker" id="setExecutionTime" style="padding-left: 0px;margin-top: 10px; margin-right: 8px;display: none;">
                                         <input class="form-control timepicker excutionTimeBatchOperations" style="background-color: white;" value="${batchOperationList.batchTimeStr}" id="excutionTime" size="20" type="text" placeholder="<spring:message code="batchOperations.batch_timings.execution_time.label"/>">
			                          </div>
                                </div>
                              ...
                              <c:forEach var="days" items="${batchOperationList.dayList}">
                               ...
                               <div class="row">
                                     <div class="form-group col-lg-5 col-sm-4 columnpadding bootstrap-timepicker" style="margin-top:10px;padding-left: 0px;padding-right: 0px;">
                                         <input class="form-control timepicker sartTimeBatchOperations" style="background-color: white;" value="${batchOperationList.batchTimeStr}" id="weeklysartTime" size="20" type="text" placeholder="<spring:message code="batchOperations.batch_timings.start_time.label"></spring:message>">
			                          </div>
                              </div>
                              ...
                              <div class="row">
                                     <div class="form-group col-lg-5 col-sm-4 columnpadding" id="nthDayExecution" style="margin-top: 10px;padding-left: 0px;display: none;">
                                         <input class="form-control calendar_icon nthDayBatchOperations" style="background-color: white;" id="nthDay" type="number" value="${batchOperationList.batch_day}" placeholder="<spring:message code="batchOperations.batch_timings.nthDay.label"></spring:message>">
			                          </div>
                              </div>
                             </div>
                             
                             <div class="col-lg-4 col-xs-12 nopadding" style="">
                                 <div class="row">
                                  
									<label style="font-size: 16px; margin-top:30px;">Batch log</label>
										
                                    <table id="batchTable" class="table table-bordered table-striped" style="overflow: auto; display: block;">
							...
							<td id="batchDate" style="white-space: pre;">${batchhistoryList.batchDataDdateStr}</td>
							<td id="batchOperation">${batchhistoryList.reportId}</td>
							<td id="batchTime">${batchhistoryList.batchTimeStr}</td>
							<td id="Status">${batchhistoryList.status}</td>
							<%-- <td id="action">${batchhistoryList.action}</td> --%>
							 <c:if test="${batchhistoryList.runStatus == 'true' || batchhistoryList.runStatus == true}">
                                                                <td id="run"><a style="color: #2e7ea7 !important; cursor: pointer;" id="run" onclick="return Run('${batchhistoryList.batchDataDdateStr}','${batchOperationList.batch_id}','edit')">Run</a></td>
                             </c:if>
                              <c:if test="${batchhistoryList.runStatus != 'true' || batchhistoryList.runStatus != true}">
                                                                <td id="run"><u><a style="color: #2e7ea7 !important; cursor: pointer;" id="run" disabled></a><u></td>
                             </c:if> 
							</tr>
							</c:forEach>
							</tbody>
            ...
            <%-- <div class="row" style="padding: 10px;">
            	...
            	<input type="button" id="submit" class="btnCls" onclick="validateBatch('edit');" value="<spring:message code="submit.label" />" />
					       </div>
					       <div class="col-lg-3 col-xs-4">
				 ...
				 <div class="row" style="padding: 10px;">
            	 <div class="col-lg-6 col-xs-12" style="padding: 10px; margin-left:65%;margin-right:0%;" >
            	...
            	<input type="hidden" id="batchId" value="${batchOperationList.batch_id}">
            	<input type="hidden" id="batchDay" value="${batchOperationList.batch_day}">
            	<input type="hidden" id="createdDateStr" value="${batchOperationList.createOnStr}"> 
