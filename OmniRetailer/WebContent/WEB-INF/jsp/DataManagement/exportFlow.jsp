...
<body>
                          ...
                          <div class="col-lg-2 form-group" style="text-align: right;">
                          			<div style="text-align: center;width: 140px;height: 130px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="return viewExportDetails('exportGeneric','generic');" title="<spring:message code="generics.data.label" />">
                                    ...
                                    <div class="col-lg-2 form-group" style="text-align: right;">
	                          		<div style="text-align: center;width: 140px;height: 130px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="return viewExportDetails('exportOutlet','outlet');" title="<spring:message code="outlet_management.reports.label" />">
	                          	...
	                          	<div class="col-lg-2 form-group" style="text-align: right;">
                          			<div style="text-align: center;width: 140px;height: 130px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="return viewExportDetails('exportWarehouse','warehouse');" title="<spring:message code="warehouse_management.reports.label" />">
                          ...
                          <c:forEach var="accessControl" items="${sessionScope.dataManagement}">
                             ...
                             <c:forEach var="accessControl" items="${sessionScope.dataManagement}">
                             		<c:if test="${accessControl.appDocument == 'OuletExports'}"> 	
                             		 	<div class="col-lg-2 form-group" style="text-align: right;">
			                          		<div style="text-align: center;width: 140px;height: 130px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="return viewExportDetails('exportOutlet','outlet');" title="<spring:message code="outlet_management.reports.label" />">
			                          			<img src="${pageContext.request.contextPath}/images/Outlet.gif" style="margin-top: 10px;"><br><br>
			                          			<span><spring:message code="outlet_management.reports.label" /></span>
                          ...
                          <c:forEach var="accessControl" items="${sessionScope.dataManagement}">
                             <c:if test="${accessControl.appDocument == 'WarehouseExports'}"> 	
                          		<div class="col-lg-2 form-group" style="text-align: right;">
                          			<div style="text-align: center;width: 140px;height: 130px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="return viewExportDetails('exportWarehouse','warehouse');" title="<spring:message code="warehouse_management.reports.label" />">
	                          			<img src="${pageContext.request.contextPath}/images/warehouse.gif" style="margin-top: 10px;"><br><br>
	                          			<span><spring:message code="warehouse_management.reports.label" /></span>
