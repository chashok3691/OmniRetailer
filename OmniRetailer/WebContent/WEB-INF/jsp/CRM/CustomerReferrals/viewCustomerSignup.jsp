 ...
 <div class="row">
  <div class="col-lg-12">
            ...
            <br/>
				...
				<spring:message code="view.customer.signup.label" />
		</h3>
              ...
              <div class="row">
               	...
               	<div class="row">
                    ...
                    <div class="form-group col-lg-2" style="padding-right: 0px">
						...
						<select class="form-control" disabled name="rewardtype"  id="rewardtype">
						<option value="coupan"${customerSignup.signupPriority == 'coupan'?'selected':''}>Coupan</option>
                 ...
                 <!--    <div class="form-group col-lg-1"></div> -->
                 	...
                 	<div class="form-group col-lg-11" style="padding-left:0px">
						...
						<input type="text" disabled class="form-control searchItems"  value="${customerSignup.couponBatchReference}" style="height:30PX;;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" id="couponRef" placeholder="<spring:message code="gift.coupon.id.label" />" />
						<div class=services>
					    		<div class="items">
<!-- 					     			<ul class="matchedStringUl quoteRef" style="width: 89%!important;padding: 0px!important;"></ul> -->
                 	...
                 	<div class="form-group col-lg-11" style="padding-left:0px">
						...
						<input type="text"  disabled class="form-control searchItems"   style="height:30PX;;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" id="loyaltyPlan" />
						<div class=services>
					    		<div class="items">
<!-- 					     			<ul class="matchedStringUl quoteRef" style="width: 89%!important;padding: 0px!important;"></ul> -->
					   			<ul class="matchedStringUl " style="width: 89%!important;padding: 0px!important;"></ul>
					   			</div>
							</div>
                   ...
                   <div class="form-group col-lg-2">
                       <label><spring:message code="offer_start_date.label"/><span style="color:red; font-size:2">*</span></label>
                	 	<input class="form-control calendar_icon form-group" disabled readonly="readonly" value="${customerSignup.startDateStr}" style="background-color: white;" id="from" size="20" type="text"  placeholder="DD/MM/YYYY" />
                ...
                <div class="row">
                	 <div class="form-group col-lg-3">
                	  <div class="form-group col-lg-11" style="padding-left:0px">
						...
						<input type="text" disabled class="form-control" disabled name="programDescription" id="programDescription" value="${customerSignup.campaignDescription}" required />
                      </div> 
                     </div>
             	...
             	<div class="form-group col-lg-11" style="padding-left: 16px; width: 110%;"> 
                        ...
                        <label>Offer</label>
						<input type="text" disabled class="form-control searchItems"  style="height:30PX;;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" id="Offer" />
						<div class=services>
					    		<div class="items">
<!-- 					     			<ul class="matchedStringUl quoteRef" style="width: 89%!important;padding: 0px!important;"></ul> -->
					   			<ul class="matchedStringUl couponRef" style="width: 89%!important;padding: 0px!important;"></ul>
                   ...
                   <div class="form-group col-lg-2" style="padding-right: 0px;white-space:nowrap">
						...
						<label>signUp Cash <span style="color:red;font-size:2px">*</span> </label>
						 <input type="number" class="form-control" disabled name="noOfReferral" id="noOfReferral" value="${customerSignup.noOfSignUps}" required />
                   ...
                   <div class="form-group col-lg-2" style="padding-left: 0px;" >
                     ...
                     <div class="form-group col-lg-2">
	                 	...
	                 	<input class="form-control calendar_icon form-group" disabled readonly="readonly" value="${customerSignup.endDateStr}" style="background-color: white;" id="to" size="20" type="text" onfocus="callCalender('to')" onclick="callCalender('to')" placeholder="DD/MM/YYYY" />
              	...
              	<div class="row">
              	 ...
              	 <div class="form-group col-lg-2" style="padding-right: 0px">
						...
						<select class="form-control" name="referralPriority" disabled id="referralPriority">
              	...
              	<div class="form-group col-lg-1"></div>
              	 ...
              	 <div class="form-group col-lg-2" style="padding-right: 0px;white-space:nowrap; width: 25%;">
						...
						<label><spring:message code="no.of.signups.label" /><span style="color:red;font-size:2px">*</span> </label>
						 <input type="number" disabled class="form-control" name="noOfReferral" id="noOfReferral" value="${customerSignup.noOfSignUps}" required />
					<span id="noOfReferralError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
					</div>
					</div>
                  ...
                  <div class="form-group col-lg-2">
                     <div class="form-group col-lg-12" style="padding: 0px ;white-space: nowrap;">
                       ...
                       <input type="text" class="form-control" name="minPurchaseAmt" id="minPurchaseAmt" disabled value="${customerSignup.minimumPurchaseAmount}" required />
      			 ...
      			 <div class="col-lg-12" style="margin-top:-6px">
                     ...
                     <table id="rewardranges" class="table table-bordered table-striped" style="">
      				...
      				<div class="form-group col-lg-3">
      				 ...
      				 <textarea class="form-control" rows="15" id="help"  disabled ></textarea>
      				</div>
      				
      				
      				    <div class="col-lg-12" style="    text-align: right;    margin-top: 25px;">
<%--       				 <input type="button"  style="" class="btnCls" onclick="validateCustomerSignup('new');" value="<spring:message code="submit.label" />" /> --%>
      				<input type="button" class="btnCls " style="" onclick="viewCustomerSignUp('CustomerSignUp','0','false');" value="<spring:message code="cancel.label" />" />
      				 </div>
              </div>
