 ...
 <div class="row">
  <div class="col-lg-12">
            ...
            <br/>
				...
				<spring:message code="new.customer.signup.label" />
		</h3>
...
<!-- 					     			<ul class="matchedStringUl quoteRef" style="width: 89%!important;padding: 0px!important;"></ul> -->
                 	...
                 	<div class="form-group col-lg-11" style="padding-left:0px">
						...
						<input type="text" class="form-control searchItems"  value="${customerSignup.couponBatchReference}" style="height:30PX;;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" disabled id="loyaltyPlan" />
						<div class=services>
					    		<div class="items">
<!-- 					     			<ul class="matchedStringUl quoteRef" style="width: 89%!important;padding: 0px!important;"></ul> -->
                ...
                <div class="row">
             	...
             	<div class="form-group col-lg-11" style="padding-left: 16px; width: 110%;"> 
                        ...
                        <label>Offer</label>
						<input type="text" class="form-control searchItems" disabled value="${customerSignup.couponBatchReference}" style="height:30PX;;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" id="offer" />
						<div class=services>
					    		<div class="items">
<!-- 					     			<ul class="matchedStringUl quoteRef" style="width: 89%!important;padding: 0px!important;"></ul> -->
                   ...
                   <div class="form-group col-lg-2" style="padding-right: 0px;white-space:nowrap">
						...
						<label>signUp Cash <span style="color:red;font-size:2px">*</span> </label>
						 <input type="number" class="form-control" name="noOfReferral" id="signupCash" value="${customerSignup.noOfSignUps}" required />
				<!--	<span id="noOfReferralError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
              	...
              	<div class="form-group col-lg-1"></div>
              	 ...
              	 <div class="form-group col-lg-2" style="padding-right: 0px;white-space:nowrap; width: 25%;">
						 <div class="form-group col-lg-9" style="padding-left: 0px">
						<label><spring:message code="no.of.signups.label" /><span style="color:red; font-size:2">*</span> </label>
              	...
              	<div class="row">
      			  ...
      			  <div class="col-lg-12 col-xs-12" style="padding-left: 0px;padding-right: 0px; margin-right:0px;">
                      	<div class="wrapper">
	        	 		 <input type="text"  class="form-control" value="${searchName}" id="supplierReport" placeholder="Search here...." />
      			 ...
      			 <div class="col-lg-12" style="margin-top:-6px">
                     ...
                     <table id="rewardranges" class="table table-bordered table-striped" style="">
      				...
      				<div class="form-group col-lg-3">
      				 ...
      				 <textarea class="form-control" disabled rows="19" id="help"></textarea>
      				</div>
