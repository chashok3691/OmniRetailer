...
// 	callCalender('expiryDate');
	...
	$("#vouchersFormView input[type=text],select,textarea,checkBox").prop("disabled", true);
							...
							<input type="button" class="btn bg-olive btn-inline" style="margin-left:2%; margin-right: 1%;" onclick="viewGiftVouchers('giftVouchers','GiftVoucher','0','menu');" value="<spring:message code="back.label" />" />
                                   	...
                                   	<div class="row">
                                   		<div class="form-group col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="voucherProgramCode" name="voucherProgramCode" readonly style="width:100%;" value="${giftVoucher.voucherProgramCode}"/>
                                             <span style="color:red; font-size:2" id="errVoucherProgramCode"></span>
                                     	</div>
                                   		<div class="form-group col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="promoName" name="promoName" readonly style="width:100%;"  value="${giftVoucher.promoName}"/>
										...
										<div class="form-group col-lg-2">
                                            ...
                                            <input type="text" class="form-control" id="unitCashValue" name="unitCashValue" readonly style="width:65%;" value="${giftVoucher.unitCashValue}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                    	...
                                    	<div class="form-group col-lg-2" style="padding-right: 0px;">
                                    	  ...
                                    	  <div class="form-group col-lg-2" style="">
										   <div class="from-group col-lg-12" style="padding-left: 0px;margin-top: 20px;">
	                                           ...
	                                           <input type="checkbox" checked id="isPaidFlag" disabled name="isPaidFlag" value="true">
	                                           </c:when>
	                                           <c:otherwise>
	                                           <input type="checkbox" id="isPaidFlag" disabled name="isPaidFlag" value="false"> 
	                                           </c:otherwise>
	                                           </c:choose>												
												</div>
											</div>										  
										...
										<div class="form-group col-lg-2">
                                            ...
                                            <div class="input-group">
                                            	<div class="input-group-addon" style="background: #f2f2f2;">
                                                	<i class="fa fa-calendar"></i>
                                            	</div>
                                            	<input class="form-control" readonly="readonly" style="background-color: #f2f2f2;width:50%;" name="createdOn" id="createdOn" size="20" type="text" value="${giftVoucher.createdOnStr}" placeholder="DD/MM/YYYY"/>
                                         ...
                                         <div class="form-group col-lg-2">
                                             ...
                                             <div class="input-group">
                                            	...
                                            	<input class="form-control" readonly="readonly" style="background-color: #f2f2f2;width:50%;" name="expiryDate" id="expiryDate" size="20" type="text"  value="${giftVoucher.expiryDateStr}" placeholder="DD/MM/YYYY"/>
                                         ...
                                         <div class="form-group col-lg-2">
                                            ...
                                            <input type="text" class="form-control"  name="validityPeriod" id="validityPeriod" readonly value="${giftVoucher.validityPeriod}" style= "width:60%;" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.no.of.days.label" />" />
                                    	...
                                    	<div class="form-group col-lg-2" style="padding-right: 0px;">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="productGroup.label" /><!--  <span style="color:red; font-size:2">*</span> --></label>
                                             <select class="form-control" name="productGroup" id="productGroup" readonly style="width: 80%;">
									...
									<div class="row">
									  ...
									  <div class="form-group col-lg-2" >
                                             ...
                                             <select class="form-control" disabled name="assignedStatusStr" id="assignedStatus" style="width:50%;">
                                            ...
                                            <input type="text" class="form-control" readonly id="min_bill_amount"  name="min_bill_amount" style= "width:50%;"  value="${giftVoucher.min_bill_amount}" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"  />
                                    	...
                                    	<div class="form-group col-lg-2" >
                                             ...
                                             <select class="form-control" name="multiple" onchange="multipleCheckValidation()" disabled style= "width:60%;"  id="multiple">
	                                            <option value="0" ${giftVoucher.multiple==true?'selected':''}>yes</option>
    	                                        <option value="1" ${giftVoucher.multiple==false?'selected':''}>no</option>
                                            </select>
										</div>
                                             ...
                                             <select class="form-control" name="status" id="status" disabled style= "width:60%;" >
										...
										<div class="form-group col-lg-2" style="">
										   ...
										   <div class="from-group col-lg-12" style="padding-left: 0px;margin-top: 20px;white-space: nowrap;">
											...
											<div class="col-lg-1" style="padding-left: 0px;">
	                                           ...
	                                           <input type="checkbox" checked id="on_discounted_bill_price"  disabled name="on_discounted_bill_price" value="true">
	                                           </c:when>
	                                           <c:otherwise>
	                                         <input type="checkbox" id="on_discounted_bill_price"  disabled name="on_discounted_bill_price" value="false">
	                                           </c:otherwise>
	                                           </c:choose>
								...
								Reason: To add the is paid flag  -->  		  
										 ...
										 <%-- <div class="row" style="margin-left: 1%">
										  <label style="font-family: Calibri;color: gray;" style="text-decoration: underline; font-size: 16px;"><spring:message code="loyalty.locations.label" /></label>
                                           ...
                                           <!--  <select onchange="addSelectedState(this.selectedIndex);" id="country" name ="country" class="form-control" > -->
                                            <select onchange="print_state('state',this.selectedIndex);" id="country" name ="country" disabled style= "width:50%;"  class="form-control" >
									...
									<div class="row" >
										...
										<div class="form-group col-lg-2">
                                            ...
                                            <select onchange="getLocationsBasedonZones();" id ="zones" disabled style= "width:100%;"  multiple="multiple" class="form-control" >
...
<!--     										<span style="color:red; font-size:2" id="errStates"></span> -->
                                            ...
                                            <select id ="location" multiple="multiple" class="form-control" disabled style= "width:100%;" >
    									...
    									<c:forEach var="locationDetails" items="${locationsbasedzone}">
                                      	...
                                      	<div class="form-group col-lg-5">
                                            ...
                                            <textarea style="resize:none;padding: 10px 10px;" class="form-control" readonly name="description" rows="3">${giftVoucher.description}</textarea>
                                     	</div>
                                     	</div>
				    ...
				    <input type="button" onclick="searchGiftVouchers('',0,true)" class="btn bg-olive btn-inline  addBtn" value="GO">

				                     		 </div>
									<div class="form-group col-lg-1" style="padding: 0px;text-align:center;margin-bottom:0px !important ">
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="searchGiftVouchers('',document.getElementById('pagination').value,'',false);" class="btn bg-olive btn-inline  addBtn" value="GO">
			                ...
			                <input type = "hidden" name = "searchristrict"  id ="searchristrict" value = "true"/>
