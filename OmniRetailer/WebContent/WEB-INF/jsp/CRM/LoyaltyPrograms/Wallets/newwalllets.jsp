...
<div class="row">
  ...
  <div class="box box-primary">
                                 ...
                                 <div class="box-header" align="center" >
                                    ...
                                    <h3 class="box-title" style="padding :5px;  border:1px solid  #808080;">Wallet-Creation</h3>
           ...
           <div>               
                             ...
                             <br>   
                                    ...
                                    <!--   <div class="form-group col-lg-2" >
										...
										<div class="col-lg-10" style="width: 85%;white-space: nowrap;padding-left:0px;">
                                           ...
                                           <c:choose>
											...
											<input type="text" class="form-control" style="width: 100%;" id="noOfwallets" name="noOfwallets" value="${walletList.signupCash}" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                            <span class="noOfwalletsErrors" style="color:red;font-weight: bold;" id="noOfwalletsErrors"></span>
                                        	</div>
                                        	</div>
                                        	<div class="form-group col-lg-2" style="padding-right:0px;">
											<div class="col-lg-10" style="width: 92%;white-space: nowrap;">
											...
											<%-- <input type="text" class="form-control" style="width: 100%;" id="maxTopupAmt" name="maxTopupAmt" value="${walletList.maxTopupAmt}" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                            <span class="maxTopupAmtErrors" style="color:red;font-weight: bold;" id="maxTopupAmtErrors"></span> --%>
                                        	</div>
                                        	</div>
                                        	<%-- <div class="form-group col-lg-2" style="padding-left: 0px;margin-left: -8px;">
											<input type="checkbox" id="autoGenerated" class="autoGenerated" value="">
								...
								<div class="row">
										...
										<input type="text"  class="form-control searchItemsww" value="${searchCriteria}" id="searchChildWallet"  placeholder="Search Wallets here.."   style="height:30PX;text-align:left;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" />
											<div class="services">
						    					<div class="items">
						     						<ul class="matchedStringUl searchWalletChildItems" style=""></ul>
						   						</div>
											</div>
									</div>
                                    	...
                                    	<diV><input type="file" class="btn bg-olive btn-inline" accept=".xlsx" title="To import, Choose the valid Exel Sheet format" style="height: 30px;display: inline-block;padding: 3px !important;width: 100%;" id="wallets" name="uploadedfilePath" onchange="addNameToTextBox('wallets');" value=""/></div>
										<div><b><span id="fileNameShow" Style="color:blue;display:block;text-align:left;"></span></b></div>
										
                                    	<%-- <img style="width: 27px;margin-left: 35px;margin-top: -26px;display: block;" id="importCoupounsTick" src="${pageContext.request.contextPath}/images/Tick.png">  --%>
                                    	...
                                    	<img style="position: absolute;width: 27px;margin-left: 37px;margin-top: 1px;display: none;" id="importCoupounscircleWait" src="${pageContext.request.contextPath}/images/circleWait.gif">
                                    	<input type="button" id="importButton" class="btnCls" style="width: 100%;font-size: 15px;padding: 4px 4px;" onclick="importDataxls()" value="Import">
                                    	<!-- <input type="button" class="btnCls" style="width: 100%;font-size: 15px;padding: 4px 4px;" onclick="" value="Import"> -->
                                    	</div>
                                    	...
                                    	<tr>
											...
											<c:forEach var="wallet" items="${walletList.wallets}" varStatus="theCount">
				                             ...
				                             <td><a style="color:#2e7ea7 !important;cursor: pointer;pointer-events:auto;" onclick="viewWalletsLedgers('${operation}','${walletList.walletProgramId}','${wallet.phoneNumber}','0')">View</a></td>
				                              </tr> 
				                             </c:forEach>
				                            </c:if> 
				                             </tbody>
                ...
                <div class="row">
              	...
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewEditWallet('${walletList.walletProgramId}','${operation}','${totalValue}');">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-4" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;"     onclick=" return viewEditWallet('${walletList.walletProgramId}','${operation}','${index - (maxRecords+1)}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-4" style="padding-right: 0px;">
              		  <input type="button" onclick="viewEditWallet('${walletList.walletProgramId}','${operation}',document.getElementById('pagination').value);" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
