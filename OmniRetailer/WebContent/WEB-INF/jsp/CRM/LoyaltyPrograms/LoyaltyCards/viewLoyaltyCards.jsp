...
$(document).ready(function(){
	debugger;
	 $("#loyalityFromView input[type=text],select,textarea,checkBox").prop("disabled", true);
	 $('#requiredOTP').prop('disabled', true);
	 $('#autoIssue').prop('disabled', true);
	 $('#searchItems').prop('disabled', false);
	 $('#maxRecords').prop('disabled', false);
});
</script>
</head>
<body>
						  ...
						  <div class="box-body">
                                  ...
                                  <div style="background: #efefef;padding: 4px 20px;">
                                   	...
                                   	<div class="form-group col-lg-2">
                                            <label style="font-family: Calibri;color: gray;white-space: nowrap;"><spring:message code="loyalityPlanId.label" /> <span style="color:red; font-size:2">*</span></label>
...
<%--                                               	<input class="form-control" readonly="readonly" style="background-color: white;" name="validFrom" id="validFrom" size="20" type="text" value="${loyaltyCard.validFrom}" onfocus="callCalender('validFrom')" onclick="callCalender('validFrom')" placeholder="DD/MM/YYYY"/> --%>
                                              	<input class="form-control" readonly="readonly" style="background-color: white;" name="validFrom" id="validFrom" size="20" type="text" value="${loyaltyCard.validFromStr}"  placeholder="DD/MM/YYYY"/>
                                     ...
                                     <%--     <fmt:parseDate  value="${loyaltyCard.validTo}" pattern="yyyy-MM-dd HH:mm:ss" var="validityTo" />
                                          ...
                                          <div class="form-group col-lg-2" style="padding-left:10px;">
                                            <label style="font-family: Calibri;color: gray;white-space: nowrap;"><spring:message code="valid.to.label" /> <span style="color:red; font-size:2">*</span></label>
                                             <div class="input-group">
                                            	...
                                            	<input class="form-control" readonly="readonly" style="background-color: white;" name="validTo" id="validTo" value="${loyaltyCard.validToStr}" size="20" type="text" placeholder="DD/MM/YYYY"/>
                                       		 </div>
                                       ...
                                       <div class="col-lg-9" >
                                    	...
                                    	<div class="col-lg-10" style="padding: 0px; margin-left: -14px;">
                                            <label style="font-family: Calibri;color: gray;white-space: nowrap;"><spring:message code="loyalty.status.label" /><!--  <span style="color:red; font-size:2">*</span> --></label>
                                             <select class="form-control" name="status" id="status">
	                                            <option value="Active" ${'Active' == loyaltyCard.status? 'selected' : ''}>Active</option>
	                                            <option value="InActive" ${'InActive' == loyaltyCard.status? 'selected' : ''}>InActive</option>
                                            </select>
                                    	</div>
										...
										<div class="form-group col-lg-2">
                                            ...
                                            <input type="text" class="form-control"  name="loyaltyProgramName" id="loyaltyProgramName" value="${loyaltyCard.loyaltyProgramName}"/>
                                            <span style="color:red; font-size:2" id="errLoyaltyProgramName"></span>
                                     	</div>
                                     	</div>
									...
									<%-- 	<fmt:parseDate  value="${loyaltyCard.startDate}" pattern="yyyy-MM-dd HH:mm:ss" var="startedDate" />
										...
										<div class="form-group col-lg-6" style="padding-right:10px;" >
                                            ...
                                            <div class="input-group">
                                            	...
                                            	<input class="form-control" readonly="readonly" style="background-color: white;" name="startDate" id="startDate" size="20" type="text" value=" ${loyaltyCard.validFromStr}"  placeholder="DD/MM/YYYY"/>
                                            	<!-- <input type="text" name="validFrom" id="validFrom" required class="form-control date-type" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/> -->
                                       		 </div><!-- /.input group -->
                                       ...
                                       <%--  <fmt:parseDate  value="${loyaltyCard.endDate}" pattern="yyyy-MM-dd HH:mm:ss" var="dateTill" />
										<fmt:formatDate var="tillDate" value="${dateTill}" pattern="dd-MM-yyyy"/> --%>
                                          ...
                                          <div class="form-group col-lg-6" style="padding-left:10px;">
                                            <label style="font-family: Calibri;color: gray;white-space: nowrap;"><spring:message code="crm.till.date.label" /> <span style="color:red; font-size:2">*</span></label>
                                             <div class="input-group">
                                            	...
                                            	<input class="form-control" readonly="readonly" style="background-color: white;" name="endDate" id="endDate" size="20" type="text" value="${loyaltyCard.validToStr}"  placeholder="DD/MM/YYYY"/>
                                       		 </div>
                                      	...
                                      	<div class="col-lg-9" style="">
                                            ...
                                            <input type="text" class="form-control"  name="noOfCards" id="noOfCards" value="${loyaltyCard.noOfCards}" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
...
<!--                                             <span style="color:red; font-size:2" id="errRewardConversionRatio"></span> -->
									...
									<div class="form-group col-lg-2" style="white-sapce:nowrap;padding:0px;margin-top: -15px;" >
                                       <div class="col-lg-9" style="">
                                    	<label style="font-family: Calibri;color: gray;" style="white-space: nowrap;"><spring:message code="basePoints.label" /><span style="color:red; font-size:2" id="basePoints">*</span></label>
                                    	 <input type="text" class="form-control"  name="basePoints" id="basePoints" value="${loyaltyCard.basePoints}"/>
                                    	</div>
                                     </div>
									
										<div class="form-group col-lg-2" style="margin-top: -15px;">
                                            <label style="font-family: Calibri;color: gray;white-space: nowrap;"><spring:message code="minimumPoints.label" /> </label>
...
<!--                                             <span style="color:red; font-size:2" id="errRewardConversionRatio"></span> -->
									...
									<div class="form-group col-lg-2" style="white-sapce:nowrap;margin-top: -15px;padding:0px" >
                                       <div class="col-lg-9" style="">
                                    	<label style="font-family: Calibri;color: gray;white-space: nowrap;"><spring:message code="minimumRedeemPoints.label" /></label>
...
<!--                                     	  <span style="color:red; font-size:2" id="errbasePoints"></span> -->
									 ...
									 <div class="form-group col-lg-2" style="white-sapce:nowrap;margin-top: -15px;" >
                                      <div class="col-lg-12" style="">
                                    	<label style="font-family: Calibri;white-space: nowrap;" >Max Points/Day</label>
                                    	 <input type="text" class="form-control"  name="maxPointsPerDay" id="maxPointsPerDay" value="${loyaltyCard.maxPointsPerDay}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                     ...
                                     <div class="form-group col-lg-2" style="white-sapce:nowrap;margin-top: -15px;padding:0px" >
                                      <div class="col-lg-9" style="padding-left:0px">
                                    	<label style="font-family: Calibri;white-space: nowrap;" >Redeem Time</label>
                                    	 <input type="text" class="form-control"  name="redeemTime" id="redeemTime" value="${loyaltyCard.redeemTime}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
						...
						<div class="row">			
							...
							<div class="col-lg-6" style="padding: 0px;">
								...
								<div class="form-group col-lg-3" style=" margin-top: -19px;">
                                 ...
                                 <a onclick="" style="font-size: 28px;" disabled="disabled" >
						...
						<div class="row">	
									...
									<div class="col-lg-12" style="margin-top: -23px;">
                                        ...
                                        <thead style="background-color: #eeeeee !important;position: relative;display:block; table-layout: fixed;">
                                            <tr>
                                             
                                            	<%-- <th><spring:message code="s.no.label" /></th> --%>
                                            	<%-- <th><spring:message code="crm.reward.criteria.label" /></th>
                                                <th><spring:message code="startvalue.label" /></th>
                                                <th><spring:message code="endvalue.label" /></th> --%>
                                                <th  style="width:25%">Criteria<%-- <spring:message code="crm.reward.criteria.label" /> --%></th>
                                                <th  style="width:25%">Start Value</th>
                                                <th  style="width:25%">End Value</th>
                                                 <th  style="width:25%"><spring:message code="offer_reward_value.label" /></th>
                                                   <th  style="width:25%"><spring:message code="loyalty.reward.type.label" /></th>
                                       ...
                                       <tbody style="text-align:ceneter;height: 100px;overflow-y: auto;overflow-x: auto;display:block; table-layout: fixed;">
                                        <c:forEach var="purchaseRange" items="${loyaltyCard.loyaltyPurcahseRanges}" varStatus="theCount">
                                            <tr id="dynamicdiv${theCount.index+1}" style="text-align:ceneter;">
                                          	 <%--    <td class='sno'>${theCount.index+1}</td> --%>
                                          	     <td  style="width:25%" id="rewardCriteria${theCount.index+1}">${purchaseRange.rewardCriteria}</td>
                                          	    <%-- <input type="hidden" id="autoNumber${theCount.index+1}" value="${purchaseRange.autoNumber}"/> --%>
                                                <td  style="width:25%" id="startvalue${theCount.index+1}">${purchaseRange.minPurchaseValue}</td>
                                                <td  style="width:25%" id="endvalue${theCount.index+1}">${purchaseRange.maxPurchaseValue}</td>
                                                <td  style="width:25%" id="rewardValue${theCount.index+1}">${purchaseRange.rewardValue}</td>
                                                <td  style="width:25%" id="rewardType${theCount.index+1}">${purchaseRange.rewardType}</td>
							...
							<div class="row">	
								<div class="col-lg-11" style=" margin-top: 19px;margin-left: 17px;">
				...
				<%-- 	
						<div class="col-lg-6" style="margin-top:-36px;padding-left:33px;">
                     ...
                     <table id="cardDetails" class="table table-bordered table-striped">
                      <thead style="background-color: #eeeeee !important;border-top: hidden; border-left: hidden;border-right: hidden;">
                         ...
                         <td>${loyalityCardInfo.loyaltyCardNumber}</td>
                         <td>${startDate}</td>
                         <td>${tillDate}</td>
                         <fmt:parseNumber var = "statusofCard" type = "number" value = "${loyalityCardInfo.cardStatus}" />
                         <c:set var="statusofCard" value="${loyalityCardInfo.cardStatus}"/>
                         <c:choose>
					 ...
					 --%>	
						...
						<div class="col-lg-6" style="">
								   ...
								   <div class="form-group col-lg-11" style="text-align:center;  margin-bottom: 0.3%;    ;">
              	...
              	<c:if test="${(totalRecords)>0}">
					...
					<br/>
						 ...
						 <div class="row" style="text-align: center;">
							<input type="button" class="btnCls" style="" onclick="viewLoyaltyCards('loyaltyCards','Loyaltycards','0','menu');" value="<spring:message code="back.label" />" />
						</div>			
