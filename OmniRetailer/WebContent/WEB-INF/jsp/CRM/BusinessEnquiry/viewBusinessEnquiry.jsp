                           ...
                           <div class="box-header" style="text-align: ">
                                ...
                                <form id="newGiftVouchers" method="post" >
	        						...
	        						<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${success}</div>
                                   	<div class="row">
                                   		...
                                   		<div class="form-group col-lg-4 col-md-4" style=""> 
                                            <input type="text" readonly="readonly" class="form-control" id="firstName" name="firstName" value="${businessEnquiry.fromFirstName}" placeholder="<spring:message code="business.enquiry.first.name.label" />"/>
                                             <span style="color:red; font-size:2" id="firstNameError"></span>
										</div>
										<div class="form-group col-lg-4 col-md-4" style=""> 
                                            <input type="text" readonly="readonly" class="form-control" id="lastName" name="lastName" value="${businessEnquiry.fromLastName}" placeholder="<spring:message code="business.enquiry.last.name.label" />"/>
                                         ...
                                         <label><spring:message code="business.enquiry.contact.info.label" /> <span style="color:red; font-size:2">*</span></label>
                                            <input type="text" class="form-control" id="emailId" readonly="readonly" name="emailId" value="${businessEnquiry.emailId}" placeholder="E-Mail ID">
                                   ...
                                   <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-right: 2px;">
				                                  	...
				                                  	<select  style="padding: 2px;"  class="form-control" disabled="disabled" id="defaultCountry" title="India - IN &#013;USA - US &#013;UK - GB &#013;Australia - AU">
				                                  ...
				                                  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="padding-left: 0px;">
				                                  	...
				                                  	<input type="text" readonly="readonly" class="form-control" placeholder="Phone No" id="phoneNumber" size="15" value="${businessEnquiry.phoneNumber}" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
				                                  </div>
                                       </div>
                                                    </div>
                                     	...
                                     	<div class="row">
                                   		...
                                   		<div class="col-lg-2 col-md-2"></div>
                                   		<div class="form-group col-lg-4 col-md-4" style=""> 
                                   			<input class="form-control calendar_icon" readonly="readonly" value="${businessEnquiry.enquiryDateStr}" name="enquiryDate" id="enquiryDate" size="20" type="text" placeholder="DD/MM/YYYY"/>
                                             <span style="color:red; font-size:2" id="enquiryDateError"></span>
										</div>
										<div class="form-group col-lg-4 col-md-4" style=""> 
										<div class="bootstrap-timepicker">
                                            <div class="input-group">                                            
                                                <input type="text" readonly="readonly" class="form-control timepicker" name="enquiryTime" id="enquiryTime" value="${businessEnquiry.enquiryTimeStr}" />
										...
										<div class="col-lg-6 col-md-6">
                                   		...
                                   		<div class="row">
                                   		<div class="form-group col-lg-4 col-md-4" style="">
                                   			<input class="form-control calendar_icon" readonly="readonly" value="${businessEnquiry.contactDateStr}" name="contactDate" id="contactDate" size="20" type="text" placeholder="DD/MM/YYYY"/> 
                                             <span style="color:red; font-size:2" id="contactDateError"></span>
										</div>
										<div class="form-group col-lg-4 col-md-4" style=""> 
											<div class="bootstrap-timepicker">
	                                            <div class="input-group">                                            
	                                                <input readonly="readonly" type="text" class="form-control timepicker" name="contactTime" id="contactTime" value="${businessEnquiry.contactTimeStr}" />
	                                                <div class="input-group-addon">
	                                                    <i class="fa fa-clock-o"></i>
	                                                </div>
	                                            </div><!-- /.input group -->
										...
										<div class="col-lg-10 col-md-10">
                                   		...
                                   		<div class="form-group col-lg-2 col-md-2" style=""> 
                                            <input type="text" readonly="readonly" class="form-control" id="houseNo" name="houseNo" value="${businessEnquiry.houseNo}" placeholder="<spring:message code="business.enquiry.house.number.label" />"/>
                                             <span style="color:red; font-size:2" id="houseNoError"></span>
										</div>
										<div class="form-group col-lg-2 col-md-2" style=""> 
                                            <input type="text" readonly="readonly" class="form-control" id="streetName" name="streetName" value="${businessEnquiry.streetName}" placeholder="<spring:message code="business.enquiry.street.label" />"/>
                                             <span style="color:red; font-size:2" id="streetNameError"></span>
										</div>
										<div class="form-group col-lg-2 col-md-2" style=""> 
                                            <input type="text" readonly="readonly" class="form-control" id="location" name="location" value="${businessEnquiry.location}" placeholder="<spring:message code="business.enquiry.locality.label" />"/>
                                             <span style="color:red; font-size:2" id="locationError"></span>
										</div>
										<div class="form-group col-lg-2 col-md-2" style=""> 
                                            <input type="text" readonly="readonly" class="form-control" id="city" name="city" value="${businessEnquiry.city}" placeholder="<spring:message code="business.enquiry.city.label" />"/>
                                             <span style="color:red; font-size:2" id="cityError"></span>
										</div>
										<div class="form-group col-lg-2 col-md-2" style=""> 
                                            <input type="text" readonly="readonly" class="form-control" id="state" name="state" value="${businessEnquiry.state}" placeholder="<spring:message code="business.enquiry.state.label" />"/>
                                             <span style="color:red; font-size:2" id="stateError"></span>
										</div>
										<div class="form-group col-lg-2 col-md-2" style=""> 
                                            <input type="text" readonly="readonly" class="form-control" id="zipCode" name="zipCode" value="${businessEnquiry.zipCode}" placeholder="<spring:message code="business.enquiry.zip.code.label" />"/>
                                     		...
                                     		<div class="col-lg-1 col-md-1"></div>
												...
												<div class="row">
			                                   		<div class="form-group col-lg-2 col-md-3" style="">
			                                            ...
			                                            <select disabled="disabled" id="enquiryType" class="form-control" >
													 ...
													 <div class="form-group col-lg-2 col-md-3" style="">
			                                            ...
			                                            <select disabled="disabled" id="enquiryChannel" class="form-control" >
													...
													<div class="form-group col-lg-4 col-md-3"  style="">
			                                            ...
			                                            <input type="text" readonly="readonly" class="form-control" value="${businessEnquiry.enquirySubject}" id="enquirySubject" name="enquirySubject" />
         ...
         <input type="hidden" id="searchBusinessEnquiry" value=""> 
				<!--added by manasa  -->
                                     	...
                                     	<div class="row">
	                                     	<div class="col-lg-1 col-md-1"></div>
	                                     	<div class="col-lg-10 col-md-10" >
		                                     	<textarea  rows="5" readonly="readonly" class="form-control" style="resize:none;" id="enquiryDesc" name="enquiryDesc" placeholder="<spring:message code="enter.enquiry.description.label" />" >${businessEnquiry.enquiryDesc}</textarea>
