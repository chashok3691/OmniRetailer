...
<script type="text/javascript">
	...
	/* if($("#phoneNumber").val() != ""){
		...
		$("#defaultCountry").attr("disabled","disabled");
	} */
	if($("#emailId").val() != "")
  ...
  <div class="col-xs-12">
	<div class="box box-primary">
		 <div class="box-header" style="text-align: center">
	         <h3><spring:message code="edit.customer.label" /></h3>
        </div>
	      <!-- form start -->
		 ...
		 <input type="button" style="margin-right: 14px;" class="btnCls" onclick="validateCustomerForm('edit')" value="<spring:message code="submit.label" />" />
						...
						<div class="form-group col-lg-3 col-md-3">
			                ...
			                <div class="row">
			                       ...
			                       <input type="hidden" class="form-control" name="mobileNumber" id="phone"  value="${customerObj.phone}"/>
			                        ...
			                        <input type="hidden" id="otpCode" value="${customerObj.otpCode}"/>
			                  </div>
	            ...
	            <div class="col-lg-12 col-md-12">
	              ...
	              <div class="row">
						...
						<div class="form-group col-lg-2 col-md-3">
                            ...
                            <input type="text" class="form-control clearError" name="monthlyIncome" value="${customerObj.monthlyIncome}" id="monthlyIncome" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"  placeholder="<spring:message code="customer.monthly.income.label" />" />
						</div>
						<div class="form-group col-lg-2 col-md-3">
						...
						<div class="form-group col-lg-2 col-md-3">
                            ...
                            <input type="text" readonly="readonly" class="form-control" value="${customerObj.availableCreditLimit}" id="creditRemaining"  placeholder="<spring:message code="customer.creditRemaining.label" />" />
						</div>
		...
		<div class="row" style="text-align: right;">
		 <input type="button" style="margin-right: 14px;" class="btnCls" onclick="validateCustomerForm('edit')" value="<spring:message code="submit.label" />" />
		  <c:if test="${sessionScope.role == 'super admin'}"> 
		  	<input type="button" class="btnCls " style="margin-right: 16px;" onclick="viewCustomers('customerViews');" value="<spring:message code="cancel.label" />" />
		  </c:if>
		 <c:forEach var="accessControl" items="${sessionScope.crm}">
            <c:if test="${accessControl.appDocument == 'CustomerView' && accessControl.write == true && accessControl.read == true}">
				<input type="button" class="btnCls " style="margin-right: 14px;" onclick="viewCustomers('customerViews');" value="<spring:message code="cancel.label" />" />
