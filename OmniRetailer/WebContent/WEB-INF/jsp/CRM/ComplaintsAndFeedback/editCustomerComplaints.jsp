 ...
 * file name		        : Inventory Manager/complaintsAndFeedback/editCustomerComplaints.jsp
 * file type		        : JSP
 * description				: The editCustomerComplaints form is displayed using this jsp
 * */ -->
 ...
 <div class="box-header" style="text-align: left; height:25px;">
   <c:set var="today" value="<%=new java.util.Date()%>" /> 
	   <div class="row">
	   	<div class="col-lg-12">
			<div class="col-lg-9">
		    	<h3><spring:message code="edit.customer.complaints.label" /></h3> 
		    </div>
	        	  ...
	        	  <label><spring:message code="customer.mobile.no.label" /> <span style="color:red; font-size:2">*</span></label>
                           	 <div class="row">
                                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                  	<select disabled="disabled" class="form-control" style="padding: 2px 5px;" id="defaultCountry" title="India - IN &#013;USA - US &#013;UK - GB &#013;Australia - AU">
                                  ...
                                  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="padding-left: 0px">
                                  	<input type="text" readonly="readonly" class="form-control" value="" placeholder="<spring:message code="enter.contact.number" />" id="phoneNumber" size="15" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                  </div>
        ...
        <div class="form-group col-lg-3">
        	 <div class="row">
	        	 <div class="col-lg-12">
	                ...
	                <input type="text" class="form-control"   id="customerEmail" value="${customerObj.email}" placeholder="" />
         ...
         <div class="form-group col-lg-3">
        	 <div class="row">
	        	 <div class="col-lg-12">
	                ...
	                <input type="text" class="form-control" id="firstName" value="${customerObj.name}"  placeholder="<spring:message code="enter.first.name" />" />
         ...
         <div class="form-group col-lg-3">
        	 <div class="row">
	        	 <div class="col-lg-12">
	                ...
	                <input type="text" class="form-control" id="lastName" value="${customerObj.lastName}"  placeholder="<spring:message code="enter.last.name" />" />
          ...
          <div class="form-group col-lg-3">
        	 <div class="row">
	        	 <div class="col-lg-12">
	                ...
	                <input class="form-control calendar_icon" readonly="readonly" style="background-color: white;" name="dob" value="${customerObj.dobStr}" id="dob" size="20" type="text" onfocus="callCalender('dob')" onclick="callCalender('dob')" placeholder="DD/MM/YYYY"/>
   ...
   <div class="form-group col-lg-3">
        	 <div class="row">
        	  <div class="col-lg-12">
	                ...
	                <input type="text" class="form-control" id="houseNumber" value="${customerObj.houseNo}"  placeholder="<spring:message code="enter.house.number.label" />" />
   ...
   <div class="form-group col-lg-3">
        	 <div class="row">
        	  <div class="col-lg-12">
	                ...
	                <input type="text" class="form-control" id="streetName" value="${customerObj.street}"  placeholder="<spring:message code="enter.street.name.label" />" />
   ...
   <div class="form-group col-lg-3">
        	 <div class="row">
        	  <div class="col-lg-12">
	                ...
	                <input type="text" class="form-control" id="locality" value="${customerObj.locality}"  placeholder="<spring:message code="enter.locality.label" />" />
    ...
    <div class="form-group col-lg-3">
        	 <div class="row">
        	  <div class="col-lg-12">
	                ...
	                <input type="text" class="form-control" id="zipcode" value="${customerObj.pin_no}" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.zipcode.label" />" />
         ...
         <div class="form-group col-lg-3">
        	 <div class="row">
        	  <div class="col-lg-12">
	                ...
	                <input type="text" class="form-control" id="city" value="${customerObj.city}"  placeholder="<spring:message code="enter.city.label" />" />
         ...
         <div class="form-group col-lg-3">
        	 <div class="row">
        	  <div class="col-lg-12">
	                ...
	                <input type="text" class="form-control" id="landmark" value="${customerObj.landMark}"  placeholder="<spring:message code="enter.landmark.label" />" />
        	 ...
        	 <div class="row">
	        	 <div class="col-lg-12">
                    ...
                    <select id="status" name="country" class="form-control">
                                     <option value="Opened" ${'Opened' == customerComplaints.complaintStatus ? 'selected' : ''}>Opened</option>
				              		<option value="Pending" ${'Pending' == customerComplaints.complaintStatus ? 'selected' : ''}>Pending </option>
									<option value="Closed" ${'Closed' == customerComplaints.complaintStatus ? 'selected' : ''}>Closed</option>
                    </select>
 				</div>
             </div>
         </div>
         ...
         <div class="form-group col-lg-3">
        	 <div class="row">
	        	 <div class="col-lg-12">
	                ...
	                <input type="text" class="form-control"   id="organizationName" value="${customerObj.companyName}" placeholder="" />
 ...
 <div class="form-group col-lg-3">
       ...
       <div class="form-group col-lg-3">
        	 <div class="row" style="text-align:center; ">
	        	 <div class="col-lg-12">
	        	<button type="button" class="buttons btn-default btn-lg" style="padding:5px 27px;width:100%; margin-top:17px; background-color: rgb(195,195,195); font-size:15px"  onclick="return getCustomerPurchaseDetails('','0');"><spring:message code="customer.complaints.browse.purchases" /></button>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <table id="example1" class="table table-bordered table-striped" style="margin-left: 10px; width: 98.2%;">
                                        <thead style="background-color: #3c8dbc; color: #ffffff">
                                            <tr>
                                                <th><div ><spring:message code="complaint.id.label" /></div></th>
                                                <th><div ><spring:message code="created.by.label" /></div></th>
                                                <th><div ><spring:message code="complaint.date.label" /></div></th>
                                                <th><div ><spring:message code="complaint.type.label" /></div></th>
                                                <th><div ><spring:message code="complaint.status.label" /></div></th>
												<th><div ><spring:message code="complaint.details.label" /></div></th>
                                            </tr>
                                        </thead>
                                        <tbody style="text-align:center">
                                        </tbody>
...
<br>
   <div class="row" style="text-align: center;">
 <c:forEach var="activity" items="${customerComplaints.nextActivities}">
 	<c:forEach var="accessControl" items="${sessionScope.customerComplaintsActivity}">
 		<c:if test="${activity == accessControl.appDocumentActivity}">
		 	<input type="button" id="submit" style="width: 70px;" class="btn bg-olive btn-inline" onclick="validateCustomerComplaintsForm('edit')" value="<spring:message code="submit.label" />">
		 	<input type="button" style="margin-left:1%;width: 80px;position: relative;" class="btn bg-olive btn-inline" onclick="validateCustomerComplaintsForm('edit','${activity}');" value="${activity}" />
 		</c:if>
   </c:forEach> 
 </c:forEach>
  <input type="button" id="submit" style="width: 70px;" class="btn bg-olive btn-inline" onclick="validateCustomerComplaintsForm('edit')" value="<spring:message code="submit.label" />">
