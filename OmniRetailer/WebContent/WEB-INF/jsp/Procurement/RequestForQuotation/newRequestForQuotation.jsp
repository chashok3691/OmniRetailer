...
<div class="row">
  <div class="col-lg-12">
				<div class="box box-primary">
                                ...
                                <form role="form">
                                    ...
                                    <div class="row">
	                                   <div class="form-group col-lg-2 col-xs-2 lbl">
                                        ...
                                        <label><spring:message code="fromlocation.label" /> <span style="color:red; font-size:2">*</span></label>
                                            <select class="form-control" id="fromlocation" onchange="getLocationDetails()">
                                        ...
                                        <!-- <div class="address-group col-lg-4 col-xs-4 lbl">
                                  		 ...
                                  		 <div class="form-group col-lg-2 col-xs-2 lbl"></div>
                                        <div class="address-group col-lg-9 col-xs-8">
                                            <input type="text" class="form-control clearError" id="fromAddress" value="${quoteObj.fromAddressLocality}" placeholder="<spring:message code="select.location"/>"/>
                                        </div>
                                        </div>
                                       <!--  <div class="address-group col-lg-4 col-xs-4 lbl">
                                  		 </div> -->
                                       ...
                                       <!--  <div class="address-group col-lg-4 col-xs-4 lbl">
                                  		  ...
                                  		  <%--  <select class="form-control" id="fromState" onchange="">
                                   ...
                                   <label><spring:message code="prepared.by.label" /> </label>
                                     ...
                                     <div class="row">
                                      <div class="address-group col-lg-9 col-xs-7 ">
		                                   <label><%-- <spring:message code="procurement.repeatSupply.label" /> --%><spring:message code="procurement.repeatSupply.label" />  </label>
		                                   <select class="form-control" id="repeatSupply" onchange="">
		                                    <option value="">-- Select --</option>
                                     ...
                                     <div class="row">
                                      <div class="address-group col-lg-9 col-xs-7 ">
		                                   <label> <spring:message code="procurement.repeatPeriod.label" /> </label>
		                                    <select class="form-control" id="repeatPeriod" onchange="">
		                                    <option value="">-- Select --</option>
                           ...
                           <option value="Ordinary" ${'Ordinary' == quoteObj.shipmentMode ? 'selected' : ''}>Ordinary</option>
                                     ...
                                     <input type="radio" checked="checked" name="tax" id="radioYes">Yes<!--  <spring:message code="procurement.taxInclusive.yes" />-->
                                      </div>
                                     </c:when>
                                     <c:otherwise>
                                     <div class="radio-inline">
                                     <input type="radio" name="tax" id="radioYes">Yes<!--  <spring:message code="procurement.taxInclusive.yes" />-->
                                      </div>
                                     </c:otherwise>
                                      ...
                                      <div class="address-group col-lg-12 col-xs-12 ">
                                       ...
                                       <div class="radio-inline">
                                       <input type="radio" name="tax" checked="checked" id="radioNo">No<!--<spring:message code="procurement.taxInclusive.no" />  -->
                                       </div>
                                       </c:when>
                                       <c:otherwise>
                                       <div class="radio-inline">
                                       <input type="radio" name="tax" id="radioNo">No<!--<spring:message code="procurement.taxInclusive.no" />  -->
                                       </div>
                                       </c:otherwise>
                                       </c:choose>
                                       </div></div>
                                     ...
                                     <div class="form-group col-lg-4">
                                        ...
                                        <div class="form-group col-lg-11 col-xs-9">
                                         <label><spring:message code="product.secondary.supplier.label" />  <span style="color:red; font-size:2">*</span></label>
                                           <select class="form-control" id="suppliers" onchange="clearError()" multiple="multiple" style="height: 141px;">
                                 ...
                                 <div class="row">
                                   <div class="address-group col-lg-12 col-xs-6 ">
                                   <div class="address-group col-lg-5 col-xs-6 " style=" margin-top: -4px;border: 1px solid rgba(192, 192, 192, 0.25);">
                                     ...
                                     <div class="radio-inline">
                                     <input type="radio" checked="checked" name="cost" id="inclusive"><spring:message code="procurement.shipmentCost.inclusive" /> 
                                      </div>
                                      </c:when>
                                      <c:otherwise>
                                      <div class="radio-inline">
                                     <input type="radio"  name="cost" id="inclusive"><spring:message code="procurement.shipmentCost.inclusive" /> 
                                      </div>
                                      </c:otherwise>
                                      </c:choose>
                                      </div></div>
                                     ...
                                     <div class="radio-inline">
                                     <input type="radio" checked="checked" name="cost" id="exclusive" ><spring:message code="procurement.shipmentCost.exclusive" />
                                      </div>
                                     </c:when>
                                     <c:otherwise>
                                     <div class="radio-inline">
                                     <input type="radio" name="cost" id="exclusive" ><spring:message code="procurement.shipmentCost.exclusive" />
                                      </div>
                                     </c:otherwise>
                                     </c:choose>
                                     </div></div>
                                      ...
                                      <div class="col-lg-2" style="padding-left: 0px;padding-top: 17px;">
      									<img alt="" style="height:21px" src="${pageContext.request.contextPath}/images/workflow_arrow.png">
      									</div>
 ...
 --%>                                      </div>
                    ...
                    <!--                        
                                              		...
                                              		<c:forEach var="item" items="${quoteObj.itemsList}" varStatus="theCount">
									             		   <tr id="dynamicdiv${theCount.count}">
														 		...
														 		<input type='hidden' id='size${theCount.count}' value='${item.size}'/>
										                  		...
										                  		<td   onkeypress='return (this.innerText.length < 10)' ><input type="number" id="demand${theCount.count}"   value="${item.demandForecast}" style="height: 100%;width:100%;text-align:center; border: none;"></td>
										                  		<td    onkeypress='return (this.innerText.length < 10)'  ><input type="number" id="minquantity${theCount.count}"  value="${item.minQty}" style="height: 100%;border: none;text-align: center;width: 100%" min="1" maxlength="10"></td>
										                  		...
										                  		<td><textarea id="remarks${theCount.count}" rows=1 style='resize:none;'>${item.remarks}</textarea></td>
                                    ...
                                    <div class="col-lg-1 col-lg1-1 "></div>
                                    <div class=" col-lg-11" style="padding-right: 13px;padding-left: 16px">
                                    <div class="col-lg-12" style="height:30px;border-bottom: 1px solid rgba(192, 192, 192, 0.25);border-top: 0px;;background-color: #f9f9f9"></div>
                                    </div>
                                     </div>
                                      <div class="row borderClass">
                                    <div class="col-lg-1 col-lg1-1 "></div>
                                    <div class=" col-lg-11" style="padding-right: 13px;padding-left: 16px">
                                    <div class="col-lg-12" style="height:30px; border-bottom:  1px solid rgba(192, 192, 192, 0.25);border-top: 0px;"></div>
                                    </div>
                                    </div>
                                    <div class="row borderClass">
                                    <div class="col-lg-1 col-lg1-1 "></div>
                                    <div class=" col-lg-11" style="padding-right: 13px;padding-left: 16px">
                                    <div class="col-lg-12" style="height:30px; border-bottom:  1px solid rgba(192, 192, 192, 0.25);background-color: #f9f9f9;border-top: 0px;"></div>
                                    </div>
                                    </div>
                                     </c:when>
                                     </c:choose>
		...
		<div class="row">
			...
			<div class="col-lg-11 loc" >
				<div class="row-fluid-5 locationRow" id="locations0">
					...
					<div class="form-group span2" style="padding-top: 23px;margin-left: 0px">
					<div class="buttons" style="margin-left: 23px">
					 ...
					 <c:forEach var="poLoc" items="${quoteObj.shipmentLocationsList}" >
						 <c:if test="${item.locationId == poLoc.shipmentLocation}">
								<tr id="selected_${poCount}" style='margin-top:5px;'>
									...
									<td id='selectedQuantity_${poCount}' class='selectedPack ${poLoc.skuId}' onBlur='changeSelectedPack(this);' onkeypress='return (this.innerText.length < 10)' contenteditable='true'><span class="${poLoc.skuId}">${poLoc.quantity}</span></td>
...
<!-- COMPOSE MESSAGE MODAL -->
	...
	<c:if test="${type == 'new'}">
       <input type="button" class="btnCls" style="" onclick="validateRequestForQuotation('Submitted','new');" value="<spring:message code="submit.label" />" />
    </c:if>
    <c:if test="${type != 'new'}">
       <input type="button" class="btnCls" style="" onclick="validateRequestForQuotation('Submitted','edit');" value="<spring:message code="submit.label" />" />
    </c:if>
    </div>
    </div>
	...
	<%-- <c:forEach var="activity" items="${quoteObj.nextActivities}">									
	 ...
	 <div class="col-lg-6" style="    padding-right: 0px;">
                 <!--   <div class="col-lg-6" style="padding-right: 0px;"></div> -->
                    <div class="col-lg-3" style=" padding-right: 0px;">
	 <c:if test="${sessionScope.role == 'super admin'}">
		<input type="button" style="" class="btnCls" onclick="viewRequestForQuotation('rqstForQutation','0');" value="<spring:message code="cancel.label" />" />
     </c:if>
     </div>
