  ...
  <div class="col-lg-12">
          ...
          <form role="form">
            ...
            <input type="hidden" class="form-control" name="supplier_Id" id="supplier_Id" readonly="readonly" value="${shipmentNoteObj.supplierId}"/>          
                ...
                <div class="form-group  col-lg-6 col-xs-8" style="margin-left: -2%;">
					<input type="text" class="form-control clearError searchItems" readonly="readonly" value="${shipmentNoteObj.poRef}" id="po_reference" />
					<!-- <div class=services>
			    		<div class="items">
          ...
          <div class="row">
             ...
             <div class="row">
                ...
                <div class="form-group col-lg-6 col-xs-8" style="margin-left: -2%;">
					<input type="text" class="form-control clearError" name="transporterCode" readonly="readonly" id="transporterCode" value="${shipmentNoteObj.transporterCode}" placeholder="<spring:message code="enter.transporter.code.label" />"/>
                ...
                <div class="form-group col-lg-6 col-xs-8" style="margin-left: -2%;">
					<input type="text" class="form-control clearError" name="transporterName" readonly="readonly" id="transporterName" value="${shipmentNoteObj.transporterName}" placeholder="<spring:message code="enter.transporter.name.label" />"/>
                ...
                <div class="form-group col-lg-5 col-xs-8" style="margin-left: -2%;">
					<input type="text" class="form-control clearError" name="carrierNo" readonly="readonly" id="carrierNo" value="${shipmentNoteObj.carrierNo}" placeholder="<spring:message code="enter.carrier.no.label" />"/>
                ...
                <div class="form-group col-lg-6 col-xs-8" style="margin-left: -2%;">
					<input type="text" class="form-control clearError" name="deliveryPerson" readonly="readonly" id="deliveryPerson" value="${shipmentNoteObj.deliveryPerson}" placeholder="<spring:message code="enter.delivery.person.label" />"/>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    	<select class="form-control clearError" style="" disabled="disabled" id="defaultCountry" title="India - IN &#013;USA - US &#013;UK - GB &#013;Australia - AU">
                    ...
                    <div class="col-lg-7 col-md-8 col-sm-8 col-xs-8" style="padding-left: 0px">
                    	<input type="text" class="form-control clearError" readonly="readonly" placeholder="<spring:message code="supplier.enter.phone.label" />" id="phoneNumber" size="15" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                    </div>
				...
				<%-- <div class="row">
						<br>
						 <div class="form-group col-lg-12" style="text-align:center;  margin-bottom: 0.3%;">
							<input type="text"  class="form-control clearError searchItems" id="searchItems"  placeholder="<spring:message code="search.items.here.label" />"  style="height:30PX;text-align:center;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" />
								<div class="services">
						    		<div class="items">
                      ...
                      <tbody style="text-align: center;">
	                       <c:forEach var="item" items="${shipmentNoteObj.shipmentNoteItems}" varStatus="theCount">
		             		   <tr id="dynamicdiv${theCount.count}">
			                  		...
			                  		<td id="quantity${theCount.count}" onkeypress='return (this.innerText.length < 10)'  class="Pack">${item.quantity }</td>
		...
		<div class="locationsAdded">
			 <c:forEach var="item" items="${shipmentNoteObj.selectedLocationList}" varStatus="theCount">
				...
				<div class="form-group span2" style="padding-top: 15px;">
					<div class="buttons" style="">
						<a onclick="showPopUp(this,'type');" id="popup${theCount.count}" class="button" style="width:110px;text-align: center;"><font size="2px"><spring:message code="shipments.label" /></font></a>
					</div>
					<span style="width: 60px;margin-left: 15px;display: none;">
 ...
 <!-- //..added by manasa -->
		...
		<div class="row">
			<div class="form-group col-lg-6">
				...
				<textarea  class="form-control clearError" readonly="readonly" placeholder="" name="shipmentTerms" id="shipmentTerms" style="resize: none;" >${shipmentNoteObj.shipmentTerms}</textarea>
			</div>
		
			<div class="form-group col-lg-6">
				<label><spring:message code="shipment.comments.label" /></label>
				<textarea  class="form-control clearError" readonly="readonly" placeholder="" name="shipmentComments" id="shipmentComments" style="resize: none;" >${shipmentNoteObj.shipmentComments}</textarea>
			</div>
		</div>
...
<br><br>
						<div class="row" style="text-align: right;margin-right:5%;">
							<input type="button" style="width: 80px;" class="btn bg-olive btn-inline" onclick="searchShipmentNotes('','','0');" value="<spring:message code="back.label" />" />
						</div>
						<br/>
