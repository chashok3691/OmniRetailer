 ...
 * Written By		        : Mythri.S
 * file type		        : JSP
 * description				: The newSupplierQuotation form is displayed using this jsp
 * */ -->
  ...
  <div class="col-lg-12">
				<div class="box box-primary">
                                    ...
                                    <input type="hidden" id="quoteRef" value="${quoteObj.quoteRef}">
                                     <input type="hidden" id="supplier_id" value="04555">
                                        <!--     <c:forEach var="supplier" items="${supplierList}">
													 <input type="hidden" id="supplier_name" value="${supplier.firmName}">
												</c:forEach>
                                 <input type="hidden" id="supplier_name" value="MSNR ENTERPRISES (WIPRO)."> -->
                                    ...
                                    <div class="row">
                                      ...
                                      <label><spring:message code="fromsupplier.label" /> <span style="color:red; font-size:2">*</span></label>
                                           ...
                                           <select class="form-control" id="fromlocation"  onchange="getSupplieretails()">
                                        ...
                                        <!-- <div class="address-group col-lg-4 col-xs-4 lbl">
                                  		 ...
                                  		 <div class="row">
                                  		  <div class="form-group col-lg-2 col-xs-2 lbl"></div>
                                        <div class="address-details col-lg-10 col-xs-8">
                                            <input type="text" class="form-control clearError" id="fromStreetName" value="${quoteObj.supplierStreetName}" placeholder="<spring:message code="street.name.label"/>"/>
                                        </div>
                                        </div>
                                        <!-- <div class="address-group col-lg-4 col-xs-4 lbl">
                                  		 </div> -->
                                  		 ...
                                  		 <div class="form-group col-lg-2 col-xs-2 lbl"></div>
                                        <div class="address-details col-lg-10 col-xs-8">
                                            <input type="text" class="form-control clearError" id="fromAddress" value="${quoteObj.supplierAddress}" placeholder="<spring:message code="select.location"/>"/>
                                        </div>
                                        </div>
                                       <!--  <div class="address-group col-lg-4 col-xs-4 lbl">
                                  		 </div> -->
                                       ...
                                       <!--   <select class="form-control" id="fromCity" onchange="">
                                         <option value="${quoteObj.supplierCity}"> <spring:message code="supplier.city.label"/> </option>

                                         </select> -->
                                         <input type="text" class="form-control clearError" id="fromCity" value="${quoteObj.supplierCity}" placeholder="<spring:message code="supplier.city.label"/>"/> 
                                        </div></div>
                                       <!--  <div class="address-group col-lg-4 col-xs-4 lbl">
                                  		 </div> -->
                                  		  <div class="row">
                          ...
                          <input type="hidden" id="selectedState" value="${quoteObj.supplierState}"></input>
                                     <!--        <input type="text" class="form-control " id="fromState" style="width:150px;" value="${quoteObj.supplierState}" placeholder="<spring:message code="state.label"/>"/>
                                       -->
                                         </div>
                                   ...
                                   <label><spring:message code="prepared.by.label" /> </label>
                                     ...
                                     <div class="row">
                                      <div class="address-group col-lg-9 col-xs-9 ">
		                            	...
		                            	<input type="text" class="form-control"  value="${quoteObj.reqQuoteRef}" id="requestref" size="15" maxlength="15"/>  -->
                       <label> <spring:message code="req.ref.label" /> </label>
                       <c:if test="${type == 'new'}">
                         <input type="text" class="form-control searchItems searchBar" value="${quoteObj.reqQuoteRef}" style="" id="rquoteRef" placeholder="<spring:message code="quote.ref.label" />" />
                      
                       </c:if>
                        <c:if test="${type!= 'new'}">
                         <input type="text" class="form-control searchItems searchBar"  readonly="readonly" value="${quoteObj.reqQuoteRef}" style="" id="rquoteRef" placeholder="<spring:message code="quote.ref.label" />" />
                      
                       </c:if>
                  <!--      <input type="text" class="form-control searchItems" value="${quoteObj.reqQuoteRef}" style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" id="rquoteRef" placeholder="<spring:message code="quote.ref.label" />" />
						 -->
						<div class=services>
					    		<div class="items">
                           	...
                           	<input type="hidden" name="quoteRef" id="quoteReference" value="${quoteObj.reqQuoteRef}"  />
                                     ...
                                     <div class="row">
                                      <div class="address-group col-lg-9 col-xs-9 ">
		                            	...
		                            	<input type="text" class="form-control" value="${quoteObj.supplierContact}" id="supcontactperson" size="15" maxlength="15"/>
                                    ...
                                    <div class="address-group col-lg-9 allignment">
                                            <label><spring:message code="contact.number.label" /> <span class="requiredField">*</span></label>
                                             <div class="row">
				                                  ...
				                                  <input type="hidden" class="form-control" name="phone" id="phone"  value="${quoteObj.supplierPhone}"/>
                                   ...
                                   <div class="row">
                                      <div class="address-group col-lg-9 col-xs-9 ">
		                            	...
		                            	<input type="text" class="form-control" id="emailid" value="${quoteObj.supplierEmail}" size="15" maxlength="15"/>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="address-group col-lg-8 col-xs-9">
                                        <label><spring:message code="open.date.label" />  <span style="color:red; font-size:2">*</span></label>
                                            <input type="text" class="form-control calendar_icon clearError" id="createdDate" readonly="readonly" style="background-color: white;" onfocus="callCalender('createdDate')" onclick="callCalender('createdDate')" value="${quoteObj.startDateForQuoteStr}" placeholder="DD/MM/YYYY" />
                           ...
                           <option value="Ordinary" ${'Ordinary' == quoteObj.shipmentMode ? 'selected' : ''}>Ordinary</option>
                               ...
                               <div class="address-group col-lg-9 col-xs-9 ">
		                            	...
		                            	<input type="text" class="form-control" placeholder="<spring:message code="enter.shipment.cost" />" id="shipmentCost" value="${quoteObj.shipmentCost}" size="15" maxlength="15"/>
		                            	...
		                            	<input type="text" class="form-control" placeholder="<spring:message code="enter.shipment.Time" />" id="shipmentTime" value="${quoteObj.shipmentTime}" size="15" maxlength="15"/>
                                        </div></div>                                       <%--  
                                        <div class="form-group col-lg-4 col-xs-4 lbl">
                                   <label><spring:message code="due.date.label" />  <span style="color:red; font-size:2">*</span></label>
                                   </div> --%>
                                     ...
                                     <label style="text-decoration: underline"><spring:message code="procurement.taxInclusive.label" /> </label>
		                            	  <select class="form-control" name="taxInclusive" id="taxInclusive">
                           ...
                           <!--   <input type="text" class="form-control" placeholder=""  id="taxInclusive" value="${quoteObj.taxInclusive}" size="15" maxlength="15"/> -->
		                                 </div> 
                                     </div>   
                                     ...
                                     <div class="row">
	                                     ...
	                                     <div class="col-lg-12" style="padding-right: 4%;text-align:center;padding-left:78px">
                                              ...
                                              <tbody style="text-align: center;">
                                              		...
                                              		<c:forEach var="item" items="${quoteObj.supplierQuoteItems}" varStatus="theCount">
									             		   <tr id="dynamicdiv${theCount.count}">
										                       ...
										                       <td id="supplyquantity${theCount.count}" contenteditable="true"  onBlur='changeSupplyQuantity(this);' onkeypress='return (this.innerText.length < 10)'  class="SupplyQuantity">${item.supplyQty}</td>
										                      ...
										                      <td><textarea id="remarks${theCount.count}" rows=1 style='resize:none;width: 250px;'>${item.remarks}</textarea></td>
										                  		<td id="Del${theCount.count}"><img id="Img${theCount.count}" src="${pageContext.request.contextPath}/images/itemdelete.png" style="width:25px;cursor:pointer;white-space:nowrap;" onclick="deleteItemDetails(this);" title="Delete"/></td>
									                  	   </tr>
								              	 </c:forEach> 
											 </tbody>
                                       </table>
		...
		<div class="row">
			...
			<div class="col-lg-11 loc" >
				<div class="row-fluid-5 locationRow" id="locations0">
					...
					<div class="form-group col-lg2-2 span2" style="padding-top: 18px;">
				
						<div class="buttons" style="">
							<a onclick="showPopUp(this);" id="popup0" class="button" style="text-align: center;"><font size="2px"><spring:message code="shipments.label" /></font></a>
						</div>
			...
			<div class="col-lg-11 loc" >
				...
				<div id="relatedItemsDiv${theCount.count}" style="display: none;"><table id="relatedItemsTable${theCount.count}"><tbody>
					<c:set var="poCount" value="1"></c:set>
					 <c:forEach var="poLoc" items="${quoteObj.suplierShipmentLocation}" >
						 <c:if test="${item.locationId == poLoc.shipmentLocation}">
								<tr id="selected_${poCount}" style='margin-top:5px;'>
									...
									<input type='hidden' id='selectedPluCode_${poCount}' value="${poLoc.skuId}" />
									<td id='selectedItemDesc_${poCount}'>${poLoc.itemDescription}</td>
									<td id="selectedUom${theCount.count}">${poLoc.unitOfMeasurement}</td>
									<td id='selectedQuantity_${poCount}' class='' onBlur='' onkeypress='return (this.innerText.length < 10)' contenteditable='true'>${poLoc.quantity}</td>
		 ...
		 <div class="row">
           ...
           <div class="row">
	            ...
	            <div class="form-group  col-lg-5 col-lg5-5" >
	                <textarea class="form-control clearError" style="resize: none;" rows="3" id="purchaseTerms" placeholder="<spring:message code="purchase.terms.label"/>">${quoteObj.purchaseTerms}</textarea>
				</div>
					
	            
				 <div class="form-group  col-lg-5 col-lg5-5" >
                	<textarea class="form-control clearError" style="resize: none;" rows="3" id="shipmentTerms" placeholder="<spring:message code="shipment.terms.label"/>">${quoteObj.shipmentTerms}</textarea>
				</div>
          </div>
         ...
         <div class="row">
          ...
          <div class="row">
                <div class="form-group col-lg-1 col-lg1-1 lbl">
       			...
       			<div class="form-group  col-lg-5 col-lg5-5">
                	<textarea class="form-control clearError" style="resize: none;" rows="3" id="paymentInstructions" placeholder="<spring:message code="procurement.payment.instructions.label"/>"> ${quoteObj.paymentInstructions}</textarea>
				</div>
				
                <div class="form-group  col-lg-5 col-lg5-5">
                	<textarea class="form-control clearError" style="resize: none;" rows="3" id="specialInstructions" placeholder="<spring:message code="special.instructions.label"/>">${quoteObj.specialInstructions}</textarea>
				</div>
         </div>
	</div><!-- /.box-body -->
<!-- COMPOSE MESSAGE MODAL -->
       ...
       <div class="modal fade popup-display" id="selected-items-modal" style="padding-right:290px;"tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialogbox">
                <div class="modal-content" style="width: 180%;">
                 ...
                 <div class="row" style="text-align: center;">
                 		<input type="button" id="saveSelection"  class="btnCls" style="margin-left:1%;margin-right:1%;width: 100px;" onclick="saveSelectedSkus();" value="<spring:message code="save.label" />" />
						<!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> -->
						<input type="button" id="cancelSelection" class="btnCls" style="margin-right: 4%;" data-dismiss="modal" aria-hidden="true" value="<spring:message code="cancel.label" />" />
                 </div>
              </div>
         </div><!-- /.modal-content -->
     </div><!-- /.modal-dialog -->
	...
	<c:if test="${type == 'new'}">
       <input type="button" class="btnCls" style="margin-left: 0%;width:80%" onclick="validateQuotation('Submitted','new');" value="<spring:message code="submit.label" />" />
    </c:if>
    <c:if test="${type != 'new'}">
       <input type="button" class="btnCls" style="margin-left: 0%;width:80%" onclick="validateQuotation('Submitted','edit');" value="<spring:message code="submit.label" />" />
    </c:if>
    </div>
    </div>
    ...
    <c:if test="${sessionScope.role == 'super admin'}">
		 <c:forEach var="activity" items="">
		 	<input type="button" style="margin-right:1%;width: 80px;position: relative;" class="btnCls" onclick="validateRequestForQuotation('${activity}','edit');" value="${activity}" />
		 </c:forEach>
	  </c:if>
	  <c:if test="${sessionScope.role != 'super admin'}">
			 <c:forEach var="activity" items="">
			 	<c:forEach var="accessControl" items="${sessionScope.procurementActivity}">
			 		<c:if test="${accessControl.appDocument == 'Qutation' && activity == accessControl.appDocumentActivity}">
					 	<input type="button" style="margin-right:3%;width: 100px;position: relative;" class="btnCls" onclick="validateRequestForQuotation('${activity}','edit');" value="${activity}" />
			 		</c:if>
    				</c:forEach> 
			 </c:forEach>
      </c:if>
	<%-- <c:forEach var="activity" items="${quoteObj.nextActivities}">									
	 ...
	 <div class="col-lg-6" style="    padding-right: 0px;">
                 <!--   <div class="col-lg-6" style="padding-right: 0px;"></div> -->
                    <div class="col-lg-3" style=" padding-right: 0px;">
	 <c:if test="${sessionScope.role == 'super admin'}">
		<input type="button"  style="width: 100px;" class="btnCls" onclick="viewqutation('all','Qutation','0','menu');" value="<spring:message code="cancel.label" />" />
     </c:if>
     </div>
	  <c:forEach var="accessControl" items="${sessionScope.warehouseStockmanagement}">
		<c:if test="${accessControl.appSubDocument == 'WarehouseQuotation' && accessControl.read == true}">   
			<input type="button" style="margin-left: 0%;;width: 100px;" class="btnCls" onclick="searchQuotation('','','0');" value="<spring:message code="cancel.label" />" />
		</c:if>
	</c:forEach>
	</div>
	</div></div></div>
	<br/>
        ...
        <script type="text/javascript">
            ...
            if($("#selectedSuppliers").val()!=''||undefined){
            	  $("#fromlocation option:selected").text($("#selectedSuppliers").val());
            }
