...
$(document).ready(function(){
	...
	$('#searchStocks').on('input',function(e){
		if($(this).val().trim()==""){
			viewWarehouseStoragePickList('warehouseStoragePickList','pickList','0','warehouse','menu');
		}
	});
	 ...
	 $('#mySearch').click(function(){
	        ...
	        return viewWarehouseStoragePickList('warehouseStoragePickList','pickList','0','warehouse','menu');
	    })
      ...
      <div class="box-header" align="center">
		<h3 class="box-title" >
			Pick-List
             ...
             <div class="box-body table-responsive">
              ...
              <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                  ...
                  <div class="row">
                  <a onclick="viewWarehouseStoragePickList('warehouseStoragePickList','pickList','0','warehouse','menu');" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                  <div class="row">
                 ...
                 <%--    <label><spring:message code="startprice.label"/></label> --%>
                    ...
                    <div class="row">
                       <div class="col-lg-1 col-xs-2">
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewWarehouseStoragePickList('warehouseStoragePickList','pickList','0','warehouse','menu');">
                  ...
                  <a onclick="return newPickList()" class="run"><spring:message code="addnew.label"/></a>
                  </div>
                  <div class="col-lg-6">
                    ...
                    <input type="hidden" id="stockType" value="${stockType}">
                     ...
                     <table id="productstocks" class="table table-bordered table-striped" style="margin-top: 0px !important;">
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                             <tr>
                                ...
                                <th>Picklist ref</th>
                                <th>Date and time</th>
                             	<th><spring:message code="select.location" /></th>
                             	<th >Picklist By</th>
                             	<th >Total items</th>
                             	<th >No of Order</th>
                             	<th >No of Indents</th>
                             	<th >Total Pick Items</th>
                               <th style="width:80px">Picklist Cost</th> 
                                <th>Status</th>
                     ...
                     <c:forEach var="picklistlist" items="${PicklistDetailsList}"  varStatus="theCount">
                         	 ...
                         	 <td>${picklistlist.pickListId}</td>
                         	  <td>${picklistlist.createdDate}</td>
                         	   <td>${picklistlist.storeLocation}</td>
                         	    <td></td>
                         	     <td></td>
                         	      <td></td>
                         	      <td></td>
                         	      <td>${fn:length(picklistlist.warehousePickListItems)}</td>
                         	      <td>${picklistlist.totalCost}</td>
                         	      <td>${picklistlist.status}</td>
                         	      <td><a style="color:#2e7ea7 !important;" onclick="viewpicklistDetails('view','${picklistlist.pickListId}')" href="#" >View
                                </a> &nbsp;&nbsp;&nbsp;<a style="color:#2e7ea7 !important;" onclick="viewpicklistDetails('edit','${picklistlist.pickListId}')" href="#" >Edit</a></td>
      	...
      	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewWarehouseStoragePickList('warehouseStoragePickList','pickList','${totalValue}','warehouse','menu');">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-2">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewWarehouseStoragePickList('warehouseStoragePickList','pickList','${index - 11}','warehouse','menu');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${index-1 != 0 &&  totalValue != totalRecords}">
              		<div class="form-group col-lg-2">  
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewWarehouseStoragePickList('warehouseStoragePickList','pickList','${index - 11}','warehouse','menu');"> ${index} - ${totalValue} of ${totalRecords} .
              		<input type="button" class='paginationButton' value="&#62;" onclick="return viewWarehouseStoragePickList('warehouseStoragePickList','pickList','${totalValue}','warehouse','menu')">
              	</div> 
              	</c:if>
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewWarehouseStoragePickList('warehouseStoragePickList','pickList',document.getElementById('pagination').value,'warehouse','menu');" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
              </div>    
              </div>    
