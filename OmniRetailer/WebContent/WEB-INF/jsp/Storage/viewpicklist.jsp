      ...
      <div class="box-header" align="center">
		...
		<div id="Error" style="text-align:center;color:red;font-weight:bold;">${err}</div>
           <div id="Success" style="text-align:center;color:blue;font-weight:bold;">${success}</div>
            <div id="Success" style="text-align:center;color:blue;font-weight:bold;">${updateDtos[0].responseMsg}</div>
                 ...
                 <%--    <label><spring:message code="startprice.label"/></label> --%>
                    ...
                    <div class="row">
                       <div class="col-lg-1 col-xs-1">
				                       ...
				                       <div class="col-lg-10 col-xs10" style="padding-left:0px;padding-right:0px">
                     ...
                     <table id="productStoragestocks" class="table table-bordered table-striped" style="margin-top: 0px !important;">
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                         ...
                         <tbody style="text-align: center;">
                          <c:forEach var="picklistlist" items="${PicklistDetailsList}"  varStatus="theCount">
                             ...
                             <td id="itemName${theCount.count}">${genaratedPicklist.itemname}</td>
                              <td id="scanCode${theCount.count}" contenteditable="true" ></td>
                               <td > <select autofocus style='width:180px' class='storageRefence'  id='storageRefQty${theCount.count}' disabled="disabled">
                                ...
                                <td id="requiredQty${theCount.count}" contenteditable="true" onblur="changeQuantities('${theCount.count}')"></td>
                                 <td id="picklistQty${theCount.count}">${genaratedPicklist.pickListQty}</td>
                                  <td id="diffQty${theCount.count}"></td>
                                   <td id="closedQty${theCount.count}"></td>
                                    <td id="damagedQty${theCount.count}" contenteditable="true"></td>
