...
<div class="row">
  <div class="col-lg-12">
				<div class="box box-primary">
                                ...
                                <br/>
                                <h3> ${dealBean.dealID } - <spring:message code="deal_details.label" /></h3>
                                </div> --%><!-- /.box-header -->
                                <!-- form start -->
                                <form method="POST">
                                    <div class="box-body">
                                   <div class="row" style="text-align: right; margin-top: 10px;">
                                 	 ...
                                 	 <%-- <c:if test="${sessionScope.role == 'super admin'}">
                                 	 	<input type="button" id="submit" class="btn bg-olive btn-inline" style="position: relative;" onclick="editDeal('${dealBean.dealID }')" value="&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="edit.label" />&nbsp;&nbsp;&nbsp;&nbsp;" />
                                 	 </c:if> --%>
                                 	 <input type="button" id="submit" class="btn bg-olive btn-inline" style="position: relative;" onclick="editDeal('${dealBean.dealID }')" value="&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="edit.label" />&nbsp;&nbsp;&nbsp;&nbsp;" />
                                 	  ...
                                 	  <%-- <c:forEach var="accessControl" items="${sessionScope.dealsAndOffers}">
										...
										<input type="button" onclick="searchDeals('','','0')" class="btn bg-olive btn-inline" style="margin-left:1%;margin-right: 2%;position: relative;" onclick="" value="<spring:message code="cancel.label" />" />
									           ...
									           <div class="row">
									             ...
									             <div class="row">
									        	 	...
									        	 	<div class="form-group col-lg-4">
									        	 		<label><spring:message code="marital.status.label" /></label>
									                	  <select disabled="disabled" id="otherDetails" class="form-control" >
															<option value="-- Select --" >-- Select --</option>
									        	 ...
									        	 <div class="row">
									        	 	<div class="form-group col-lg-4">
									        	 		 ...
									        	 		 <input disabled="disabled" type="text" id="city" class="form-control" value="${dealBean.customerFilter.city}" />
											   ...
											   <div class="col-lg-6" >
										           <div class="row">
										           	<div class="form-group col-lg-4">
									                	...
									                	<input disabled="disabled" class="form-control calendar_icon" readonly="readonly" value="${dealBean.customerFilter.start_date}" style="background-color: white;" id="fromDate" onfocus="callCalender('fromDate')" onclick="callCalender('fromDate')" placeholder="DD/MM/YYYY"/>
									        	 	</div>
									        	 	...
									        	 	<label><spring:message code="customer.turnover.label" /></label>
									        	 		 <div class="row">
							        						<div class="col-lg-6" style="padding-right: 5px;">
									                            <input disabled="disabled" type="text" class="form-control" id="startPrice"  value="${dealBean.customerFilter.startPrice}" required oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="start.price.label" />" />
							        						</div>
							        						<div class="col-lg-6" style="padding-left: 5px;">
									                            <input disabled="disabled" type="text" class="form-control" id="endPrice"  value="${dealBean.customerFilter.endPrice}" required oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="end.price.label" />" />
							        						</div>
							        					</div>
									        	 	</div>
									        	 </div>
									             <div class="row">
									             	<div class="form-group col-lg-4">
									                	...
									                	<input disabled="disabled" class="form-control calendar_icon" readonly="readonly" value="${dealBean.customerFilter.end_date}" style="background-color: white;" id="endDate" onfocus="callCalender('endDate')" onclick="callCalender('endDate')" placeholder="DD/MM/YYYY"/>
									        	 	</div>
									        	 	<div class="form-group col-lg-2">
									        	 	</div>
									        	 	<div class="form-group col-lg-6">
									        	 		<label><spring:message code="purchase.channel.label" /></label>
									                	  <select disabled="disabled" id="purchaseChannel" class="form-control" >
									                	  	 <option value="-- Select --" >-- Select --</option>
									        	 ...
									        	 <div class="row">
									        	 	<div class="form-group col-lg-4">
								                	  ...
								                	  <select disabled="disabled" id="customerRating" class="form-control" >
														<option value="-- Select --" >-- Select --</option>
									        	 	...
									        	 	<label><spring:message code="referrals.label" /></label>
									        	 		 <select disabled="disabled" id="referrals" class="form-control">
									        	 		 	<option value="-- Select --" >-- Select --</option>
									        	 ...
									        	 <div class="form-group col-lg-6">
									                	  ...
									                	  <select disabled="disabled" id="productCategory" onchange="emptyProduct();" name ="productCategory" class="form-control" >
									                	  	<option value="" >-- Select --</option>
									                	  	 <c:forEach var="category" items="${categories}">
									                	  	 	<option value="${category.categoryName}" ${category.categoryName == dealBean.customerFilter.productCategory ? 'selected' : ''}>${category.categoryDescription}</option>
						 ...
						 <div class="dealConfiguration subBlock">    
								...
								<div class="row-fluid-5">
									<!--  <div class="span8"> -->
									    ...
									    <div class="form-group span2">
                                            ...
                                            <input type="text" class="form-control" name="dealName" id="dealName" placeholder="<spring:message code="enter_deal_name.label" />" readonly="readonly" value="${dealBean.dealName }"/>
                                            ...
                                            <input type="text" name="dealstartdate" id="dealStartDate" required class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask readonly="readonly" value="${dealBean.dealStartDate }"/>
                                        </div><!-- /.input group -->
                                        ...
                                        <div class="form-group span2">
									     <label><spring:message code="deal_category.label" />  <span class="requiredField">*</span></label>
                                           <select class="form-control" name="dealCategory" id="dealcategory" disabled="disabled">
                                           <!--  <option value="turnoverdeal">Turn Over(Bill Amount) Deal</option> -->
                                            <option value="itemspecificdeal" ${dealBean.dealCategory == "item_specific" ? 'selected' : ''}>Item Specific Deal</option>
                                            <option value="turnover" ${dealBean.dealCategory == "turn_over" ? 'selected' : ''}>Total Bill(Turn Over) Deal</option>
                                            <option value="group_turn_over" ${dealBean.dealCategory == "group_turn_over" ? 'selected' : ''} >Group (Turn Over) Deal</option>
                                            
                                            <%-- <option value="${supplier.supplierCode}" ${supplier.supplierCode == selectedSupplier ? 'selected' : ''}>${supplier.firmName}</option> --%>
                                            </select>
                                            <br>
                                            ...
                                            <input type="text" name="dealenddate" id="dealEndDate" required class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask readonly="readonly" value="${dealBean.dealEndDate }"/>
                                        </div><!-- /.input group -->
									  ...
									  <div class="form-group span2">
                                            ...
                                            <select class="form-control" name="priority" id="dealcategory" disabled="disabled">
                                          ...
                                          <div class="bootstrap-timepicker">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" readonly="readonly" class="form-control timepicker" name="startTime" value="${dealBean.dealStartTime}" id="startTime"/>
                                                <div class="input-group-addon">
                                        ...
                                        <div class="form-group span2">
                                          ...
                                          <textarea class="form-control" name="dealDesc" id="dealDesc" style="resize: none;" rows="1" placeholder="<spring:message code="deal_description_placeholder.label"/>" readonly="readonly">${dealBean.dealDescription }</textarea>
                                          <br>
											  <div class="bootstrap-timepicker">
                                            <label><spring:message code="endtime.label"/> <span class="requiredField">*</span></label>
                                            <div class="input-group">                                            
                                                <input type="text" readonly="readonly" name="endTime" value="${dealBean.dealEndTime}" class="form-control timepicker" id="endTime"/>
                                                <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div>
                                            </div><!-- /.input group -->
                                    ...
                                    <!--  </div> -->
									  <div class="form-group span2">
	                                          ...
	                                          <select class="form-control" name="location" id="editdealLocation" multiple="multiple" disabled="disabled" style="height: 91px;">
								...
								<div class="form-group col-lg-12"
								   ...
								   <div class="row">
                                      ...
                                      <!--Modification Start   -->
                          <div style="border: 1px solid rgb(181, 230, 29); margin: -15px -5px; padding: 5px;pointer-events: none;">
								<div style=""
     			...
     			<!--Modification end   -->
                                      <!-- <div class="row">
									   <div class="form-group col-lg-12" >
									   		<c:if test="${not empty dealBean.dealGroupId}">
									   			<input type="checkbox" disabled="disabled" onchange="toggleBased(this)" style="vertical-align: -2px" id="basedOnProduct"/>&nbsp; <spring:message code="configure.based.on.product.label" />
                                      		</c:if>
                                      		<c:if test="${empty dealBean.dealGroupId}">
                                      			<input type="checkbox" disabled="disabled" checked="checked" onchange="toggleBased(this)" style="vertical-align: -2px" id="basedOnProduct"/>&nbsp; <spring:message code="configure.based.on.product.label" />
                                      		</c:if>
                                         	 <hr style="margin-top: 1px;">
                                         </div>
                                      </div>
									    ...
									    <input type="text" readonly="readonly" class="form-control searchItems basedOnProduct" id="searchItems" placeholder="<spring:message code="deal_enter_product_name.label" />"  style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;"/>
											<div class="services">
								    			<div class="items">
								     				<ul class="matchedStringUl dealProduct" style="width: 190px;"></ul>
								   				</div>
											</div>
                                       ...
                                       <div class="form-group col-lg-3" style="margin-top: -25px;">
									     <label><spring:message code="buy_sku_id.label" /></label>
									        <input type="text" readonly="readonly"  class="form-control searchItems basedOnProduct" id="buySkuList" placeholder="<spring:message code="deal_enter_sale_sku_Id.label" />"  style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;"/>
											<div class="services">
								    			<div class="items">
								     				<ul class="matchedStringUl buySkuList" style="width: 190px;"></ul>
								   				</div>
											</div>
											<div style="overflow-x : auto;margin-bottom: 15px;">
									  ...
									  <div class="row">
											<div class="form-group col-lg-3" style="margin-top: -25px;">
							        	 		 <label><spring:message code="deal_product_category.label" /></label>
		                                            <select class="form-control basedOnProduct" disabled="disabled" style="background: white;" name="category" id="dealCategory">
		                                            	<option value="-- Select --" >-- Select --</option>
		                                           		 <c:forEach var="category" items="${categories}">
											 ...
											 <div class="form-group col-lg-3" style="margin-top: -25px;">
	                                            ...
	                                            <select class="form-control basedOnProduct" disabled="disabled" style="background: white;" name="sub_category" id="deal_sub_category">
	                                            	<option value="-- Select --" >-- Select --</option>
									     ...
									     <input type="text" readonly="readonly" class="form-control searchItems basedOnProduct" id="dealProductsDataList" placeholder="<spring:message code="deal_enter_product_name.label" />"  style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;"/>
											<div class="services">
								    			<div class="items">
								     				<ul class="matchedStringUl dealProductsList" style="width: 190px;"></ul>
								   				</div>
											</div>
											<div style="overflow-x : auto;margin-bottom: 15px;">
                                       ...
                                       <div class="form-group col-lg-3" style="margin-top: -25px;">
									    <label><spring:message code="offer_sku_id.label" /></label>
									      <input type="text" readonly="readonly" class="form-control searchItems basedOnProduct" id="dealSkudatalist" placeholder="<spring:message code="deal_enter_product_name.label" />"  style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;"/>
											<div class="services">
								    			<div class="items">
								     				<ul class="matchedStringUl dealSkudatalist" style="width:190px;"></ul>
								   				</div>
											</div>
											<div style="overflow-x : auto;margin-bottom: 15px;">
									  ...
									  <div class="row">
									   <div class="form-group col-lg-12" >
									   		<c:if test="${empty dealBean.dealGroupId}">
									   			<input type="checkbox" disabled="disabled" onchange="toggleBased(this)" style="vertical-align: -2px" id="basedOnGroup"/>&nbsp;&nbsp;&nbsp; <spring:message code="configure.based.on.group.label" />
                                      		</c:if>
                                      		<c:if test="${not empty dealBean.dealGroupId}">
                                      			<input type="checkbox" disabled="disabled" checked="checked" onchange="toggleBased(this)" style="vertical-align: -2px" id="basedOnGroup"/>&nbsp;&nbsp;&nbsp; <spring:message code="configure.based.on.group.label" />
                                      		</c:if>
                                         	 <hr style="margin-top: 1px;">
                                         </div>
                                      </div>
									  ...
									  <div class="form-group col-lg-3" style="margin-top: -25px;">
									    ...
									    <input type="text"  class="form-control searchItems basedOnGroup" readonly="readonly" id="dealGroup" placeholder="<spring:message code="enter.group.label" />"  style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;"/>
											<div class="services">
								    			<div class="items">
								     				<ul class="matchedStringUl dealGroup" style="width: 190px;"></ul>
								   				</div>
											</div>
                                        ...
                                        <div class="form-group col-lg-3" style="margin-top: -25px;">
									     <label><spring:message code="offer_sku_id.label" /></label>
									      <input type="text"  class="form-control searchItems basedOnGroup" readonly="readonly" id="dealGroupSkuSearch" placeholder="<spring:message code="deal_enter_deal_sku_Id.label" />"  style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;"/>
											<div class="services">
								    			<div class="items">
								     				<ul class="matchedStringUl dealGroupSku" style="width: 190px;"></ul>
								   				</div>
											</div>
										<div style="overflow-x : auto;margin-bottom: 15px;">
			 		...
			 		<c:forEach var="dealranges" items="${dealBean.rangeList}">
		                <tr style="text-align: center;">
		                   <td style="width: 15%">${dealranges.groupId }</td>
                       	   <td style="width: 15%">${dealranges.itemId }</td>
		                   <td style="width: 15%">${dealranges.minimumPurchaseQuantity }</td>
		                   <td style="width: 15%">${dealranges.minimumPurchaseamount }</td>
		                   <td style="width: 15%">${dealranges.dealQuantity }</td>
		                   <td style="width: 15%">${dealranges.rangeMode }</td>
		                   <td style="width: 7%">${dealranges.description }</td>
		               	 </tr>
		              </c:forEach>
                    </table>
                 </div>
                              <!--  for slabs table end -->       
                                ...
                                <div class="row">
                               		...
                               		<div class="col-md-3" >
                                         ...
                                         <div class="icon-remove blue delete" id="dealBanner_image">
											<c:if test="${not empty dealBean.deal_image}">
												<%-- <img class="thumbnail" id="dealBanner_thumbnail" src="data:image/jpeg;base64,${deal_image}" style="width:80px;height:80px;"/> --%>
                                	 ...
                                	 <div class="row">
                                         ...
                                         <c:if test="${dealBean.dealStatus == 'ACTIVE'}">
                                            <div class="radio">
                                                ...
                                                <label>
                                                    <input type="radio" id="dealStatus" name="dealStatus" value=true checked disabled="disabled">
                                                    <spring:message code="deal_enable.label"/>
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" id="dealStatus" name="dealStatus" value=false disabled="disabled">
                                           ...
                                           <c:if test="${dealBean.dealStatus == 'INACTIVE'}">
                                            <div class="radio">
                                                ...
                                                <label>
                                                    <input type="radio" id="dealStatus" name="dealStatus" value=true  disabled="disabled">
                                                    <spring:message code="deal_enable.label"/>
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" id="dealStatus" name="dealStatus" checked value=false disabled="disabled">
                                                   <spring:message code="deal_disable.label"/>
                                                </label>
                                            </div>
                                           </c:if>
                                    ...
                                    <div class="form-group col-md-3" style="padding: 0px;">
                                      ...
                                      <c:if test="${dealBean.claimLoyaltypoints == 'true'}">
                                            <div class="radio">
                                                ...
                                                <label>
                                                    <input type="radio" name="loyaltyPoints" value=true checked disabled="disabled">
                                                    <spring:message code="yes.label"/>
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="loyaltyPoints" value=false disabled="disabled">
                                      ...
                                      <c:if test="${dealBean.claimLoyaltypoints == 'false'}">
                                            <div class="radio">
                                                ...
                                                <label>
                                                    <input type="radio" name="loyaltyPoints" value=true  disabled="disabled">
                                                    <spring:message code="yes.label"/>
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="loyaltyPoints" value=false checked disabled="disabled">
                                                   <spring:message code="no.label"/>
                                                </label>
                                            </div>
                                            </c:if>
                                         ...
                                         <label><spring:message code="deal_giftvouchet_status.label" /></label>
                                          <c:if test="${dealBean.claimgiftvouchers == 'true'}">
                                            <div class="radio">
                                                ...
                                                <label>
                                                    <input type="radio" name="giftvouchers" value=true checked disabled="disabled">
                                                    <spring:message code="yes.label"/>
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="giftvouchers" value=false disabled="disabled">
                                                   <spring:message code="no.label"/>
                                                </label>
                                            </div>
                                            </c:if>
                                            ...
                                            <div class="radio">
                                                ...
                                                <label>
                                                    <input type="radio" name="giftvouchers" value=true  disabled="disabled">
                                                    <spring:message code="yes.label"/>
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="giftvouchers" value=false checked disabled="disabled">
                                                   <spring:message code="no.label"/>
                                                </label>
                                            </div>
                                            </c:if>
                                   ...
                                   <div class="form-group col-md-3" style="padding: 0px;"> 
                                         <label><spring:message code="deal_claims_coupons.label" /></label>
                                          <c:if test="${dealBean.claimCoupons == 'true'}">
                                            <div class="radio">
                                                ...
                                                <label>
                                                    <input type="radio" name="coupons" value=true checked disabled="disabled">
                                                    <spring:message code="yes.label"/>
                                                </label>
                                            </div>
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="coupons" value=false disabled="disabled">
                                                   <spring:message code="no.label"/>
                                                </label>
                                            </div>
                                            </c:if>
                                          <c:if test="${dealBean.claimCoupons == 'false'}">
                                            <div class="radio">
                                                ...
                                                <label>
                                                    <input type="radio" name="coupons" value=true  disabled="disabled">
                                                    <spring:message code="yes.label"/>
                                                </label>
                                            </div>
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="coupons" value=false checked disabled="disabled">
                                                   <spring:message code="no.label"/>
                                                </label>
                                            </div>
                                            </c:if>
                                    ...
                                    <div class="form-group col-lg-3" style="">
                                    	...
                                    	<textarea class="form-control" readonly="readonly" name="dealImageText" id="dealImageText" rows="1" style="resize: none;" placeholder="<spring:message code="display.tag.line.label" />" >${dealBean.dealImageText}</textarea>
                                    </div>
                                    	<div class="form-group col-lg-3" style="">
                                    		<label><spring:message code="deal.image.text.font.label" /></label>
                                    		<input type="text" class="form-control" readonly="readonly" id="dealImageTextFontHidden"  value="${dealBean.dealImageTextFont}">
                                    	...
                                    	<div class="form-group col-lg-2" style="">
		                                   	...
		                                   	<input class="form-control" readonly="readonly" type="text" id="dealImageTextSize" value="${dealBean.dealImageSize}" placeholder="<spring:message code="deal.image.size.label" />" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" />
                                    	</div>
                                    	<div class="form-group col-lg-2" style="">
	                                    	<label><spring:message code="deal.image.color.label" /></label>
	                                    	 <div class="input-group my-colorpicker2">
                                            <input type="text" readonly="readonly" id="dealImageTextColor" value="${dealBean.dealImageColor}" class="form-control"/>
                                            <div class="input-group-addon">
                                                <i></i>
                                            </div>
                                        </div><!-- /.input group -->
                                   ...
                                   <%--  <div class="row">
                                    ...
                                    <div class="form-group col-lg-3" style="">
                                    	...
                                    	<textarea class="form-control" readonly="readonly" name="saleText" id="saleText" rows="1" style="resize: none;" placeholder="<spring:message code="display.sale.text.label" />" >${dealBean.salePriceText}</textarea>
                                    </div>
                                    	<div class="form-group col-lg-3" style="">
                                    		<label><spring:message code="deal.image.text.font.label" /></label>
                                    		<!-- <select class="form-control" id="saleTextFont">
                                    		</select> -->
                                    		<input type="text" class="form-control" readonly="readonly" id="saleTextFontHidden" value="${dealBean.salePriceFont}">
                                    	</div>
                                    	<div class="form-group col-lg-2" style="">
		                                   	<label><spring:message code="deal.image.size.label" /></label>
		                                   	<input class="form-control" readonly="readonly" type="text" id="saleTextSize" value="${dealBean.salePriceSize}" placeholder="<spring:message code="deal.image.size.label" />" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" />
                                    	</div>
                                    	<div class="form-group col-lg-2" style="">
	                                    	<label><spring:message code="deal.image.color.label" /></label>
	                                    	 <div class="input-group my-colorpicker2">
                                            <input type="text" id="saleTextColor" readonly="readonly" value="${dealBean.salePriceColor}" class="form-control"/>
                                            <div class="input-group-addon">
                                                <i></i>
                                            </div>
                                        </div><!-- /.input group -->
                                   ...
                                   <%--  <div class="row">
                                    ...
                                    <div class="form-group col-lg-3" style="">
                                    	...
                                    	<textarea class="form-control" readonly="readonly" name="dealText" id="dealText" rows="1" style="resize: none;" placeholder="<spring:message code="display.deal.text.label" />" >${dealBean.dealPriceText}</textarea>
                                    </div>
                                    	<div class="form-group col-lg-3" style="">
                                    		<label><spring:message code="deal.image.text.font.label" /></label>
                                    		<!-- <select class="form-control" id="dealTextFont">
                                    		</select> -->
                                    		<input type="text" class="form-control" readonly="readonly" id="dealTextFontHidden" value="${dealBean.dealPriceFont}">
                                    	</div>
                                    	<div class="form-group col-lg-2" style="">
		                                   	<label><spring:message code="deal.image.size.label" /></label>
		                                   	<input class="form-control" readonly="readonly" type="text" value="${dealBean.dealPriceSize}" id="dealTextSize" placeholder="<spring:message code="deal.image.size.label" />" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" />
                                    	</div>
                                    	<div class="form-group col-lg-2" style="">
	                                    	<label><spring:message code="deal.image.color.label" /></label>
	                                    	 <div class="input-group my-colorpicker2">
                                            <input type="text" id="dealTextColor" readonly="readonly" value="${dealBean.dealPriceColor}" class="form-control"/>
                                            <div class="input-group-addon">
                                                <i></i>
                                            </div>
                                        </div><!-- /.input group -->
                                   ...
                                   <div class="row">
                                      ...
                                      <br>
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input class="form-control" readonly="readonly" value="${dealBean.closedOnStr}" name="closedOn" id="closedOn" size="20" type="text" placeholder="YYYY/MM/DD"/>
                                        </div><!-- /.input group -->
                                         </div>
                                       
                                         <div class="form-group col-lg-3">
                                            <label><spring:message code="closed.reason.label" /></label>
                                            <input type="text" readonly="readonly" class="form-control" name="closedReason" id="closedReason" value="${dealBean.closedReason}" required placeholder="<spring:message code="enter.authorised.by.label" />" />
						...
						<%-- <c:if test="${sessionScope.role == 'super admin'}">
							<input type="button" id="submit" class="btn bg-olive btn-inline" onclick="editDeal('${dealBean.dealID }')" value="&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="edit.label" />&nbsp;&nbsp;&nbsp;&nbsp;" />
						</c:if> --%>
						<input type="button" id="submit" class="btn bg-olive btn-inline" onclick="editDeal('${dealBean.dealID }')" value="&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="edit.label" />&nbsp;&nbsp;&nbsp;&nbsp;" />
						 <%-- <c:forEach var="accessControl" items="${sessionScope.dealsAndOffers}">
	                       <c:if test="${accessControl.appDocument == 'DealsConfiguration' && accessControl.write == true}">
							...
							<input type="button" onclick="searchDeals('','','0')" class="btn bg-olive btn-inline" style="margin-left:1%;margin-right: 2%;" onclick="" value="<spring:message code="cancel.label" />" />
						</div>
						 </div><!-- /.box-body -->
                  ...
                  <!--added by manasa  -->
				<input type="hidden" id="outletLocation" value="${dealObj.storeLocation}">
		 <input type="hidden" id="from" value="${dealObj.dealStartDate}">
        <input type="hidden" id="to" value="${dealObj.dealEndDate}"> 
				<!--added by manasa  -->
