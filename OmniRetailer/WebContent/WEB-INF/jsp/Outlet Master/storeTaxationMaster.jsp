...
if(err != "")
  alert(err);
$("#searchStoreTaxation").val($("#storeTax").val());
//if($("#searchTax").val().trim()!="")
	$("#searchStoreTaxation").focus();
	...
	$('#mySearch').click(function(){
	    var search = $('#searchStoreTaxation').val();
	    return searchStoreTaxationMaster(search,'','0');
	})
	$('#searchStoreTaxation').keypress(function(e){
...
<div class="row">
  ...
  <div class="box box-primary">
                  ...
                  <div id="Error" style="text-align: center;color: red;font-size: 2;font-weight: bold;padding-top:15px;">${error}</div>
                  ...
                  <div class="row">
	                       ...
	                       <%--   <div class="col-lg-4 col-xs-4" style="text-align:right;top:5px;padding-right: 0px;">
	                         ...
	                         <div class="col-lg-5 col-xs-5" style="padding-left: 0px">
	                          <label><spring:message code="EmployeeForm.location"/></label>
	                           <select class="form-control" id="location" onchange="return viewStoreTaxation('taxation','0',this.options[this.selectedIndex].value);">
                                ...
                                <span style="color: red; font-size: 2; font-weight: bold;"id="locationErr"></span>
	                           </div>
	                          </div>
	                          <div class="col-lg-3"></div>
	                      </div>
                	...
                	<div class="row">
	                     ...
	                     <%-- <input type="hidden" id="searchStoreTaxation" value="${searchName}"> --%>
	                       <!--modified by manasa  -->
	                        ...
	                        <div class="col-lg-1 col-xs-2" style="margin-top:-18px">
				                      <label>Show</label> 
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewStoreTaxation('taxation','0','');">
                      ...
                      <div class="wrapper">	 
                      <input type="text"  class="form-control" style="" value="" id="searchStoreTaxation" placeholder="<spring:message code="search.taxation.label" />"/>
	                    ...
	                    <%-- <div class="col-lg-1 col-lg-3" style="padding:0px 4px;">
							<input type="button" style="" class="btn btn-primary  addBtn" onclick="viewMirrorStore('0','taxation');" value="<spring:message code="mirrorStrore.label" />">
					    </div> --%>
					           
	                     <%--   <div class="col-lg-11">
	                      	 <input type="text"  class="form-control searchItems searchBar"  value="" id="searchStoreTaxation" placeholder="<spring:message code="search.taxation.label" />"style="" />
								<div class="services">
					    			<div class="items">
		                    ...
		                    <div class="col-lg-1" style="padding-left: 0px;">
								                <input type="button" style="" class="btn bg-olive btn-inline  addBtn" onclick="return newStoreTax();" value="<spring:message code="addnew.label" />">
								           </div>
		                    
		                    
		                    	 <div class="col-lg-1" style="padding-left: 0px;">
									<div class="buttons" style="padding-left: 0px;">
		  				               <a onclick="return validateStoreTaxation('taxation');" class="button"><font size="2px">Delete</font></a>
									 </div>
								</div> 
		                    </c:if>
		                      <c:forEach var="accessControl" items="${sessionScope.outletManagement}">
                                 ...
                                 <div class="col-lg-1" style="padding-left: 0px;">
								            ...
								            <div class="col-lg-1" style="padding-left: 0px;">
								                <input type="button" style="" class="btn bg-olive btn-inline  addBtn" onclick="return validateStoreTaxation('taxation');" value="Delete">
								           </div>
                                           ...
                                           <c:forEach var="storeTax" items="${storeTaxationList}" varStatus="theCount">
                                            ...
                                            <c:forEach var="accessControl" items="${sessionScope.outletManagement}">
    											<c:if test="${accessControl.appDocument == 'Taxation' && accessControl.write == true}"> 
                                          	    ...
                                          	    <td>${storeTax.slNo}</td>
                                                <td id="storeTaxation${storeTax.slNo}">${storeTax.taxCategoryName}</td>
                                                <td>${storeTax.taxName}</td>
                                                <td>${storeTax.taxType}</td>
                                                <td>${storeTax.taxRate}</td>
                                                <td>${storeTax.effectiveFromStr}</td>
                                                <td>${storeTax.status}</td>
                                                <td><a style="color:#2e7ea7 !important;cursor: pointer;" onclick="return viewEditStoreTax('${storeTax.taxName}','${storeTax.location}','${storeTax.taxCategoryName}','view')">View</a>&nbsp;&nbsp;&nbsp;
                                                 <c:if test="${sessionScope.role == 'super admin'}"> 
                                                 	<a style="color:#2e7ea7 !important;cursor: pointer;" onclick="return viewEditStoreTax('${storeTax.taxName}','${storeTax.location}','${storeTax.taxCategoryName}','edit')">Edit</a>
                                                 </c:if>
                                                <c:forEach var="accessControl" items="${sessionScope.outletManagement}">
    												<c:if test="${accessControl.appDocument == 'Taxation' && accessControl.write == true}"> 
                                                		<a style="color:#2e7ea7 !important;cursor: pointer;" onclick="return viewEditStoreTax('${storeTax.taxName}','${storeTax.location}','${storeTax.taxCategoryName}','edit')">Edit</a>
                ...
                <div class="row">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="return viewStoreTaxation('taxation','${totalValue}','<c:out value="${selectedLocation}"/>')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewStoreTaxation('taxation','${index -(maxRecords + 1)}','<c:out value="${selectedLocation}"/>');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewStoreTaxation('taxation',document.getElementById('pagination').value,'')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
