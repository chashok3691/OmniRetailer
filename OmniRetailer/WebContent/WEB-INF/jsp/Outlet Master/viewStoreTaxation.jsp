...
<div class="row">
  <div class="col-xs-12">
				...
				<div class="box box-primary" style="padding: ">
                   ...
                   <br/>
                   <h3 class="box-title" style="padding :5px;  border:1px solid  #808080;"><spring:message code="view.outlet.taxation.label" /></h3>
                   </div><!-- /.box-header -->
                   <!-- form start -->
                       ...
                       <input type="hidden" id="searchStoreTaxation" value="${searchName}">
						...
						<div class="row" style="text-align: center;">
						  <c:if test="${sessionScope.role == 'super admin'}"> 
						  	<input type="button" class="btnCls" style="margin-left:5%;" onclick="return viewStoreTaxation('taxation','0','${taxlocation}');" value="<spring:message code="cancel.label" />" />
						  </c:if>
