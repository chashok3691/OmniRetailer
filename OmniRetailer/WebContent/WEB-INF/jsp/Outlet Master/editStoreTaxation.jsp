...
<div class="row">
  <div class="col-xs-12">
				...
				<div class="box box-primary" style="padding: ">
                   ...
                   <br/>
                   <h3 class="box-title" style="padding :5px;  border:1px solid  #808080;"><spring:message code="edit.outlet.taxation.label" /></h3>
                   </div><!-- /.box-header -->
                   <!-- form start -->
...
<!--                                           <div class=" col-lg-1"></div> -->
						...
						<div class="row" style="text-align: center;">
						 <input type="button"  class="btnCls" onclick="validateStoreTaxation('edit');" value="<spring:message code="submit.label" />" />
						  <c:if test="${sessionScope.role == 'super admin'}"> 
						  	<input type="button" class="btnCls buttonMargin"  onclick="return viewStoreTaxation('taxation','0','${taxlocation}');" value="<spring:message code="cancel.label" />" />
						  </c:if>
