				...
				<div class="box box-primary" style="padding: ">
                     ...
                     <br/>
                           ...
                           <div class="box-body">
	        				...
	        				<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${success}</div>
                                ...
                                <label><spring:message code="counter_name.label" /></label><span class="requiredField">*</span>
                                  <input type="text" onblur="criteria(this)" class="form-control" name ="counterName" id="counterName" value = "${counterName }" placeholder="<spring:message code="enter_counter.label"/><spring:message code="counter_name.label" />" value="" />
                              </div>
                              <div class="form-group col-lg-6">
						...
						<div class="row" style="text-align: center;">
						 <input type="button" class="btnCls" onclick="saveCounter();" value="&nbsp;&nbsp;&nbsp;<spring:message code="submit.label" />&nbsp;&nbsp;&nbsp;" />
