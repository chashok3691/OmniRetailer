...
<meta charset="UTF-8">
	...
	$(document).ready(function(){	
		 ...
		 for(var i=1;i<=len;i++){
			 callCalender('empStartDate'+i);
			 callCalender('empEndDate'+i);
		 }
		$('.odd').remove();
	});
	</script>
...
<div class="row">
  <div class="col-xs-12">
                ...
                <h3><spring:message code="edit.shift.allocation.label" /></h3>
                </div><!-- /.box-header -->
                <!-- form start -->
	        		...
	        		<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -10px">${success}</div>
                       ...
                       <input type="hidden" id="shiftWeekDays" value="${shiftMasterDetailsObj.weekDays}">
                          <div class="form-group col-lg-3">
                            ...
                            <select class="form-control" disabled="disabled" name="shiftDepartment" id="shiftDepartment">
                                <c:forEach var="department" items="${departmentList}">
									<option value="${department}" ${department == shiftAllocation.shiftDepartment ? 'selected' : ''}>${department}</option>
								</c:forEach>
                              </select>
                        ...
                        <div class="row">
                         ...
                         <div class="form-group col-lg-6">
                         	...
                         	<input type="text" onblur="criteria(this)"  class="form-control searchItems searchBar" id="searchEmployee"  placeholder="<spring:message code="search.employee.label" />"  style=""  />
							<div class="services">
					 			<div class="items">
                         ...
                         <tr id="dynamicdiv${theCount.count}">
                            ...
                            <td><div style="width: 355px;">
                            	<c:if test="${shift.day1Flag == true}">
	                            	<input type="checkbox" id="sun${theCount.count}" checked="checked" style="vertical-align: -2px" class="sun">Sun&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            	</c:if>
                            	<c:if test="${shift.day1Flag == false}">
	                            	<input type="checkbox" id="sun${theCount.count}" style="vertical-align: -2px" class="sun">Sun&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            	</c:if>
				...
				<div class="row" style="text-align: center;">
				    <input type="button" style="" class="btnCls" onclick="validateShiftAllocation('edit')" value="<spring:message code="submit.label" />" />
