				 ...
				 <c:set var="counter" value="${counterDetails}" scope="page" />
                     ...
                     <br/>
                           ...
                           <div class="box-body">
	        				...
	        				<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${success}</div>
                                ...
                                <label><spring:message code="counter_name.label" /></label><span class="requiredField">*</span>
                                  <input type="text" class="form-control" readonly="readonly"  name ="counterName" id="counterName"  value="${counter.counterName}"/>
                              </div>
                              <div class="form-group col-lg-6">
						...
						<div class="row" style="text-align: center;">
						 ...
						 <input type="button" readonly="readonly" class="btnCls" style="margin-left:15%;margin-right: 15px;pointer-events: all;" onclick="return viewWhCounterMaster('WhcounterMaster','0');" value="<spring:message code="cancel.label" />" />
						</div>
					<br/>
