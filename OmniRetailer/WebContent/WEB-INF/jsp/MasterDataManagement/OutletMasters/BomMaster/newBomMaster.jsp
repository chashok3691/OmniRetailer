                          	...
                          	<div class="row form-group">
                          	 <div class=" col-lg-6">
								...
								<div class=" col-lg-4" style="padding-left: 0px;">
										...
										<div class="services">
						    				<div class="items">
						     				<ul class="matchedStringUl itemname" style="width: 100%;"></ul>
						   					</div>
										</div>
						                  </div>
                             ...
                             <div class=" col-lg-6">
                              ...
                              <div class=" col-lg-6">
                               ...
                               <div class=" col-lg-6">
                                ...
                                <input type="number" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"  value="${bomresponse.costPrice}" name="city" id="costprice"  />
                                </div>
                               </div></div>
                            <div class="row form-group">
                              <div class=" col-lg-6">
                               ...
                               <div class=" col-lg-6">
                                ...
                                <div class=" col-lg-2" style="padding-left: 0px">
                                <input type="number" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"  value="${bomresponse.salePrice}" step="0.01" name="city" id="saleprice"  />
                                </div>
                               </div></div>
                             <div class="row">
                  ...
                  <div class="box-body table-responsive">
                     <table id="itemsList" class="table table-bordered table-hover">
                       ...
                       <tbody style="text-align: center;">
						...
						<div class="row" style="">
						 <input type="button"  class=" btnCls" onclick="validateBomForm('new')" value="<spring:message code="submit.label" />" />
