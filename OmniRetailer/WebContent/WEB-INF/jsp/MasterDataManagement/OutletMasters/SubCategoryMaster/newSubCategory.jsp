 ...
 * Written By		        : Mythri
 * file name		        : admin/genericData/newSubCategory.jsp
 * file type		        : JSP
...
<div class="row">
  <div class="col-xs-12">
				...
				<div class="box box-primary" style="padding: ">
                     ...
                     <br/>
                        <h3><spring:message code="new.sub.category.label" /></h3>
                         </div><!-- /.box-header -->
                         <!-- form start -->
                          <form>
                           <div class="box-body">
	        			   ...
	        			   <div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${success}</div>
                              ...
                              <div class="row" style="padding: 0% 1%;">
								...
								<div class="form-group col-lg-7">
                                  ...
                                  <input type="text" onblur="criteriaSlashes(this)" class="form-control" id="subCategoryName" placeholder="<spring:message code="enter.sub.category.name" />" value="${subCategoryDetails.subcategoryName}" />
								...
								<div class="row" style="padding: 0% 1%;">
									...
									<div class="col-lg-7">
										...
										<section  class="form-control form-group" 
											id="sectionsList"  style="height: 100px" multiple="multiple" ></section>
									</div>
								</div>
            ...
            <img class="thumbnail companyimage" id="dealBanner_thumbnail" alt="No Image" src="${subCategoryDetails}">
						...
						<div class="row" style="text-align: center;">
						 <input type="button"  class="btnCls" onclick="saveSubCategory('new');" value="<spring:message code="submit.label" />" />
					...
					<c:forEach var="accessControl" items="${sessionScope.genericBusinessSettings}">
                         ...
                         <c:if test="${accessControl.appDocument == 'SubcategoryMaster' && accessControl.write == true && accessControl.read == true}">
						 <input type="button" class="btnCls buttonMargin"  onclick="return viewSubCategoryMaster('subCategoryMaster','0');" value="<spring:message code="cancel.label" />" />
						 </c:if>
					</c:forEach>
						</div>
