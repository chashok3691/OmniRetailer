...
<input type="hidden" id="allignment" value="1"/>
	<div class="barcode-container  ${plu.pluCode}"
		...
		<div id="${plu.pluCode}allign"
			style="padding: 1px; margin-left: 1px;; margin-top: 0px; margin-bottom: 1px; /* border-top: 1px solid #000;border-bottom: 1px solid #000;border-left: 1px solid #000;border-right: 1px solid #000; */ width: 4.80cm;">
			...
			<div class="col-lg-12" style="font-size:11px;"><div class="col-lg-12" style="font-size:11px;">Product ID:${skulist.skuId}
			</div></div>
			<div class="row">
		...
		<div class="row">
		<div class="col-lg-12" style="font-size:11px;"><div class="col-lg-4" style="font-size:11px;">Size:${plu.size}</div></div>
		</div>
		<div class="col-lg-12" style="font-size:11px;"><div class="col-lg-4" style="font-size:11px;">Size:${plu.size}</div></div>
