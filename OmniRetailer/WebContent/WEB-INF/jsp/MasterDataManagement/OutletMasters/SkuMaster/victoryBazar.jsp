...
/* 	var product = ${skulist.skuId};
	...
	$(document).ready(function() {
		...
		var dateTime = getCurrentDate();
		  ...
		  date = date[0].split('/');
		  var formatedDate = date[0]+"/"+date[2].substring(2, 4);;
		  document.getElementById("dateoftheDay").innerHTML =
			  " PKD :    "+formatedDate;
		newBarcode();
	});
...
<input type="hidden" id="allignment" value="1"/>
	<div class="barcode-container  ${plu.pluCode}"
		style="font-family: sans-serif;">
		 <div  class="row" id="${plu.pluCode}allign"
			...
			<div>
			<span class="col-lg-4" style="font-size:10px;margin-top:0px;margin-left:10px;font-weight:bold;font-family:Arial Black">VICTORY BAZARS</span></div>
			<div>
		...
		<span class="col-lg-3" style="font-size:9px;margin-left:5px;white-space: nowrap;font-weight:bold;font-family:Arial Black">VB Price :</span>
  ...
  font-weight:bold"><span id="dateoftheDay" style=" font-family:Arial Black;"></span> </p>
		 </div> 
