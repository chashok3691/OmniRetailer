 ...
 * Written By		        : Mythri
 * file name		        : Inventory Manager/master/viewProduct.jsp
 * file type		        : JSP
...
$(document).ready(function(){
   ...
   /*  var primarySupplier = $("#primary_supplier").val();
    var primarySupplierLabel = $("#primary_supplier option:selected").text();
	...
	if(subcategoryArray != undefined){
		...
		for(var i=0;i<subcategoryArray.length;i++){
			if(subCategory == subcategoryArray[i])
	...
	var selectedSuppliers = $("#selectedSuppliers").val().replace('[','').replace(']','').replace(/ /g,'');
//	alert(selectedSuppliers);
...
<div class="row">
  <div class="col-xs-12">
				<div class="box box-primary">
                                ...
                                <br/>
                                <h3><spring:message code="view.product.header.label" /></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                    ...
                                    <div class="box-body">
                                   	...
                                   	<div class="row">
                                   		...
                                   		<div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="productId" id="product_id" required value="${product.productId}" readonly="readonly" />
                                       </div>
                                         </div>
										...
										<div class="form-group col-lg-3">
                                            ...
                                            <div class="col-lg-11" style="padding-left: 0px">
                                            <input type="text" class="form-control" name="productName"  readonly="readonly"  id="product_name" value="${product.productName}" required placeholder="<spring:message code="enter.product.name.label" />" />
                                     ...
                                     <%--  <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control"  readonly="readonly" name="product_description" id="product_description" value="${product.product_description}" required placeholder="<spring:message code="enter.product.description.label" />" />
                                        ...
                                        <div class="form-group col-lg-3">
                                         <div class="col-lg-10" >
                                            <label><spring:message code="category.name.label" /></label>
                                             <select class="form-control" disabled="disabled" name="category" id="category">
                                        ...
                                        <div class="form-group col-lg-3">
                                         <div class="col-lg-11" style="padding-left: 0px">
                                            ...
                                            <select class="form-control" disabled="disabled" name="sub_category" id="sub_category">
                                            </select>
                                         </div>
                                       </div>
                                       <div class="form-group col-lg-2">
                                            <label><spring:message code="product.taxable.label" /></label>
                                             <div class="col-lg-11" style="padding-left: 0px">
                                             <select class="form-control" name="taxable" disabled="disabled" id="taxable">
                                            <option value="Yes" ${'Y' == product.taxable ? 'selected' : ''}>Yes</option>
                                            <option value="No" ${'N' == product.taxable ? 'selected' : ''}>No</option>
                                            </select>
                                        </div> 
                                        </div>
                                        ...
                                        <div class="form-group col-lg-2">
                                           ...
                                           <div class="col-lg-12" style="padding-left: 0px">
                                            <select class="form-control" name="asset_category" disabled="disabled" id="asset_category">
                                        ...
                                        <%--  <div class="form-group col-lg-3">
                                            ...
                                            <select class="form-control" name="storage_location" disabled="disabled" id="storage_location">
                                         ...
                                         <div class="row">
                                          <div class="form-group col-lg-2">
                                           ...
                                           <label><spring:message code="product.abc.category.label" /></label>
                                            <select class="form-control" name="abc_category" disabled="disabled" id="abc_category">
                                         ...
                                         <div class="form-group col-lg-2">
                                           ...
                                           <div class="col-lg-11" style="padding-left: 0px">
                                             <select class="form-control" name="warehouse_stocking_unit" disabled="disabled" id="warehouse_stocking_unit">
                                         ...
                                         <label><spring:message code="product.retail.stock.unit.label" /></label>
                                            ...
                                            <select class="form-control" name="retail_stocking_unit" disabled="disabled" id="retail_stocking_unit">
                                        ...
                                        <div class="col-lg-1"></div>
                                         ...
                                         <label><spring:message code="product.lead.time.label" /> <span style="color:red; font-size:2">*</span></label>
                                          <div class="col-lg-11" style="padding-left: 0px">
                                            ...
                                            <input type="text" class="form-control"  readonly="readonly"  name="lead_time_days" id="lead_time_days" value="${product.lead_time_days}"  oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.product.lead.time.label" />" />
                                        ...
                                        <div class="col-lg-11" >
                                            ...
                                            <select class="form-control" name="primary_supplier" disabled="disabled" id="primary_supplier">
                                        ...
                                        <div class="col-lg-11" style="padding-left: 0px">
                                            ...
                                            <select class="form-control" name="productSupplier" disabled="disabled" id="productSupplier" multiple>
                                            <%--  <c:forEach var="selectedSupplier" items="${selectedSuppliers}"> --%>
                                             <c:forEach var="supplier" items="${supplierList}">
										...
										<%-- 	</c:forEach> --%>
                                           ...
                                           <div class="form-group col-lg-3">
                                            ...
                                            <div class="col-lg-11" style="padding-left: 0px">
                                            <select class="form-control" name="warehouse" disabled="disabled" id="warehouse" multiple="multiple">
                                         ...
                                         <div class="form-group col-lg-3">
                                           <div class="col-lg-11" style="padding-left: 0px">
                                            ...
                                            <select class="form-control" name="productStore" disabled="disabled" id="productStore" multiple="multiple">
                                         ...
                                         <div class="form-group col-lg-2">
                                           <div class="col-lg-11" style="padding-right: 0px">
                                            ...
                                            <select class="form-control" disabled="disabled" name="buy_UOM" id="buy_UOM">
                                         ...
                                         <div class="form-group col-lg-2">
                                            ...
                                            <input type="text" class="form-control"  readonly="readonly" name="buy_unit_price" id="buy_unit_price" value="${product.buy_unit_price}" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.product.buy.unit.price.label" />" />
                                         ...
                                         <div class="col-lg-11" style="padding-left: 0px">
                                            ...
                                            <select class="form-control" disabled="disabled" name="sell_UOM" id="sell_UOM">
                                        ...
                                        <div class="form-group col-lg-2">
                                           ...
                                           <div class="col-lg-11" style="padding-left: 0px">
                                            <input class="form-control" readonly="readonly" name="sell_unit_price" id="sell_unit_price" value="${product.sell_unit_price}"  oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.product.sell.unit.price.label" />" />
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="col-lg-11" style="padding-right: 0px" >
                                            ...
                                            <input class="form-control" name="stock_in_hand"  readonly="readonly" id="stock_in_hand" value="${product.stock_in_hand}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.product.stock.in.hand.label" />" />
                                         ...
                                         <div class="form-group col-lg-2">
                                            ...
                                            <input class="form-control" name="min_stock"  readonly="readonly" id="min_stock" value="${product.min_stock}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.product.min.stock.label" />" />
                                         ...
                                         <div class="form-group col-lg-2">
                                           <div class="col-lg-11" style="padding-left: 0px">
                                            ...
                                            <input class="form-control" name="max_stock" readonly="readonly" id="max_stock" value="${product.max_stock}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.product.max.stock.label" />" />
                                        ...
                                        <div class="form-group col-lg-2">
                                            ...
                                            <input class="form-control" name="re_order_point"  readonly="readonly" id="re_order_point" value="${product.re_order_point}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.product.re.order.point.label" />" />
                                       ...
                                       <textarea class="form-control" rows="3" style=" width: 98.5%;" disabled="disabled"  required placeholder="<spring:message code="enter.product.description.label" />">${product.productName}</textarea>
						...
						<%--  <input type="button" class="btn bg-olive btn-inline" onclick="validateProductForm('edit')" value="<spring:message code="save.label" />" /> --%>
						<input type="button" class="btnCls" onclick="viewProductMaster('productmaster','0');" value="<spring:message code="cancel.label" />" />
						</div>
						<br/>
