 ...
 * Written By		        : Mythri
 * file name		        : Inventory Manager/master/editProduct.jsp
 * file type		        : JSP
...
<div class="row">
  <div class="col-xs-12">
				<div class="box box-primary">
                                ...
                                <br/>
                                <h3><spring:message code="edit.product.header.label" /></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                    ...
                                    <div class="box-body">
                                      ...
                                      <div class="col-lg-10" >
                                        ...
                                        <div class=" col-lg-2">
                                         ...
                                         <div class="row">
                                          <div class=" col-lg-2">
                                          <div class="form-group col-lg-11" style="padding-right: 0px">
                                         ...
                                         <div class="form-group col-lg-2">
                                          ...
                                          <div class="col-lg-11" style="padding-left: 0px">
                                            <input type="text" class="form-control" name="lead_time_days" id="lead_time_days" value="${product.lead_time_days}"  oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.product.lead.time.label" />" />
						...
						<div class="row" style="text-align: center;">
						 <input type="button" class="btnCls"  onclick="validateProductForm('edit')" value="<spring:message code="submit.label" />" />
	 	...
	 	<input type="hidden" id="selectedStores" value='${selectedStores}' />
	 		<input type="hidden" id="maxRecords" value="${maxRecords}"/>
						 	<input type="hidden" id="searchProduct" value="${searchName}"/>
