 ...
 * file name		        : MasterDataManagement/Outlet master/PriceRangeMaster/newPriceRangeMaster.jsp
 * file type		        : JSP
 ...
 <div class="row">
  ...
  <div class="col-xs-12">
    ...
    <div class="box box-primary">
     ...
     <h3 class="box-title"><spring:message code="priceRangeMaster.newPriceRange.label" /></h3>
  </div>
  </div>
      ...
      <span id="priceDescError" style="color: red;;font-size: 2;font-weight: bold;"></span> 
      </div>
  ...
  <div class="col-lg-12 col-sm-12 col-xs-12 multi_select_label" style="text-align: center;">
      ...
      <div class=" col-lg-12 buttonspadding">
                  ...
                  <div class="col-lg-6" style="    padding-right: 0px;">
                   <div class="col-lg-6" style="padding-right: 0px;"></div>
                    ...
                    <a onclick="validatepriceRangeform(priceRangeMaster,'new');" class="btnCls"><spring:message code="submit.label" /></a>
                    </div>
