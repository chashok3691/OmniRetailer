 ...
 * Written By		        : Manasa
 * file name		        : MasterDataManagement/OutletMasters/outletStockUpdate
 * file type		        : JSP
...
if(err != "")
	...
	$('document').ready(function(){
	    $('#mySearch').click(function(){
	        ...
	        return viewOutletStockUpdateDetails('OutletStockUpdate','0');
	    })
                           ...
                           <div class="col-lg1-2 col-lg-2" style="">
                            ...
                            <div class="col-lg-1" style="    width: 12%;    background: #ccc;">
                               <div class="col-lg-12" style="    border-top: 1px solid #ccc; border-bottom: 1px solid #ccc;">
                                  <div class="row">
                                    <a onclick="viewOutletStockUpdateDetails('OutletStockUpdate','0')" class="button"><spring:message code="searchbutton.label" /></a>
                                  </div>
                                 <div class="row">
                                ...
                                <br>
									    ...
									    <div class="row">
									      <div class="col-lg-1 col-xs-2" style="margin-top: 0px;">
								                <select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewOutletStockUpdateDetails('OutletStockUpdate','0')">
				                       ...
				                       <div class="col-lg-10 col-xs-8" style="margin-left: -15px;padding-left: 19px;margin-bottom: 10px;">
                                          <div class="wrapper">	 
                                       	...
                                       	<div class="col-lg-1" style="padding-left: 0px;margin-left:9px;">
								                <input type="button" style="" class="btn bg-olive btn-inline  addBtn" onclick="return updateOutletStockForAll('save');" value="<spring:message code="saveall.label" />">
								          </div>
					                </div>
					       <div style="overflow: auto;">         
                          <table id="skupriceTavble"  class="table table-bordered table-striped" style="white-space: nowrap;">
...
<%--                                  <th style="width:105px"><spring:message code="newSalePrice.label"/></th> --%>
	...
	<td><div id="overflowtext"> <a href="#" data-toggle="tooltip"  title="${sku.description}">${sku.description}</a></div></td>    
                            	 
<%--                                  <td><div style="width:145px">${sku.description}</div></td>
 --%>                                 <td>${sku.ean}</td>
                                 <td></td>
                                 <td>${sku.uom}</td>
                                 <td></td>
        				    ...
        				    <c:when test="${fn:length(sku.skuPriceLists) eq 1}">
        				      <tr id="priceListId" class="priceListId">
                               <c:forEach var="plucode" items="${sku.skuPriceLists}" varStatus="totalpricelists">
                                 ...
                                 <td><div style="width:145px">${plucode.description}</div></td>
...
<%--                                  <td id="newPrice${totalskus.count}1${totalpricelists.count}" class="newPrice" onkeypress='return (this.innerText.length < 10)' onBlur="caluclateProfitability('${totalskus.count}1${totalpricelists.count}')" style="padding: 8px; background-color: #ffffff;    border: 1px solid #ccc;" contenteditable="true" >${plucode.salePrice} <input type="number" style="border: none;    border: none;height: 100%;text-align: center;"  value="${plucode.newSalePrice}"  /></td> --%>
        				    ...
        				    <tr  class="collapse rowone${totalskus.count}" id="skuPriceList${totalskus.count}1">
                                <!--    <th></th> -->
                                  ...
                                  <th style="padding:3px;"><div style="white-space: nowrap;padding: 5px;background: #c1c1c1;"><spring:message code="description.label" /></div></th>
        				 ...
        				 <c:forEach var="plucode" items="${sku.skuPriceLists}" varStatus="totalpricelists">
        				  ...
        				  <c:if test="${fn:length(sku.skuPriceLists) gt 1}">
        				   <tr  class="collapse rowone${totalskus.count}" id="productrange${totalskus.count}${totalpricelists.count}" class="productRange">
        						...
        						<input type="hidden" class="skuID" id="skuId${totalskus.count}1${totalpricelists.count}"  value=${plucode.skuId}" />
...
<%--                                  <fmt:formatNumber var="newcostPrice" type="number"  minFractionDigits="2" maxFractionDigits="2" value="${((plucode.salePrice-plucode.costPrice)/plucode.costPrice)*100}" />${newcostPrice} --%>
                       ...
                       <div class="row" style="margin-right:0%;margin-left: 0.1%;">
              	          <c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		          <div class="form-group col-lg-6" style="text-align: left;">
              		                ...
              		                <input type="button" class='paginationButton' value="&#62;" onclick="viewOutletStockUpdateDetails('OutletStockUpdate','${totalValue}');">
              	              </div>									
                       	</c:if>
                       	<c:if test="${totalValue == totalRecords}">
              			   <c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		          <input type="button" class='paginationButton' value="&#60;" onclick="return viewOutletStockUpdateDetails('OutletStockUpdate','${index - (maxRecords + 1)}');"> ${index} - ${totalValue} of ${totalRecords} 
              	   ...
              	   <div class="col-lg-6" style="text-align: right;"> 
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewOutletStockUpdateDetails('OutletStockUpdate',document.getElementById('pagination').value)" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
