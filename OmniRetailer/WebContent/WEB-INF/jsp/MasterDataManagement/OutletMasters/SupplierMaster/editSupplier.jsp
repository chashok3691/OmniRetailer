								 ...
								 <div class="col-lg-12" >
                                        ...
                                        <div class="form-group col-lg-3">
                                         ...
                                         <label><spring:message code="supplier.target.order.value.label" /></label>
                                            ...
                                            <input type="text" class="form-control" name="targetOrderValue" id="targetOrderValue"  oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="supplier.enter.target.order.value.label" />" value="${supplierBean.targetOrderValue}" />
