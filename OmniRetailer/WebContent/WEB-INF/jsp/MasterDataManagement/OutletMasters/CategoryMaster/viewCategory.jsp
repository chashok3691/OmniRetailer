...
<meta charset="UTF-8">
	...
	<script src="${pageContext.request.contextPath}/js/masterDataManagement/outletMasters/categoryMaster.js">
...
<div class="row">
  <div class="col-xs-12">
				...
				<div class="box box-primary" style="padding: ">
                   ...
                   <br/>
                   <h3><spring:message code="view.category.label" /></h3>
                   </div><!-- /.box-header -->
                   <!-- form start -->
                     <form>
                       <div class="box-body">
                        <div id="Error" style="text-align: center;color: red;font-size: 2;font-weight: bold;">${err}</div>
                          <div class="form-group" style="padding-left: 0px">
                           <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control" readonly="readonly" id="categoryName" placeholder="<spring:message code="enter.category.name" />" value="${categoryDetails.categoryName}" />
                         </div>
                         ...
                         <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control" style="width:100%;" readonly="readonly" id="categoryPriority" placeholder="<spring:message code="enter.priority.number" />" value="${categoryDetails.sortOrder}" />
                           ...
                           <div class="form-group col-lg-2" style="padding-top: 21px">
                              <div class="fileUpload btn btn-primary browsebutton" style="font-weight: bold;">
			    			        <span style="font-size: 15px;">Browse...</span>
			    			         ...
			    			         <input id="categoryBtn" type="file" accept=".jpg ,.jpeg, .png, .PNG, .gif" disabled="disabled" onchange="addNameToTextBox('category',this);" class="upload">
               ...
               <%-- <img class="thumbnail companyimage" id="dealBanner_thumbnail" alt="No Image" src="data:image/jpeg;base64,${denominationMasterResponse.denominationImage}" style=""/> --%>
                  ...
                  <div class="form-group" style="padding-left: 0px">
                           ...
                           <div class="form-group col-lg-2" style="padding-top: 21px">
                              <div class="fileUpload btn btn-primary browsebutton" style="font-weight: bold;">
			    			        <span style="font-size: 15px;">Browse...</span>
			    			         <input id="categorybannerBtn" type="file" accept=".jpg ,.jpeg, .png, .PNG, .gif" disabled="disabled" onchange="addNameToTextBox('categorybanner',this);" class="upload">
						      </div>
                           </div>
                ...
                <div class="col-lg-2"></div>
                      ...
                      <div class="form-group" style="padding-left: 0px">
                           <div class="form-group col-lg-12">
                            ...
                            <textarea class="form-control" id="categoryDescription" readonly="readonly"  style="resize: none;" placeholder="<spring:message code="enter.category.description" />" >${categoryDetails.categoryDescription}</textarea>
                         </div>
                         </div>
                       </div><!-- /.box-body -->
                      <br>			
						...
						<div class="form-group col-lg-12">
						 <%-- <input type="button" class="btn bg-olive btn-inline" onclick="saveCategory('edit');" value="<spring:message code="save.label" />" /> --%>
						 <input type="button" class="btnCls" onclick="return viewCategoryMaster('categoryMaster','0');" value="<spring:message code="cancel.label" />" />
						</div>
						</div>
					<br/>
