...
<div class="row">
  <div class="col-xs-12">
				...
				<div class="box box-primary" style="padding: ">
                   ...
                   <br/>
                   <h3><spring:message code="view.shipment.rate.label" /></h3>
                   </div><!-- /.box-header -->
                   <!-- form start -->
                     <form id="newLocation" method="post">
                       <div class="box-body">
                        ...
                        <div class="row">
                       	 <div class="form-group col-lg-6">
                                   ...
                                   <div class="form-group col-lg-6" style="margin-left: -4%;">
                                       <select class="form-control" id="locationId" disabled="disabled" onchange="">
                                 ...
                                 <div class="row">
                                    <input type="hidden" id="sno" value="${shipmentRateObj.snoStr}">
                      	 			<div class="form-group col-lg-6" style="margin-bottom:9px;">    
                                        ...
                                        <div class="form-group col-lg-6" style="margin-left: -4%;">
                                            <select id="country" name="country" disabled="disabled" class="form-control"></select>
                                        ...
                                        <div class="form-group col-lg-6" style="margin-left: -4%;">
                                            <select id="shipmentType" name="shipmentType" disabled="disabled" class="form-control">
									  	 	  	<option value="">-- Select --</option>
                                        ...
                                        <div class="form-group col-lg-6" style="margin-left: -4%;">
                                            <select id="shipmentMode" name="shipmentMode" disabled="disabled" class="form-control">
									  	 	  	<option value="">-- Select --</option>
                                        ...
                                        <div class="form-group col-lg-6" style="margin-left: -4%;">
                                            <select id="packageType" name="packageType" disabled="disabled" class="form-control">
				  	 	  						<option value="">-- Select --</option>
				    						</select>
                                        </div> 
                         </div>
                         ...
                         <div class="form-group col-lg-3" style="margin-left: -4%;">
                        	 <input type="text" class="form-control" id="distanceStartRange" readonly="readonly" name="distanceStartRange" placeholder="<spring:message code="start.value.label" />" value="${shipmentRateObj.distanceStartRangeValueStr}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                        	 <span id="distanceStartRangeError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                         </div>
                         <div class="form-group col-lg-3">
                        	 <input type="text" class="form-control" id="distanceEndRange" readonly="readonly" name="distanceEndRange" placeholder="<spring:message code="end.value.label" />" value="${shipmentRateObj.distanceEndRangeValueStr}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                         ...
                         <div class="form-group col-lg-3" style="margin-left: -4%;">
                        	 <input type="text" class="form-control" id="orderValueStartRange" readonly="readonly" name="orderValueStartRange" placeholder="<spring:message code="start.value.label" />" value="${shipmentRateObj.orderStartPriceStr}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                        	 <span id="orderValueStartRangeError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                         </div>
                         <div class="form-group col-lg-3">
                        	 <input type="text" class="form-control" id="orderValueEndRange" readonly="readonly" name="orderValueEndRange" placeholder="<spring:message code="end.value.label" />" value="${shipmentRateObj.orderEndPriceStr}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                         ...
                         <div class="form-group col-lg-5"  style="text-align:right;">
                          ...
                          <div class="form-group col-lg-3" style="margin-left: -4%;">
                        	 <input type="text" class="form-control" id="orderQuantityStartRange" readonly="readonly" name="orderQuantityStartRange" placeholder="<spring:message code="start.value.label" />" value="${shipmentRateObj.orderQuantityStartValueStr}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                        	 <span id="orderQuantityStartRangeError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                         </div>
                         <div class="form-group col-lg-3">
                        	 <input type="text" class="form-control" id="orderQuantityEndRange" readonly="readonly" name="orderQuantityEndRange" placeholder="<spring:message code="end.value.label" />" value="${shipmentRateObj.orderQuantityEndValueStr}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                          ...
                          <div class="form-group col-lg-3" style="margin-left: -4%;">
                        	 <input type="text" class="form-control" id="weightStartRange" readonly="readonly" name="weightStartRange" placeholder="<spring:message code="start.value.label" />" value="${shipmentRateObj.weightStartRangeValueStr}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                        	 <span id="weightStartRangeError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                         </div>
                         <div class="form-group col-lg-3">
                        	 <input type="text" class="form-control" id="weightEndRange" readonly="readonly" name="weightEndRange" placeholder="<spring:message code="end.value.label" />" value="${shipmentRateObj.weightEndRangeValueStr}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                         ...
                         <div class="form-group col-lg-6" style="margin-left: -4%;">
                             <input type="text" class="form-control" id="shipmentCost" readonly="readonly" name="shipmentCost" placeholder="<spring:message code="enter.shipment.cost" />" value="${shipmentRateObj.shipmentCostStr}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
						 ...
						 <div class="row">
                           <div class="form-group col-lg-11" style="margin-left:6.0%;width: 86.5%;">
	                            ...
	                            <textarea rows="3" id="remarks" name="remarks" style="resize: none;" readonly="readonly" class="form-control allField" placeholder="<spring:message code="enter.remarks.label" />" >${shipmentRateObj.remarks}</textarea>
						...
						<div class="row" style="text-align: center;">
						  	<input type="button" class="btnCls"  onclick="return viewShipmentRateMaster('shipmentRateMaster','0');" value="<spring:message code="cancel.label" />" />
						</div>
					<br/>
