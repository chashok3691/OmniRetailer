...
<%-- 	    </c:if> --%>
	...
	<div class="form-group col-lg-3 col-md-3">
		...
		<div class="form-group col-lg-4 col-md-4">
			...
			<textarea class="form-control" onblur="criteriaSlashes2(this);" id="comments" style="resize: none;" placeholder="<spring:message code="enter.comments.label" />">${productGroupobj.groupComments}</textarea>
