			...
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<form id="newSku" method="post">
						<div class="box-body">
							<div class="row" style=" margin-top: -27px;">
								...
								<div class="col-lg-9" style=" margin-top: 14px; color: red; font-size: 2; ">	
								Note: "Quick" Update is common to all locations. please use "Detailed Edit" for Specific location. 
								</div>
								<input type="button" id="edit" style="position: relative;margin-right: 10px" class="btnCls" onclick="validateWarehouseQuickSkuMaster('edit')" value="<spring:message code="submit.label" />" /> 
								<input type="button" id="edit" class="btnCls"
									style="margin-right: 10px;position: relative" onclick="resetAllQuick();"
							...
							<div class="row">
								...
								<div class="form-group col-lg-2">
									<label><spring:message code="skuid.label" /> <span style="color: red; font-size: 2">*</span></label>
										...
										class="form-control allField" disabled readOnly id="skuIdWarehouseQuick" value="${sku.skuId}"
							     ...
							     <div class="form-group col-lg-2">
									<label><spring:message code="product.name.label" /> <span style="color: red; font-size: 2">*</span></label> 
									 <div class="col-lg-12" style="padding-left: 0px">
									    <input type="text" onblur="criteria(this)" class="form-control allField " id="searchItemsQuick" value="${sku.description}" placeholder="<spring:message code="enter.product.name.label" />"/>
									     <!-- <div class="services">
										    <div class="items">
							...
							<div class="row">
								...
								<div class="form-group col-lg-2">
									<label><spring:message code="secondaryDepartment.label" />
										...
										id="primaryDepartmentQuick" placeholder="<spring:message code="search" />" style="" value="${sku.secondaryDepartment}" />
								    	<div class="services">
										  <div class="items">
				 ...
				 <div class="form-group col-lg-2">
                           ...
                           <select class="form-control" id="classNameWarehouseQuick" name="subclassName" >
                           		 <option value=""><spring:message code="ALL.label"/></option>
	                           <%--  <c:forEach var="subCategoryDetailsList" items="${subCategoryDetailsList}">
									<option value="${subCategoryDetailsList.subcategoryName}" ${subCategoryDetailsList.subcategoryName == subcategory ? 'selected' : ''} id="${subCategoryDetailsList.subcategoryName}" >${subCategoryDetailsList.subcategoryName}</option>
						 		</c:forEach> --%>
						...
						<%-- 	<div class="form-group col-lg-2">
									...
									<div class="col-lg-10" style="padding-left: 0px">
									<input type="text" onblur="criteria(this)" class="form-control allField"  name="hsnCode"
										id="hsnCodeWarehouseQuick"  placeholder="<spring:message code="hsnCode.label" />" value="${sku.hsnCode}" />
...
<input type="hidden" id="updatedDateStrQuick" value="${sku.updated_date}">
<input type="hidden" id="createdDateStrQuick" value="${sku.created_date}">
							...
							<%-- <c:forEach var="plu" items="${sku.skuLists}" varStatus="theCount">
							...
							<c:set var="countValue" value="${theCount.count}"/>
							 ...
							 --%>
							    ...
							    <div class="form-group col-lg-2 " style="">
									<label><spring:message code="costprice.label" /><span style="color: red; font-size: 2">*</span></label>
									<c:forEach var="plu" items="${sku.warehouseSkuPriceLists}" varStatus="theCount">	
									 <c:if test="${theCount.count == 1 }"> 
									 <input type="text" onblur="criteria(this)" class="form-control allField req pluSale" onkeydown="clearError(this);" onblur="calcMarkUp(this);" value="${plu.costPrice}" id="costPriceWarehouseQuick"
									 oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
							...
							<span id="costPriceErrorforWarehouseQuick"style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
						         ...
						         <div class="form-group col-lg-2 " style="">
									...
									<c:forEach var="plu" items="${sku.warehouseSkuPriceLists}" varStatus="theCount">	
								 	<c:if test="${theCount.count == 1 }"> 
									 <input type="text" onblur="criteria(this)" class="form-control allField req pluSale" onkeydown="clearError(this);" onblur="calcMarkUp(this);" value="${plu.price}" id="mrpWarehouseQuick"
									 oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
									placeholder="<spring:message code="enter.sale.price.label" />" />
							 	...
							 	<c:if test="${theCount.count == 1 }">
										 <input type="text" onblur="criteria(this)" class="form-control allField req pluSale"
											...
											value="${plu.salePrice}${priceListCount}" id="salePriceWarehouseQuick"	oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
											placeholder="<spring:message code="enter.sale.price.label" />" />
							...
							<div class="row">
								...
								<div class="form-group col-lg-2" style="padding-right:0px">
									...
									<input type="text" onblur="criteria(this)" id="businessCategoryWarehouseQuick" 
										class="form-control allField" value="${plu.business_category}"
...
<!--                              </div> -->
							...
							<div class="form-group col-lg-2"  style="">
									...
									<input type="text" id="productHandingWarehouseQuick" onblur="criteria(this)" 
						...
						<div class="form-group col-lg-2"  style="">
									...
									<input type="text" id="productIntakeDetailforWarehouseQuick" onblur="criteria(this)"
							...
							<div class="row" style="text-align: right;">
								<div class="col-md-12">
									<input type="button" id="edit" style="margin-right: 25px"
										class="btnCls" onclick="validateWarehouseQuickSkuMaster('edit')"
	...
	<input type="hidden" id="picklistItemWarehouseQuick" value="${skuObj.picklistItem}">
    <input type="hidden" id="retailUnitsWarehouseQuick" value="${skuObj.retailUnits}">
    <input type="hidden" id="supplierNameQuick" value="${sku.supplierName}" />
    <input type="hidden" id="nonTaxableWarehouseQuick" value="${sku.nonTaxable}" />
    <input type="hidden" id="discountableWarehouseQuick" value="${sku.discountable}" />
    <input type="hidden" id="allowDecimalsWarehouseQuick" value="${sku.allowDecimals}" />
    <!-- PriceList keys -->
    <input type="hidden" id="autoNumWarehouseQuick" value="${sku.autoNum}" />
   	<input type="hidden" id="pluCodeWarehouseQuick" value="${sku.pluCode}" />
   	<input type="hidden" id="colorShadeWarehouseQuick" value="${sku.colorShade}" />
   	<input type="hidden" id="mbqWarehouseQuick" value="${sku.mbq}" />
   	<input type="hidden" id="quantityInHandWarehouseQuick" value="${sku.quantityInHand}" />
   	<input type="hidden" id="eanWarehouseQuick" value="${sku.ean}" />
   	<input type="hidden" id="zeroStockBillingWarehouseQuick" value="${sku.zeroStockBilling}" />
   	<input type="hidden" id="styleRangeWarehouseQuick" value="${sku.styleRange}" />
   	<input type="hidden" id="measureRangeWarehouseQuick" value="${sku.measureRange}" />
   	
   	<input type="hidden" id="confirmPromptPriceWarehouseQuick" value="${sku.confirmPromptPrice}" />
   	<input type="hidden" id="batchnoWarehouseQuick" value="${sku.productBatchNo}" />
   	<input type="hidden" id="storeLocationWarehouseQuick" value="${sku.storeLocation}" />
							...
							<input type="hidden" id="minSaleQtyForWarehouseQuick" value="${sku.minSaleQty}" />
							...
							<input type="hidden" id="comboWarehouseQuick" value="${sku.is_combo}" />
							<input type="hidden" id="productHandingDetailQuick" value="${sku.productHandlng}" />
							...
							<input type="hidden" id="productPrecautionsQuick" value="${sku.product_precaution}" />
							<input type="hidden" id="productSideEffectsQuick" value="${sku.product_side_effect}" />
