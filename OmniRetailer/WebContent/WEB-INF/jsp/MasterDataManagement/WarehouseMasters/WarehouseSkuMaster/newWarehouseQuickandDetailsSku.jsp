			...
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<div class="nav-tabs-custom">
                                ...
                                <li><a href="#tab_2" data-toggle="tab" target="_self" id="tab_2_detailedEdit"><spring:message code="detailedEdit.label"/></a></li>
		  ...
		  <!-- Quick Content Start -->
					             <c:if test="${type=='new'}">
                        			...
                        			<!-- left column -->
                      				  ...
                      				  <div class="col-lg-12">
                        				 <%@ include file="newWarehouseQuickSku.jsp" %>  
                                  	 	</div>
					 ...
					 <c:if test="${type=='edit'}">
                        			...
                        			<!-- left column -->
                      				  ...
                      				  <div class="col-lg-12">
                        				 <%@ include file="editWarehouseQuickSku.jsp" %>  
                                  	 	</div>
					 ...
					 <c:if test="${type=='view'}">
                        			...
                        			<!-- left column -->
                      				  ...
                      				  <div class="col-lg-12">
                        				 <%@ include file="viewWarehouseQuickSku.jsp" %>   
                                  	 	</div>
