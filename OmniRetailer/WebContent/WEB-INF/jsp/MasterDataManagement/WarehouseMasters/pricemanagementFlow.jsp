                           ...
                           <c:if test="${sessionScope.role == 'super admin'}"> 
                         		...
                         		<div class="col-lg-2">
	                          		...
	                          		<div class="col-lg-2 form-group" style="text-align: right;">
		                          			<div style="text-align: center;width: 140px;height: 130px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="return viewPriceUpdate('warehousePriceUpdate','0','warehouse');" title="<spring:message code="price.updating.label" />">
			                          			<img src="${pageContext.request.contextPath}/images/PriceUpdate.png" style="margin-top: 10px;"><br><br>
