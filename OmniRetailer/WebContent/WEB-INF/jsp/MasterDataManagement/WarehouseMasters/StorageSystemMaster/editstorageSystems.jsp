...
<div class="row">
  ...
  <div class="box box-primary">
      <div class="box-header" align="center">
               ...
               <h3  class="box-title" style="border:1px solid #3d3838;;font-weight: bold;width:20%;padding:5px">${warehouseStorage.storageSystemId} - Edit</h3>
           </div>
           <div align="center">
               ...
               <select class="form-control" id="materialtype" style="width:80%">
                ...
                <span id="searchItemsError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
                   ...
                   <table id="packagingList" class="table table-bordered table-striped" style=" ">
                      ...
                      <td id="Del${theCount.count}" style="width:5%">
				<img id="Img${theCount.count}" src="${pageContext.request.contextPath}/images/itemdelete.png" style="cursor:pointer;display: block;margin-left: auto;margin-right: auto;width: 50%;" onclick='deleteItem(this);' title="Delete${storageSystem.skuId}"/></td>
                      ...
                      <input type="button" id="edit"  class="btn bg-olive btn-inline" onclick="validateStorageSystemMaster('edit')" style="margin-left:35%;width: 80px;"   value="Update" />
