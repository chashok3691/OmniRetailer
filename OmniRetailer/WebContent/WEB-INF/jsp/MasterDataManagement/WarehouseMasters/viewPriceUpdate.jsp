	...
	$('document').ready(function(){
		$('#searchPriceUpdate').on('input',function(e){
			...
			if($(this).val().trim()==""){
				 ...
				 return viewPriceUpdate('warehousePriceUpdate','0','warehouse');
			}
		});
                           ...
                           <div class="col-lg1-2 col-lg-2" style="">
                            ...
                            <div class="col-lg-1" style="    width: 12%;    background: #ccc;">
                               <div class="col-lg-12" style="    border-top: 1px solid #ccc; border-bottom: 1px solid #ccc;">
                                  <div class="row">
                                    <a onclick="viewPriceUpdate('warehousePriceUpdate','0','${flowLocation}')" class="button"><spring:message code="searchbutton.label" /></a>
                                ...
                                <br>
									    ...
									    <div class="row">
									      <div class="col-lg-1 col-xs-2" style="margin-top: 0px;">
								                <select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewPriceUpdate('warehousePriceUpdate','0','warehouse')">
...
<%--                                  <fmt:formatNumber var="newcostPrice" type="number"  minFractionDigits="2" maxFractionDigits="2" value="${((plucode.salePrice-plucode.costPrice)/plucode.costPrice)*100}" />${newcostPrice} --%>
                       ...
                       <div class="row" style="margin-right:0%;margin-left: 0.1%;">
              	          ...
              	          <c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		          <div class="form-group col-lg-6" style="text-align: left;">
              		                ...
              		                <input type="button" class='paginationButton' value="&#62;" onclick="viewPriceUpdate('warehousePriceUpdate','${totalValue}','warehouse');">
              	              </div>									
                       	</c:if>
                       	<c:if test="${totalValue == totalRecords}">
              			   <c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		          <input type="button" class='paginationButton' value="&#60;" onclick="return viewPriceUpdate('warehousePriceUpdate','${index - (maxRecords + 1)}','warehouse');"> ${index} - ${totalValue} of ${totalRecords} 
              	   ...
              	   <div class="col-lg-6" style="text-align: right;"> 
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewPriceUpdate('warehousePriceUpdate',document.getElementById('pagination').value,'warehouse')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
