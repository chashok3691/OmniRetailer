 ...
 * Written By		        : Manasa
 * file name		        : Master data Management/Generic master/RouteMaster/editRoutingMaster.jsp
 * file type		        : JSP
...
$(document).ready(function(){
	...
	debugger
	 ...
	 for(var i=1;i<=len;i++){
		 callCalender('routeStartDate'+i);
		 callCalender('routeEndDate'+i);
		// callCalender('routeCalendar'+i); 
	 }
...
<div class="row">
  <div class="col-lg-12">
				<div class="box box-primary">
                                ...
                                <h3 style="text-align:center;">${routeList.routeId}-Details</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
        ...
        <div  class="col-lg-4 col-xs-3 col-sm-3">
         <label><spring:message code="route.id.label"/></label>
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6" style="padding-left: 0px;">
           <input type="text" onblur="criteria(this)" class="form-control"  name="routeId" id="routeId" disabled value="${routeList.routeId}"  placeholder="<spring:message code="enterroute.id.label" />">
        </div>
        </div>
         <div class="row" style="padding: 4px;white-space:nowrap;margin-bottom: 14px;">
        <div  class="col-lg-4 col-xs-3 col-sm-3">
         <label><spring:message code="route.name.label"/></label>
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6" style="padding-left: 0px;">
           <input type="text"class="form-control"  onblur="criteria(this)" name="routeName" id="routeName" value="${routeList.routeName}" placeholder="<spring:message code="enterroute.name.label" />">
        ...
        <div  class="col-lg-4 col-xs-3 col-sm-3">
         <label><spring:message code="route.category.label"/></label>
          ...
          <div class="col-lg-6 col-xs-6 col-sm-6" style="padding-left: 0px;">
             ...
             <select class="form-control" id="routeCategory" onchange="searchlocationsBasedOnZoneForDashboard('outletZone','outletLocation','')">
...
<%--            <input type="text" class="form-control" name="pickUpLocation" id="pickUpLocation" value="" placeholder="<spring:message code="enterpickup.lcation.label" />"> --%>
       ...
       <div  class="col-lg-6 col-xs-6 col-sm-6" style="padding-left: 6px;">
           <input type="text" class="form-control" onblur="criteria(this)"  style="" name="endPoint" value="${routeList.endPoint}" placeholder="<spring:message code="enterend.point.label" />"  id="endPoint" />
        ...
        <label><spring:message code="newarrival.startdate"/></label>
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6" style="padding-left: 0px;">
          <input class="form-control calendar_icon"  readonly="readonly"  name="startDate" id="startDate" value="${routeList.startDateStr}" style="background-color: white;"  size="20" type="text" onfocus="callCalender('startDate')" onclick="callCalender('startDate')" placeholder="DD/MM/YYYY">
        </div>
        </div>
        <div class="row" style="padding: 4px;margin-bottom: 14px;">
        <div  class="col-lg-4 col-xs-4 col-sm-4" style="width:27%;">
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6" style="padding-left: 0px;">
         <input class="form-control calendar_icon"  readonly="readonly"  name="endDate" id="endDate" value="${routeList.endDateStr}" style="background-color: white;"  size="20" type="text" onfocus="callCalender('endDate')" onclick="callCalender('endDate')" placeholder="DD/MM/YYYY">
        ...
        <!--   <div class="row weeklyExecution" id="weeklyExecution" style="margin: 10px 0px 0px 0px;display: none;">
             ...
             <!--   </div>
                      ...
                      <div class="col-lg-1" style="">
                        <div class="buttons" style="margin-bottom: -10px;text-align:right">
                ...
                <div class="table-responsive" style="overflow-x:auto;margin-right: -1%;">
 		 ...
 		 <tr id="dynamicdiv${theCount.count}">
 			...
 			<input type="text" class="form-control timepicker" value="${routMapList.startTimeStr}" id="routeStartTime${theCount.count}" onBlur="validatetime()"/></td>
 			...
 			<td><div ><input type="text" onblur="criteria(this)" pattern="/^\d+\.\d{0,2}$/" id="latitude${theCount.count}" value="${routMapList.gpsLatitude}" style='vertical-align: -2px;width:100%' ></div>
 			</td>
 			<td><div ><input type="text"  onblur="criteria(this)" pattern="(/^-?(([-+]?)([\d]{1,3})((\.)(\d+))?)/g)" id="langitude${theCount.count}" value="${routMapList.gpsLongitude}"  style='vertical-align: -2px;width:100%' ></div>
 			</td>
 			<td><div style="width: 170px;"><input type="text" onblur="criteria(this)" id="description${theCount.count}" value="${routMapList.description}" style='vertical-align: -2px' class='sun'></div>
 			</td>
 			<td><div><input type="number" onblur="criteria(this)"  id="maxOrders${theCount.count}" value="${routMapList.maximum_allowed_orders}" style='vertical-align: -2px;width:100%' class='sun'></div>
 			</td>
 			
 			<%-- <td> <input class="form-control calendar_icon startDate" value="${routMapList.calendar}" 
 			readonly="readonly" style="width:100px;background-color: white;" id="routeCalendar${theCount.count}" 
 			onfocus="callCalender('routeCalendar${theCount.count}')" onclick="callCalender('routeCalendar${theCount.count}')" 
