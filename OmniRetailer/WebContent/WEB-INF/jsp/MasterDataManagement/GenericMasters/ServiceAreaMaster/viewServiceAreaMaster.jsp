...
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDHNN78JQSuDoLAZigF4cTbHgyeduFpVn8&callback=loadMap"></script>  -->     
...
$(document).ready(function(){
	...
	if ($("#map").prop("checked") == true){
    	...
    	$(".addServiceListBtn1").addClass("disabled");
...
<div class = "col-lg-10" id="googleMap"  style="height:400px;width:100%">
                      ...
                      <div class="row">
                         <div class="form-group col-lg-3">
                            ...
                            <input type="text" class="form-control" disabled id="areaCode" name="areaCode" placeholder="<spring:message code="enter.street.name" />" value="${serviceAreaMaster.area_code}" />
                         ...
                         <div class="form-group col-lg-3">
                            ...
                            <input type="text" class="form-control" id="city"  disabled placeholder="<spring:message code="enter.area" />" value="${serviceAreaMaster.city}" />
                          ...
                          <label><spring:message code="newarrival.startdate"/></label>
                            <input type="text" class="form-control" id="startDate" disabled name="startDate"  readOnly value="${serviceAreaMaster.startDateStr}" style="background-color: white;"  size="20" type="text" onfocus="callCalender('startDate')" onclick="callCalender('startDate')" placeholder="DD/MM/YYYY">
                         </div>
                         
                          <div class="form-group col-lg-3">
                           <label><spring:message code="priority.label"/></label>
          <input class="form-control" type="text" id="priority" disabled value="${serviceAreaMaster.priority}">
                        </div>
                       ...
                       <div class="row">
                          ...
                          <input type="text" id="areaDescription"  disabled class="form-control" value="${serviceAreaMaster.area_description}">
                         </div>
                         <div class="form-group col-lg-3">
                             <label><spring:message code="zone.label"/></label>
                              <select  disabled class="form-control" id="outletZone" >
          ...
          <input class="form-control calendar_icon" disabled  readonly="readonly"  name="endDate" id="endDate" value="${serviceAreaMaster.endDateStr}"  readOnly style="background-color: white;"  size="20" type="text" onfocus="callCalender('endDate')" onclick="callCalender('endDate')" placeholder="DD/MM/YYYY">
                        </div>
...
<!--           				<input class="form-control" type="text" id="status"> -->
                    <select class="form-control" id="status">
		             ...
		             <select class="form-control form-group" id="location"  disabled="diasbled" >
                    ...
                    <select id="AreaTypeId" class="form-control" onchange="changeFunc();" disabled="diasbled" >
                    ...
                    <input class="form-control" id="radius" value="${serviceAreaMaster.radius}" disabled="diasbled" >                 
                        </div>
                         </div>
                         ...
                         <div>	 
                           ...
                           <div class="table-responsive" style="overflow-x:auto;margin-left:2%;margin-right: 2%;">
                            ...
                            <label>
      						 <input type="radio" id="map" name="map" value="map" onchange="selectServiceAreaType()">
      						<b> LoadMap </b>
      						
    						</label> 
                            <div class="row">
									    <div class="col-lg-3">
                                            <input type="text" class="form-control" class="latitudeValue"  id="gpsLatitude" value="" />
                                            <!-- <span id="buildingNameError" style="text-align:right;color:red;font-weight:bold;"></span> -->
                                        </div>
                                        <div class="col-lg-3">
                                        <input type="text" class="form-control" class="gpsLongitude" id="gpsLongitude"  value="" >
                                        </div>
                                        <div class="col-lg-4">
					                        <input type="text"  id="locationDescription" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" class="form-control">
                                        </div>
                                        
                                        <div class="col-lg-2">
                                        	 <div class="addServiceListBtn1" style="margin-bottom: -5px;text-align:right">
 	  ...
 	  <c:forEach items="${serviceAreaMaster.serviceAreaList}" var="serviceAreaMapList" varStatus="theCount">
 		 <tr id="dynamicdiv${theCount.count}">
 			...
 			<td><div ><input type='text' id="langitude${theCount.count}" value="${serviceAreaMapList.longitude}"  style='vertical-align: -2px' ></div>
 		     ...
 		     <td><div style="width: 170px;"><input type="text" id="description${theCount.count}" value="" style='vertical-align: -2px' class='sun'></div></td>
 			 <td id="Del${theCount.count}" ><img id="Img${theCount.count}" src="${pageContext.request.contextPath}/images/itemdelete.png" style="width:30px;cursor:pointer;" onclick="deleteItem(this);" /></td>
 			</tr>
 			</c:forEach>
 ...
 <div class="table-responsive" style="overflow-x:auto;margin-left:2%;margin-right: 2%;">
 			...
 			<input type="hidden" id="slnoPin${theCount2.count}" value="${serviceAreaPinList.slNo}">
          ...
          <c:otherwise>      
                      ...
                      <div class="row">
                         <div class="form-group col-lg-3">
                            <label>Area Code</label>
                            <input type="text" class="form-control" disabled id="areaCode" name="areaCode" placeholder="<spring:message code="enter.street.name" />" value="" />
                         	<span id="streetNameError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                         </div>
                         <div class="form-group col-lg-3">
                            <label><spring:message code="EmployeeForm.address.city" /> <span style="color:red; font-size:2">*</span></label>
                            <input type="text" class="form-control" id="city" disabled  placeholder="<spring:message code="enter.area" />" value="" />
                        	<span id="areaError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                         </div>
                          <div class="form-group col-lg-3">
                          <label><spring:message code="newarrival.startdate"/></label>
                            <input type="text" class="form-control" id="startDate"  disabled name="startDate"  readOnly value="" style="background-color: white;"  size="20" type="text" onfocus="callCalender('startDate')" onclick="callCalender('startDate')" placeholder="DD/MM/YYYY">
                         </div>
                         
                          <div class="form-group col-lg-3">
                           <label><spring:message code="priority.label"/></label>
          <input class="form-control" type="text"  disabled id="priority">
                        </div>
                         </div>
                       ...
                       <div class="row">
                         ...
                         <div class="form-group col-lg-3">
                             <label><spring:message code="zone.label"/></label>
                              <select class="form-control" disabled id="outletZone" >
                           		 <option value=""><spring:message code="ALL.label"/></option>
	                            <c:forEach var="zoneList" items="${zoneList}">
						...
						<div class="row" style="text-align: center;">
						 <%-- <input type="button" style="" class="btnCls" onclick="createServiceAreaMaster('edit');" value="<spring:message code="submit.label" />" /> --%>
						  <c:if test="${sessionScope.role == 'super admin'}"> 
						  	<input type="button" class="btnCls " onclick="return viewServiceAreaMaster('serviceAreaMaster','0')" value="<spring:message code="cancel.label" />" />
						  </c:if>
							<input type="button" class="btnCls " style="" onclick="return viewServiceAreaMaster('serviceAreaMaster','0');" value="<spring:message code="cancel.label" />" />
