 ...
 * file type		        : JSP
 * description				: The editAsset form is displayed using this jsp
 * */ -->
  ...
  <div class="col-xs-12">
	<div class="box box-primary " style="padding: ">
    	<div class="box-header" id="tofocus" style="text-align: left">
    		<h3 align="center"><spring:message code="edit.asset.label" /></h3>
    	</div><!-- /.box-header -->
    <!-- form start -->
    <form>
        <div class="box-body">
        <div class="row" style="text-align: right; margin-top: 0px;">
			...
			<%-- <input type="button" id="submit" style="margin-right: 2%;" class="btn bg-olive btn-inline" onclick="validateAssetMasterForm('edit')" value="<spring:message code="save.label" />">
			<input type="button" class="btn bg-olive btn-inline" style="margin-right: 3%;" onclick="viewAssetMaster('assetMaster','0')" value="<spring:message code="cancel.label" />"> --%>
        </div>
        ...
        <div class="form-group col-lg-1"></div>
           ...
           <div class="row">
             <div class="col-lg-6">
                 ...
                 <input class="form-control form-group calendar_icon"  style="background-color: white;" name="aquiredDate" id="aquiredDate" value="${assetMaster.dateStr}" size="20" type="text" onfocus="callCalender('aquiredDate')" onclick="callCalender('aquiredDate')" placeholder="DD/MM/YYYY"/>
	 ...
	 <div class="row">
		  <div class="col-lg-12">
			  ...
			  <input type="text" class="form-control form-group" id="location" value="${assetMaster.location}" placeholder="<spring:message code="enter.location.label" />" />
		 </div>
	  </div>              
	 <div class="row">
		  <div class="col-lg-12">
...
<div class="col-lg-1"></div>
  ...
  <div class="row" style="text-align: center; margin-top: 10px;">
        <input type="button" id="submit" style="" class="btnCls" onclick="validateAssetMasterForm('edit')" value="<spring:message code="submit.label" />">
        <c:if test="${sessionScope.role == 'super admin'}">
		    	<input type="button" class="btnCls buttonMargin" style="" onclick="viewAssetMaster('assetMaster','0');" value="<spring:message code="cancel.label" />">
		 </c:if>
