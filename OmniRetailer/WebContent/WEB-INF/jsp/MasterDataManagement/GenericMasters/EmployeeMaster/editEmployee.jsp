 ...
 * Written By		        : Mythri
 * modified By				: Vinay
 * file name		        : admin/genericData/editEmployee.jsp
 * file type		        : JSP
				...
				<div class="box box-primary">
                                ...
                                <form id="editEmployee" method="post">
                                    ...
                                    <div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${success}</div>
                                            ...
                                            <input type="hidden" class="form-control" name="shiftId" id="shiftId" readonly="readonly" value="${employee.shiftId}"/>
                                       
                                    	<div class="row">
                                   	       <div class="form-group col-lg-3">
                                            <label><spring:message code="enter.EmployeeForm.id" /><span style="color:red; font-size:2">*</span></label>
                                            <input type="text" class="form-control" name="employeeCode" value="${employee.employeeCode }"  id="employeeCode" required placeholder="<spring:message code="enter.EmployeeForm.id" />" readonly="readonly" style=" width: 80%"/>
                                       ...
                                       <label><spring:message code="EmployeeForm.firstName" /> <span style="color:red; font-size:2">*</span></label>
                                            <input type="text" onblur="criteria(this)" class="form-control" name="firstName" id="firstName" value="${employee.firstName}" placeholder="<spring:message code="enter.EmployeeForm.firstName" />" />
								...
								<div class="row">
                                        ...
                                        <div class="form-group col-lg-2">
                                             ...
                                             <input class="form-control calendar_icon" readonly="readonly"  style="background-color: white;" name="dateOfBirth" value="${employee.dob}" id="dob" size="20" type="text" onfocus="callCalender('dob')" onclick="callCalender('dob')" placeholder="DD/MM/YYYY"/>
                                ...
                                <div class="row">
                                     	<div class="form-group col-lg-3">
                                      	...
                                      	<div class="form-group col-lg-2">
                                            ...
                                            <input class="form-control calendar_icon" value="${employee.dateOfJoin}" readonly="readonly" style="background-color: white;" name="dateOfJoining" id="doj" size="20" type="text" onclick="callCalender('doj')" onfocus="callCalender('doj')" placeholder="DD/MM/YYYY"/>                                          
                                        ...
                                        <div class="form-group col-lg-3">
                                           ...
                                           <input type="text" onblur="criteria(this)" class="form-control searchItems" id="searchDepartmentNames" value="${employee.department}" placeholder="<spring:message code="search.department.name.label" />" style="height:30PX;width: 80%;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" />
			                                ...
			                                <input type="hidden" onblur="criteria(this)" class="form-control" name="department" id="department" value="${employee.department}" />
                                ...
                                <div class="row">
                                       ...
                                       <div class="form-group col-lg-2">
			                                ...
			                                <input type="hidden" onblur="criteria(this)" class="form-control" name="reportingManager" id="employeeId" value="${employee.reportingManager}" />
								...
								<div class="form-group col-lg-3">
									<label><spring:message
											code="EmployeeForm.consultantType" /> </label> <select
										class="form-control" name="consultantType" id="consultantType"
										style="width: 80%">

										<option value="specialist"
											${'specialist' == employee.consultantType ? 'selected' : ''}><spring:message
												code="enter.EmployeeForm.specialist" /></option>
										<option value="operator"
											${'operator' == employee.consultantType ? 'selected' : ''}><spring:message
												code="enter.EmployeeForm.operator" /></option>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-7 col-md-8 col-sm-8 col-xs-8" style="padding-left: 0px">
                                  	<input type="text" class="form-control"   placeholder="<spring:message code="supplier.enter.mobile.label" />" id="phoneNumber1" size="15" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                                                    <span id="phoneError" style="text-align:right;color: red;font-size: 2;font-weight: bold;margin-left: -40px;white-space: nowrap;"></span>
                              ...
                              <div class="row" style="width: 100%">  
                                         ...
                                         <div class="form-group col-lg-9" style="width: 71%">
                                            ...
                                            <textarea onblur="criteria(this)" class="form-control" style="resize:auto;" rows="12" name="remarks" id="remarks"  >${employee.remarks}</textarea>
                                        </div>
                                     </div>
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="validateEmployeeForm('edit')" value="<spring:message code="submit.label" />" style="width:80%"/> &nbsp;&nbsp; &nbsp;
						 <input type="button" class="btnCls buttonMargin"  onclick="viewEmployeeMaster('employeeMaster','0','<c:out value="${location}"/>');" value="<spring:message code="cancel.label" />" />
						</div>		
						
						  <input type="hidden" name="searchCriteria" value="${searchName}" id="searchEmployeeMaster"/>
						...
						<div class="form-group col-lg-2" style="margin: 0 auto">
						<input type="button" class="btn bg-olive btn-inline"  onclick="viewEmployeeMaster('employeeMaster');" value="<spring:message code="cancel.label" />" />
						</div>
						<div class="form-group col-lg-2"></div>
						<div class="form-group col-lg-2"></div>
						</div> --%>
