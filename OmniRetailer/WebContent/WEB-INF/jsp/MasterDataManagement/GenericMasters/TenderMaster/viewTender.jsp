...
<div class="box box-primary">
                              ...
                              <center> <h3 class="box-title" style="padding :5px;  border:1px solid  #808080;;font-weight: bold;width: 20%;margin-bottom:40px;white-space: nowrap;">View Tender</h3></center>
                                </div><!-- /.box-header -->
                     ...
                     <div class="box-body table-responsive" style="padding-left:100px">
	                ...
	                <input class="form-control " readonly style="width:65%" value="${tenderDetails.tenderCode}"  name="tendercode" readonly="readonly" id="tendercode" size="20" type="text"   />
	                ...
	                <select class="form-control " disabled="disabled" style="width:65%" name="returntender" id="returntender" >
                                            <option value="1" ${'true' == tenderDetails.returnTender ? 'selected' : ''} >Yes</option>
		                                  		<option value="0" ${'false' == tenderDetails.returnTender ? 'selected' : ''} >No</option>
		                                  		 </select>
	                ...
	                <input class="form-control " readonly style="width:85%" value="${tenderDetails.tenderName}"  name="tenderName" id="tenderName" size="20" type="text"   />
	                ...
	                <select class="form-control " disabled="disabled" style="width:85%" name="allowreturntender" id="allowreturntender" >
                                            <option value="1" ${'true' == tenderDetails.allowOtherReturnTender ? 'selected' : ''} >Yes</option>
		                                  		<option value="0" ${'false' == tenderDetails.allowOtherReturnTender ? 'selected' : ''} >No</option>
		                                  	 </select>
	                ...
	                <input class="form-control " readonly style="width:65%" value="${tenderDetails.tenderKey}"  name="tenderkey" id="tenderkey" size="20" type="text"   />
	               ...
	               <select  disabled style="width:65%" id="country" name ="country" class="form-control" title="India - IN &#013;USA - US &#013;UK - GB &#013;Australia - AU" >
	                ...
	                <input class="form-control " readonly style="width:65%" value="${tenderDetails.modeOfPayment}"  name="modeOfPayment" id="modeOfPayment"  type="text"   />
					...
					<input class="form-control " readonly style="width:65%" value="${tenderDetails.backEndTenderCode}"  name="backendCode" id="backendCode"  type="text"   />
                     </div>
                     </div>   
    ...
    margin-top: 20px;">
                     ...
                     <div class="col-lg-1" style="margin-top: 32px;padding-left: 45px;margin-left: 50px;">
                     
                     </div>
                     <div class="col-lg-6"  style="margin-top: 32px;padding-left: 45px;">
                   <input type="button" style="width:55%;padding:6px" onclick="return viewTenderMaster('tenderMaster','0');" class="btn bg-olive btn-inline addBtn"  value="Cancel" />
