...
<div class="box box-primary">
                              ...
                              <center> <h3 class="box-title" style="padding :5px;  border:1px solid  #808080;;font-weight: bold;width: 20%;margin-bottom:40px;white-space: nowrap;">Edit Tender</h3></center>
                                </div><!-- /.box-header -->
	                ...
	                <input class="form-control " style="width:65%" value="${tenderDetails.tenderCode}"  name="tendercode" readonly="readonly" id="tendercode"  size="20" type="text"   />
	                ...
	                <input class="form-control " readonly="readonly" style="width:85%" value="${tenderDetails.tenderName}"  name="tenderName" id="tenderName" size="20" type="text"   />
                  ...
                  <div class="col-lg-12">
	                ...
	                <input class="form-control " style="width:65%" value="${tenderDetails.tenderKey}"  name="tenderkey" onblur="criteria(this)" id="tenderkey" size="20" type="text"  oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"  />
	               ...
	               <select  style="width:65%" id="country" name ="country" class="form-control" title="India - IN &#013;USA - US &#013;UK - GB &#013;Australia - AU" >
	                ...
	                <input class="form-control " style="width:65%" value="${tenderDetails.modeOfPayment}"  name="modeOfPayment" onblur="criteria(this)" id="modeOfPayment"  type="text"   />
					...
					<input class="form-control " style="width:65%" value="${tenderDetails.backEndTenderCode}"  name="backendCode" onblur="criteria(this)" id="backendCode"  type="text"   />
                     </div>
                     </div>                      
                                         <br>
                                        <br>
    ...
    margin-top: 20px;">
                     ...
                     <div class="col-lg-6" style="margin-top: 32px;padding-left: 45px;">
                           <input type="button" style="width:55%;padding:8px" onclick="validateTender('tenderMaster','update')" class="btn bg-olive btn-inline addBtn"  value="Update" />
