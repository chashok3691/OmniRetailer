				...
				<div class="box box-primary">
                                ...
                                <form id="newB2BPartner" method="post">
                                    ...
                                    <div class="col-lg-9"> 
                                   		...
                                   		<div class="form-group col-lg-3">
                                            ...
                                            <input type="text" onblur="criteria(this)" readonly disabled class="form-control" name="firmName" value="${b2bPartnerList.partnerName}" id="firmName" required placeholder="Firm Name" style="margin-bottom: 5px;width: 70%" />
                                    	...
                                    	<div class="col-lg-3">
	                                        ...
	                                        <input type="text" onblur="criteria(this)" readonly disabled class="form-control" name="plotNumber" value="${b2bPartnerList.plotNo}" id="plotNumber" required placeholder="Plot/Building" style=" width: 70%" />
	                                        <span id="plotNumberError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                                        </div>
										<div class="form-group col-lg-3">
                                            <label>Business Type</label>
                                         	 <input type="text" onblur="criteria(this)" readonly disabled class="form-control" name="businessType" value="${b2bPartnerList.businessType}" id="businessType" required placeholder="Business Type" style=" width: 90%" />
                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label>GST Number </label>
                                            <input type="text" onblur="criteria(this)" readonly disabled class="form-control" name="gstNumber" value="${b2bPartnerList.gstNumber}" id="gstNumber" required placeholder="GST Number" style=" width: 90%" />
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" onblur="criteria(this)" readonly disabled class="form-control" name="personName" value="${b2bPartnerList.personName}" id="personName" required placeholder="Enter Person Name " style=" width: 90%" />
                                            <span id="personNameError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                                            </div>
                                            <div class="col-lg-12 nopadding">
                                            <label>Bank A/C No</label>
                                            <input type="number" onblur="criteria(this)" readonly disabled class="form-control" name="bankAccountNo" value="${b2bPartnerList.bankAccountNumber}" id="bankAccountNo" required placeholder="Account No" style=" width: 90%" />
                                            <span id="bankAccountNoError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                                            </div>
                                            <div class="col-lg-12 nopadding">
                                            <label>Bank Name</label>
                                            <input type="text" onblur="criteria(this)" readonly disabled class="form-control" name="bankName" value="${b2bPartnerList.bankName}" id="bankName" placeholder="Enter bank name" style=" width: 90%"/>
                                        	</div>
                                        	<div class="col-lg-12 nopadding">
                                            <label>IFSC Code</label>
                                            <input type="text" onblur="criteria(this)" readonly disabled class="form-control" name="ifscCode" value="${b2bPartnerList.ifscCode}" id="ifscCode" placeholder="Enter IFSC Code" style=" width: 90%"/>
                                        	</div>
                                        </div>
                                        <div class="form-group col-lg-3">
                                           <div class="col-lg-12 nopadding">
                                           <label> </label>
                                           <input type="text" onblur="criteria(this)" readonly disabled class="form-control" name="street" value="${b2bPartnerList.street}" id="street" required placeholder="Street/Road Name" style="margin-bottom: 5px;width: 90%" />
                                           <span id="streetError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                                           </div>
                                           <div class="col-lg-12 nopadding">
                                           <input type="text" onblur="criteria(this)" readonly disabled class="form-control" name="location" value="${b2bPartnerList.address}" id="location" required placeholder="Location" style="margin-bottom: 5px;width: 90%;"/>
                                           <span id="locationError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                                           </div>
                                           <div class="col-lg-12 nopadding">
                                           <input type="text" onblur="criteria(this)" readonly disabled class="form-control" name="city" id="city" value="${b2bPartnerList.city}" style="margin-bottom: 5px;width: 90%;" required placeholder="Enter City" />
           								   <span id="cityError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>                             
                                           </div>
                                           <div class="col-lg-12 nopadding">
                                           <select class="form-control" name="state" id="state" readonly disabled style="margin-bottom: 5px;width: 90%;">
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <label>Phone <span style="color:red; font-size:2">*</span></label>
                                       		<input type="text" class="form-control" readonly disabled placeholder="<spring:message code="supplier.enter.mobile.label" />" value="${b2bPartnerList.phone}" style=" width: 90%;" id="b2bPhoneNumber"  size="10" maxlength="10"/>
                                            ...
                                            <input type="email" onblur="" class="form-control" readonly disabled name="email" value="${b2bPartnerList.email}" id="emailId"  style=" width: 90%" required placeholder="Enter Email ID" />
                                        	<span id="emailError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                                        	</div>
                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label>PAN Number </label>
                                            <input type="text" onblur="criteria(this)" readonly disabled class="form-control" style="width: 90%" name="panNumber" placeholder="PAN Number" value="${b2bPartnerList.pan}" id="panNumber" />
						...
						<div class="row" style="text-align: center;">
						 <%-- <input type="button" style="" class="btnCls" onclick="validateB2BPartnerForm('edit');" value="<spring:message code="submit.label" />" /> --%>
						  	<input type="button" class="btnCls"  onclick="viewb2bPartners('b2bPartners','0');" value="<spring:message code="cancel.label" />" />
						</div>
									<br/>
