...
<div class="row">
  <div class="col-xs-12">
				<div class="box box-primary">
                                ...
                                <br/>
                                <h3><spring:message code="new.zone.header.label" /></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                    	 ...
                                    	 <div class="form-group col-lg-6">
                                    	 	<div class="row">
                                    	 		<%-- <div class="col-lg-6">
		                                            ...
		                                            <input type="text" class="form-control" name="zoneID" value="${zone.zoneID}" id="zoneID" required placeholder="<spring:message code="enter.zone.name.label" />" oninput="this.value = this.value.replace(/[^a-zA-Z0-9 -]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" />
                                            ...
                                            <input type="text" class="form-control" value="${outletDetails.gpsLongitude}"  id="gpsLongitude"  placeholder="<spring:message code="enter.longitude.label" />" />
...
<!-- 						                             <span id="error" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span> -->
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="validateZone('new')" value="<spring:message code="submit.label" />" />
