...
$('#mySearch').click(function(){
    var search = $('#searchZone').val();
 viewZoneMaster('zoneMaster','0');
})
 $('#searchZone').keyup(function(e){
   		  ...
   		  <div class="box-header" align="center">
              <h3 class="box-title"><spring:message code="all.zone.label" /></h3>
                      ...
                      <div class="box-body table-responsive">
                          <div class="row">
                            <div class="col-lg-1 col-xs-1">
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewZoneMaster('zoneMaster','0')">
		                ...
		                <div class="col-lg-9">
	        	 		 <%-- <input type="text"  class="form-control searchItems searchBar"  value="" id="searchZone" placeholder="<spring:message code="search.zone.label" />" />
							...
							<input type="text"  class="form-control" value="${searchName}" id="searchZone" placeholder="<spring:message code="search.zone.label" />" />
                     ...
                     <c:forEach var="accessControl" items="${sessionScope.genericBusinessSettings}">
                          <c:if test="${accessControl.appDocument == 'ZoneMaster' && accessControl.write == true}"> 
                          <div class="col-lg-1" style="padding-left: 0px;">
								                <input type="button" style="" class="btn bg-olive btn-inline addBtn" onclick="return newZone('zoneMaster');" value="<spring:message code="addnew.label" />">
								           </div>
								           <div class="col-lg-1" style="padding-left: 0px;">
                          ...
                          <table id="example1" class="table table-bordered table-striped" style="">
                             ...
                             <tr>
                              ...
                              <c:forEach var="accessControl" items="${sessionScope.genericBusinessSettings}">
                                 ...
                                 <th><spring:message code="zone.name.label" /></th>
                         ...
                         <tbody style="text-align: center;">
                          ...
                          <c:forEach var="zone" items="${zoneList}">
                             <tr>
                              <c:if test="${sessionScope.role == 'super admin'}"> 
                              	<td><input type="checkbox" name="selectall" class="selectableCheckbox" id="selectall" value='${zone.zoneID}' /></td>
                              </c:if>
                            <c:forEach var="accessControl" items="${sessionScope.genericBusinessSettings}">
                          		<c:if test="${accessControl.appDocument == 'ZoneMaster' && accessControl.write == true}"> 
                             		<td><input type="checkbox" name="selectall" class="selectableCheckbox" id="selectall" value='${zone.zoneID}' /></td>
                            	 ...
                            	 <td>${zone.slNo}</td>
                                 <td>${zone.zoneID}</td>
                                 <td>${zone.addressOne}</td>
                                 <td>${zone.phoneNum}</td>
                                 <td>
                                 <a style="color:#2e7ea7 !important;cursor: pointer;" onclick="return viewEditZone('${zone.zoneID}','view')">View</a>&nbsp;&nbsp;&nbsp;
                                  <c:if test="${sessionScope.role == 'super admin'}"> 
                                  	<a style="color:#2e7ea7 !important;cursor: pointer;" onclick="return viewEditZone('${zone.zoneID}','edit')">Edit</a>
                                  </c:if>
                                   <c:forEach var="accessControl" items="${sessionScope.genericBusinessSettings}">
                         			 <c:if test="${accessControl.appDocument == 'ZoneMaster' && accessControl.write == true}"> 
                                 		<a style="color:#2e7ea7 !important;cursor: pointer;" onclick="return viewEditZone('${zone.zoneID}','edit')">Edit</a>
             ...
             --%>     
                 ...
                 <div class="row">
              	...
              	<c:if test="${index-1 == 0 && totalRecords > maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewZoneMaster('zoneMaster','${index+maxRecords-1}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-2">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewZoneMaster('zoneMaster','${index - maxRecords-1}');"> ${index} - ${totalValue} of ${totalRecords} 
              		<input type="button" class='paginationButton' value="&#62;" >
              		</div>
              			</c:if>
              			<c:if test="${totalValue-maxRecords <= 0}">
              	...
              	<c:if test="${index-1 != 0 &&  totalValue != totalRecords}">
              		<div class="form-group col-lg-2">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewZoneMaster('zoneMaster','${index - maxRecords-1}');"> ${index} - ${index+maxRecords-1} of ${totalRecords} .
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewZoneMaster('zoneMaster','${index+maxRecords-1}')">
              	</div> 
              	</c:if>
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewZoneMaster('zoneMaster',document.getElementById('pagination').value)" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
              </div>   
