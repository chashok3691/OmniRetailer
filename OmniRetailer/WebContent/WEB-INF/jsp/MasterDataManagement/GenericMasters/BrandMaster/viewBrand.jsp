 ...
 * file name		        : admin/genericData/viewBrand.jsp
 * file type		        : JSP
 * description				: The ViewBrand form is to display  the brand details.
 * */ -->
  ...
  <div class="col-xs-12">
	<div class="box box-primary " style="padding: ">
       <div class="box-header" style="text-align: left">
           <h3><spring:message code="view.brand.label" /></h3>
       </div><!-- /.box-header -->
       <!-- form start -->
       <form>
          <div class="box-body">
               ...
               <div id="Error" style="text-align: center;color: red;font-size: 2;font-weight: bold;">${err}</div>
					<div class="row">  
  						<div class="col-lg-12" >
							...
							<input type="button" class="btnCls" style="margin-right: 30px;" onclick="viewBrandMaster('brandMaster','0')" value="<spring:message code="cancel.label" />">
							</div>
						</div>
					</div>
               	 </div>
          ...
          <div class="form-group col-lg-4">
              ...
              <div class="row">
           		<div class="col-lg-12">
                     ...
                     <textarea class="form-control" style="resize:none;" id="description1" readonly="readonly" placeholder="<spring:message code="enter.description1" />">${brandDetails.bDescription}</textarea>
                </div>   
           </div>
           <div class="row">
           		<div class="col-lg-12">
                	<label><spring:message code="brand.category.label" /> <span style="color:red; font-size:2">*</span></label>
                    <input type="text" class="form-control" id="brandCategory" readonly="readonly" value="${brandDetails.brandCategory}" placeholder="<spring:message code="enter.brand.category" />" />
      ...
      <div class="form-group col-lg-4">
           <div class="row">
               <div class="col-lg-12">
                     ...
                     <input type="text" class="form-control" id="manufacturer" readonly="readonly" value="${brandDetails.manufacturer}" placeholder="<spring:message code="enter.manufacturer" />" />
               </div>
            </div>
          <div class="row">
            <div class="col-lg-12">
                      <label><spring:message code="supplier.name.label" /> <span style="color:red; font-size:2">*</span></label>
                      <input type="text" class="form-control allField searchItems" name="supplier_name" id="searchSupplier" readonly="readonly" value="${supplierName}" />
				<!-- <div class=services>
					<div class="items">
          ...
          <div class="col-lg-12">
          		<div class="col-lg-6">
                     ...
                     <select id="customerGroup" disabled="disabled" name="customerType"  class="form-control">
                 ...
                 <div class="row">
                      <div class="col-lg-12">
						  <label><spring:message code="product.category.label" /></label>
     					  <select class="form-control" disabled="disabled" onchange="searchSubCategoriesBasedOnCategory('category')" name="category" id="category">
 					...
 					<%--  <div class="form-group col-lg-4">
                               <!--  <label><spring:message code="supplier.name.label" /> <span style="color:red; font-size:2"></span></label>-->
                                     <input type="hidden" id="desc"/>
                                   	...
                                   	<input type="text"  class="form-control searchItems" id="searchItems" readonly="readonly" placeholder="<spring:message code="search.items.here.label" />"  style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;"  />
								<div class="services">
			    					<div class="items">
	  ...
	  <div class="form-group col-lg-4">
           <div class="row">
                 <div class="col-lg-12">
                       ...
                       <input type="text" class="form-control" id="startPrice" readonly="readonly" value="${brandPrice.startPrice}"  /> 
       ...
       <div class="form-group col-lg-4">
            <div class="row">
                 <div class="col-lg-12">
                       ...
                       <input type="text" class="form-control" id="endPrice" readonly="readonly" value="${brandPrice.endPrice}" />
            ...
            <div class="row">
                 <div class="col-lg-12">
                       ...
                       <select class="form-control" id="location" disabled="disabled">
       ...
       <div class="row">  
  			<div class="col-lg-12" >
            	...
            	<textarea class="form-control" style="resize:none;" id="description2" readonly="readonly" placeholder="<spring:message code="enter.description2" />">${brandPrice.description}</textarea> 
			</div>
		</div>
	     <div class="row">  
  			<div class="col-lg-12" >
