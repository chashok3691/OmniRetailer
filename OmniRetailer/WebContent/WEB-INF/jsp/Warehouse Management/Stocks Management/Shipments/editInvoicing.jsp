  ...
  <div class="col-lg-12">
        ...
        <div  class="col-lg-3 col-xs-3 col-sm-3">
         <label><spring:message code="counters.label"/></label>
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6">
           <input type="text" name="counter" id="counter" value="${itemLists.counterId}">
        </div>
        </div>
         <div class="row" style="padding: 4px;white-space:nowrap;">
        <div  class="col-lg-3 col-xs-3 col-sm-3">
         <label><spring:message code="gstin.or.uin.label"/><span style="color:red; font-size:2">*</span></label>
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6">
           <input type="text" name="gstin" id="gstin" value="${itemLists.gstn}">
           <br>
        ...
        <div  class="col-lg-3 col-xs-3 col-sm-3">
         <label><spring:message code="statename.label"/></label>
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6">
           <input type="text" name="stateName" id="stateName" value="${itemLists.state}">
        </div>
        </div>
           <div class="row" style="padding: 4px;white-space:nowrap;">
        <div  class="col-lg-3 col-xs-3 col-sm-3">
         <label><spring:message code="pin.label"/></label>
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6">
           <input type="text" name="pinValue" id="pinValue" value="${itemLists.shippedToZipCode}">
        </div>
        </div>
           <div class="row" style="padding: 4px;white-space:nowrap;">
        <div  class="col-lg-3 col-xs-3 col-sm-3">
         <label><spring:message code="customer.newfeedback.email"/></label>
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6">
           <input type="text" name="emailId" id="emailId"  value="${itemLists.email}">
        </div>
        </div>
        ...
        <div  class="col-lg-3 col-xs-3 col-sm-3">
         <label><spring:message code="grn.ref.label"/></label>
              ...
              <div  class="col-lg-6 col-xs-6 col-sm-6">
        <input type="text" class="form-control searchItems"	value="${itemLists.goodsReceiptNoteRef}" style="height:30PX;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" onblur=""	placeholder="<spring:message code="enter.shipment.ref.label" />" id="goodsReceiptNoteRef" />
        ...
        <div  class="col-lg-5 col-xs-5 col-sm-5" style="width:32%;white-space:nowrap;">
         <label><spring:message code="invoice.number.label"/><span style="color:red; font-size:2">*</span></label>
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6">
           		<input type="text" name="invoiceNumber" id="invoiceNumber" value="${itemLists.invoiceId}">
           		<span id="invoiceNumberError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
           		
           		<input type="hidden" id="shipmentId" class="shipmentId" value="${itemLists.shipmentId}">
        </div>
        </div>
        <div class="row" style="padding: 4px;">
        <div  class="col-lg-5 col-xs-5 col-sm-5" style="width:32%;white-space:nowrap;">
         <label><spring:message code="delivery.note.label"/></label>
          ...
          <div  class="col-lg-6 col-xs-6 col-sm-6">
           <input type="text" name="deliveryNote" id="deliveryNote" value="${itemLists.shipmentNoteId}">
        </div>
        </div>
        ...
        <input type="text" class="form-control searchItems" value="${itemLists.orderId}"	style="height:30PX;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" 	value="${itemLists.orderId}" placeholder="<spring:message code="enter.po.reference.label" />" id="po_reference" />
			...
			<label style="font-family: Calibri;"><spring:message code="supplier.code.label" /><span style="color:red; font-size:2">*</span></label>
					...
					<div  class="col-lg-6 col-xs-6 col-sm-6">						
											<input type="text" class="form-control" readonly="readonly"
												name="supplier_Id" id="supplier_Id" value="${itemLists.supplierId}" />
...
<%-- 						 		</c:forEach> --%>
        ...
        <div  class="col-lg-5 col-xs-5 col-sm-5" style="white-space:nowrap;"><label>Delivery Date</label>
          ...
          <div  class="col-lg-5 col-xs-6 col-sm-6">
           ...
           <input class="form-control calendar_icon form-group"  readonly="readonly"  name="deliveryDate" id="deliveryDate"  value="${itemLists.shipmentDateStr}" style="background-color: white;"  size="20" type="text"  onfocus="callCalender('deliveryDate')" onclick="callCalender('deliveryDate')" placeholder="DD/MM/YYYY">
						...
						<input class="form-control" readonly="readonly" style="background-color: white;width: 14%;margin: 0px;display: inline-block;margin-right: 10px;" name="updated_due_date" id="updatedDate" size="20" type="text" value="${startFormat}"/>
                                      ...
                                      <span class=" border" style="padding-left: 0px;padding-top: 17px;font-size: 16px;">
                                        ...
                                        <%--  </c:forEach> --%>
      									...
      									<div class="col-lg-2">
      									<c:choose>
      									<c:when test="${not empty nextWorkflowList}">
      									<label><spring:message code="actionrecquired.label" /></label>
                                             <select class="form-control" id="statusofInvoice" name="status">
                                             <option value="">Action Required</option>
                                               <c:forEach var="activity" items="${nextWorkflowList}">
                                              <option value="${activity}">${activity}</option>
                                             </c:forEach>
                                              <%-- <c:forEach var="nextWorkFlowStates" items="${nextWorkflowList}">
                                              <option value="${nextWorkFlowStates}">${nextWorkFlowStates}</option>
                                             </c:forEach> --%>
                                           </select>
      									 </c:when>
      									<c:when test="${empty nextWorkflowList}">
      									<label><spring:message code="actionrecquired.label" /></label>
                                          <select class="form-control" id="statusofInvoice" name="status">
                                             <option value="${itemList.status}">Action Required</option>
                                                <c:forEach var="activity" items="${nextWorkflowList}">
                                              <option value="${activity}">${activity}</option>
                                             </c:forEach>
                                             <%-- <c:forEach var="nextWorkFlowStates" items="${nextWorkflowList}">
