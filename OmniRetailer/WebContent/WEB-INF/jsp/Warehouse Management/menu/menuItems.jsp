                      ...
                      <input type="text"  class="form-control" style="" value="${searchName}" id="searchMenus" placeholder="<spring:message code="menu.search.label" />"/>
						...
						<input type="hidden" id="menu" value="${searchName}">
	        	 		...
	        	 		<div class="col-lg-1" style="padding-left: 0px;">
		  				               ...
		  				               <input type="button" onclick="return newMenuItems('${flowUnder}');" class="btn bg-olive btn-inline  addBtn" value="<spring:message code="addnew.label"/>" style="margin-left: 7px;">
									  ...
									  <thead style="background-color: #3c8dbc; color: #ffffff">
                                        ...
                                        <c:forEach var="menu" items="${menuDetailsList}">
                                            <tr>
                                            	...
                                            	<td>${menu.remarks}</td>
                                               <td style="text-align: center;"><a href="#" onclick="return viewMenuItems('${menu.menu_name}','${flowUnder}')">View</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                               <a href="#" onclick="return viewEditMenuItems('${menu.menu_name}','${flowUnder}')">Edit</a></td> 
                							</tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
