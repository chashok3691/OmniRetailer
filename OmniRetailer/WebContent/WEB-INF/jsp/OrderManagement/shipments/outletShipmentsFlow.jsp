...
<body>
            			...
            			<c:if test="${accessControl.appDocument == 'OrderManagementShipmentNotes'}"> 
		                          	<div class="col-lg-2 form-group">
		                          		<div style="text-align: center;width: 120px;height: 120px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="viewHomePageDeals('confirmedFulfillmentOrders')" title="<spring:message code="shipment.notes.label" />">
            			...
            			<c:if test="${accessControl.appDocument == 'OrderManagementBillOfLading'}">
	                          	<div class="col-lg-2 form-group" style="text-align: left;">
	                          		<div style="text-align: center;width: 120px;height: 120px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="viewHomePageDeals('fulfilledFulfillmentOrders');" title="<spring:message code="bill.of.landing" />">
	                          			<img src="${pageContext.request.contextPath}/images/Shipments_Delivered.png" style="margin-top: 10px;"><br>
	                          			<span><spring:message code="bill.of.landing" /></span>
	                          		</div>
	                          	</div>
	                          	</c:if>
                          </c:forEach>
