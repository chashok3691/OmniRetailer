...
<div class="row">
  <div class="col-lg-12">
	<div class="box box-primary">
         ...
         <h3><spring:message code="edit.shipment.label" /> : ${orderShipment.shipmentId}</h3>
         </div><!-- /.box-header -->
         <!-- form start -->
         <form role="form">
             <div class="box-body">
              ...
              <input type="hidden" id="type" value="${type}">
                 <div class="row">
	                ...
	                <div class="form-group col-lg-3 col-sm-3">
	                    <input type="text" class="form-control calendar_icon" value="${orderShipment.orderShippedDateStr}" readonly="readonly" id="date" style="background-color: white;" onfocus="callCalender('date')" onclick="callCalender('date')"/>
                ...
                <div class="row"> 
	                ...
	                <div class="form-group col-lg-3 col-sm-3">
						<input type="text" class="form-control" name="shippedBy" id="shippedBy" value="${orderShipment.shippedBy}" placeholder="<spring:message code="enter.shippedBy.label" />"/>
				...
				<div class="row">
	                ...
	                <div class="form-group col-lg-3 col-sm-3">
	                  	<input type="text" class="form-control" name="carrier" value="${orderShipment.carrier_name}" id="carrier" placeholder="<spring:message code="enter.carrier.label" />"/>
					</div> 
					<div class="col-lg-1 col-xs-1 col-sm-1"></div>  
					<div class="form-group col-lg-2 col-sm-2 lbl" style="text-align:right;">                   
	                ...
	                <div class="form-group col-lg-3 col-sm-3">
						<input type="text" class="form-control" name="vehicleNumber" id="vehicleNumber" value="${orderShipment.vehicleNo}" placeholder="<spring:message code="enter.vehicle.number.label" />"/>
				...
				<div class="row">
	                ...
	                <div class="form-group col-lg-3 col-sm-3">
						<input type="text" class="form-control" name="inspectedBy" id="inspectedBy" value="${orderShipment.inspectedBy}" placeholder="<spring:message code="enter.inspectedBy.label" />" />
	                ...
	                <div class="form-group col-lg-3 col-sm-3">
						<input type="text" class="form-control" name="driverName" id="driverName" value="${orderShipment.driverName}" placeholder="<spring:message code="enter.driver.name.label" />"/>
				...
				<div class="row">
	                ...
	                <div class="form-group col-lg-3 col-sm-3">
						<input type="text" class="form-control" name="rfidTagNo" id="rfidTagNo" value="${orderShipment.rfidTagNo}" placeholder="<spring:message code="enter.rfidTagNo.label" />"/>
				...
				<div class="row">
	                ...
	                <div class="form-group col-lg-3 col-sm-3">
						<input type="text" class="form-control" name="shipmentNote" id="shipmentNote" value="${orderShipment.shipmentNote}" placeholder="<spring:message code="search.shipment.note.label" />" style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" />
	                ...
	                <div class="form-group col-lg-3 col-sm-3">
						<input type="text" class="form-control" name="shipmentAgency" id="shipmentAgency" value="${orderShipment.shipmentAgency}" placeholder="<spring:message code="enter.shipmentAgency.label" />"/>
				...
				<div class="row">
	                ...
	                <div class="form-group col-lg-3 col-sm-3">
						<input type="text" class="form-control" name="gatePassRef" id="gatePassRef" value="${orderShipment.gatePassRef}" placeholder="<spring:message code="enter.gatePassRef.label" />" style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;"/>
 		 ...
 		 <div class="col-lg-9 col-sm-9" style="margin-top: 1%;">
            <textarea class="form-control" style="resize:none;" rows="3" id="routingInstruction" placeholder="<spring:message code="enter.routing.instruction" />">${orderShipment.routingInstructions}</textarea>
		</div>
		</div>
		<div class="row">
		<div class="form-group col-lg-2 col-sm-2 lbl" style="text-align:right;margin-top: 3%;">                   
 		 ...
 		 <div class="col-lg-9 col-sm-9" style="margin-top: 1%;">
            <textarea class="form-control" style="resize:none;" rows="3" id="packagesDescription" placeholder="<spring:message code="enter.packagesDescription.label" />">${orderShipment.packagesDescription}</textarea>
		</div>
		</div>
		<div class="row">
		<div class="form-group col-lg-2 col-sm-2 lbl" style="text-align:right;margin-top: 3%;">                   
 		 ...
 		 <div class="col-lg-9 col-sm-9" style="margin-top: 1%;">
            <textarea class="form-control" style="resize:none;" rows="3" id="remarks" placeholder="<spring:message code="enter.remarks.label" />">${orderShipment.remarks}</textarea>
		</div>
	</div>
              <br>                    
          <div class="row">
            			...
            			<tbody style="text-align: center;">
            				<c:forEach var="item" items="${orderShipment.shipmentItemsList}" varStatus="theCount">
                            	 <tr id="dynamicdiv${theCount.count}" style='margin-top:5px;'>
                                    ...
                                    <td id="orderedQuantity${theCount.count}"  class='Pack' onBlur='changePack(this);' onkeypress='return (this.innerText.length < 10)' contenteditable='true'>${item.quantity}</td>
