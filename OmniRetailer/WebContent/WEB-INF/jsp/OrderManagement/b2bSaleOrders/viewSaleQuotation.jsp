...
<div class="row">
  <div class="col-lg-12">
                                ...
                                <form role="form">
                                    ...
                                    <div class="row">
	                                   <div class="form-group col-lg-2 col-xs-2 lbl">
                                        ...
                                        <label><spring:message code="fromlocation.label" /> <span style="color:red; font-size:2">*</span></label>
                                            <select class="form-control" id="fromlocation" disabled="disabled">
                                        ...
                                        <div class="address-group col-lg-9 col-xs-8">
                                         <label><spring:message code="address.label" /> </label>
                                            <input type="text" class="form-control clearError" id="fromCompany" readonly="readonly" value="${quoteObj[0].fromAddress}" placeholder="<spring:message code="company.name.label"/>"/>
                                        </div></div>
                                        <!-- <div class="address-group col-lg-4 col-xs-4 lbl">
                                  		 ...
                                  		 <div class="row">
                                  		  <div class="form-group col-lg-2 col-xs-2 lbl"></div>
                                        <div class="address-group col-lg-9 col-xs-8">
                                            <input type="text" class="form-control clearError" disabled="disabled" id="fromStreetName" value="${quoteObj[0].fromStreetName}" placeholder="<spring:message code="street.name.label"/>"/>
                                        </div>
                                        </div>
                                        <!-- <div class="address-group col-lg-4 col-xs-4 lbl">
                                  		 </div> -->
                                  		 ...
                                  		 <div class="form-group col-lg-2 col-xs-2 lbl"></div>
                                        <div class="address-group col-lg-9 col-xs-8">
                                            <input type="text" class="form-control clearError" disabled="disabled" id="fromAddress" value="${quoteObj[0].fromLocality}" placeholder="<spring:message code="select.location"/>"/>
                                        </div>
                                        </div>
                                       <!--  <div class="address-group col-lg-4 col-xs-4 lbl">
                                  		 </div> -->
                                        ...
                                        <input type="text" class="form-control" value="${quoteObj[0].fromCity}" disabled="disabled" id="fromCity" placeholder="<spring:message code="supplier.city.label"/>">
                                        </div>
                                        <div class="address-group col-lg-5 col-xs-5" style="width: 33%">
                                  		  <input type="text" class="form-control" value="${quoteObj[0].fromState}" disabled="disabled" id="fromState" placeholder="<spring:message code="state.label"/>">
                                  		 </div>
                                        </div>
                                  		  ...
                                  		  <input type="text" class="form-control" value="${quoteObj[0].fromPhoneNo}" disabled="disabled" id="fromState" placeholder="Phone No">
                                  		 </div>
                                   ...
                                   <div class="form-group col-lg-9 col-xs-6" style="padding-right: 0px">
                                      ...
                                      <div class="row">
                                        ...
                                        <label>Project Start Date<span style="color:red; font-size:2">*</span></label>
                                            <input type="text" class="form-control calendar_icon clearError" value="${quoteObj[0].projectStartDateStr}"  disabled="disabled" id="createdDate"  style="background-color: white;" onfocus="callCalender('createdDate')" onclick="callCalender('createdDate')" placeholder="DD/MM/YYYY" />
                                            <span id="createdDateError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
                                        </div>
                                        </div>
                                   ...
                                   <div class="form-group col-lg-9 col-xs-6" style="padding-right: 0px">
                                         <label>Project End Date<span style="color:red; font-size:2">*</span></label>
                                            <input type="text" class="form-control calendar_icon clearError" value="${quoteObj[0].projectEndDateStr}"  disabled="disabled" id="lastDateForQuoteStr" style="background-color: white;" onfocus="callCalender('lastDateForQuoteStr')" onclick="callCalender('lastDateForQuoteStr')" placeholder="DD/MM/YYYY" />
                                            <span id="lastDateForQuoteStrError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
                                        </div>
                                    ...
                                    <div class="row">
	                                   <div class="form-group col-lg-2 col-xs-2 lbl">
                                        ...
                                        <label>Customer<span style="color:red; font-size:2">*</span></label>
                                             <input type="text" class="form-control clearError" disabled="disabled" id="fromStreetName" value="${quoteObj[0].customerId}" placeholder="Customer ID"/>
                                        ...
                                        <div class="address-group col-lg-9 col-xs-8">
                                         <label><spring:message code="address.label" /> </label>
                                            <input type="text" class="form-control clearError" id="fromCompany" readonly="readonly" value="${quoteObj[0].toAddress}" placeholder="<spring:message code="company.name.label"/>"/>
                                        </div></div>
                                       
                                  		 <div class="row">
                                  		  <div class="form-group col-lg-2 col-xs-2 lbl"></div>
                                        <div class="address-group col-lg-9 col-xs-8">
                                            <input type="text" class="form-control clearError" disabled="disabled" id="fromStreetName" value="${quoteObj[0].toStreetName}" placeholder="<spring:message code="street.name.label"/>"/>
                                        </div>
                                        </div>
                                  		 ...
                                  		 <div class="form-group col-lg-2 col-xs-2 lbl"></div>
                                        <div class="address-group col-lg-9 col-xs-8">
                                            <input type="text" class="form-control clearError" disabled="disabled" id="fromAddress" value="${quoteObj[0].toLocality}" placeholder="<spring:message code="select.location"/>"/>
                                        </div>
                                        </div>
                                        ...
                                        <input type="text" class="form-control" value="${quoteObj[0].fromCity}" disabled="disabled" id="fromCity" placeholder="<spring:message code="supplier.city.label"/>">
                                         ...
                                         <div class="address-group col-lg-5 col-xs-5" style="width: 33%">
                                  		  ...
                                  		  <div class="address-group col-lg-6 col-xs-8">
                                  		  <label>Phone No</label>
                                  		  <input type="text" class="form-control" value="${quoteObj[0].toPhone}" disabled="disabled" id="fromState" placeholder="Phone No">
                                  		 </div>
                                        </div>
                                   ...
                                   <div class="row">
                                        ...
                                        <label>Customer Name<span style="color:red; font-size:2">*</span></label>
                                             <input type="text" class="form-control clearError" disabled="disabled" id="fromStreetName" value="${quoteObj[0].customerName}" placeholder="Customer Name"/>
                                     ...
                                     <div class="form-group col-lg-9 col-xs-6" style="padding-right: 0px">
                                      <label>Tender Ref</label>
                                            <input type="text" class="form-control calendar_icon clearError" disabled="disabled" id="lastDateForQuoteStr"  style="background-color: white;"  value="${quoteObj[0].tenderRef}" placeholder="Tender Ref" />
                                            <span id="lastDateForQuoteStrError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
                                     ...
                                     <div class="form-group col-lg-9 col-xs-6" style="padding-right: 0px">
                                         <label>Deposit Amt<span style="color:red; font-size:2">*</span></label>
                                            <input type="text" class="form-control calendar_icon clearError" disabled="disabled"  id="lastDateForQuoteStr"  style="background-color: white;"  value="${quoteObj[0].depositAmount}" placeholder="Deposit Amt" />
                                            <span id="lastDateForQuoteStrError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
                                   ...
                                   <!--   <p style="font-size: 18px;"> ${quoteObj.status}</p> -->
                                      ...
                                      <div class="row" style="margin-top: 10px">
	                                     ...
	                                     <div class="col-lg-11" style="padding-right: 1%;text-align:center;">
	                                     		<input type="text"  class="form-control searchItems searchBar" id="searchItems" disabled="disabled" placeholder="<spring:message code="search.items.here.label" />"  style="background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" />
												<div class="services">
										    		<div class="items">
                                              ...
                                              <c:set var="TotalDis" value = "0"> </c:set>
                                              		<c:forEach var="item" items="${quoteObj[0].salesQuotationItems}" varStatus="theCount">
									             		   <tr id="dynamicdiv${theCount.count}">
										                  		...
										                  		<td id="uom${theCount.count}">${item.discount}</td>
										                  		<td id="uom${theCount.count}">${item.tax}</td>
										                  		<td id="uom${theCount.count}">${item.cost}</td>
           ...
           <div class="row">
	           <div class="col-lg-1 col-lg1-1"></div>
	            <div class="form-group  col-lg-5 col-lg5-5" >
	                <textarea class="form-control clearError" disabled="disabled" style="resize: none;" rows="2" id="salesTerms" placeholder="Sales Terms">${quoteObj[0].salesTerms}</textarea>
				</div>
					
	            
				 <div class="form-group  col-lg-5 col-lg5-5" >
                	<textarea class="form-control clearError" disabled="disabled" style="resize: none;" rows="2" id="shipmentTerms" placeholder="<spring:message code="shipment.terms.label"/>">${quoteObj[0].shipmentTerms}</textarea>
				</div>
          </div>
	...
	<c:if test="${type == 'new'}">
       <input type="button"  class="btnCls" style="display: none" onclick="validateRequestForQuotation('Submitted','new');" value="<spring:message code="submit.label" />" />
    </c:if>
    <c:if test="${type != 'new'}">
       <input type="button" class="btnCls" style="display: none" onclick="validateRequestForQuotation('Submitted','edit');" value="<spring:message code="submit.label" />" />
    </c:if>
    </div>
    </div>
