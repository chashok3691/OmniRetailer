	        ...
	        <div class="col-lg-3" >
	           ...
	           <div class="col-lg-8 col-sm-8 col-xs-8">
	            <label><spring:message code="location.label"/></label>
	             <select class="form-control" id="outletLocation" onchange="searchApplicationLog('','','0')">
	        ...
	        <div class="col-lg-3" >
				                      ...
				                      <input type="hidden" id="ed" value="${endDate}">
						                <%--   <div class="col-lg-4" style="text-align:right;top:5px;margin-left:14%;">
						                  ...
						                  <div class="col-lg-6 col-sm-6 col-xs-12" style="padding-right: 7px;" >
						                   <label><spring:message code="offer_start_date.label"/></label>
						                    <input class="form-control calendar_icon" readonly="readonly" value="" style="background-color: white;" id="appfrom" size="20" type="text" onfocus="callCalender('appfrom')" onclick="callCalender('appfrom')" placeholder="From Date" />
						                  </div>
	                                     ...
	                                     <div class="form-group col-lg-1" style="padding-left: 0px; ">
	                                         <input type="button" style="width:85%;padding: 4px 8px;margin-top:18px;" class="btn bg-olive btn-inline" onclick="searchApplicationLog('','','0')" value="<spring:message code="search" />" />
	                                     </div>
	        		</div>
	        		<div class="col-lg-1" style="margin-top: 1.5%;">
						                <%-- <div class="row">
						                  ...
						                  <div class="col-lg-6"> --%>
						                    <select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="searchApplicationLog('','','0');">
       					...
       					<div class="col-lg-10" style="margin-top: 1.5%;">
		        	 		 <input type="text"  class="form-control searchItems searchBar"  value="" id="searchLog" placeholder="<spring:message code="search.log.label" />"style="" />
								<div class="services">
					    			<div class="items">
					     				<ul class="matchedStringUl applicationLog" style=""></ul>
					   				</div>
								</div>
...
<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px;">
 <input type="button" class="iosclosebutton1" onclick="validateApplicationLog('applicationLog','0','save');"  value="Ok">
</div>
<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px;">
        ...
        <div class="modal-footer" style="padding:0px;">
              ...
              <div class="row">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewApplicationLog('applicationLog','${totalValue}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-12" style="text-align: right;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewApplicationLog('applicationLog','${index - (maxRecords + 1)}');"> ${index} - ${totalValue} of ${totalRecords} 
