...
<div class="row">
  <div class="col-xs-12">
				<div class="box box-primary">
                                ...
                                <br/>
                                <h3><spring:message code="new.mini.banner.label" /></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
	        						...
	        						<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${success}</div>
                                       ...
                                       <!--  </div>
                                        <div class="col-lg-8" style="padding-left: 0px;"> -->
                                            <input type="text" class="form-control" id="bannerId" name="bannerId" oninput="this.value = this.value.replace(/[^a-zA-Z0-9 -]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="if.not.given.auto.generated" />"/>
                                             <span style="color:red; font-size:2;font-weight: bold;" id="bannerIdError"></span>
										<!-- </div> -->                                        
                                     	</div>
										<div class="form-group col-lg-4">
										<!-- <div class="col-lg-4" style="padding-left: 0px;"> -->
                                        ...
                                        <div class="col-lg-8" style="padding-left: 0px;"> -->
                                            ...
                                            <span style="color:red; font-size:2;font-weight: bold;" id="bannerPriorityError"></span>
                                        <!--  </div> -->
                                    	</div>
                                    	</div>
                                    	<div class="row">
                                       ...
                                       <!--  </div>
                                        <div class="col-lg-8" style="padding-left: 0px;"> -->
                                            ...
                                            <span style="color:red; font-size:2;font-weight: bold;" id="statusError"></span>
                                        <!-- </div> -->
                                    	</div>
                                    	</div>
                                    	<div class="row">
                                    	...
                                    	<div class="form-group col-lg-9">
                                           ...
                                           <!--  </div>
                                            <div class="form-group col-lg-8" style="padding-left: 0px;padding-right: 25px;"> -->
						  					...
						  					<!-- </div> -->
						  					<span style="color:red; font-size:2;font-weight: bold;" id="bannerThumbnailError"></span>
						  					</div>
						  					<div class="col-lg-3" style="padding-left: 2px;">
						  					<!-- <div class="form-group col-lg-12"> -->
						  						<br>
                                        ...
                                        <select class="form-control" id="productCategory">
                                            ...
                                            <%-- <input type="text" class="form-control" id="productCategory" name="productCategory" oninput="this.value = this.value.replace(/[^a-zA-Z0-9 -]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.banner.id.label" />"/> --%>
                                             <span style="color:red; font-size:2;font-weight: bold;" id="productCategoryError"></span>
										<!-- </div> -->                                        
                                     	</div>
										<div class="form-group col-lg-4">
										<!-- <div class="col-lg-4" style="padding-left: 0px;"> -->
										...
										<select class="form-control" id="brandCategory">
                                            ...
                                            <span style="color:red; font-size:2;font-weight: bold;" id="bannerCategoryError"></span>
										<!-- </div> -->
                                     	</div>
                                     	<div class="form-group col-lg-4">
										<!-- <div class="col-lg-4" style="padding-left: 0px;"> -->
                                       ...
                                       <!--  </div>
                                        <div class="col-lg-8" style="padding-left: 0px;"> -->
                                            ...
                                            <span style="color:red; font-size:2;font-weight: bold;" id="departmentcategoryError"></span>
                                         <!-- </div> -->
                                    	</div>
                                    	</div>
                                    	<div class="row">
                                    	...
                                    	<div class="row">
                                    	<div class="form-group col-lg-4">
                                    	<label><spring:message code="Homepage_Banner.target_url.label"/></label>
                                    	<input placeholder="<spring:message code="Homepage_Banner.target_url.label.placeHolder"/>" name="Target URL" class="form-control" id="targetURL" type="text">
                                    	</div>
                                    	</div>                                    	
					...
					<c:forEach var="accessControl" items="${sessionScope.b2cManagement}">
                        <c:if test="${accessControl.appDocument == 'MiniBanner' && accessControl.write == true && accessControl.read == true}">
