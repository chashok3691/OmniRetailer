...
<div class="row">
  <div class="col-xs-12">
				<div class="box box-primary">
                                ...
                                <c:if test="${type == 'edit'}">
	                                <h3><spring:message code="edit.mini.banner.label" /></h3>
								</c:if>
								<c:if test="${type == 'new'}">
                                ...
                                <form id="newGiftVouchers" method="post" >
	        						...
	        						<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${success}</div>
                                       ...
                                       <!--  </div>
                                    	...
                                    	<input placeholder="<spring:message code="Homepage_Banner.target_url.label.placeHolder"/>" name="Target URL" class="form-control" id="targetURL" type="text" value="${banner.targetURL}">
                                    	</div>
                                    	</div>
						...
						<c:if test="${type == 'edit'}">
						  <input type="button" class="btn bg-olive btn-inline" style="width: 65px;" onclick="validateHomePageBanner('edit')" value="<spring:message code="submit.label" />" />
						</c:if>
						<c:if test="${type == 'new'}">
							<input type="button" class="btn bg-olive btn-inline" style="width: 65px;" onclick="validateHomePageBanner('new')" value="<spring:message code="submit.label" />"/>
						</c:if>
					 <c:if test="${sessionScope.role == 'super admin'}"> 
					 	<input type="button" class="btn bg-olive btn-inline" style="margin-left:5%;" onclick="viewHomePageBanners('','0');" value="<spring:message code="cancel.label" />" />
					 </c:if>
