...
<div class="row">
  <div class="col-xs-12">
				<div class="box box-primary">
                                ...
                                <h3><spring:message code="view.mini.banner.label" /></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form id="newGiftVouchers" method="post" >
	        						...
	        						<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${success}</div>
                                       ...
                                       <!--  </div>
                                    	...
                                    	<input placeholder="<spring:message code="Homepage_Banner.target_url.label.placeHolder"/>" name="Target URL" class="form-control" id="bannerName" type="text" readonly="readonly"  value="${banner.targetURL}">
                                    	</div>
                                    	</div>
