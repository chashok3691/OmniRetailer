			...
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-header" style="text-align: center; ">
						...
						<div class="col-lg-4" ><span style="border: 1px solid black;font-size:20px;padding: 4px 12px 4px 12px;">Featured Retailer - Edit</span></div>
								...
								<div class="form-group col-lg-2">
									...
									<label><spring:message code="featuredShops.status.label" /></label>
									 <select id="status" class="form-control">
										<option value="Active" ${'Active' == featuredRetailer.status ? 'selected' : ''}>Active</option>
										<option value="Inactive" ${'Inactive' == featuredRetailer.status ? 'selected' : ''}>In-Active</option>
...
<!-- description -->			  
								<div class="form-group col-lg-5">
								  <div class="col-lg-10" >
									...
									<input type="text"  class="form-control" id="description" value="${featuredRetailer.featureDescription}" placeholder="<spring:message code="enter.featured.description.label" />"/>
...
<!-- package -->
								<div class="form-group col-lg-4">
								  <div class="col-lg-7">
									...
									<input type="text"   class="form-control" id="package" value="${featuredRetailer.packageName}"/>
...
<!-- startDate -->
								<div class="form-group col-lg-2">
									...
									<input class="form-control calendar_icon" value='${fn:substring(start, 0, 10) } ' readonly="readonly" style="background-color: white;" name="startDate" id="startDate" size="20" type="text" onclick="callCalender('startDate')" onfocus="callCalender('startDate')"  placeholder="DD/MM/YYYY" />
							    ...
							    <div class="col-lg-10" >
							     ...
							     <div class="col-lg-9" style="padding:0px">
										...
										<c:forEach var="locationId" items="${workLocationsList}">
							         	<option value="${locationId}" ${locationId == featuredRetailer.locationId ? 'selected' : ''} >${locationId}</option>
						 				</c:forEach>
									 	</select> 
								 ...
								 <label><spring:message code="zone.label" /></label><br>
								    <select id="zone" class="form-control" >
	                                             <c:forEach var="zone" items="${zones}">
													<option value="${zone}" ${zone == featuredRetailer.zoneId ? 'selected' : ''}>${zone}</option>
												</c:forEach>
									</select>
								 </div>
								 </div>
<!-- endDate -->								 
								 <div class="form-group col-lg-2">
								 	...
								 	<input class="form-control calendar_icon" readonly="readonly" value="${fn:substring(end, 0, 10)}"style="background-color: white;" name="endDate" id="endDate" size="20" type="text" onclick="callCalender('endDate')" onfocus="callCalender('endDate')" placeholder="DD/MM/YYYY" />
...
<!-- Empty box -->			   
								...
								<div class="col-lg-10" style=" height:150px;">
									<textarea  class="form-control" id="reatilerLocation" style=" height:100px;resize: none;">${featuredRetailer.locationId}</textarea>
...
<!-- Image -->
								 ...
								 <div style="margin-bottom:0px;height: 29px;width: 125px;"> <label style="padding-top: 27px;"><spring:message code="featuredShops.image.label" /></label></div>
						  					<br>
												<div class="fileUpload btn btn-primar" style="font-weight: bold;height: 29px;width: 125px;border-color: ''">
									    			...
									    			<input type='hidden' id='retailerImage_refId'  value="${featuredRetailer.strPicture}">
									    			<input type='hidden' id='retailerImageFile'  value="${featuredRetailer.imageLink}">
												</div> 
								 </div>
								 <div class="col-lg-2">
								 	<br>
							...
							<input type='hidden' id="frCreatedDateStr" value="${featuredRetailer.createdDateStr}">
							<input type='hidden' id="frUpdatedDateStr" value="${featuredRetailer.updatedDateStr}">
