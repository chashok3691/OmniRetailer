  ...
  <div class="col-lg-12">
				<div class="box box-primary">
                                <div class="box-header" style="text-align: left;">
                                 <h3 style="text-align: center;"><label style="text-align: center;padding: 5px;padding-left: 20px;padding-right: 20px;border: 1px solid gray;border-radius:5px;"><spring:message code="home.page.offers.label" />-View</label></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form">
                                    <div class="box-body">
    		...
    		<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -25px">${success}</div>
                ...
                <label><spring:message code="title.label" /> <span style="color:red; font-size:2"></span></label>
					<input type="text" readonly="readonly" class="form-control" name="title" id="title" value="${hotDealsList.dealsDisplayTitle}" placeholder=""/>
					<span id="titleError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
				</div>        
               <div class="form-group col-lg-12" >
                <label><spring:message code="prepared.by.label" /> <span style="color:red; font-size:2"></span></label>
					<input type="text" class="form-control" readonly="readonly" name="preparedBy" id="preparedBy" value="${hotDealsList.preparedBy}" placeholder=""/>
					<span id="preparedByError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
				</div> 
                 </div>
                  <div class="col-lg-2 col-sm-2">
                   <div class="form-group col-lg-12" >
                <label><spring:message code="deals.priority.label" /> <span style="color:red; font-size:2"></span></label>
                                            <select class="form-control" readonly="readonly" name="priority" id="dealPriority">
                ...
                <select readonly="readonly" class="form-control" name="dealStatus" id="dealStatus">
                ...
                <input class="form-control calendar_icon" readonly="readonly" value="${hotDealsList.effectiveFromDateStr}" style="background-color: white;" id="from" size="20" type="text"  placeholder="Start Date" />
                ...
                <div class="form-group col-lg-12" >
                 ...
                 <input class="form-control calendar_icon" readonly="readonly" value="${hotDealsList.endDateStr}" style="background-color: white;" id="to" size="20" type="text"  placeholder="End Date" />
					<!-- <input type="text" class="form-control" name="dealEndDate" id="dealEndDate" value="" placeholder=""/>
					<span id="dealEndDateError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span> -->
				</div> 
                  </div>
                   ...
                   <div class="col-lg-5 col-sm-5" style="padding-right: 0px;">
                    <div class="form-group col-lg-12" >
	                            ...
	                            <textarea readonly="readonly" rows="4" id="description" name="description" style="resize: none;" class="form-control allField" placeholder="<spring:message code="enter.description.label" />" >${hotDealsList.dealDescription}</textarea>
                 ...
                 <div class="col-lg-3 col-sm-3" style="padding-left: 0px;">
                  <div class="form-group col-lg-12" >
                	...
                	<select class="form-control" id="displaypage" disabled="disabled">
                	
                	
                	 <option value="homepage" ${'homepage' == hotDealsList.offerDisplayPage ? 'selected' : ''}>home page</option>
                     <option value="offerpage" ${'offerpage' == hotDealsList.offerDisplayPage ? 'selected' : ''}>offer page</option>
          ...
          <div class="row">
            ...
            <%--  <div class="row">
                ...
                <select class="form-control" id="offerProductCategory" onchange="searchOffersBasedOnCategory('offerProductCategory','dontAdd');">
                ...
                <select class="form-control" id="offerGroups" onchange="">
				                           	<option value="select">-- Select --</option>
             ...
             <%-- <div class="row">
                ...
                <select class="form-control" id="dealProductCategory" onchange="searchDealsBasedOnCategory('dealProductCategory','dontAdd');">
             	...
             	<div class="form-group col-lg-12" >
             	<label><spring:message code="group_id.label" /> <span style="color:red; font-size:2"></span></label>
                <select class="form-control" id="dealGroup" onchange="">
				                           	<option value="select">-- Select --</option>
		 ...
		 <input type="hidden" id="dealfrom" value="${dealObj.effectiveFromDateStr}">
        <input type="hidden" id="dealto" value="${dealObj.endDateStr}">
        <!--  <input type="hidden" id="searchEvents" value=""> --> 
				<!--added by manasa  -->
