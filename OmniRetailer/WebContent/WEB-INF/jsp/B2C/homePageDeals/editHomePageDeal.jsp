 ...
 * file name		        : B2C/editHomePageDeal.jsp
 * file type		        : JSP
...
<div class="row">
  <div class="col-lg-12">
				<div class="box box-primary">
                                ...
                                <h3 style="text-align: center;"><label style="text-align: center;padding: 5px;padding-left: 20px;padding-right: 20px;border: 1px solid gray;border-radius:5px;"><spring:message code="home.page.offers.label" />-Edit</label></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form">
                                    <div class="box-body">
    		...
    		<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -25px">${success}</div>
                ...
                <label><spring:message code="title.label" /> <span style="color:red; font-size:2"></span></label>
					...
					<span id="titleError" style="text-align: right; color: red; font-size: 2; position: absolute;"></span>
				</div>        
                 <div class="form-group col-lg-12" >
                <label><spring:message code="prepared.by.label" /> <span style="color:red; font-size:2"></span></label>
					...
					<span id="preparedByError" style="text-align: right; color: red; font-size: 2; position: absolute;"></span>
				</div> 
                ...
                <input class="form-control calendar_icon startDateHotdeal" readonly="readonly" value="${hotDealsList.effectiveFromDateStr}" style="background-color: white;" id="from" size="20" type="text" onfocus="callCalender('from')" onclick="callCalender('from')" placeholder="Start Date" />
					...
					<span id="dealStartDateError" style="text-align: right; color: red; font-size: 2; position: absolute;"></span> 
				</div>         
                <div class="form-group col-lg-12" >
          ...
          <div class="row">
             ...
             <div class="row" style="margin-top: 0px;margin-left: 0px;margin-right: 0px;margin-bottom: 0px;">
              ...
              <div class="form-group col-lg-12" >
                ...
                <select class="form-control" id="offerGroups" onchange="searchOffersBasedOnCategory('offerProductCategory','dontAdd');">
				                           	<option value="">-- Select --</option>
             ...
             <div class="col-lg-12 col-sm-12" >
              ...
              <div class="form-group col-lg-12" >
               ...
               <div class="form-group col-lg-12" >
             	<label><spring:message code="group_id.label" /> <span style="color:red; font-size:2"></span></label>
                <select class="form-control" id="dealGroup" onchange="searchDealsBasedOnCategory('dealProductCategory','dontAdd');">
				                           	<option value="select">-- Select --</option>
        ...
        <!--  <input type="hidden" id="searchEvents" value=""> --> 
				<!--added by manasa  -->
							...
							<div class="form-group col-lg-12">
						 <input type="button" style="width: 65px;" class="btn bg-olive btn-inline" onclick="validateHotDealForm('homePageDeals','edit');" value="<spring:message code="submit.label" />" />
