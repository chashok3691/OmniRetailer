  ...
  <div class="col-lg-12 col-xs-12">
	<div class="box box-primary ">
     <div class="box-header" style="text-align: left">
    	<h3><spring:message code="editNewArrivals.heading"/></h3>
     </div><!-- /.box-header -->
    <!-- form start -->
    <form>
    <input type="hidden" value="${newarrivalId}" id="newarrivalId"/>
      <div class="box-body">
        <div class="row form-group" style="text-align: right; margin-top: 0px;">
        	...
        	<input type="button" id="submit" style="position: relative;margin-right: 1%" class="btn bg-olive btn-inline" onclick="validateNewarrivalForm('edit')" value="&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="createNewArrivals.button.save"/>&nbsp;&nbsp;&nbsp;&nbsp;">
        	 ...
        	 <div class=" col-lg-6 col-sm-6 form-group">
        	 		...
        	 		<div class="col-lg-2 col-md-2 col-xs-0 col-sm-2"></div>
		               ...
		               <label><spring:message code="createNewArrivals.title.label"/><span style="color:red; font-size:2"></span></label>
		                <input type="text"  class="form-control " value="${newarrivalslist.newCategoryName}" id="newarrivalGroup" placeholder="<spring:message code="createNewArrivals.title.label.placeholder"/>">
...
<div class="row">
                  ...
                  <div class="col-lg-8 col-md-8 col-xs-7 col-sm-9 " style="padding-left:0px ;margin-bottom: 3px">
                   <label><spring:message code="createNewArrivals.brandName.label"/></label>
					<select class="form-control" name="pricerange" id="brandcode" onchange="getProductsByCriteria('','filter','0')">
                             	...
                             	<option value="${brand.bName}" ${brand.bName == newarrivalslist.brandId ? 'selected' : ''}>${brand.bName}</option>
							 </c:forEach>
          						 </select>
                    <span style="color:red; font-size:2; position: absolute;" id="endDateError"></span>
                  </div>
  ...
  <div class="table-responsive">
    		...
    		<div id="picture${theCount.count}image">
				...
				<td><input id="featuredText${theCount.count}" type="text" value="" /></td>

				<td id="Del${theCount.count}" ><img id="Img${theCount.count}" src="${pageContext.request.contextPath}/images/itemdelete.png" style='width:25px;cursor:pointer;' onclick="deleteItem(this);" title="Delete ${newArrivalsList.skuDesc}" />
				</td>
			</tr>
     </c:forEach> 
 			</tbody>
        ...
        <input type="hidden" id="arrivalto" value="${arrivalObj.endDateStr}">
         ...
         <div class="row" style="text-align: right; margin-top: 10px;">
        	<input type="button" id="submit" style="position: relative;margin-right: 1%" class="btn bg-olive btn-inline" onclick="validateNewarrivalForm('edit')" value="<spring:message code="submit.label" />">
			<input type="button" class="btn bg-olive btn-inline" style="margin-right: 2%;position: relative;" onclick="viewNewArrivals('newArrivals');" value="<spring:message code="createNewArrivals.button.cancel"/>">	 
        </div>
