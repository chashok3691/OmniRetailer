...
<body>
                          ...
                          <div class="row">
                           ...
                           <div class="row">
                          		...
                          		<div class="col-lg-2 form-group" style="text-align: right;">
	                          		<div style="text-align: center;width: 140px;height: 130px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="return viewAllHomePageDeals('homePageDeals','0');" title="<spring:message code="payment.gateway.label" />">
