  ...
  <div class="col-xs-12">
				<div class="box box-primary">
                                <div class="box-header" style="text-align: center">
                               		 <h3><spring:message code="viewshoppinglist.heading.label" /></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form id="newProduct" method="post" >
                                    <div class="box-body">
                                      ...
                                      <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="list_type" id="list_type" readonly value="${shoppinglistresponse.listName}" required  />
                                        ...
                                        <div class="form-group col-lg-3">
                                            <label><spring:message code="createshoppinglist.shopppinglist.customercategery.label" /></label>
                                             <select class="form-control" onchange="searchSubCategoriesBasedOnCategory('category')" disabled="" name="category" id="category">
                                              <c:forEach var="customerCategory" items="${categories}">
                                              <option value="${customerCategory.categoryName}" ${customerCategory.categoryName == shoppinglistresponse.customerCategory ? 'selected' : ''}>${customerCategory.categoryDescription}</option>
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <select class="form-control" name="country"  disabled="${isvisible}"  id="country">
							            ...
							            <select class="form-control" name="status" id="status" disabled="">
                                         ...
                                         <div class="form-group col-lg-4">
                                            <label ><spring:message code="createshoppinglist.shopppinglist.listdescription.label" /> </label>
                                                     <input type="text" class="form-control" name="list_description" id="list_description" value="${shoppinglistresponse.listDescription}" required readonly />
                                         ...
                                         <div class="form-group col-lg-3">
                                            ...
                                            <select id="purchaseChannel" class="form-control" disabled>
                                         ...
                                         <div class="form-group col-lg-3">
                                            ...
                                            <select id="salesZone" class="form-control" disabled>
									        	 		 	<option value="-- Select --" >-- Select --</option>
									                	  	<c:forEach var="zone" items="${zones}">
																<option value="${zone}" ${shoppinglistresponse.zoneID == zone ? 'selected' : ''}>${zone}</option>
															 </c:forEach>
									         </select>
                                        </div>
                                        </div>
						   ...
						   <div class="form-group col-lg-12" >
							   ...
							   <div class="form-group col-lg-12" >
							    <c:if test="${empty categoryId}">
                               	 <input type="checkbox"   disabled onchange="toggleBased('basedOnProduct')" style="vertical-align: -2px" id="basedOnProduct"/>&nbsp; <spring:message code="configure.based.on.product.label" />
                               	 <hr style="margin-top: 1px;"></c:if>
							    <c:if test="${not empty categoryId}">
                               	 <input type="checkbox" checked="checked"  disabled onchange="toggleBased('basedOnProduct')" style="vertical-align: -2px" id="basedOnProduct"/>&nbsp; <spring:message code="configure.based.on.product.label" />
                               	 <hr style="margin-top: 1px;"></c:if>
                               </div>
                               </div> 
                               </div>
                            ...
                            <div class="form-group col-lg-12" >
							   ...
							   <div class="col-lg-12" style="padding-right: 0px">
									<div class="form-group col-lg-3" style="margin-top: -25px;">
					        	 		 ...
					        	 		 <input type="text"  class="form-control searchItems basedOnProduct " id="searchItems" readonly="readonly"  placeholder="<spring:message code="deal_enter_product_name.label" />"  style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;margin-left:1px;"/>
									<div class="services">
						    			<div class="items">
    		          ...
    		          <td id="orderedQuantity${theCount.count}">${itemsList.orderQty}</td>
							  ...
							  <div class="row">
			   					<div class="form-group col-lg-12" >
                                   	...
                                   	<input type="checkbox" checked="checked" onchange="toggleBased('basedOnGroup')" disabled style="vertical-align: -2px" id="basedOnGroup"/>&nbsp;&nbsp;&nbsp; <spring:message code="configure.based.on.group.label" />
                                   	 <hr style="margin-top: 1px;"></c:if>
						    ...
						    <div class="row">
							   ...
							   <div class="col-lg-12" style="padding-right: 0px">
									     ...
									     <label><spring:message code="sale_group_id.label" /></label>
									        ...
									        <input type="text"  class="form-control searchItems basedOnGroup saleGroups"  id="saleGroup" disabled ="" style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;margin-left:1px;"/>
											<div class="services">
								    			<div class="items">
                                          ...
                                          <thead style="background-color:rgb(128,128,128); color: #ffffff">
                                            <tr>
                                                ...
                                                <tr>
		                                        		...
		                                        		<td id="saleGroupId">${itemsList.groupId}</td>
		                                               <%--  <th><spring:message code="action.label"/></th> --%>
		                                        	 </tr>
		                                        	 </c:forEach>
                                                </tbody>
			...
			<tr class="update" id="dynamicdiv${theCount.count}" style='margin-top:5px;'>
			         ...
			         <td id="itemId${theCount.count}">${itemsList.skuId}</td>
    		          ...
    		          <td id="orderedQuantity${theCount.count}">${itemsList.orderQty}</td>
						...
						<input class="btn bg-olive btn-inline" style="width:65px;margin-top:-50px;" onclick="viewShoppingList('shoppinglist')" value="Cancel" type="button">
