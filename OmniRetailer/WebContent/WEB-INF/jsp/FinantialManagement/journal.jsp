                        ...
                        <label><spring:message code="Organization.label"/></label>
                         ...
                         <div class="col-lg-3">
                          <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
							...
							<option value="${location.locationId}" ${location.locationId == selLocation ? 'selected' : ''} id="${location.locationId}" >${location.locationId}</option>
						</c:forEach>
                              </select>
 	                 </div>
	            </div>
              ...
              <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
                 			 <input type="hidden" id="type" value="${type}">
						            ...
						            <label><spring:message code="offer_start_date.label"/></label>
						                    <input class="form-control  calendar_icon" style="background-color: white;" value="${start_date}" autocomplete="off" id="start_date" size="20" type="text"  onfocus="callCalender('start_date')" onclick="callCalender('start_date')" placeholder="DD/MM/YYYY" />
	              </div>
	            </div>
                  ...
                  <div class="col-lg-3">
	               <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
	                  <label><spring:message code="offer_end_date.label"/></label>
						      <input class="form-control  calendar_icon" style="background-color: white;" autocomplete="off" value="${end_date}" id="end_date" size="20" type="text" onfocus="callCalender('end_date')" onclick="callCalender('end_date')" placeholder="DD/MM/YYYY" />
		           </div>
		          </div>                      
                  ...
                  <div class="row">
                   ...
                   <input type="button" style="margin-top:22px;width: 135%;" class="btn bg-olive btn-inline addBtn" onclick="accountingjournal('','','')" value="<spring:message code="search" />" />
                  </div>
                  <div class="row">
                  <a onclick="accountingjournal('View','','');" style="margin-top:31px;width: 135%;"  class="btn bg-olive btn-inline addBtn"><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div>
	  ...
	  <!-- <div style="overflow:auto"> -->    
         <table id="productstocks" class="table table-bordered table-striped" style="margin-top:0%;">
          <thead style="background-color: #3c8dbc; color: #ffffff">
                 <tr>  
                 	 <th class="col-lg-1"><spring:message code="sno.label" /></th>
                     ...
                     <th class="col-lg-2"><spring:message code="debit.amt" /></th>
                      <th class="col-lg-2"><spring:message code="Account.type" /></th>
                     <th class="col-lg-2"><spring:message code="Account.id" /></th>
             ...
             <tbody style="text-align: center;white-space: nowrap;">
                 ...
                 <c:forEach var="Assets" items="${AssetsList}" varStatus="TheCount">
                  ...
                  <td>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;"
                     onclick="editJournal('${Assets.transactionRef}','${Assets.createdDateStr}','${Assets.locationId}','${Assets.remarks}','${Assets.creditAmount}','${Assets.debitAmount}','${Assets.accountType}','${Assets.accountId}','${Assets.accountName}')">Edit</a>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="deleteJournal('${Assets.transactionRef}')">Delete</a></td>
	              ...
	              <div class="row" style="padding-left: 5px;padding-right: 0px;margin-top: 10px;">                      
	               <div class="col-lg-3" style="width:165px;">
	                <label><spring:message code="created.date.label" /></label>
 	                 ...
 	                 <div class="row" style="padding-left: 5px;padding-right: 0px;margin-top: 10px;">                      
	              	<div class="col-lg-3" style="width:165px;">
                            <label><spring:message code="Account.type" /></label>
                              <select class="form-control" name="" id="account_type" onchange="getAccountList()">
                         ...
                         <div class="col-lg-3" style="width:165px;">
                            <label><spring:message code="Account.id" /></label>
                              <select class="form-control" name="" id="account_id">
                                     <c:forEach var="Accounts" items="${AccountsList}">
							<option value="${Accounts.accountId}" ${Accounts.accountId == selectedLocation ? 'selected' : ''} id="${Accounts.accountId}" >${Accounts.accountName}</option>
						</c:forEach>
                              </select>
 	                 </div>
                          <div class="col-lg-3" style="width:165px; display: none">
                            <label><spring:message code="Account.id" /></label>
                              <select class="form-control" name="" id="account_name">
                                     <c:forEach var="Accounts" items="${AccountsList}">
							<option value="${Accounts.accountName}" ${Accounts.accountName == selectedLocation ? 'selected' : ''} id="${Accounts.accountName}" >${Accounts.accountName}</option>
						</c:forEach>
                              </select>
 	                 </div>
 	                 </div>		
                       ...
                       <div class="col-lg-3" style="width:165px;">
                        <label><spring:message code="Txn.Type" /></label>
                          ...
                          <div class="col-lg-3" style="width:165px;">
                           <label><spring:message code="Txn.Value" /></label>                                       
 	                 ...
 	                 <input type="hidden" id="accountName" value="${AssetsList[0].accountName}" />	
						...
						<div class="row" style="text-align: center;margin-top: 30px;">
						 <input type="button" style="" id="sumbitBtn" class="btnCls" onclick="createJournalTransactions();" value="<spring:message code="submit.label" />" />
						 <input type="button" style="display: none" id="updateBtn" class="btnCls" onclick="updateJournal();" value="<spring:message code="update.label" />" />
						
						<input type="button" style="display: none" class="btnCls buttonMargin"  onclick="accountingAssets('','','');" value="<spring:message code="cancel.label" />" />
                        ...
                        <div style="padding-left: 5px;">
							<input type="number" id="total.debit" value="${totalDebit}" readonly="readonly" style="border-radius: 5px;border:1px solid lightgrey;" /> 
                         </div>
              ...
              <input type="hidden" id="flowUnder" name="flowUnder" value= "${flowUnder}">
                <div class="row" style="/* display:none; */">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="accountingjournal('view','','${totalValue}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="accountingjournal('view','','${index - (maxRecords + 1)}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="accountingjournal('view','',document.getElementById('pagination').value);" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
