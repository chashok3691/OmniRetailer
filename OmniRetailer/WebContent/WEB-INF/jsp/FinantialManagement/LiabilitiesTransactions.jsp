  ...
  <div class="box box-primary">
       <div class="box-header" style="text-align: center;padding-bottom: 0px;">				
		<h3 class="box-title" style="border: 1px solid gray;padding: 5px;padding-left: 40px;padding-right: 40px;">
				<spring:message code="Accounting.liabilities.transaction"/>
			</h3>
	</div><!-- /.box-header -->
              ...
              <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
	            ...
	            <div class="col-lg-3">
                  ...
                  <div class="row">
                   ...
                   <input type="button" style="margin-top:22px;width: 135%;" class="btn bg-olive btn-inline addBtn" onclick="searchTransactions('Liabilites','0')" value="<spring:message code="search" />" />
                  </div>
                  <div class="row">
                  <a onclick="viewLiabilitesTransactions('view','${AccountId}','');" style="margin-top:31px;width: 135%;"  class="btn bg-olive btn-inline addBtn"><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div>
		...
		<span id="txnDescriptionError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
	                ...
	                <label><spring:message code="created.date.label" /></label>
 	                 ...
 	                 <input type="hidden" id="accountName" value="${AssetsList[0].accountName}" />	
						...
						<div class="row" style="text-align: center;margin-top: 30px;">
						 <input type="button" style="" id="sumbitBtn" class="btnCls" onclick="CreateLiabilitesTransactions();" value="<spring:message code="submit.label" />" />
              ...
              <div class="row" style="/* display:none; */">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewLiabilitesTransactions('view','${AccountId}','${totalValue}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewLiabilitesTransactions('view','${AccountId}','${index - (maxRecords + 1)}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewLiabilitesTransactions('view','${AccountId}',document.getElementById('pagination').value);" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
