                                   	...
                                   	<div class="row">
                                    	...
                                    	<div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 60%;" onchange="RemoveAccountErr();" id="AccountId" placeholder="<spring:message code="Accounting.Account.Id" />" />
                                    	  ...
                                    	  <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 80%;" id="AccountName" onchange="RemoveAccountErr();" placeholder="<spring:message code="Accounting.Account.name" />" />
                                    	 	        <span id="errorAccName" style="text-align:Left;color: red;font-size: 2;font-weight: bold;display:none;">Please enter account name</span>
                                    	  ...
                                    	  <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 80%;" id="DiscriptionId" placeholder="<spring:message code="Accounting.discription" />" />
                                    	 		</div>
                                    	 	</div>
...
<!-- 						                             <span id="error" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span> -->
							...
							<div class="form-group col-lg-6">
								<div class="row">
                                           ...
                                           <label><spring:message code="Accounting.Account.Type" /><!-- <span style="color:red; font-size:2">*</span> --></label>
                                              <select class="form-control" name="zoneID" id="AccountType" style="width: 60% !important;">
                                        ...
                                        <%-- <c:forEach var="locationStr" items="${locationStr}"> 
                                 	 	 ...
                                 	 	 <div class="row">
                                  	 	<div class="form-group col-lg-12">
                                           <label><spring:message code="Accounting.Organisation.Id" /><span style="color:red; font-size:2">*</span></label>
				                             <select class="form-control" style="width: 60%;" id="organization" onchange="RemoveAccountErr();" onchange="getOrganizationlocations()" >
				                           <option value=""><spring:message code="ALL.label"/></option>
					                        ...
					                        <span id="errorOrganizationId" style="text-align:Left;color: red;font-size: 2;font-weight: bold;display:none;">Please select organizationId</span>
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="CreateExpenses('New','0');" value="<spring:message code="submit.label" />" />
						  <c:if test="${sessionScope.role == 'super admin'}"> 
						  	<input type="button" class="btnCls buttonMargin"  onclick="" value="<spring:message code="cancel.label" />" />
						  </c:if>
