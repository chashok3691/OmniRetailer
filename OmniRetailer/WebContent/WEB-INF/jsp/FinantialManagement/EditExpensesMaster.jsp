                                   	...
                                   	<div class="row">
                                    	...
                                    	<div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 60%;" onchange="RemoveAccountErr();" value="${AssetsList[0].accountId}" disabled="disabled" id="AccountId" placeholder="<spring:message code="Accounting.Organisation.Id" />" />
                                    	  ...
                                    	  <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 80%;" value="${AssetsList[0].accountName}"  onchange="RemoveAccountErr();"  id="AccountName" placeholder="<spring:message code="Accounting.Incorporation" />" />
                                    	  ...
                                    	  <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 80%;" value="${AssetsList[0].accountDescription}" id="DiscriptionId" placeholder="<spring:message code="Accounting.discription" />" />
                                    	 		</div>
                                    	 	</div>
...
<!-- 						                             <span id="error" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span> -->
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="CreateExpenses('Edit','0');" value="<spring:message code="submit.label" />" />
