  ...
  <div class="box box-primary">
       <div class="box-header" style="text-align: center;padding-bottom: 0px;">
			...
			<h3 class="box-title" style="border: 1px solid gray;padding: 5px;padding-left: 40px;padding-right: 40px;">
				<spring:message code="Liabilities.subLedger.label"/>
			</h3>
		<%-- </c:if>  --%>
	</div><!-- /.box-header -->
	      ...
	      <div class="row" style="padding-left:15px;padding-right:15px;">
              ...
              <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
                  ...
                  <div class="row">
                   ...
                   <input type="button" style="margin-top:22px;width: 135%;" class="btn bg-olive btn-inline addBtn" onclick="LiabilitiesSubLedger('view','${Organization}','${accountId}','${accountname}','');" value="<spring:message code="search" />" />
                  </div>
                  <div class="row">
                  <a  type="button" style="margin-top:31px;width: 135%;"  class="btn bg-olive btn-inline addBtn"  onclick="LiabilitiesSubLedger('clear','${Organization}','${accountId}','${accountname}','');"><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div>
...
<div id="Error" class="Error" style="margin-top:-40px;text-align:center;color:red;font-weight:bold;">${err}</div>
  <div id="Success" class="Error" style="margin-top:-40px;text-align:center;color:blue;font-weight:bold;">${success}</div>
	      ...
	      <div class="row">
           ...
           <div class="col-lg-8" style="margin-top: 10px; padding-left: 15px;width: 81%">
                     ...
                     <input type="text"  class="form-control"  value="${searchName}" id="searchAccount" placeholder="<spring:message code="search.account.label" />"/>
							<button id="mySearch" class="searchbutton"  onclick="LiabilitiesSubLedger('view','${Organization}','${accountId}','${accountname}','');" ></button>
							<!-- <div class="services">
				    			<div class="items">
        ...
        <div class="modal fade" id="myModal" role="dialog">
          ...
          <h3 class="modal-title" style="text-align: center;">Liabilities Sub Ledger</h3>
          </div>
								...
								<div class="row" style="margin-left:20%;">
                                           ...
                                           <label><spring:message code="Accounting.Account.Type" /><!-- <span style="color:red; font-size:2">*</span> --></label>
                                              <select class="form-control" name="zoneID" id="Sub_AccountType" style="width: 60% !important;">
                                                   ...
                                                   <option value="Liability" id="Liability" >Liability</option>
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="CreateSubLiabilities('New','0');" value="<spring:message code="submit.label" />" />
						  <c:if test="${sessionScope.role == 'super admin'}"> 
						  	<input type="button" class="btnCls buttonMargin"   onclick="LiabilitiesSubLedger('view','${Organization}','${accountId}','${accountname}','');" value="<spring:message code="cancel.label" />" />
						  </c:if>
						 <c:forEach var="accessControl" items="${sessionScope.genericBusinessSettings}">
                             <c:if test="${accessControl.appDocument == 'ZoneMaster' && accessControl.write == true && accessControl.read == true}">
								<input type="button" class="btnCls buttonMargin"  onclick="LiabilitiesSubLedger('view','${Organization}','${accountId}','${accountname}','');" data-dismiss="modal" value="<spring:message code="cancel.label" />" />
							</c:if>
						</c:forEach>
						</div>
									<br/>
                        			...
                        			<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${resultStr}</div>
                                   	<div class="row">
                                    	...
                                    	<div class="row" style="margin-left:20%;">
                                    	 		<div class="form-group col-lg-12">
		                                            <label><spring:message code="Accounting.SubAccount.Id" /><span style="color:red; font-size:2">*</span></label>
		                                            <input type="text" class="form-control" style="width: 60%;" value="${subAssetsList[0].subAccountTypeId}" disabled="disabled" id="viewSub_AccountId" placeholder="<spring:message code="Accounting.SubAccount.Id" />" />
                                    	 			<span id="errorAccId" style="text-align:Left;color: red;font-size: 2;font-weight: bold;display:none;">Please enter account ID</span>
       ...
       <div class="box-header" style="text-align: center;padding-bottom: 0px;">
        ...
        <div class="">
            ...
            <form id="newEmployee" method="post">
                        			...
                        			<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -20px">${resultStr}</div>
                                   	<div class="row">
                                    	...
                                    	<div class="row" style="margin-left:20%;">
                                    	 		<div class="form-group col-lg-12">
		                                            <label><spring:message code="Accounting.SubAccount.Id" /><span style="color:red; font-size:2">*</span></label>
		                                            <input type="text" class="form-control" style="width: 60%;" value="${subAssetsList[0].subAccountTypeId}" disabled="disabled" id="editSub_AccountId" placeholder="<spring:message code="Accounting.SubAccount.Id" />" />
                                    	 			<span id="errorAccId" style="text-align:Left;color: red;font-size: 2;font-weight: bold;display:none;">Please enter account ID</span>
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="CreateSubLiabilities('Edit','0');" value="<spring:message code="submit.label" />" />
						  <c:if test="${sessionScope.role == 'super admin'}"> 
						  	<input type="button" class="btnCls buttonMargin" onclick="LiabilitiesSubLedger('view','${Organization}','${accountId}','${accountname}','');" value="<spring:message code="cancel.label" />" />
						  </c:if>
						 <c:forEach var="accessControl" items="${sessionScope.genericBusinessSettings}">
             ...
             <tbody style="text-align: center;white-space: nowrap;">
             	 ...
             	 <tr>
             	 	 ...
             	 	 <td>${subAssetsList.subAccountTypeId}</td>
             	 	  <td>${subAssetsList.accountName}</td>
             	 	    ...
             	 	    <td><a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;"  onclick="viewLiabilitiesSubLedger('View','${subAssetsList.accountId}','${subAssetsList.subAccountTypeId}')">View</a>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="viewLiabilitiesSubLedger('Edit','${subAssetsList.accountId}','${subAssetsList.subAccountTypeId}')">Edit</a>
                 <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;"   onclick="viewLiabilitesSubTransactions('data','${subAssetsList.subAccountTypeId}','')">Data</a>
                 </td>
                 </tr>
                </c:forEach>
             </tbody>
              ...
              <div class="row" >
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="LiabilitiesSubLedger('view','','','','${totalValue}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="LiabilitiesLedger('view','','','','${index - (maxRecords + 1)}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${index-1 != 0 &&  totalValue != totalRecords}">
              		<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="LiabilitiesSubLedger('view','','','','${index - (maxRecords + 1)}');"> ${index} - ${totalValue} of ${totalRecords} .
              		<input type="button" class='paginationButton' value="&#62;" onclick="LiabilitiesSubLedger('view','','','','${totalValue}')">
              	</div> 
              	</c:if>
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="LiabilitiesSubLedger('view','','','',document.getElementById('pagination').value);" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
