...
$(document).ready(function(){
	...
	$('#creditNoteSearch').click(function(){
        ...
        return viewInputGst('ItemTaxGSTReport','0','false');
    })
  ...
  <div class="col-lg-12">
   ...
   <div class="col-lg-12" style=" background: #f4f4f4;    ">
              ...
              <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
	               ...
	               <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                  <a onclick="viewInputGst('ItemTaxGSTReport','0','false')" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                ...
                <div class="col-lg-12"><br></div>
				                    ...
				                    <div class="row">
				                       <div class="col-lg-1 col-xs-2">
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewInputGst('ItemTaxGSTReport','0','false');">
                     ...
                     <input type="button" class="btn bg-olive btn-inline  addBtn" onclick="viewInputGst('save','0');" value="SAVE"/>
		   ...
		   <input type="hidden" id="stockdownloadurl" value="${downloadurl}">
                                        ...
                                        <tbody style="text-align: center;">
                                           <c:forEach var="warehouseReport" items="${WarehouseReportObj.reportsList}" varStatus="theCount">
                                        	 <tr>
                                        	 	...
                                        	 	<td>${warehouseReport.supplyQuantity}</td>
             ...
             <div class="row">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewInputGst('ItemTaxGSTReport','${totalValue}','false')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewInputGst('ItemTaxGSTReport','${index - (maxRecords + 1)}','false');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewInputGst('ItemTaxGSTReport',document.getElementById('pagination').value,'false')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
...
<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px;">
 <input type="button" class="iosclosebutton1" onclick="viewInputGst('ItemTaxGSTReport','0','true')"  value="Ok">
</div>
<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px;">
