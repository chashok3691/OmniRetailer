  ...
  <div class="box box-primary">
       <div class="box-header" style="text-align: center;padding-bottom: 0px;">				
		<h3 class="box-title" style="border: 1px solid gray;padding: 5px;padding-left: 40px;padding-right: 40px;">
				<spring:message code="Accounting.expenses.subtransaction"/>
			</h3>
	</div><!-- /.box-header -->
	      ...
	      <div class="row" style="padding-left:15px;padding-right:15px;">
              ...
              <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
                  ...
                  <div class="row">
                   ...
                   <input type="button" style="margin-top:22px;width: 135%;" class="btn bg-olive btn-inline addBtn" onclick="searchSubTransactions('Expenses','0')" value="<spring:message code="search" />" />
                  </div>
                  <div class="row">
                  <a onclick="viewExpensesTransactions('view','${AccountId}','');" style="margin-top:31px;width: 135%;"  class="btn bg-olive btn-inline addBtn"><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div>
              ...
              <c:set var="totalCredit" value="${0}"/>
                 ...
                 <c:set var="totalCredit" value="${totalCredit + Assets.creditAmount}" />
                  ...
                  <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="editAccountTransaction('${Assets.accountId}','${Assets.accountName}','${Assets.locationId}','${Assets.remarks}','${Assets.transactionDateStr}','${Assets.creditAmount}','${Assets.debitAmount}','${Assets.sno}')">Edit</a>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="deleteAccountTransaction('${Assets.sno}','Expenses','${AccountId}')">Delete</a></td>
	      ...
	      <div style="margin-top: 10px;padding-left: 5px;padding-right: 10px;">
	                ...
	                <label><spring:message code="created.date.label" /></label>
 	                 ...
 	                 <input type="hidden" id="accountName" value="${AssetsList[0].accountName}" />	
						...
						<div class="row" style="text-align: center;margin-top: 30px;">
						 <input type="button" style="" id="sumbitBtn" class="btnCls" onclick="CreateExpensesSubTransactions();" value="<spring:message code="submit.label" />" />
						<input type="button" style="display: none" id="updateBtn" class="btnCls" onclick="updateAccountTransaction('Expenses');" value="<spring:message code="update.label" />" />
						
						<input type="button" class="btnCls buttonMargin"  onclick="accountingExpenses('','data','','');" value="<spring:message code="cancel.label" />" />
              ...
              <div class="row" style="/* display:none; */">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewExpensesTransactions('view','${AccountId}','${totalValue}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewExpensesTransactions('view','${AccountId}','${index - (maxRecords + 1)}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewExpensesTransactions('view','${AccountId}',document.getElementById('pagination').value);" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
