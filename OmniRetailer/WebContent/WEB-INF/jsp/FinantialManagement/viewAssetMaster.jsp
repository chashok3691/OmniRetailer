                                    	...
                                    	<div class="row">
                                    	  ...
                                    	  <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 80%;" value="${AssetsList[0].accountName}" disabled="disabled" id="AccountName" placeholder="<spring:message code="Accounting.Incorporation" />" />
                                    	 	</div>
                                    	 	</div>
                                    	  ...
                                    	  <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 80%;" value="${AssetsList[0].accountDescription}" disabled="disabled" id="DiscriptionId" placeholder="<spring:message code="Accounting.discription" />" />
                                    	 		</div>
                                    	 	</div>
...
<!-- 						                             <span id="error" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span> -->
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="display: none" class="btnCls" onclick="CreateAsset('Edit','0');" value="<spring:message code="submit.label" />" />
