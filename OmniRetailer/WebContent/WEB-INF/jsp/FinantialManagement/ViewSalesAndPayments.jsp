 ...
 * Written By		        : Surya.k
 * file name		        : FinancialManagement/ViewSalesAndPayments.jsp
 * file type		        : JSP
	    ...
	    <div class="box-body table-responsive" style="height:100%;" >
	      ...
	      <div class="row" style="padding-left:15px;padding-right:15px;">
                ...
                <label><spring:message code="customerId.label" /></label>
                 <input type="text" class="form-control" id="customerId"  name="supplier" value="${paymentsList[0].customerId}" disabled="disabled"/>   
	          ...
	          <div class="col-lg-2">
                   ...
                   <label>Bank Account</label>
					 <select class="form-control form-group" id="accountName" disabled="disabled">
         ...
         <table id="productstocks" class="table table-bordered table-striped" style="margin-top:0px;width:100%;height:300px;">
          ...
          <thead style="background-color: #3c8dbc; color: #ffffff;">
             ...
             <tbody style="text-align: center;white-space: nowrap;">
                 ...
                 <td>${childList.saleQuantity}</td> 
                 <td>${childList.salePrice}</td> 
