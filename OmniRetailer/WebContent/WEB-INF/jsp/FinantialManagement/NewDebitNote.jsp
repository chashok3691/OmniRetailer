  ...
  <div class="box box-primary">
       <div class="box-header" style="text-align: center;padding-bottom: 0px;">
            <h3 class="box-title" style="border: 1px solid gray;padding: 5px;padding-left: 10px;padding-right: 10px;">
				<label style="font-weight:bold;"><spring:message code="debite.note.label"/></label>
			</h3>
	  </div><!-- /.box-header -->
    ...
    <input class="form-control  calendar_icon" style="background-color: white;width: 50%" id="po_date"  autocomplete="off" size="20" type="text"  onfocus="callCalender('po_date')" onclick="callCalender('po_date')" placeholder="DD/MM/YYYY" />
	...
	<label style="margin-bottom:0px;width: 50%;"><spring:message code="debite.note.grn.invoice.label"/><span style="color:red; font-size:2">*</span></label>
   	<input class="form-control  calendar_icon" style="background-color: white;width: 50%" id="invoice_date"  autocomplete="off" size="20" type="text"  onfocus="callCalender('invoice_date')" onclick="callCalender('invoice_date')" placeholder="DD/MM/YYYY" />
    ...
    <input class="form-control  calendar_icon" style="background-color: white;width: 50%" id="return_date"  autocomplete="off" size="20" type="text"  onfocus="callCalender('return_date')" onclick="callCalender('return_date')" placeholder="DD/MM/YYYY" />
    ...
    <input type="text"   class="form-control" id="Tax_invoice_number"  style="display:inline-block;float:right;width:53%;" value=""><br>
    ...
    <input type="text"   class="form-control" id="debit_note_grn_number"  style="display:inline-block;float:right;width:53%;" value=""><br>
    ...
    <input type="text"   class="form-control" id="debit_note_po_no"  style="display:inline-block;float:right;width:53%;" value=""><br>
    ...
    <input type="text"   class="form-control" id="debit_note_gst_reg_no"  style="display:inline-block;float:right;width:53%;" value=""><br>  
    ...
    <input type="text"   class="form-control" id="comments"  style="display:inline-block;float:right;width:53%;height: 65px" value=""><br>  
	</div>
	</div>
	</div>
	</div>
...
<label style="font-weight:bold;width: 50%;font-size: 18px">Grand Total</label><label style="font-weight:bold;width: 50%;    text-align: center;" id="grandTotal"></label>
</div>
...
<div class="row" style="text-align: center; margin-bottom: 10px">
						 <input type="button" style="" class="btnCls" onclick="createDebitNote('new','');" value="<spring:message code="submit.label" />" />
