  ...
  <div class="box box-primary">
       <div class="box-header" style="text-align: center;padding-bottom: 0px;">
			...
			<h3 class="box-title" style="border: 1px solid gray;padding: 5px;padding-left: 40px;padding-right: 40px;">
				<spring:message code="Income.subLedger.label"/>
			</h3>
		<%-- </c:if>  --%>
	</div><!-- /.box-header -->
	      ...
	      <div class="row" style="padding-left:15px;padding-right:15px;">
              ...
              <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
                  ...
                  <div class="row">
                   ...
                   <input type="button" style="margin-top:22px;width: 135%;" class="btn bg-olive btn-inline addBtn" onclick="IncomeSubLedger('view','${Organization}','${accountId}','${accountname}','');" value="<spring:message code="search" />" />
                  </div>
                  <div class="row">
                  <a  type="button" style="margin-top:31px;width: 135%;"  class="btn bg-olive btn-inline addBtn" onclick="IncomeSubLedger('clear','${Organization}','${accountId}','${accountname}','');" ><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div>
...
<div id="Error" class="Error" style="margin-top:-40px;text-align:center;color:red;font-weight:bold;">${err}</div>
  <div id="Success" class="Error" style="margin-top:-40px;text-align:center;color:blue;font-weight:bold;">${success}</div>
	      ...
	      <div class="row">
           ...
           <div class="col-lg-8" style="margin-top: 10px; padding-left: 15px;width: 81%">
                     ...
                     <input type="text"  class="form-control"  value="${searchName}" id="searchAccount" placeholder="<spring:message code="search.account.label" />"/>
							<button id="mySearch" class="searchbutton" onclick="IncomeSubLedger('view','${Organization}','${accountId}','${accountname}','');"  ></button>
							<!-- <div class="services">
				    			<div class="items">
        ...
        <div class="modal fade" id="myModal" role="dialog">
          ...
          <h3 class="modal-title" style="text-align: center;">Income Sub Ledger</h3>
          </div>
        <div class="modal-body">
            ...
            <form id="newEmployee" method="post">
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="CreateSubIncome('New','0');" value="<spring:message code="submit.label" />" />
						  <c:if test="${sessionScope.role == 'super admin'}"> 
						  	<input type="button" class="btnCls buttonMargin"  onclick="IncomeSubLedger('view','${Organization}','${accountId}','${accountname}','');" value="<spring:message code="cancel.label" />" />
						  </c:if>
						 <c:forEach var="accessControl" items="${sessionScope.genericBusinessSettings}">
                             <c:if test="${accessControl.appDocument == 'ZoneMaster' && accessControl.write == true && accessControl.read == true}">
								<input type="button" class="btnCls buttonMargin" onclick="IncomeSubLedger('view','${Organization}','${accountId}','${accountname}','');" data-dismiss="modal" value="<spring:message code="cancel.label" />" />
							</c:if>
						</c:forEach>
						</div>
									<br/>
        ...
        <div class="modal-body">
            ...
            <form id="newEmployee" method="post">
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="CreateSubIncome('Edit','0');" value="<spring:message code="submit.label" />" />
						  <c:if test="${sessionScope.role == 'super admin'}"> 
						  	<input type="button" class="btnCls buttonMargin"  onclick="IncomeSubLedger('view','${Organization}','${accountId}','${accountname}','');"  value="<spring:message code="cancel.label" />" />
						  </c:if>
						 <c:forEach var="accessControl" items="${sessionScope.genericBusinessSettings}">
             ...
             <tbody style="text-align: center;white-space: nowrap;">
             	 ...
             	 <tr>
             	 	 ...
             	 	 <td>${subAssetsList.subAccountTypeId}</td>
             	 	  <td>${subAssetsList.accountName}</td>
             	 	    ...
             	 	    <td><a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="viewIncomeSubLedger('View','${subAssetsList.accountId}','${subAssetsList.subAccountTypeId}')">View</a>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="viewIncomeSubLedger('Edit','${subAssetsList.accountId}','${subAssetsList.subAccountTypeId}')">Edit</a>
                <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;"    onclick="viewIncomeSubTransactions('data','${subAssetsList.subAccountTypeId}','')">Data</a>
                 </td>
                 </tr>
                </c:forEach>
             </tbody>
              ...
              <div class="row" >
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="IncomeSubLedger('view','','','','${totalValue}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="IncomeSubLedger('view','','','','${index - (maxRecords + 1)}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="IncomeSubLedger('view','','','',document.getElementById('pagination').value);" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
