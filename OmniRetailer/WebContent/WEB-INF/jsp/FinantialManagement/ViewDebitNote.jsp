...
<script type="text/javascript">
 $(document).ready(function(){
	 callCalender('po_date');
	  ...
	  $("#debit_note_grn_number").keydown(function(){
		   $("#grn_numberError").html("");
		   $("#Error").html("");
	 });
  ...
  <div class="box box-primary">
       <div class="box-header" style="text-align: center;padding-bottom: 0px;">
            <h3 class="box-title" style="border: 1px solid gray;padding: 5px;padding-left: 10px;padding-right: 10px;">
				<label style="font-weight:bold;">View Debit Note</label>
			</h3>
	  </div><!-- /.box-header -->
	...
	<div class="col-lg-12" >
     ...
     <div style="padding-left:0px;padding-right: 0px;width: 50%;">
		             ...
		             <select class="form-control form-group" disabled="disabled" id="outletLocation" >
    ...
    <input class="form-control  calendar_icon" disabled="disabled" value="${debitNoteDeatils[0].purchaseOrderDateStr}" style="background-color: white;width: 50%" id="po_date"  autocomplete="off" size="20" type="text"  onfocus="callCalender('po_date')" onclick="callCalender('po_date')" placeholder="DD/MM/YYYY" />
	
	<label style="margin-bottom:0px;width: 50%;"><spring:message code="debite.note.grn.invoice.label"/><span style="color:red; font-size:2">*</span></label>
   	<input class="form-control  calendar_icon" disabled="disabled" value="${debitNoteDeatils[0].invoiceDateStr}" style="background-color: white;width: 50%" id="invoice_date"  autocomplete="off" size="20" type="text"  onfocus="callCalender('invoice_date')" onclick="callCalender('invoice_date')" placeholder="DD/MM/YYYY" />
    ...
    <input class="form-control  calendar_icon" disabled="disabled" value="${debitNoteDeatils[0].returnDateStr}" style="background-color: white;width: 50%" id="return_date"  autocomplete="off" size="20" type="text"  onfocus="callCalender('return_date')" onclick="callCalender('return_date')" placeholder="DD/MM/YYYY" />
    ...
    <input type="text"   class="form-control" disabled="disabled" value="${debitNoteDeatils[0].taxInvoiceNo}" id="Tax_invoice_number"  style="display:inline-block;float:right;width:53%;" value=""><br>
    <span id="Tax_invoice_numberError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>	 
    
	<label style="margin-bottom:15px;"><spring:message code="debite.note.grn.number.label"/><span style="color:red; font-size:2">*</span></label>
    <input type="text"   class="form-control" disabled="disabled" value="${debitNoteDeatils[0].grnNo}" id="debit_note_grn_number"  style="display:inline-block;float:right;width:53%;" value=""><br>
    <span id="grn_numberError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
   
    <label style="margin-bottom:15px;"><spring:message code="debite.note.PO.No.label"/><span style="color:red; font-size:2">*</span></label>
    <input type="text"   class="form-control" disabled="disabled" value="${debitNoteDeatils[0].purchaseOrderNo}" id="debit_note_po_no"  style="display:inline-block;float:right;width:53%;" value=""><br>
    ...
    <input type="text"   class="form-control" disabled="disabled" value="${debitNoteDeatils[0].gstRegistrationNo}" id="debit_note_gst_reg_no"  style="display:inline-block;float:right;width:53%;" value=""><br>  
    ...
    <input type="text"   class="form-control" id="comments" disabled="disabled" value="${debitNoteDeatils[0].transactionDescription}" style="display:inline-block;float:right;width:53%;height: 65px" value=""><br>  
	</div>
	</div>
	</div>
	</div>
         ...
         <table id="productsList" class="table table-bordered table-striped" style="margin-top:0%;">
          <thead style="background-color: #3c8dbc; color: #ffffff">
                 <tr>  
                     ...
                     <th class="col-lg-2"><spring:message code="debite.note.cost.price.label" /></th>
             ...
             <tbody style="text-align: center;white-space: nowrap;">
                <c:forEach var="debitNoteitems" items="${debitNoteDeatils[0].debitNoteItems}" varStatus="TheCount">
             	 <tr>
             		<td>${TheCount.count}</td>
             	 <td>${debitNoteitems.skuId}</td>	
             	 <td>${debitNoteitems.description}</td>	
             	 <td>${debitNoteitems.quantity}</td>	
             	 <td>${debitNoteitems.costPrice}</td>	
             	 <td>${debitNoteitems.taxRate}</td>	
             	 <td>${debitNoteitems.cost}</td>	
             	 <td>${debitNoteitems.reasonForReturn}</td>	
                 </tr>
                </c:forEach>
            </tbody>
         </table>
...
<label style="font-weight:bold;width: 50%;font-size: 18px">Grand Total</label><input style="font-weight:bold;width: 50%;    text-align: center;" disabled="disabled" value="${debitNoteDeatils[0].debitNoteValue}" id="grandTotal"/>
</div>
...
<div class="row" style="text-align: center; margin-bottom: 10px">
						  <c:if test="${sessionScope.role == 'super admin'}"> 
						  	<input type="button" class="btnCls buttonMargin"  onclick="accountingDebitNoteSummary('clear','debitNote','0');" value="<spring:message code="cancel.label" />" />
						  </c:if>
