	      ...
	      <div class="row" style="padding-left:15px;padding-right:15px;">
              ...
              <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
                  ...
                  <div class="col-lg-3">
	               <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
	                  <label><spring:message code="offer_end_date.label"/></label>
						      <input class="form-control  calendar_icon" style="background-color: white;" readOnly="readOnly" value="${endDate}" id="endDate" size="20" type="text" onfocus="callCalender('endDate')" autocomplete="off" onclick="callCalender('endDate')" placeholder="DD/MM/YYYY" />
		           </div>
		          </div>
                  ...
                  <div class="row">
                   ...
                   <input type="button" style="margin-top:22px;width: 135%;" class="btn bg-olive btn-inline addBtn" onclick="accountingIncome('','data','','');" value="<spring:message code="search" />" />
                  </div>
                  <div class="row">
                  <a type="button" style="margin-top:31px;width: 135%;"  class="btn bg-olive btn-inline addBtn" onclick="accountingIncome('','clear','','');"><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div>
  ...
  <div id="Success" class="Error" style="margin-top:-40px;text-align:center;color:blue;font-weight:bold;">${success}</div>
	     ...
	     <%--  <div class="col-lg-1 col-xs-2" style="margin-top: 10px;">
           ...
           <div class="col-lg-9" style="margin-top: 10px; padding-left: 15px;">
                      <div class="wrapper">	 
                     <input type="text"  class="form-control"  value="${searchName}" id="searchIncome" placeholder="<spring:message code="search.account.label" />"/>
							<button id="mySearch" class="searchbutton" onclick="accountingIncome('','data','','');"></button>
							<!-- <div class="services">
				    			<div class="items">
		...
		<div class="col-lg-2" style="margin-top: 10px;float: right;">
	        <input type="button" style="float: right;" class="btn bg-olive btn-inline addBtn" onclick="CreateIncomeAccount();" value="<spring:message code="Accounting.createnew" />" />
	     </div>
             ...
             <tbody style="text-align: center;white-space: nowrap;">
                <c:forEach var="AssetsList" items="${AssetsList}" varStatus="TheCount">
             	 <tr>
                    ...
                    <td><a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="IncomeSubLedger('view','${AssetsList.organizationId}','${AssetsList.accountId}','${AssetsList.accountName}','')">SubLedger</a>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="return accountingIncome('','view','${AssetsList.accountId}')">View</a>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="return accountingIncome('','edit','${AssetsList.accountId}')">Edit</a>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick=" viewIncomeTransactions('view','${AssetsList.accountId}','')">Data</a></td>
                 </tr>
                </c:forEach>
             </tbody>
         </table>
              ...
              <div class="row" >
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="accountingIncome('','data','','${totalValue}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return accountingIncome('','data','','${index - (maxRecords + 1)}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="accountingIncome('','data','',document.getElementById('pagination').value);" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
