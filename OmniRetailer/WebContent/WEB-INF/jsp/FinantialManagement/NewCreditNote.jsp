  ...
  <div class="box box-primary">
       <div class="box-header" style="text-align: center;padding-bottom: 0px;">
            <h3 class="box-title" style="border: 1px solid gray;padding: 5px;padding-left: 10px;padding-right: 10px;">
				<label style="font-weight:bold;"><spring:message code="credit.note.label"/></label>
			</h3>
	  </div><!-- /.box-header -->
    ...
    <input type="text"   class="form-control" id="debit_note_sales_number"  style="display:inline-block;float:right;width:53%;" value=""><br>
...
<div class="row" style="text-align: center; margin-bottom: 10px">
						 <input type="button" style="" class="btnCls" onclick="createCreditNote('new','');" value="<spring:message code="submit.label" />" />
