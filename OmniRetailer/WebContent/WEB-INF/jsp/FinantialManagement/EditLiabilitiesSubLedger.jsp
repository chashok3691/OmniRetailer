                                    	...
                                    	<div class="row" style="margin-left:20%;">
                                    	  ...
                                    	  <div class="row" style="margin-left:20%;">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 60%;" value="${subAssetsList[0].accountName}"  id="Sub_AccountName" placeholder="<spring:message code="Accounting.Account.name" />" />
                                    	 	</div>
                                    	 	</div>
                                    	  ...
                                    	  <div class="row" style="margin-left:20%;">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 60%;" value="${subAssetsList[0].accountDescription}"  id="Sub_DiscriptionId" placeholder="<spring:message code="Accounting.discription" />" />
                                    	 		</div>
                                    	 	</div>
