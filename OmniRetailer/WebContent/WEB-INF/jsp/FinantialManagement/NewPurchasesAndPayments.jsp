	      ...
	      <div class="col-lg-12" style="background: #eee; padding-top: 14px; padding-bottom: 0px;">
             ...
             <div class="row">
                 ...
                 <%--  <div class="row">
                  ...
                  <label style="margin-left: -153%; padding-top: 10px;"><spring:message code="paymentcomments.label"/></label>
                  <textarea class="form-control form-group" id="paymentcomments" cols="" style="width: 291px;height: 102px;margin-left: -153%;"></textarea>
                  </div>
                   
                    <div class="col-lg-2" style="padding-right:15px;margin-left: -9%;border-right: 1px solid #ccc;padding-left:5px;padding-bottom: 22px;padding-top:0px;background: #ccc;height: 145px;;">
                  <div style="">
		        ...
		        <div class="form-group col-lg-12" style="text-align:center;margin-bottom: 0.5%;width: 100%; margin-top: 1.5%;padding: 0px">
                                         ...
                                         <%-- 	<label><spring:message code="search.items.here.label" /></label> --%>
											...
											<div class="services">
								    			<div class="items">
								     				<ul class="matchedStringUl payments" style=""></ul>
								   				</div>
											</div>
        ...
        <input type="hidden" id="outletLocation" value="Retail Outlet">
         ...
         <div class="col-sm-12 col-lg-12 col-xs-12" style="margin-top: 30px">
           ...
           <div class="col-sm-12 col-lg-12 col-xs-12">
            ...
            <input type="button" class="btn bg-olive btn-inline  addBtn" onclick="createPurchasesAndPayments('new','${status}')" value="Submit" >
            </div>
