                                    	...
                                    	<div class="row">
                                    	  ...
                                    	  <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 80%;" onchange="RemoveAccountErr();" value="${AssetsList[0].accountName}" id="AccountName" placeholder="<spring:message code="Accounting.Incorporation" />" />
...
<!-- 						                             <span id="error" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span> -->
								...
								<div class="row">
                                           ...
                                           <label><spring:message code="Accounting.Account.Type" /><!-- <span style="color:red; font-size:2">*</span> --></label>
                                              <select class="form-control" name="zoneID" id="AccountType" style="width: 60% !important;">
                                                   ...
                                                   <option value="Assets" id="Assets" ${AssetsList[0].accountType== "Assets" ? 'selected' : ''}>Assets</option>
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="CreateAsset('Edit','0');" value="<spring:message code="submit.label" />" />
