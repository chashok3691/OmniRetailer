            ...
            <form id="newEmployee" method="post">
                                   	...
                                   	<div class="row">
                                    	...
                                    	<div class="row" style="margin-left:20%;">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 60%;" value="${subAssetsList[0].subAccountTypeId}" disabled="disabled" id="Sub_AccountId" placeholder="<spring:message code="Accounting.SubAccount.Id" />" />
                                    	  ...
                                    	  <div class="row" style="margin-left:20%;">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 60%;" value="${subAssetsList[0].accountName}" disabled="disabled" id="Sub_AccountName" placeholder="<spring:message code="Accounting.Account.name" />" />
                                    	 	</div>
                                    	 	</div>
                                    	  ...
                                    	  <div class="row" style="margin-left:20%;">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 60%;" value="${subAssetsList[0].accountDescription}" disabled="disabled" id="Sub_DiscriptionId" placeholder="<spring:message code="Accounting.discription" />" />
                                    	 		</div>
                                    	 	</div>
							...
							<div class="row" style="margin-left:20%;">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 60%;" value="${subAssetsList[0].accountId}" disabled="disabled" id="AccountId" placeholder="<spring:message code="Accounting.Account.Id" />" />
								...
								<div class="row" style="margin-left:20%;">
                                           ...
                                           <label><spring:message code="Accounting.Account.Type" /><!-- <span style="color:red; font-size:2">*</span> --></label>
                                              <select class="form-control" name="zoneID" disabled="disabled" id="Sub_AccountType" style="width: 60% !important;">
                                 ...
                                 <div class="row" style="margin-left:20%;">
                                           ...
                                           <label><spring:message code="Accounting.Status" /></label>
				                              <select  class="form-control" name="Status" disabled="disabled" id="StatusId" style="width: 60% !important;">
