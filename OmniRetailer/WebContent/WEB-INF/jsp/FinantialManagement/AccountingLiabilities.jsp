  ...
  <div class="box box-primary">
       <div class="box-header" style="text-align: center;padding-bottom: 0px;">
			...
			<h3 class="box-title" style="border: 1px solid gray;padding: 5px;padding-left: 40px;padding-right: 40px;">
				<spring:message code="Accounting.liabilities.head"/>
			</h3>
		<%-- </c:if>  --%>
	</div><!-- /.box-header -->
	      ...
	      <div class="row" style="padding-left:15px;padding-right:15px;">
              ...
              <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
                  ...
                  <div class="row">
                   ...
                   <input type="button" style="margin-top:22px;width: 135%;" class="btn bg-olive btn-inline addBtn" onclick="accountingLiabilities('','data','','');" value="<spring:message code="search" />" />
                  </div>
                  <div class="row">
                  <a type="button" style="margin-top:31px;width: 135%;"  class="btn bg-olive btn-inline addBtn" onclick="accountingLiabilities('','clear','','');" ><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div>
  ...
  <div id="Success" class="Error" style="margin-top:-40px;text-align:center;color:blue;font-weight:bold;">${success}</div>
	     ...
	     <%--  <div class="col-lg-1 col-xs-2" style="margin-top: 10px;">
           ...
           <div class="col-lg-9" style="margin-top: 10px; padding-left: 15px; ">
                      <div class="wrapper">	 
                     <input type="text"  class="form-control"  value="${searchName}" id="searchLiabilities" placeholder="<spring:message code="search.account.label" />"/>
							<button id="mySearch" class="searchbutton" onclick="accountingLiabilities('','data','','');"></button>
							<!-- <div class="services">
				    			<div class="items">
		...
		<div class="col-lg-2" style="margin-top: 10px;float: right;">
	        <input type="button" style="float: right;" class="btn bg-olive btn-inline addBtn" onclick="CreateLiabilityAccount();" value="<spring:message code="Accounting.createnew" />" />
	     </div>
             ...
             <tbody style="text-align: center;white-space: nowrap;">
                <c:forEach var="AssetsList" items="${AssetsList}" varStatus="TheCount">
             	 <tr>
                    ...
                    <td><a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="LiabilitiesSubLedger('view','${AssetsList.organizationId}','${AssetsList.accountId}','${AssetsList.accountName}','')">SubLedger</a>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="return accountingLiabilities('','view','${AssetsList.accountId}')">View</a>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="return accountingLiabilities('','edit','${AssetsList.accountId}')">Edit</a>
                    <a style="color:#2e7ea7 !important;cursor: pointer;margin-right:6px;" onclick="viewLiabilitesTransactions('view','${AssetsList.accountId}',document.getElementById('pagination').value)">Data</a></td>
                 </tr>
                </c:forEach>
             </tbody>
         </table>
              ...
              <div class="row" >
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="accountingLiabilities('','data','','${totalValue}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return accountingLiabilities('','data','','${index - (maxRecords + 1)}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="accountingLiabilities('','data','',document.getElementById('pagination').value);" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
