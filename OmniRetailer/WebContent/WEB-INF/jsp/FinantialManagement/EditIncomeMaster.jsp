                                    	...
                                    	<div class="row">
                                    	  ...
                                    	  <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 80%;" value="${AssetsList[0].accountName}" id="AccountName"  placeholder="<spring:message code="Accounting.Incorporation" />" />
...
<!-- 						                             <span id="error" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span> -->
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="CreateIncome('Edit','0');" value="<spring:message code="submit.label" />" />
