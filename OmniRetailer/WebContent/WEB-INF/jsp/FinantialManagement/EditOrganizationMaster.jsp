                                   	...
                                   	<div class="row">
                                    	...
                                    	<div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 60%;"  id="OrganizationId" disabled="disabled" value="${OrganizationList[0].organizationId}" placeholder="<spring:message code="Accounting.Organisation.Id" />" />
                                    	 		</div>
                                    	</div>
                                    	  ...
                                    	  <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            <label><spring:message code="Accounting.Incorporation"  /><span
												style="color: red; font-size: 2">*</span></label>
		                                            <input type="text" class="form-control" style="width: 80%;" id="IncorporationName" value="${OrganizationList[0].incorporationName}" placeholder="<spring:message code="Accounting.Incorporation" />" />
                                    	  ...
                                    	  <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 80%;" id="DiscriptionId" value="${OrganizationList[0].description}"  placeholder="<spring:message code="Accounting.discription" />" />
                                    	 		</div>
                                    	 	</div>
                                    	 ...
                                    	 <div class="row" style="margin-bottom: 10px;">
                                            ...
                                            <label><spring:message code="Accounting.gstin" /> <span
												style="color: red; font-size: 2">*</span></label>
                                            <input type="text" class="form-control"  id="GstinId"  value="${OrganizationList[0].gstn}"  placeholder="<spring:message code="Accounting.gstin" />" />
                                        ...
                                        <div class=" col-lg-6">
                                    	 ...
                                    	 <div class="row" style="margin-bottom: 10px;">
                                            ...
                                            <label>PAN No<span
												style="color: red; font-size: 2">*</span></label>
                                            <input type="text" class="form-control"  id="panNo"  value="${OrganizationList[0].panNo}"  placeholder="Pan No" />
                                           <span id="errorPANno"
												style="text-align: left; color: red; font-size: 2; font-weight: bold; display: none;">Please
												Enter PAN no</span>
                                        </div>
                                         <div class=" col-lg-6 ">
                                            <label>Bank Account No<span
												style="color: red; font-size: 2">*</span></label>
                                            <input type="text" class="form-control" value="${OrganizationList[0].defaultBankAccount}"  id="bankAccNo"  placeholder="Bank Account No" />
                                           <span id="errorbank"
												style="text-align: left; color: red; font-size: 2; font-weight: bold; display: none;">Please
                                    	 ...
                                    	 <div class="row">
												...
												style="color: red; font-size: 2">*</span></label>
		                                            <input type="text" class="form-control" style="width: 80%;" value="${OrganizationList[0].website}" id="WebSiteId" placeholder="<spring:message code="Accounting.website" />" />
...
<!-- 						                             <span id="error" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span> -->
                                    	 	 ...
                                    	 	 <div class="row">
                                    	 		<div class="form-group col-lg-12">
		                                            ...
		                                            <input type="text" class="form-control" style="width: 80%;" id="EmailId" value="${OrganizationList[0].emailId}" placeholder="<spring:message code="Accounting.email.id" />" />
                                    	 		</div>
                                    	 	</div>
							...
							<div class="form-group col-lg-6">
									...
									<div class="row">
                                           ...
                                           <label><spring:message code="Accounting.Incorporation.type" /><!-- <span style="color:red; font-size:2">*</span> --></label>
                                              <select class="form-control" name="zoneID" id="IncorporationType" style="width: 60% !important;">
										...
										<div class="form-group col-lg-12">
											<label><spring:message
													code="Accounting.Franchise.type" /> <!-- <span style="color:red; font-size:2">*</span> --></label>
											<select class="form-control"  name="businessType"
												id="businessType" 
												id="IncorporationType" style="width: 40% !important;" onchange="getLocations()">
												 <option value="Franchise" id="FYes" ${OrganizationList[0].businessType== "Franchise" ? 'selected' : ''} >Yes</option>
                                                   <option value="Main" id="FNo" ${OrganizationList[0].businessType== "Main" ? 'selected' : ''}>No</option>
											</select> 
										</div>
									</div>
                                     ...
                                     <div class="row">
                                  	 	<div class="form-group col-lg-12">
                                            <label><spring:message code="Accounting.addresss" /><span
												style="color: red; font-size: 2">*</span></label>
                                            <input type="text" class="form-control"  id="AddressId1" value="${OrganizationList[0].buildingNo}" placeholder="" style="margin-bottom: 10px; width: 40%;"/>
											...
											<div class="row">	
												...
												placeholder="City" style="width: 100%;margin-top:-21px" value="${OrganizationList[0].city}"/>
												</div>
												<div class="form-group col-lg-1"></div>
												<div class="form-group col-lg-5">
												...
												placeholder="PIN Code" value="${OrganizationList[0].pincode}" style=" width:100%;margin-left:-64px;margin-top:-21px" />
												</div>
												</div>
											
                                  	 	    <span id="errorAddressId" style="text-align:left;color: red;font-size: 2;font-weight: bold; display:none;">Please enter total address</span>
						...
						<div class="row" style="text-align: center;">
						 <input type="button" style="" class="btnCls" onclick="CreateOrginization('Edit','0');" value="<spring:message code="submit.label" />" />
