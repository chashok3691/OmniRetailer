	    ...
	    <div class="box-body table-responsive" style="padding-bottom: 50px" >
	      ...
	      <div class="row" style="padding-left:15px;padding-right:15px;margin-bottom: 52px;">
              ...
              <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
				  ...
				  <input class="form-control  calendar_icon" style="background-color: white;" id="start_date" size="20" type="text"  onfocus="callCalender('start_date')" onclick="callCalender('start_date')" placeholder="DD/MM/YYYY" />
	          </div>
	          </div>	   
	         ...
	         <div class="col-lg-6">
              <div class="col-lg-3" style="margin-top: 14px;width: 63%;padding-left: 0px;">
						...
						<div class="col-lg-3" >
    					<input type="button" style="margin-top:15px" class="btn bg-olive btn-inline" value="Upload" id="btnUpload"  onclick="uploadBankStatement(this)" />
             ...
             <div class="row">
		             ...
		             <select class="form-control form-group" id="Account_Name" onchange="accountNameChange(this.options[this.selectedIndex].index,'Account_Id')" >
                ...
                <div class="col-lg-3">
	               <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
	                  <label><spring:message code="offer_end_date.label"/></label>
						      <input class="form-control  calendar_icon" style="background-color: white;" id="end_date" size="20" type="text" onfocus="callCalender('end_date')" onclick="callCalender('end_date')" placeholder="DD/MM/YYYY" />
		           </div>
		          </div>   
		       <div class="col-lg-6">
	               <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;width:83%;">
	                  <label><spring:message code="comments.label"/></label>
						      <input type="text" id="comments" class="form-control" style=""/>
		           </div>
		          </div>                      
               </div>
                  </div>
                  ...
                  <div class="row">
                   ...
                   <input type="button" style="margin-top:18px;width: 135%;" class="btn bg-olive btn-inline addBtn" onclick="startReconciliation()" value="<spring:message code="start.label" />" />
                  </div>
                  <div class="row">
                  <a onclick="accountingReconciliation('','');" style="margin-top:31px;width: 135%;"  class="btn bg-olive btn-inline addBtn"><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div>
   ...
   <table id="asstesList" class="table table-bordered table-striped" style="margin-top:4px;width:100%;">
          ...
          <thead style="background-color: #3c8dbc; color: #ffffff">
             ...
             <tbody style="text-align: center;white-space: nowrap;">
              <c:forEach var="asstestransaction" items="${reconciliationObj.transactionReconciliation}" varStatus="TheCount">
	             	<tr>
	                 <td>${TheCount.count}</td>
             	 	 <td id="assetDate${TheCount.count}">${asstestransaction.assetTransactionDateStr}</td>
			          <td id="assetDes${TheCount.count}">${asstestransaction.assetTransactionDescription}</td>
			          
			          <td id="assetDebitAmt${TheCount.count}">${asstestransaction.transactionDebitAmount}</td>
	                 <td id="assetCreditAmt${TheCount.count}">${asstestransaction.transactionCreditAmount}</td> 
    ...
    <table id="bankListIds" class="table table-bordered table-striped" style="margin-top:4px;width:100%;">
          ...
          <thead style="background-color: #3c8dbc; color: #ffffff">
             ...
             <tbody style="text-align: center;white-space: nowrap;">
	                 ...
	                 <c:forEach var="banktransaction" items="${reconciliationObj.bankBookReconciliation}" varStatus="TheCount">
	             	<tr>
	                  <td>${TheCount.count}</td>
	                 <td id="bankDate${TheCount.count}">${banktransaction.bankTransactionDateStr}</td> 
	                 <td id="bankDes${TheCount.count}">${banktransaction.bankTransactionDescription}</td> 
	                 
	             	 <td id="bankDebit${TheCount.count}">${banktransaction.bankStatementDebitAmount}</td>
	                 <td id="bankCredit${TheCount.count}">${banktransaction.bankStatementCreditAmount}</td> 
	                 
	                  <input type='hidden' id="bankflag${TheCount.count}" value="1"/>
	                  <input type='hidden' id="bankId" value="${banktransaction.accountId}"/>
         	  ...
         	  <div class="col-lg-3" style="padding-left: 0px">
         	   ...
         	   <div class="col-lg-3" style="padding-left: 0px">
         	   <input type="text" disabled="disabled" value="${reconciliationObj.totalAssetDebitAmount}" id="comments" class="form-control" style=""/>
         	  </div>
         	   <div class="col-lg-3" style="padding-left: 0px">
         	   <input type="text" disabled="disabled" value="${reconciliationObj.totalAssetCreditAmount}" id="comments" class="form-control" style=""/>
         	  </div>
         	  </div>
         	   <div class="col-lg-6" style="padding-left: 0px">
         	   <div class="col-lg-3" style="padding-left: 0px">
         	   ...
         	   <div class="col-lg-3" style="padding-left: 0px">
         	   <input type="text" disabled="disabled" value="${reconciliationObj.totalBankDebitAmount}" id="comments" class="form-control" style=""/>
         	  </div>
         	   <div class="col-lg-3" style="padding-left: 0px">
         	   <input type="text" disabled="disabled" value="${reconciliationObj.totalBankCreditAmount}" id="comments" class="form-control" style=""/>
         	  </div>
         	  </div>
         	  </div>
      
   				<input type="hidden" id="assetdiff" value="${reconciliationObj.totalAssetDifference}" id="comments" class="form-control" style=""/>
   				<input type="hidden" id="bankdiff" value="${reconciliationObj.totalBankDifference}" id="comments" class="form-control" style=""/>
            ...
            <input type="button" class="btn bg-olive btn-inline  addBtn" onclick="saveReconciliation()" value="Save" >
