  ...
  <div class="box box-primary">
       <div class="box-header" style="text-align: center;padding-bottom: 0px;">
			...
			<h3 class="box-title" style="border: 1px solid gray;padding: 5px;padding-left: 40px;padding-right: 40px;">
				<spring:message code="Accounting.Profit.And.loss.head"/>
			</h3>
		<%-- </c:if>  --%>
	</div><!-- /.box-header -->
	    <div class="box-body table-responsive" style="    height: -webkit-fill-available;">
	      
	      <div class="row" style="padding-left:15px;padding-right:15px;">
                              <div class="col-lg-11" style="background: #eee; width: 88%; padding-top: 10.5px; padding-bottom: 0px;">
                  ...
                  <input type="hidden" id="orderworkflow" value="${status}"/>
                       ...
                       <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
						...
						bussinessCycle	<option value="${organization.organizationId}" ${organization.organizationId == selectedLocation ? 'selected' : ''} id="${organization.organizationId}" >${organization.organizationId}</option>
						</c:forEach>
	                        </select>
                         </div>
                      </div>
              ...
              <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
                 			 <input type="hidden" id="type" value="${type}">
						            ...
						            <label><spring:message code="offer_start_date.label"/></label>
						                    <input class="form-control  calendar_icon" style="background-color: white;" id="startDate" size="20" type="text" readOnly="readOnly" onfocus="callCalender('startDate')" onclick="callCalender('startDate')" placeholder="DD/MM/YYYY" />
	              </div>
	            </div>
                     ...
                     <div class="row">
                       <div class="col-lg-3">
                       <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
                       <label><spring:message code="Strategy.label"/></label>
                       
	            <select class="form-control form-group" id="strategy">
             	        <option value="monthly"id="" >Monthly</option>               					
						<option value="quarterly" id="" >Quarterly</option>
						<option value="halfyearly"id="" >Half Yearly</option>
						<option value="yearly" id="" >Yearly</option>					
	            </select> 
                  ...
                  <div class="col-lg-3">
	               <div class="col-lg-9" style="padding-left:0px;padding-right: 0px;">
	                  <label><spring:message code="offer_end_date.label"/></label>
						      <input class="form-control  calendar_icon" style="background-color: white;" id="endDate" size="20" type="text" onfocus="callCalender('endDate')" onclick="callCalender('endDate')" placeholder="DD/MM/YYYY" />
		           </div>
		          </div>
                  ...
                  <div class="col-lg-1" style="padding-right:15px;border-right: 1px solid #ccc;padding-top: 7px;padding-bottom: 22px;width: 12%;padding: 10px 15px;background: #ccc;height: 137px;">
                  <div class="col-lg-9" style="">
                  <div class="row">
                  
                   <input type="hidden" id="type" value="${type}">    
                   <input type="button" style="margin-top:29px;width: 135%;" class="btn bg-olive btn-inline addBtn" onclick="viewProfitAndLoss();" value="<spring:message code="search" />" />
                  </div>
                  <div class="row">
                  <a  type="button" style="margin-top:31px;width: 135%;"  class="btn bg-olive btn-inline addBtn" onclick="viewProfitAndLoss();"><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div>
...
<div id="Error" class="Error" style="margin-top:-40px;text-align:center;color:red;font-weight:bold;">${err}</div>
  <div id="Success" class="Error" style="margin-top:-40px;text-align:center;color:blue;font-weight:bold;">${success}</div>
	      ...
	      <div class="row" style="">
           ...
           <div class="col-lg-10" style="margin-top: 10px; padding-left: 15px;width: 81%;display:none;">
                      <div class="wrapper">	 
                     <input type="text"  class="form-control"  value="${searchName}" id="searchAccount" placeholder="<spring:message code="search.account.label" />"/>
							<button id="mySearch" class="searchbutton" onclick="" ></button>
         ...
         <div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px; border-bottom: 1px solid;">
   <div class="col-lg-3 col-sm-3 col-xs-3" style=" padding: 0px;">
   <label class="labelHeader"><spring:message code="Details.expenses.label" /></label>
   ...
   <label class="labelHeader">INR</label>
    ...
    <div class="col-lg-3 col-sm-3 col-xs-3" style=" padding: 0px;">
   <label class="labelHeader"><spring:message code="Details.revenue.label" /></label>
  ...
  <div class="col-lg-12 col-sm-12 col-xs-12" style="margin-top: 0px; padding: 0px;">
  		 ...
  		 <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 0px; padding: 0px;text-align: left;">
                ...
                <c:forEach var="expenses" items="${profitAndLossList.expensesList}" varStatus="TheCount">
             	 
             	 	 <label style="width:100%;margin-top: 10px; padding-left: 15px;">${expenses.accountName}</label>
       ...
       <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 0px; padding: 0px;text-align: center;">
                <c:forEach var="expenses" items= "${profitAndLossList.expensesList}" varStatus="TheCount">
                 	 ...
                 	 <label style="width:100%;margin-top: 10px;">${expenses.totalExpensesAmount}</label>
                 
                </c:forEach>   
  		 </div>
  		   <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 0px; padding: 0px;text-align: left;">
                <c:forEach var="income" items="${profitAndLossList.incomeList}" varStatus="TheCount">
             	 
             	 	 <label style="width:100%;margin-top: 10px; padding-left: 15px;">${income.accountName}</label>
              ...
              <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 0px; padding: 0px;text-align: center;">
                <c:forEach var="income" items="${profitAndLossList.incomeList}" varStatus="TheCount">
                 	 ...
                 	 <label style="width:100%;margin-top: 10px;">${income.totalIncomeAmount}</label>
    		 		  ...
    		 		  <div class="col-lg-12 col-sm-12 col-xs-12" style="margin-top: 20px; padding: 0px;border-top: 1px solid;">
   <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 20px; padding: 0px;text-align: left; ">
   <label class="" style="padding-left: 15px;">Start Day Stock Value</label>
  
   </div>
    <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 20px; padding: 0px;text-align: center;">
   <label class="">${profitAndLossList.dayStartValue}</label>
   </div>
    <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 20px; padding: 0px;text-align: left;">
   <label class="" style="padding-left: 15px;">End Day Stock Value</label>
  
   </div>
    <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 20px; padding: 0px;text-align: center;">
   <label class="">${profitAndLossList.dayEndValue}</label>
   </div>
   ...
   <div class="col-lg-12 col-sm-12 col-xs-12" style="margin-top: 20px; padding: 0px;border-top: 1px solid;">
   <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 20px; padding: 0px;text-align: left; ">
   <label class="" style="padding-left: 15px;">Total Expenses Amount</label>
  
   </div>
    <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 20px; padding: 0px;text-align: center;">
   <label class="">${profitAndLossList.totalExpensesAmount+profitAndLossList.dayStartValue}</label>
   </div>
    <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 20px; padding: 0px;text-align: left;">
   <label class="" style="padding-left: 15px;">Total Income Amount</label>
  
   </div>
    <div class="col-lg-3 col-sm-3 col-xs-3" style="margin-top: 20px; padding: 0px;text-align: center;">
   <label class="">${profitAndLossList.totalIncomeAmount+profitAndLossList.dayEndValue}</label>
   </div>
