...
<body>
                   ...
                   <div class="row">
                   	<div class="col-lg-2" style="text-align: right;">
                   		<div style="text-align: center;width: 140px;height: 130px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="showSaleQuotation('saleQuotation','0','clear')" title="<spring:message code="sale.quotation.label" />">
                   			<img src="${pageContext.request.contextPath}/images/NewUser.png" style="margin-top: 10px;"><br><br>
                   			<spring:message code="sale.quotation.label" />
                   		</div>
                   	</div>
                   	<div class="col-lg-2">
                   		<div style="text-align: center;width: 140px;height: 130px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="" title="<spring:message code="sale.po.label" />">
                   			<img src="${pageContext.request.contextPath}/images/EditUser.png" style="margin-top: 10px;"><br><br>
                   			<spring:message code="sale.po.label" />
                   		</div>
                   	</div>
                   	<%-- <div class="col-lg-2">
