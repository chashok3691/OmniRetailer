               	 ...
               	 <div class="row">
                       ...
                       <div class="form-group col-lg-3">
                          ...
                          <!--  <div class="input-group">
                               <div class="input-group-addon">
                                ...
                                <input class="form-control calendar_icon" readonly="readonly" value="${role.validDate}" style="background-color: white;" name="validDate" id="validDate" size="20" type="text" onfocus="callCalender('validDate')" onclick="callCalender('validDate')" placeholder="DD/MM/YYYY"/>
                       ...
                       <div class="row">
                        <div class="form-group col-lg-12">
                           ...
                           <textarea rows="1" cols="" class="form-control" style="resize:none" name="roleDescription" id="roleDescription" required placeholder="<spring:message code="enter.roleDescription.label" />" >${role.roleDescription}</textarea>
...
<%-- 		                            	<img style="float: right;height: 20px;cursor: pointer;" id="GenericBusinessSettingsImg" onclick="activateSubFlow('GenericBusinessSettings');" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
			                    ...
			                    <br>
		                         ...
		                         <div class="row divsubbg" style="border: none">
                                  ...
                                  <span id="OrgDepartmentsCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" value="OrgDepartment Master" name="GenericBusinessSettingsRead" id="OrgDepartmentsRead"/>Read
                                  </span>
                                  
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" name="GenericBusinessSettingsWrite"  id="OrgDepartmentsWrite"/>Write
                                  </span>
                                  
                                     <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" name="GenericBusinessSettingsCCTo"  id="OrgDepartmentsCCTo"/>CC To
                                  </span>
                               </div> 
			                    <br>	                               
			                                <div class="row divsubbg" style="border: none">  
		                               ...
		                               <br>
		                                ...
		                                <div class="row divsubbg" style="border: none">
		                   		  		  <span class="col-lg-6" style="cursor: pointer;padding-left: 60px;" >
		                                  	<spring:message code="route.master.label" />
		                                  </span>
		                                  <span id="RouteMasterCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="GenericBusinessSettingsRead" style="vertical-align: -2px" id="RouteMasterRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="GenericBusinessSettingsWrite" style="vertical-align: -2px" id="RouteMasterWrite"/>Write
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="GenericBusinessSettingsCCTo" style="vertical-align: -2px" id="RouteMasterCCTo"/>CC To
		                                  </span>
		                               </div>
		                                ...
		                                <br>
			                               ...
			                               <div class="row divsubbg" style="border: none">  
			                                  ...
			                                  <span id="TenderMasterCheck" class="col-lg-2" style="padding: 0px">
			                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" value="Zone Master" name="GenericBusinessSettingsRead" id="TenderMasterRead"/>Read
			                                  </span>
			                                  <span class="col-lg-2" style="padding: 0px">
			                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" name="GenericBusinessSettingsWrite"  id="TenderMasterWrite"/>Write
			                                  </span>
			                                  <span class="col-lg-2" style="padding: 0px">
			                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" name="GenericBusinessSettingsCCTo"  id="TenderMasterCCTo"/>CC To
			                                  </span>
			                               </div>
...
<%-- 		                            	<img style="float: right;height: 20px;cursor: pointer;" id="OutletMasterSettingsImg" onclick="activateSubFlow('OutletMasterSettings');" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
		                        ...
		                        <div style="margin-left: 0%">
			                        ...
			                        <br>
		                               ...
		                               <div class="row divsubbg" style="border: none; ">
		                                  ...
		                                  <span id="StorageMasterCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletMasterSettingsRead" style="vertical-align: -2px" id="StorageMasterRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletMasterSettingsWrite" style="vertical-align: -2px" id="StorageMasterWrite"/>Write
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletMasterSettingsCCTo" style="vertical-align: -2px" id="StorageMasterCCTo"/>CC To
		                                  </span>
                                ...
                                <div id="outletsPriceManagementId" class="row divsubbg" style="border: none;">
...
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('RestaurentManagement');" id="RestaurentManagementImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
	                            ...
	                            <div id="PriceManagementFlow" class="inactiveSubChildBlock" style="font-size: 12px;background-color: rgb(240,240,240)">
		                         ...
		                         <br>
		                                  ...
		                                  <span id="StockUpdateCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletMasterSettingsRead" style="vertical-align: -2px" id="StockUpdateRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletMasterSettingsWrite" style="vertical-align: -2px" id="StockUpdateWrite"/>Write
		                                  </span>
		                                    <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletMasterSettingsCCTo" style="vertical-align: -2px" id="StockUpdateCCTo"/>CC To
		                                  </span>
		                               </div>
                        		</div>
                        	</div>
                               ...
                               <br>
                                ...
                                <div id="RestaurentManagementId" class="row divsubbg" style="border: none;">
	                              ...
	                              <span id="RestaurentManagementCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="selectAll('RestaurentManagementRead');" name="OutletManagementRead" id="RestaurentManagementRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
			                             ...
			                             <br>
	                               		<div id="OutletStockRequestId" class="row divsubchildactivitiesbg" style="border: none">
		                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 80px;" onclick="activateSubChildActivities('OutletStockRequest');">
		                              		  	<spring:message code="outlet.stock.request.label" /> -In
		                              		  </span>
		                          ...
		                          <br>
		                           ...
		                           <br>
		                            <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="OutletKeyValueProductsCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="InventoryManagementRead" style="vertical-align: -2px" id="OutletKeyValueProductsRead"/>Read
		                                  </span>
		                                  
		                                  <span id="" class="col-lg-2" style="padding: 0px">
		                                  </span>
		                                   <span id="" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="InventoryManagementCCTo" style="vertical-align: -2px" id="OutletKeyValueProductsCCTo"/>CC To
		                                  </span>
		                           </div> 
...
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('RestaurentManagement');" id="RestaurentManagementImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
		                       ...
		                       <%--       <br>
		                               ...
		                               <div id="StoreStockVerification" class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="StoreStockVerificationCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="InventoryManagementRead" style="vertical-align: -2px" id="StoreStockVerificationRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="InventoryManagementWrite" style="vertical-align: -2px" id="StoreStockVerificationWrite"/>Write
		                                  </span>
		                               
		                                     
		                                   <span id="" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="InventoryManagementCCTo" style="vertical-align: -2px" id="StoreStockVerificationCCTo"/>CC To
		                                <img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildActivities('StoreStockVerification');" id="StoreStockVerificationImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
		                                  </span>
		                             </div>  
		                              <div style="margin-left: 0%">
...
<%--                               	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('WarehouseManagement');" id="WarehouseManagementImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                         ...
                         <div id="WarehouseManagementFlow" style="margin-left: 0%;color:#666;background-color: rgb(240,240,240);margin-left: 2px;margin-right: 2px;" class="inactiveBlock">
                               ...
                               <br>
                                  	...
                                  	<div id="WarehouseShiftManagementId" class="row divsubbg" style="border: none;">
	                              <span  class="col-lg-6"  onclick="activateSubFlow('WarehouseShiftManagement');" style="cursor: pointer;padding-left: 40px;">
	                              	<spring:message code="shift.management.label" />
	                              </span>
	                              <span id="WarehouseShiftManagementCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="selectAll('WarehouseShiftManagementRead');" value="Inventory Management" name="WarehouseManagementRead" id="WarehouseShiftManagementRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="WarehouseManagementWrite" style="vertical-align: -2px" onclick="selectAll('WarehouseShiftManagementWrite')" id="WarehouseShiftManagementWrite"/>Write
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('ShiftManagement');" id="ShiftManagementImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                                  </span>
                                      <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="WarehouseManagementCCTo" style="vertical-align: -2px" onclick="selectAll('WarehouseShiftManagementCCTo')" id="WarehouseShiftManagementCCTo"/>CC To
                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('WarehouseShiftManagement');" id="WarehouseShiftManagementImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
                                  </span>
                                  </div>
                                  <div style="margin-left: 0%;">
	                              <div id="WarehouseShiftManagementFlow" class="inactiveSubBlock" style="font-size: 12px">
	                                <br>
                               		<div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 60px;" >
	                              		  	<spring:message code="shift.master.label" />
	                              		  </span>
	                              		  <span id="WarehouseShiftMasterCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseShiftManagementRead" value="Stocks" style="vertical-align: -2px" id="WarehouseShiftMasterRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseShiftManagementWrite" style="vertical-align: -2px"  id="WarehouseShiftMasterWrite"/>Write
		                                  </span>
		                                   <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseShiftManagementCCTo" style="vertical-align: -2px"  id="WarehouseShiftMasterCCTo"/>CC To
		                                  </span>
		                           </div>
		                           <br>
                               		<div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="WarehouseShiftConfigurationCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseShiftManagementRead" value="Stocks" style="vertical-align: -2px" id="WarehouseShiftConfigurationRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseShiftManagementWrite" style="vertical-align: -2px"  id="WarehouseShiftConfigurationWrite"/>Write
		                                  </span>
		                                      <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseShiftManagementCCTo" style="vertical-align: -2px"  id="WarehouseShiftConfigurationCCTo"/>CC To
		                                  </span>
		                           </div>
                                </div>
	                          </div>
...
<%-- 		                                  		<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('WarehouseStocks');" id="WarehouseStocksImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
		                           ...
		                           <br>
		                            <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="WarehousePackagingCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseStockmanagementRead" style="vertical-align: -2px" id="WarehousePackagingRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseStockmanagementWrite" style="vertical-align: -2px" id="WarehousePackagingWrite"/>Write
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseStockmanagementCCTo" style="vertical-align: -2px" id="WarehousePackagingCCTo"/>CC To
		                                  </span>
		                             </div>
		                             <br>
	                            ...
	                            <div id="WarehouseStockVerificationsFlow" class="inactiveSubChildBlock" style="font-size: 10px;background-color: rgb(240,240,240)">
		                          <br>
	                                <div class="row divsubchildbg" style="border: none">
		                             ...
		                             <br>
	                                 <div id="WarehouseStockVerificationactivity" class="row divsubbg" style="border: none">
	                              		   <span class="col-lg-6" style="cursor: pointer;padding-left: 80px" >
	                              		  	<spring:message code="stock.verification.label" />
	                              		  </span>
	                              ...
	                              <div id="WarehouseGoodsTransferFlow" class="inactiveSubChildBlock" style="font-size: 12px;">
		                           ...
		                           <div id="WarehouseStockRequestId" class="row divsubchildactivitiesbg" style="border: none">
                              		   <span class="col-lg-6" style="cursor: pointer;padding-left: 80px;" onclick="activateSubChildActivities('WarehouseStockRequest');" >
                              		  	<spring:message code="warehouse.stockrequests.label" /> - In
                              		  </span>
...
<%-- 		                           	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildActivities('WarehouseStockReturn');" id="WarehouseStockReturnImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">  --%>
                           ...
                           <%--     <div id="WarehouseProcurementId"  class="row divsubbg" style="border: none">
                               ...
                               <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="WarehouseBillingAndPaymentsCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseManagementRead" style="vertical-align: -2px" id="WarehouseBillingAndPaymentsRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseManagementWrite" style="vertical-align: -2px" id="WarehouseBillingAndPaymentsWrite"/>Write
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="WarehouseManagementCCTo" style="vertical-align: -2px" id="WarehouseBillingAndPaymentsCCTo"/>CC To
		                                  </span>
		                             </div>
		                             <br>
...
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('PurchaseOrder');" id="PurchaseOrderImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                            ...
                            <!--Shipment Recept note role modification -->
                             <div id="ShipmentReceiptsId" class="row divsubbg" style="border: none">
                   		  		  <span class="col-lg-6" style="cursor: pointer;padding-left: 40px;" onclick="activateSubFlow('ShipmentReceipts');" >
                                  	<spring:message code="goods.receipts.label" />
                                  </span>
                                  <span id="ShipmentReceiptsCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="ProcurementRead" style="vertical-align: -2px" id="ShipmentReceiptsRead"/>Read
...
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('PurchaseOrder');" id="PurchaseOrderImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                                     ...
                                     <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="ProcurementCCTo" style="vertical-align: -2px" id="ShipmentReceiptsCCTo"/>CC To
                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('ShipmentReceipts');" id="ShipmentReceiptsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
                                  </span>
                            </div>
                            <div style="margin-left: 0%;">
	                            <div id="ShipmentReceiptsFlow" class="inactiveSubBlock" style="font-size: 12px;background-color: rgb(240,240,240)">
	                                 <br>
	                               		<div class="row divbg" style="border: none">
		                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 60px;" >
		                              		  	<spring:message code="activities.label" />
		                              		  ...
		                              		  <span id="" class="col-lg-6" style="padding: 0px">
		                              		  	<select class="form-control activities" name="ShipmentReceipts" multiple="multiple" id="ShipmentReceiptsActivities">
			                              		  	<c:forEach var="workflow" items="${workflowsList}" varStatus="theCount">
							                            <c:if test="${workflow.businessFlow == 'Outlet GRN'}">
							                            	<option value ="${workflow.statusName}">${workflow.statusName}</option>
							                            </c:if>
                            ...
                            <!--Shipment Recept note role modification end  -->
                             <br>
...
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('OrderManagementSalesOrder');" id="OrderManagementSalesOrderImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                             ...
                             <div style="margin-left: 0%;">
	                            <div id="OrderManagementSalesOrderFlow" class="inactiveSubBlock" style="font-size: 12px;background-color: rgb(240,240,240)">
	                                 <br>
	                               		<div class="row divsubbg" style="border: none">
		                              		  ...
		                              		  <span id="" class="col-lg-6" style="padding: 0px">
		                              		  	<select class="form-control activities" name="OrderManagementSalesOrder" multiple="multiple" id="OrderActivities">
			                              		  	<c:forEach var="workflow" items="${workflowsList}" varStatus="theCount">
							                            <c:if test="${workflow.businessFlow == 'Order'}">
							                            	<option value ="${workflow.statusName}">${workflow.statusName}</option>
							                            </c:if>
		                      ...
		                      <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="OrderManagementB2BCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OrderManagementRead" style="vertical-align: -2px" id="OrderManagementB2BRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OrderManagementWrite" style="vertical-align: -2px" id="OrderManagementB2BWrite"/>Write
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OrderManagementCCTo" style="vertical-align: -2px" id="OrderManagementB2BCCTo"/>CC To
		                                  </span>
		                             </div>
		                      <br>
...
<%--                               	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('DealsAndOffers');" id="DealsAndOffersImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                              ...
                              <div id="DealsAndOffersFlow" style="color:#666;background-color: rgb(240,240,240);margin-left: 2px;margin-right: 2px;" class="inactiveBlock">
	                   		  ...
	                   		  <br>
		                                <div id="campaignPromotionsId"  class="row divsubbg" style="border: none">
		                               	  <span class="col-lg-6"  onclick="activateSubFlow('CampaignPromotions');" style="cursor: pointer;padding-left: 40px;">
			                              		<spring:message code="promotions.label" />
			                              </span>
			                              <span id="CampaignPromotionsCheck" class="col-lg-2" style="padding: 0px">
		                                  		<input type="checkbox" name="DealsAndOffersRead" style="vertical-align: -2px" onclick="selectAll('CampaignPromotionsRead')" id="CampaignPromotionsRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" name="DealsAndOffersWrite" style="vertical-align: -2px" onclick="selectAll('CampaignPromotionsWrite')" id="CampaignPromotionsWrite"/>Write
<%-- 		                                  		<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('OutletStocks');" id="OutletStocksImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  		<input type="checkbox" name="DealsAndOffersCCTo" style="vertical-align: -2px" onclick="selectAll('CampaignPromotionsCCTo')" id="CampaignPromotionsCCTo"/>CC To
		                               <img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('CampaignPromotions');" id="CampaignPromotionsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
	                   		 ...
	                   		 <div style="margin-left: 0%;">
			                     <div id="CampaignPromotionsFlow" class="inactiveSubBlock" style="font-size: 10px;background-color: rgb(240,240,240)">
				                    <br>
	                   		   <div class="row divsubbg" style="border: none">
                   		  		  <span class="col-lg-6" style="cursor: pointer;padding-left: 60px;" >
                                  ...
                                  <span id="DealsConfigurationCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsRead" style="vertical-align: -2px" id="DealsConfigurationRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsWrite" style="vertical-align: -2px" id="DealsConfigurationWrite"/>Write
                                  </span>
                                   <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsCCTo" style="vertical-align: -2px" id="DealsConfigurationCCTo"/>CC To
                                  </span>
                               </div>
                                <br>
	                   		   <div class="row divsubbg" style="border: none">
                                  ...
                                  <span id="OffersConfigurationCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsRead" style="vertical-align: -2px" id="OffersConfigurationRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsWrite" style="vertical-align: -2px" id="OffersConfigurationWrite"/>Write
                                  </span>
                                    <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsCCTo" style="vertical-align: -2px" id="OffersConfigurationCCTo"/>CC To
                                  </span>
                               </div>
                                ...
                                <br>
                                  ...
                                  <span id="CustomerReferalCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsRead" style="vertical-align: -2px" id="CustomerReferalRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsWrite" style="vertical-align: -2px" id="CustomerReferalWrite"/>Write
                                  </span>
                                   <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsCCTo" style="vertical-align: -2px" id="CustomerReferalCCTo"/>CC To
                                  </span>
                               </div>
                                 <br>
                                  ...
                                  <span id="CustomerSignUpCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsRead" style="vertical-align: -2px" id="CustomerSignUpRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsWrite" style="vertical-align: -2px" id="CustomerSignUpWrite"/>Write
                                  </span>
                                   <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignPromotionsCCTo" style="vertical-align: -2px" id="CustomerSignUpCCTo"/>CC To
                                  </span>
                               </div>
                             ...
                             <div style="margin-left: 0%;">
	                            <div id="CustomerComplaintsFlow" class="inactiveSubBlock" style="font-size: 12px;">
                                  ...
                                  <span id="CustomerOTPCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" value="CustomerOTP" name="crmRead" id="CustomerOTPRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
...
<%--                                 	<img style="float: right;height: 20px;cursor: pointer;" id="DashboardImg" onclick="activate('Dashboard');" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                 ...
                 <!-- Finantial management flow -->   
                <!--Added By Manideep
                 Reason :To give the roles permissions for finantial management -->     
                        <br>
                          <div id="FinantialId" class="row divbg" >
                             <span onclick="activate('Finantial');" class="col-lg-6" style="font-size: 15px;cursor: pointer;">
                             	<spring:message code="Financial.management.label" />
                             </span>
                             <span id="FinantialCheck" class="col-lg-2" style="padding: 0px">
                              	<input type="checkbox" style="vertical-align: -2px" onclick="selectAll('FinantialRead')" name="consoleRead" id="FinantialRead"/>Read
                             </span>
                             <span  class="col-lg-2" style="padding: 0px">
                              	 <input type="checkbox" style="vertical-align: -2px" onclick="selectAll('FinantialWrite')" name="consoleWrite" id="FinantialWrite"/>Write 
                             </span>
                              <span  class="col-lg-2" style="padding: 0px">
                              	<input type="checkbox" style="vertical-align: -2px" onclick="selectAll('FinantialCCTo')" name="consoleCCTo" id="FinantialCCTo"/>CC To
                              	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('Finantial');" id="FinantialImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
                             </span>
                             </div>
                             <div id="FinantialFlow" style="margin-left: 0%;color:#666;background-color: rgb(240,240,240);margin-left: 2px;margin-right: 2px;" class="inactiveBlock">
	                   		<br>
                              
	                   		
	                   		<div id="FAccountingId"  class="row divsubbg" style="border: none">
	                               	  <span class="col-lg-6"  onclick="activateSubFlow('FAccounting');" style="cursor: pointer;padding-left: 40px;">
		                              	<spring:message code="Accounting.configuration.label" />
		                              </span>
		                              <span id="FAccountingCheck" class="col-lg-2" style="padding: 0px">
	                                  	<input type="checkbox" name="FinantialRead" style="vertical-align: -2px" onclick="selectAll('FAccountingRead')" id="FAccountingRead"/>Read
	                                  </span>
	                                  <span class="col-lg-2" style="padding: 0px">
	                                   <input type="checkbox" name="FinantialWrite" style="vertical-align: -2px" onclick="selectAll('FAccountingWrite')" id="FAccountingWrite"/>Write 
	                                  </span>
	                                   <span class="col-lg-2" style="padding: 0px">
	                                  	<input type="checkbox" name="FinantialCCTo" style="vertical-align: -2px" onclick="selectAll('FAccountingCCTo')" id="FAccountingCCTo"/>CC To
	                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('FAccounting');" id="FAccountingImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
	                                  </span>
                                </div>
                                 <div style="margin-left: 0%;">
	                              <div id="FAccountingFlow" class="inactiveSubBlock" style="font-size: 12px;background-color: rgb(240,240,240)">
	                               <br>
	                   			
	                   			<!--Sub flows in accounting  -->
                 				<div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 80px;" >
	                              		  	<spring:message code="Accounting.configuration.Organisation" />
	                              		  </span>
	                              		  <span id="OrganizationMasterCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingRead" style="vertical-align: -2px" id="OrganizationMasterRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingWrite" style="vertical-align: -2px" id="OrganizationMasterWrite">Write
		                                  </span>
		                                    <span  class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingCCTo" style="vertical-align: -2px" id="OrganizationMasterCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
		                            ...
		                            <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="FAssetsCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingRead" style="vertical-align: -2px" id="FAssetsRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingWrite" style="vertical-align: -2px" id="FAssetsWrite">Write
		                                  </span>
		                                    <span id="FAssetsCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingCCTo" style="vertical-align: -2px" id="FAssetsCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
		                            ...
		                            <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="FLiabilitiesCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingRead" style="vertical-align: -2px" id="FLiabilitiesRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingWrite" style="vertical-align: -2px" id="FLiabilitiesWrite">Write
		                                  </span>
		                                    <span id="FLiabilitiesCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingCCTo" style="vertical-align: -2px" id="FLiabilitiesCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
		                             ...
		                             <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="FIncomeCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingRead" style="vertical-align: -2px" id="FIncomeRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingWrite" style="vertical-align: -2px" id="FIncomeWrite">Write
		                                  </span>
		                                    <span id="FIncomeCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingCCTo" style="vertical-align: -2px" id="FIncomeCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
		                            ...
		                            <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="FExpencesCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingRead" style="vertical-align: -2px" id="FExpencesRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingWrite" style="vertical-align: -2px" id="FExpencesWrite">Write
		                                  </span>
		                                    <span id="FExpencesCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingCCTo" style="vertical-align: -2px" id="FExpencesCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
	                   			 <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="FEquityCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingRead" style="vertical-align: -2px" id="FEquityRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingWrite" style="vertical-align: -2px" id="FEquityWrite">Write
		                                  </span>
		                                    <span id="FExpencesCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingCCTo" style="vertical-align: -2px" id="FEquityCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
		                             ...
		                             <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="FReconciliationCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingRead" style="vertical-align: -2px" id="FReconciliationRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingWrite" style="vertical-align: -2px" id="FReconciliationWrite">Write
		                                  </span>
		                                    <span id="FReconciliationCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingCCTo" style="vertical-align: -2px" id="FReconciliationCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
		                            ...
		                            <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="FJournalCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingRead" style="vertical-align: -2px" id="FJournalRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingWrite" style="vertical-align: -2px" id="FJournalWrite">Write
		                                  </span>
		                                    <span id="FJournalCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingCCTo" style="vertical-align: -2px" id="FJournalCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
		                             ...
		                             <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="FCreditNoteCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingRead" style="vertical-align: -2px" id="FCreditNoteRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingWrite" style="vertical-align: -2px" id="FCreditNoteWrite">Write
		                                  </span>
		                                    <span id="FCreditNoteCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingCCTo" style="vertical-align: -2px" id="FCreditNoteCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
		                             ...
		                             <div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 80px;" >
	                              		  	<spring:message code="debit.note.label" />
	                              		  </span>
	                              		  <span id="FDebitNoteCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingRead" style="vertical-align: -2px" id="FDebitNoteRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingWrite" style="vertical-align: -2px" id="FDebitNoteWrite">Write
		                                  </span>
		                                    <span id="FDebitNoteCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FAccountingCCTo" style="vertical-align: -2px" id="FDebitNoteCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
	                   			</div>
	                   		...
	                   		<br>
	                   		 <div class="row divsubbg" style="border: none">
                                  <span class="col-lg-6" style="cursor: pointer;padding-left: 40px;" >
                                  	<spring:message code="Purchases.and.payments.label" />
                                  </span>
                                  <span id="FPurchasesPaymentsCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" value="FinantialSales" name="FinantialRead" id="FPurchasesPaymentsRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	 <input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" name="FinantialWrite"  id="FPurchasesPaymentsWrite"/>Write 
                                  </span>
                                    <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)"  name="FinantialCCTo" id="FPurchasesPaymentsCCTo"/>CC To
                                  </span>
                               </div>  
                               <br>
                                ...
                                <div class="row divsubbg" style="border: none">
                                  <span class="col-lg-6" style="cursor: pointer;padding-left: 40px;" >
                                  	<spring:message code="Accounting.SalesandPayments.label" />
                                  </span>
                                  <span id="FSalesandPaymentsCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" value="FinantialSales" name="FinantialRead" id="FSalesandPaymentsRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	 <input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" name="FinantialWrite"  id="FSalesandPaymentsWrite"/>Write 
                                  </span>
                                    <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)"  name="FinantialCCTo" id="FSalesandPaymentsCCTo"/>CC To
                                  </span>
                               </div>  
                               <br>
                               ...
                               <div class="row divsubbg" style="border: none">
                                  <span class="col-lg-6" style="cursor: pointer;padding-left: 40px;" >
                                  	<spring:message code="Accounting.PettyCash.label" />
                                  </span>
                                  <span id="FPettyCashCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" value="FinantialSales" name="FinantialRead" id="FPettyCashRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	 <input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" name="FinantialWrite"  id="FPettyCashWrite"/>Write 
                                  </span>
                                    <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)"  name="FinantialCCTo" id="FPettyCashCCTo"/>CC To
                                  </span>
                               </div>  
                               <br>
                                ...
                                <div class="row divsubbg" style="border: none">
                                  <span class="col-lg-6" style="cursor: pointer;padding-left: 40px;" >
                                  	<spring:message code="Accounting.AdvanceandPayments.label" />
                                  </span>
                                  <span id="FAdvanceandPaymentsCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" value="FinantialSales" name="FinantialRead" id="FAdvanceandPaymentsRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	 <input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" name="FinantialWrite"  id="FAdvanceandPaymentsWrite"/>Write 
                                  </span>
                                    <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)"  name="FinantialCCTo" id="FAdvanceandPaymentsCCTo"/>CC To
                                  </span>
                               </div>  
                               <br>
                               
	                   		<div id="FReportsId"  class="row divsubbg" style="border: none">
	                               	  <span class="col-lg-6"  onclick="activateSubFlow('FReports');" style="cursor: pointer;padding-left: 40px;">
		                              	<spring:message code="Reports.label" />
		                              </span>
		                              <span id="FReportsCheck" class="col-lg-2" style="padding: 0px">
	                                  	<input type="checkbox" name="FinantialRead" style="vertical-align: -2px" onclick="selectAll('FReportsRead')" id="FReportsRead"/>Read
	                                  </span>
	                                  <span class="col-lg-2" style="padding: 0px">
	                                   <input type="checkbox" name="FinantialWrite" style="vertical-align: -2px" onclick="selectAll('FReportsWrite')" id="FReportsWrite"/>Write 
	                                  </span>
	                                   <span class="col-lg-2" style="padding: 0px">
	                                  	<input type="checkbox" name="FinantialCCTo" style="vertical-align: -2px" onclick="selectAll('FReportsCCTo')" id="FReportsCCTo"/>CC To
	                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('FReports');" id="FReportsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
	                                  </span>
                                </div>
                                 <div style="margin-left: 0%;">
	                              <div id="FReportsFlow" class="inactiveSubBlock" style="font-size: 12px;background-color: rgb(240,240,240)">
	                               <br>
	                   		
	                   		<!--Sub flows in accounting reports  -->
                 				<div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 80px;" >
	                              		  	<spring:message code="Reports.profitability" />
	                              		  </span>
	                              		  <span id="FProfitabilityCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsRead" style="vertical-align: -2px" id="FProfitabilityRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsWrite" style="vertical-align: -2px" id="FProfitabilityWrite">Write
		                                  </span>
		                                    <span id="FProfitabilityCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsCCTo" style="vertical-align: -2px" id="FProfitabilityCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
	                   		<div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 80px;" >
	                              		  	<spring:message code="Reports.taxation" />
	                              		  </span>
	                              		  <span id="FTaxationCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsRead" style="vertical-align: -2px" id="FTaxationRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsWrite" style="vertical-align: -2px" id="FTaxationWrite">Write
		                                  </span>
		                                    <span id="FTaxationCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsCCTo" style="vertical-align: -2px" id="FTaxationCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
		                      ...
		                      <div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 80px;" >
	                              		  	<spring:message code="Reports.receivable" />
	                              		  </span>
	                              		  <span id="FReceivableCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsRead" style="vertical-align: -2px" id="FReceivableRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsWrite" style="vertical-align: -2px" id="FReceivableWrite">Write
		                                  </span>
		                                    <span id="FReceivableCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsCCTo" style="vertical-align: -2px" id="FReceivableCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
	                   		 ...
	                   		 <div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 80px;" >
	                              		  	<spring:message code="Reports.payables" />
	                              		  </span>
	                              		  <span id="FPayablesCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsRead" style="vertical-align: -2px" id="FPayablesRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsWrite" style="vertical-align: -2px" id="FPayablesWrite">Write
		                                  </span>
		                                    <span id="FPayablesCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsCCTo" style="vertical-align: -2px" id="FPayablesCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
		                            ...
		                            <div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 80px;" >
	                              		  	<spring:message code="Reports.deep" />
	                              		  </span>
	                              		  <span id="FDeepAnalysisCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsRead" style="vertical-align: -2px" id="FDeepAnalysisRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  <input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsWrite" style="vertical-align: -2px" id="FDeepAnalysisWrite">Write
		                                  </span>
		                                    <span id="FDeepAnalysisCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="FReportsCCTo" style="vertical-align: -2px" id="FDeepAnalysisCCTo"/>CC To
		                                  </span>
		                           </div>
		                            <br>
                       ...
                       <!--end of finantial management roles  -->
					                           ...
					                           <div class="row divsubbg" style="border: none">
					                            ...
					                            <br>
			                               		<div class="row divsubbg" style="border: none">
				                              		  ...
				                              		  <span id="OutletSalesManSalesCheck" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsRead" style="vertical-align: -2px" id="OutletSalesManSalesRead"/>Read
					                                  </span>
					                                  <span class="col-lg-2" style="padding: 0px">
					                                  </span>
					                                   <span class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesManSalesCCTo"/>CC To
					                                  </span>
					                           </div>
		                                  	...
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesPriceOverrideCCTo"/><spring:message code="cc.to.label"/>
					                            ...
					                            <br>
			                               		<div class="row divsubbg" style="border: none">
				                              		  ...
				                              		  <span id="OutletSalesSerialBillReportCheck" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsRead" style="vertical-align: -2px" id="OutletSalesSerialBillReportRead"/>Read
					                                  </span>
					                                  <span class="col-lg-2" style="padding: 0px">
					                                  </span>
					                                    <span id="" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesSerialBillReportCCTo"/>CC To
					                                  </span>
					                           </div>
					                            ...
					                            <br>
			                               		<div class="row divsubbg" style="border: none">
				                              		  ...
				                              		  <span id="OutletSalesCouponReportCheck" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsRead" style="vertical-align: -2px" id="OutletSalesCouponReportRead"/>Read
					                                  </span>
					                                  <span class="col-lg-2" style="padding: 0px">
					                                  </span>
					                                    <span id="" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesCouponReportCCTo"/>CC To
					                                  </span>
					                           </div>
					                           ...
					                           <br>
			                               		<div class="row divsubbg" style="border: none">
				                              		  ...
				                              		  <span id="OutletSalesVoucherReportCheck" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsRead" style="vertical-align: -2px" id="OutletSalesVoucherReportRead"/>Read
					                                  </span>
					                                  <span class="col-lg-2" style="padding: 0px">
					                                  </span>
					                                    <span id="" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesVoucherReportCCTo"/>CC To
					                                  </span>
					                           </div>
					                            <br>
			                               		<div class="row divsubbg" style="border: none">
				                              		  ...
				                              		  <span id="OutletSalesPersonWiseReportCheck" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsRead" style="vertical-align: -2px" id="OutletSalesPersonWiseReportRead"/>Read
					                                  </span>
					                                  <span class="col-lg-2" style="padding: 0px">
					                                  </span>
					                                    <span id="" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesPersonWiseReportCCTo"/>CC To
					                                  </span>
					                           </div>
					                           <!--4 new Roles on 21/02/2020-->
					                            <br>
			                               		<div class="row divsubbg" style="border: none">
				                              		  ...
				                              		  <span id="OutletSalesPriceVariationReportCheck" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsRead" style="vertical-align: -2px" id="OutletSalesPriceVariationReportRead"/>Read
					                                  </span>
					                                  <span class="col-lg-2" style="padding: 0px">
					                                  </span>
					                                    <span id="" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesPriceVariationReportCCTo"/>CC To
					                                  </span>
					                           </div>
					                           ...
					                           <br>
			                               		<div class="row divsubbg" style="border: none">
				                              		  ...
				                              		  <span id="OutletSalesSalesVsProcurementReportCheck" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsRead" style="vertical-align: -2px" id="OutletSalesSalesVsProcurementReportRead"/>Read
					                                  </span>
					                                  <span class="col-lg-2" style="padding: 0px">
					                                  </span>
					                                    <span id="" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesSalesVsProcurementReportCCTo"/>CC To
					                                  </span>
					                           </div>
					                            ...
					                            <br>
			                               		<div class="row divsubbg" style="border: none">
				                              		  ...
				                              		  <span id="OutletSalesCreditNoteReportCheck" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsRead" style="vertical-align: -2px" id="OutletSalesCreditNoteReportRead"/>Read
					                                  </span>
					                                  <span class="col-lg-2" style="padding: 0px">
					                                  </span>
					                                    <span id="" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesCreditNoteReportCCTo"/>CC To
					                                  </span>
					                           </div>
					                            ...
					                            <br>
			                               		<div class="row divsubbg" style="border: none">
				                              		  ...
				                              		  <span id="OutletSalesCreditNoteRedeemReportCheck" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsRead" style="vertical-align: -2px" id="OutletSalesCreditNoteRedeemReportRead"/>Read
					                                  </span>
					                                  <span class="col-lg-2" style="padding: 0px">
					                                  </span>
					                                    <span id="" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesCreditNoteRedeemReportCCTo"/>CC To
					                                  </span>
					                           </div>
					                            ...
					                            <br>
			                               		<div class="row divsubbg" style="border: none">
				                              		  ...
				                              		  <span id="OutletSalesCashierEfficiencyReportCheck" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsRead" style="vertical-align: -2px" id="OutletSalesCashierEfficiencyReportRead"/>Read
					                                  </span>
					                                  <span class="col-lg-2" style="padding: 0px">
					                                  </span>
					                                    <span id="" class="col-lg-2" style="padding: 0px">
					                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletSalesReportsCCTo" style="vertical-align: -2px" id="OutletSalesCashierEfficiencyReportCCTo"/>CC To
					                                  </span>
					                           </div>
					                           <!-- price Change report -->
					                           <br>
...
<!-- 		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="OutletReportsWrite" style="vertical-align: -2px" id="OutletCRMReportsWrite"/>Write -->
		                       ...
		                       <br>
                               <%-- <div id="CampaignReportsId"  class="row divsubbg" style="border: none">
	                               	  <span class="col-lg-6"  onclick="activateSubFlow('CampaignReports');" style="cursor: pointer;padding-left: 40px;">
		                              	<spring:message code="campaign.code.label" />
		                              </span>
		                              <span id="CampaignReportsCheck" class="col-lg-2" style="padding: 0px">
	                                  	<input type="checkbox" name="ReportsRead" style="vertical-align: -2px" onclick="selectAll('CampaignReportsRead')" id="CampaignReportsRead"/>Read
	                                  </span>
	                                  <span class="col-lg-2" style="padding: 0px">
	                                  	<!-- <input type="checkbox" name="ReportsWrite" style="vertical-align: -2px" onclick="selectAll('OutletReportsWrite')" id="OutletReportsWrite"/>Write -->
	                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('OutletReports');" id="OutletReportsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
	                                   ...
	                                   <span class="col-lg-2" style="padding: 0px">
	                                  	<input type="checkbox" name="ReportsCCTo" style="vertical-align: -2px" onclick="selectAll('CampaignReportsCCTo')" id="CampaignReportsCCTo"/>CC To
	                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('CampaignReports');" id="CampaignReportsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
	                                  </span>
                                </div> --%>
                                <div id="CampaignReportsId"  class="row divsubbg" style="border: none">
	                               	  <span class="col-lg-6"  onclick="activateSubFlow('CampaignReports');" style="cursor: pointer;padding-left: 40px;">
...
<%-- 	                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('OutletReports');" id="OutletReportsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
		                       ...
		                       <div style="margin-left: 0%;">
	                           <div id="CampaignReportsFlow" class="inactiveSubBlock" style="font-size: 12px;background-color: rgb(240,240,240)">
	                           <br>
	                           <div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 60px;" >
	                              		  	<spring:message code="promotion.wise.sales.label" />
	                              		  </span>
	                              		  <span id="PWSalesReportCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignReportsRead" style="vertical-align: -2px" id="PWSalesReportsRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<!-- <input type="checkbox" onclick="toggleCheckBox(this)" name="OutletReportsWrite" style="vertical-align: -2px" id="OutletOrdersReportsWrite"/>Write -->
		                                  </span>
		                                   <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignReportsCCTo" style="vertical-align: -2px" id="PWSalesReportsCCTo"/>CC To
		                                  </span>
		                           </div>
		                           <br>
	                           <div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 60px;" >
	                              		  	<spring:message code="promotion.wise.orders.label" />
	                              		  </span>
	                              		  <span id="PWOrdersReportCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignReportsRead" style="vertical-align: -2px" id="PWOrdersReportsRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<!-- <input type="checkbox" onclick="toggleCheckBox(this)" name="OutletReportsWrite" style="vertical-align: -2px" id="OutletOrdersReportsWrite"/>Write -->
		                                  </span>
		                                   <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignReportsCCTo" style="vertical-align: -2px" id="PWOrdersReportsCCTo"/>CC To
		                                  </span>
		                           </div>
	                           ...
	                           <div class="row divsubbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 60px;" >
	                              		  	<spring:message code="item.wise.promotion.sales.label" />
	                              		  </span>
	                              		  <span id="IWPromotionSalesReportCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignReportsRead" style="vertical-align: -2px" id="IWPromotionSalesReportsRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<!-- <input type="checkbox" onclick="toggleCheckBox(this)" name="OutletReportsWrite" style="vertical-align: -2px" id="OutletOrdersReportsWrite"/>Write -->
		                                  </span>
		                                   <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="CampaignReportsCCTo" style="vertical-align: -2px" id="IWPromotionSalesReportsCCTo"/>CC To
		                                  </span>
		                           </div>
...
<%--                                   	<img style="float: right; height: 20px;cursor: pointer;" onclick="activateSubFlow('storeReturnedBills');" id="storeReturnedBillsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
<%--                                 	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('storeExchangedBills');" id="storeExchangedBillsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                                  </span>
                                </div>
...
<%-- 		                                 <img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('warehouseAppWarehouseStockIssues');" id="warehouseAppWarehouseStockIssuesImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
		                                 ...
		                                 <img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('storeStoreStockVerification');" id="storeStoreStockVerificationIssueImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
		                                  </span>
		                             </div>
		                            <div style="margin-left: 0%">
	                     ...
	                     <%--      <div id="storeStockVerificationMasterId" class="row divsubbg" style="border: none;">
	                              <span class="col-lg-6"  onclick="activateSubFlow('storeStockVerificationMaster');" style="cursor: pointer;padding-left: 40px;">
	                              	<spring:message code="stock.verification.master" />
	                              </span>
	                              <span id="storeStockVerificationMasterCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="selectAll('storeStockVerificationMasterRead');" name="storeStockManagementRead" id="storeStockVerificationMasterRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="storeStockManagementWrite" style="vertical-align: -2px" onclick="selectAll('storeStockVerificationMasterWrite')" id="storeStockVerificationMasterWrite"/>Write
                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('storeGoodsProcurement');" id="storeGoodsProcurementImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="storeStockManagementCCTo" style="vertical-align: -2px" onclick="selectAll('storeStockVerificationMasterCCTo')" id="storeStockVerificationMasterCCTo"/><spring:message code="cc.to.label" />
                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('storeStockVerificationMaster');" id="storeStockVerificationMasterImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
                                  </span>
                                  </div>
                                  <div style="margin-left:0%;">
	                              <div id="storeStockVerificationMasterFlow" class="inactiveSubBlock" style="font-size: 12px">
	                                <br>
                               		<div id="StockVerificationId" class="row divsubbg" style="border: none;">
	                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 60px;" onclick="activateSubChildFlow('StockVerification');" >
	                              		  	<spring:message code="warehouse_stockverification.label" />
	                              		  </span>
	                              		  <span id="StockVerificationCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="storeStockVerificationMasterRead" style="vertical-align: -2px" value="StockVerification" id="StockVerificationMasterStockVerificationRead"/>Read
		                                  </span>
		                                  <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="storeStockVerificationMasterWrite" style="vertical-align: -2px"  id="StockVerificationMasterStockVerificationWrite"/>Write
		                                  </span>
		                                   <span class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="storeStockVerificationMasterCCTo" style="vertical-align: -2px"  id="StockVerificationMasterStockVerificationCCTo"/><spring:message code="cc.to.label" />
		                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('StockVerificationMasterStockVerification');" id="StockVerificationImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
		                                  </span>
		                           </div>
	                            <div style="margin-left: 0%;">
		                            <div id="StockVerificationMasterStockVerificationFlow" class="inactiveSubChildBlock" style="font-size: 12px;background-color: rgb(240,240,240)">
		                                 <br>
		                               		<div class="row divsubbg" style="border: none">
			                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 80px;" >
			                              		  	<spring:message code="activities.label" />
			                              		  ...
			                              		  <span id="" class="col-lg-6" style="padding: 0px">
			                              		  	<select class="form-control activities" name="StockVerificationMasterStockVerification" multiple="multiple" id="StockVerificationMasterStockVerificationActivities">
				                              		   	<c:forEach var="workflow" items="${workflowsList}" varStatus="theCount"> 
 								                            <c:if test="${workflow.businessFlow == 'Store Stock Verification'}"> 
 								                            	<option value ="${workflow.statusName}">${workflow.statusName}</option> 
								                          </c:if>
...
<%--                                 	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('storeLoyaltyCards');" id="storeLoyaltyCardsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
	                       ...
	                       <!--  written by manasa 
	                       purpose:to give permession for cherla health
	                       -->
	                        <div  class="row divbg" >
	...
	<%-- 	                           <br>
		                       ...
		                       <br>    
		                        ...
		                        <!--  //ending for cherla health permission
	                       -->
	                         <br>
...
<%--                                     <img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('warehouseAppStockVerification');" id="warehouseAppStockVerificationImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
 --%>                             
                                </span>
                   		   </div>
                   		   
                   		     <div style="margin-left: 0%">
			                       		<div id="warehouseOrdersFlow" class="inactiveSubChildBlock" style="font-size: 10px;background-color: rgb(240,240,240)">
			                       			<br>
			                       			<div class="row divsubbg" style="border: none;">
			                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 60px;" >
			                              		  	<spring:message code="activities.label" />
			                              		  ...
			                              		  <span id="" class="col-lg-6" style="padding: 0px">
			                              		  	<select class="form-control activities" name="warehouseAppOrders" multiple="multiple" id="warehouseAppOrdersActivities">
				                              		  	<c:forEach var="workflow" items="${workflowsList}" varStatus="theCount">
								                            <c:if test="${workflow.businessFlow == 'Order'}">
								                            	<option value ="${workflow.statusName}">${workflow.statusName}</option>
								                            </c:if>
                   		   ...
                   		   <div id="warehouseAppWareHouseStockVerificationId" class="row divbg">
                                <span class="col-lg-6" style="cursor: pointer;font-size: 15px;" onclick="activateSubChildFlow('warehouseAppWareHouseStockVerification');" >
                                	<spring:message code="warehouse_stockverification.label" />
                                </span>
                   		   ...
                   		   <div style="margin-left: 0%">
			                       		<div id="warehouseAppWareHouseStockVerificationFlow" class="inactiveSubChildBlock" style="font-size: 10px;background-color: rgb(240,240,240)">
			                       			...
			                       			<div class="row divsubbg" style="border: none;">
			                              		  ...
			                              		  <span id="" class="col-lg-6" style="padding: 0px">
			                              		  	<select class="form-control activities" name="warehouseAppWareHouseStockVerification" multiple="multiple" id="warehouseAppWareHouseStockVerificationActivities">
				                              		  	<c:forEach var="workflow" items="${workflowsList}" varStatus="theCount">
								                            <c:if test="${workflow.businessFlow == 'Warehouse Stock Verification'}">
								                            	<option value ="${workflow.statusName}">${workflow.statusName}</option>
								                            </c:if>
...
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('warehouseAppReports');" id="warehouseAppReportsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
				  ...
				  <input type="hidden" id="maxRecords" value="${maxRecords}">	
				 	<input type="hidden" id="searchRoles" value="">										
				</div>  
                     	</div><!-- /.box-body -->
               	<br>
				<div class="row" style="text-align: center;">
			 		<input type="button" class="btnCls" onclick="validateRole('edit');" value="&nbsp;&nbsp;<spring:message code="submit.label" />&nbsp;&nbsp;" />
					<input type="button" class="btnCls buttonMargin" style="" onclick="viewRolesMaster('role','0');" value="<spring:message code="cancel.label" />" />
				</div>
				<br/>
