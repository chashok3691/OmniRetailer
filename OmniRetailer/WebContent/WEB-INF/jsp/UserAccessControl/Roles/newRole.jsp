 ...
 * Written By		        : Mythri
 *modified by                : manasa
 * file name		        : admin/newRole.jsp
 * file type		        : JSP
 * description				: The new role form is displayed using this jsp
 * modificationsBy			: Vijay
 * modiFicationDescriptions	: vijay : added 'CC To' access permissions  
 * */ -->
...
<html>
 ...
 <%--        <script src="${pageContext.request.contextPath}/js/plugins/input-mask/jquery.inputmask.js" type="text/javascript"></script>
	...
	$(document).ready(function(){
		...
		if(activitiesStr != null && activitiesStr != "")
...
<div class="row">
  <div class="col-xs-12">
		<div class="box box-primary">
           ...
           <br/>
           <h3><spring:message code="new.role.header" /></h3>
           </div><!-- /.box-header -->
           <!-- form start -->
	        	...
	        	<div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -10px">${success}</div>
               	 <div class="row">
                   	 <div class="form-group col-lg-3">
                           ...
                           <input type="text" class="form-control" name="roleName" id="roleName" value="${role.roleName}" required placeholder="<spring:message code="enter.rolename.label" />" />
                       ...
                       <div class="form-group col-lg-3">
                           ...
                           <!-- <div class="input-group">
                               <div class="input-group-addon">
                                 ...
                                 <input class="form-control calendar_icon" readonly="readonly" style="background-color: white;" value="${role.validDate}"  name="validDate" id="validDate" size="20" type="text" onfocus="callCalender('validDate')" onclick="callCalender('validDate')" placeholder="DD/MM/YYYY"/>
                               <!-- <input type="text" name="validDate" id="validDate" required class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/> -->
                           <!-- </div> --><!-- /.input group -->
                   ...
                   <div class="row" >
                    ...
                    <div class="form-group col-lg-2" style="padding-left: 1px;padding-right: 1px;margin-top: 8px;cursor: pointer;margin-bottom: 0px;" onclick="activateHeader('console');" ><span style="font-weight: bold;font-size: 16px;color:#666;cursor: pointer;"><spring:message code="cloud.permissions.label" /> </span></div>
...
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('outletCustomerOrders');" id="outletCustomerOrdersImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                               ...
                               <br>
                                  ...
                                  <span id="DepartmentsOutletManagementCheck" class="col-lg-2" style="padding: 0px">
...
<%-- 		                                  		<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('OutletSalesReports');" id="OutletSalesReportsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
		                           ...
		                           <br>
	                              		  ...
	                              		  <span id="OutletProfitabilityReportsCheck" class="col-lg-2" style="padding: 0px">
...
<%-- 		                                  		<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('OutletSalesReports');" id="OutletSalesReportsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                   ...
                   <div class="form-group col-lg-6">
                   		  <div class="row divbg" style="margin-top: 10px;">
                                ...
                                <span  class="col-lg-2" style="padding: 0px">
                                	<input type="checkbox" onclick="selectAll('storeBillingCCTo')" style="vertical-align: -2px" name="storeAppWrite" id="storeBillingCCTo"/><spring:message code="cc.to.label" />
...
<%--                                   	<img style="float: right; height: 20px;cursor: pointer;" onclick="activateSubFlow('storeReturnedBills');" id="storeReturnedBillsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                                ...
                                <%-- <div style="margin-left:0%;">
                                 ...
                                 <br>
	                              ...
	                              <span class="col-lg-6"  onclick="activateSubFlow('storeHomeDeliveryBill');" style="cursor: pointer;padding-left: 40px;">
...
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('storeHomeDeliveryBill');" id="storeHomeDeliveryBillImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                        ...
                        <div id="storeShipmentBillsId" class="row divbg" >
                   	  ...
                   	  <div id="storeStockManagementId" class="row divbg" >
                             <span  class="col-lg-6" onclick="activate('storeStockManagement');" style="font-size: 15px;cursor: pointer;">
                             	<spring:message code="stockmanagement.label" />
                             </span>
...
<%--                               	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('storeStockManagement');" id="storeStockManagementImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                              ...
                              <span  class="col-lg-2" style="padding: 0px">
	                   		...
	                   		<br>
	                   		 <div class="row divsubbg" style="border: none">
	                              		  ...
	                              		  <span id="ViewStocksCheck" class="col-lg-2" style="padding: 0px">
                               ...
                               <%-- 	<div id="storeStockmanagementId" class="row divbg" style="border: none;">
	                              <span class="col-lg-6"  onclick="activateSubFlow('storeStockmanagement');" style="cursor: pointer;">
	                              	<spring:message code="stockmanagement.label" />
	                              </span>
	                              <span id="storeStockmanagementCheck" class="col-lg-3" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="selectAll('storeStockmanagementRead');" name="storeStockManagementRead" id="storeStockmanagementRead"/>Read
                                  </span>
                                  <span class="col-lg-3" style="padding: 0px">
                                  	<input type="checkbox" name="storeStockManagementWrite" style="vertical-align: -2px" onclick="selectAll('storeStockmanagementWrite')" id="storeStockmanagementWrite"/>Write
                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubFlow('storeStockmanagement');" id="storeStockmanagementImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
                                  </span>
                                  </div>
                                  <div style="margin-left:0%;">
	                              <div id="storeStockmanagementFlow" class="inactiveSubBlock" style="font-size: 12px">
	                                <br>
                               		<div class="row divbg" style="border: none">
	                              		  <span class="col-lg-6" style="cursor: pointer;" >
	                              		  	<spring:message code="view.stock.label" />
	                              		  </span>
	                              		  <span id="ViewStocksCheck" class="col-lg-3" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="storeStockmanagementRead" style="vertical-align: -2px" value="ViewStocks" id="StockmanagementViewStocksRead"/>Read
		                                  </span>
		                                  <span class="col-lg-3" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="storeStockmanagementWrite" style="vertical-align: -2px"  id="StockmanagementViewStocksWrite"/>Write
	                                ...
	                                <div class="row divbg" style="border: none">
	                              		   <span class="col-lg-6" style="cursor: pointer;" >
	                              		  	<spring:message code="verify.stocks.label" />
	                              		  </span>
	                              		  <span id="VerifyStocksCheck" class="col-lg-3" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="storeStockmanagementRead" style="vertical-align: -2px" value="VerifyStocks" id="StockmanagementVerifyStocksRead"/>Read
		                                  </span>
		                                  <span class="col-lg-3" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="storeStockmanagementWrite" style="vertical-align: -2px" id="StockmanagementVerifyStocksWrite"/>Write
		                                  </span>
		                             </div>
	                              </div>
	                          </div> --%>
	                          ...
	                          <div id="storeGoodsTransferId" class="row divsubbg" style="border: none;">
	                              <span class="col-lg-6"  onclick="activateSubFlow('storeGoodsTransfer');" style="cursor: pointer;padding-left: 40px;">
...
<%-- 		                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('GoodsTransferStockReturn');" id="GoodsTransferStockReturnImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
	                          ...
	                          <div id="storeGoodsProcurementId" class="row divsubbg" style="border: none;">
	                              <span class="col-lg-6"  onclick="activateSubFlow('storeGoodsProcurement');" style="padding-left: 40px;cursor: pointer;">
...
<%-- 		                                 <img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('GoodsProcurementOutletGRN');" id="GoodsProcurementOutletGRNImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
	                               ...
	                               <%--  <div class="row divbg" style="border: none">
	                              		   <span class="col-lg-6" style="cursor: pointer;" >
	                              		  	<spring:message code="receipts.label" />
	                              		  </span>
	                              		  <span id="ReceiptsCheck" class="col-lg-3" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="storeGoodsProcurementRead" style="vertical-align: -2px" value="Receipts" id="GoodsProcurementReceiptsRead"/>Read
		                                  </span>
		                                  <span class="col-lg-3" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="storeGoodsProcurementWrite" style="vertical-align: -2px" id="GoodsProcurementReceiptsWrite"/>Write
		                                  </span>
		                             </div> --%>
		                             <br>
...
<%-- 		                                 <img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('warehouseAppWarehouseStockIssues');" id="warehouseAppWarehouseStockIssuesImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
	                          ...
	                          <div id="storeDeliveriesId" class="row divsubbg" style="border: none;">
	                              <span class="col-lg-6"  onclick="activateSubFlow('storeDeliveries');" style="padding-left: 40px;cursor: pointer;">
...
<%--                               	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('warehouseAppStockManagement');" id="warehouseAppStockManagementImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                              ...
                              <span  class="col-lg-2" style="padding: 0px">
                              	<input type="checkbox" onclick="selectAll('warehouseAppStockManagementCCTo')" style="vertical-align: -2px" name="warehouseAppCCTo" id="warehouseAppStockManagementCCTo"/>CC To
                              	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('warehouseAppStockManagement');" id="warehouseAppStockManagementImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
                             </span>
                             </div>
	                   		 ...
	                   		 <br>
                               	<%-- <div class="row divsubbg" style="border: none;">
	                              <span id="warehouseAppPurchaseOrderId" class="col-lg-6"  style="cursor: pointer;padding-left: 40px;">
	                              	<spring:message code="purchase.order.label" />
	                              </span>
	                              <span id="warehouseAppPurchaseOrderCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" name="warehouseAppStockManagementRead" id="warehouseAppPurchaseOrderRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="warehouseAppStockManagementWrite" onclick="toggleCheckBox(this)" style="vertical-align: -2px" id="warehouseAppPurchaseOrderWrite"/>Write
                                  </span>
                                   <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="warehouseAppStockManagementCCTo" onclick="toggleCheckBox(this)" style="vertical-align: -2px" id="warehouseAppPurchaseOrderCCTo"/>CC To
                                  </span>
                                  </div> --%>
...
<%--                                   <img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('warehouseAppPurchaseOrder');" id="warehouseAppPurchaseOrderImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                                ...
                                <br>
                                  ...
                                  <span class="col-lg-2" style="padding: 0px">
                                      ...
                                      <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="warehouseAppStockManagementCCTo" onclick="toggleCheckBox(this)" style="vertical-align: -2px" id="warehouseAppShipmentsNotesCCTo"/>CC To
                                  </span>
                                  </div>
                                  <br>
                               <%-- 	<div class="row divsubbg" style="border: none;">
	                              <span id="warehouseAppGoodsReceiptsId" class="col-lg-6"  style="cursor: pointer;padding-left: 40px;">
	                              	<spring:message code="goods.receipts.label" />
	                              </span>
	                              <span id="warehouseAppGoodsReceiptsCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="toggleCheckBox(this)" name="warehouseAppStockManagementRead" id="warehouseAppGoodsReceiptsRead"/>Read
                                  </span>
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="warehouseAppStockManagementWrite" onclick="toggleCheckBox(this)" style="vertical-align: -2px" id="warehouseAppGoodsReceiptsWrite"/>Write
                                  </span>
                                         <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="warehouseAppStockManagementCCTo" onclick="toggleCheckBox(this)" style="vertical-align: -2px" id="warehouseAppGoodsReceiptsCCTo"/>CC To
                                  </span>
                                  </div> --%>
...
<%--                                    <img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('warehouseAppGoodsReceipts');" id="warehouseAppGoodsReceiptsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                                  ...
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="warehouseAppStockManagementCCTo" onclick="toggleCheckBox(this)" style="vertical-align: -2px" id="warehouseAppInspectionReceiptsCCTo"/>Write
                                  </span>
                                  </div>
                                  <br>
                               	<div class="row divsubbg" style="border: none;">
                                  ...
                                  <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="warehouseAppStockManagementCCTo" onclick="toggleCheckBox(this)" style="vertical-align: -2px" id="warehouseAppInvoicingCCTo"/>CC To
                                  </span>
                                  </div>
                                  <br>
                               	<div class="row divsubbg" style="border: none;">
                                  ...
                                  <span class="col-lg-2" style="padding: 0px">
                                   ...
                                   <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" name="warehouseAppStockManagementCCTo" onclick="toggleCheckBox(this)" style="vertical-align: -2px" id="warehouseAppPaymentsCCTo"/>CC To
                                  </span>
                                  </div>  
                             </div>
	                          <br>
...
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('warehouseAppGoodsTransfer');" id="warehouseAppGoodsTransferImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                                   ...
                                   <span class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="selectAll('warehouseAppGoodsTransferCCTo')" name="warehouseAppCCTo" id="warehouseAppGoodsTransferCCTo"/>CC To
                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('warehouseAppGoodsTransfer');" id="warehouseAppGoodsTransferImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
                                  </span>
                               </div>
                                     <div style="margin-left:0%;">
...
<%-- 		                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activateSubChildFlow('warehouseAppStockRequest');" id="warehouseAppStockRequestImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
	                          ...
	                          <div class="row divbg">
                                ...
                                <span  class="col-lg-2" style="padding: 0px">
                                  ...
                                  <span  class="col-lg-2" style="padding: 0px">
                                	<input type="checkbox" style="vertical-align: -2px" name="warehouseAppCCTo"  id="warehouseAppOrdersCCTo"/>CC To
                                </span>
                   		   </div>
                   		   <br>
                   		   <div id="warehouseAppShipmentsId" class="row divbg">
                                ...
                                <span  class="col-lg-2" style="padding: 0px">
                                 ...
                                 <span  class="col-lg-2" style="padding: 0px">
                                	<input type="checkbox" style="vertical-align: -2px" name="warehouseAppCCTo" id="warehouseAppShipmentsCCTo"/>CC To
                                </span>
                   		   </div>
                   		   <br>
                   		  <%--  <div id="warehouseAppStockVerificationId" class="row divbg">
                                ...
                                <span  class="col-lg-2" style="padding: 0px">
                                	<input type="checkbox" style="vertical-align: -2px" name="warehouseAppCCTo" id="warehouseAppStockVerificationCCTo"/>CC To
                                </span>
                   		   </div> --%>
                   		   ...
                   		   <div style="margin-left: 0%">
			                       		<div id="warehouseAppStockWareHouseVerificationFlow" class="inactiveSubChildBlock" style="font-size: 10px;background-color: rgb(240,240,240)">
			                       			<br>
			                       			<div class="row divsubbg" style="border: none;">
			                              		  <span class="col-lg-6" style="cursor: pointer;padding-left: 60px;" >
			                              		  	<spring:message code="activities.label" />
...
<%--                                   	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('warehouseAppReports');" id="warehouseAppReportsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png"> --%>
                                    ...
                                    <span id="warehouseAppReportsCheck" class="col-lg-2" style="padding: 0px">
                                  	<input type="checkbox" style="vertical-align: -2px" onclick="selectAll('warehouseAppReportsCCTo');" name="warehouseAppCCTo" id="warehouseAppReportsCCTo"/>CC To
                                  	<img style="float: right;height: 20px;cursor: pointer;" onclick="activate('warehouseAppReports');" id="warehouseAppReportsImg" alt="" src="${pageContext.request.contextPath}/images/leftIcon.png">
		                             ...
		                             <br>	                                
                               		...
                               		<div class="row divsubbg" style="border: none">
		                                  ...
		                                  <!-- <span class="col-lg-3" style="padding: 0px">
		                                    ...
		                                    <span id="warehouseAppPurchaseReportsCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="warehouseAppReportsCCTo" style="vertical-align: -2px" id="warehouseAppPurchaseReportsCCTo"/>CC To
		                                  </span>
		                           </div>
		                             <br>
	                                <div class="row divsubbg" style="border: none">
...
<!-- 		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="warehouseAppReportsRead" style="vertical-align: -2px" id="warehouseAppShipmentReportsRead"/>Read -->
		                                    ...
		                                    <span id="" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="warehouseAppReportsCCTo" style="vertical-align: -2px" id="warehouseAppShipmentReportsCCTo"/>CC To
		                                  </span>
		                                  <!-- <span class="col-lg-3" style="padding: 0px">
		                             ...
		                             <br>
                               		<div class="row divsubbg" style="border: none">
		                                 ...
		                                 <!--  <span class="col-lg-3" style="padding: 0px">
		                                   ...
		                                   <span id="" class="col-lg-2" style="padding: 0px"></span>
		                                    <span id="warehouseAppStockReportsCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="warehouseAppReportsCCTo" style="vertical-align: -2px" id="warehouseAppStockReportsCCTo"/>CC To
		                                  </span>
		                           </div>
		                             <br>
	                                <div class="row divsubbg" style="border: none">
		                                   ...
		                                   <span id="warehouseAppInspectionReportsCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="warehouseAppReportsCCTo" style="vertical-align: -2px" id="warehouseAppInspectionReportsCCTo"/>CC To
		                                  </span>
		                                  <!-- <span class="col-lg-3" style="padding: 0px">
		                              ...
		                              <br>
                               		<div class="row divsubbg" style="border: none">
		                                  ...
		                                  <span id="warehouseAppGoodsTransferReportsCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="warehouseAppReportsCCTo" style="vertical-align: -2px" id="warehouseAppGoodsTransferReportsCCTo"/>CC To
		                                  </span>
		                                  <!-- <span class="col-lg-3" style="padding: 0px">
	                                ...
	                                <div class="row divsubbg" style="border: none">
		                                   ...
		                                   <span id="warehouseAppExpiryReportsCheck" class="col-lg-2" style="padding: 0px">
		                                  	<input type="checkbox" onclick="toggleCheckBox(this)" name="warehouseAppReportsCCTo" style="vertical-align: -2px" id="warehouseAppExpiryReportsCCTo"/>CCTo
		                                  </span>
		                                 <!--  <span class="col-lg-3" style="padding: 0px">
				...
				<div class="row" style="text-align: center;">
			 		<input type="button" class="btnCls" onclick="validateRole('new');" value="&nbsp;&nbsp;<spring:message code="submit.label" />&nbsp;&nbsp;" />
			 		 ...
			 		 <c:forEach var="accessControl" items="${sessionScope.userAccessControl}">
	                     <c:if test="${accessControl.appDocument == 'RolesManagement' && accessControl.write == true && accessControl.read == true}">
							<input type="button" class="btnCls buttonMargin" style="" onclick="viewRolesMaster('role','0');" value="<spring:message code="cancel.label" />" />
						</c:if>
					</c:forEach>
				</div>
