...
callCalender('fromWPricevariation');
callCalender('toWPricevariation');
$("#PriceVariation").val($("#stock").val());
...
$('#PriceVariation').on('input',function(e){
	if($(this).val().trim()==""){
		viewPriceVariationreport('warehousePriceVariation','0','');
	}
});
...
$('#mySearch').click(function(){
    ...
    return viewPriceVariationreport('warehousePriceVariation','0',search);
})
...
<div class="row">
 ...
 <ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#home">	<spring:message code="price.variation.label" /></a></li>
  <li><a data-toggle="tab" href="#menu1">Graphical Report</a></li>
</ul>
  ...
  <div id="home" class="tab-pane fade in active">
          ...
          <div class="box-header" align="center">
              ...
              <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                	 	...
                	 	<input class="form-control calendar_icon form-group" readonly="readonly" value="${startdate}" style="background-color: white;" id="fromWPricevariation" size="20" type="text" onfocus="callCalender('fromWPricevariation')" onclick="callCalender('fromWPricevariation')" placeholder="DD/MM/YYYY" />
	              </div>
	            </div>
...
<%--                            		 <option value=""><spring:message code="ALL.label"/></option> --%>
	               ...
	               <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
	                   <label><spring:message code="offer_end_date.label"/></label>
	                 	<input class="form-control calendar_icon form-group" readonly="readonly" value="${enddate}" style="background-color: white;" id="toWPricevariation" size="20" type="text" onfocus="callCalender('toWPricevariation')" onclick="callCalender('toWPricevariation')" placeholder="DD/MM/YYYY" />
		           </div>
		          </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                  <a onclick="viewPriceVariationreport('warehousePriceVariation','0','')" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                  <div class="row">
                  ...
                  <div class="col-lg-12 col-xs-12" style="padding-bottom:3px;padding-left: 0px;padding-right: 0px;">
                      	  ...
                      	  <div class="wrapper">
	        	 		 <input type="text"  class="form-control" value="${searchName}" id="PriceVariation" placeholder="<spring:message code="search.items.here.label" />" />
						<!-- 	<input type="button" value="Search" id="mySearch"> -->
						<button id="mySearch" class="searchbutton"></button>
						 
							</div>
                      	<%--  <input type="text"    class="form-control searchItems searchBar" style=""  id="PriceVariation" placeholder="<spring:message code="search.items.here.label" />" />
							<div class="services">
				    			<div class="items">
				     				<ul class="matchedStringUl PriceVariation" style=""></ul>
				   				</div>
							</div> --%>
                            ...
                            <thead style="background-color: #ccc !important; color: #ffffff">
                               <tr>
                                    ...
                                    <th style="border: 2px solid #444 !important;"><spring:message code="report.procqty.label" /></th>
                                       <th style="border: 2px solid #444 !important;"><spring:message code="report.proprice.label" /></th>
                                          <th style=" border: 2px solid #444 !important;"><spring:message code="report.pricediff.label" /></th>
                                             <th style="border: 2px solid #444 !important;"><spring:message code="report.pricevar.label" /></th>
                                </tr>
                            </thead>
                           <tbody style="text-align: center;">
                             <c:forEach var="warehousereport" items="${warehousereport.warehouseReportList}" varStatus="thecount">
                          	 <tr>
                                 <td>${thecount.count+index-1}
                                 </td>
                                 <td class="graph" id="skuid${thecount.index+index}">${warehousereport.skuID}</td> 
                                  <td>${warehousereport.itemDescription}</td> 
                                   <td>${warehousereport.uom}</td> 
                                    <td id="date${thecount.index+index}">${warehousereport.dateStr}</td> 
                                     <td>${warehousereport.procQty}</td> 
                                      <td id="Pqty${thecount.index+index}">${warehousereport.procPrice}</td> 
                                       <td id="Cqty${thecount.index+index}">${warehousereport.pricDiff}</td> 
                                        <td>${warehousereport.pricVariance}</td> 
              ...
              <div class="row">
               ...
               <input type="hidden" id="totalnum" value="${totalRecords}">
              	<c:if test="${index-1 == 0 && totalRecords >10}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewPriceVariationreport('warehousePriceVariation','${totalValue}','${searchName}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-10 >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewPriceVariationreport('warehousePriceVariation','${index - 11}','${searchName}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewPriceVariationreport('warehousePriceVariation',document.getElementById('pagination').value,'${searchName}')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
              		</div>
                 ...
                 <div class="modal-body">
                  ...
                  <canvas id="stocksLineChart" height="350 !important;" width="600  !important;"></canvas>
                              ...
                              <div id="menu1" class="tab-pane fade in ">
                               ...
                               <canvas id="pricevar" height="350 !important;" width="600  !important;"></canvas>
