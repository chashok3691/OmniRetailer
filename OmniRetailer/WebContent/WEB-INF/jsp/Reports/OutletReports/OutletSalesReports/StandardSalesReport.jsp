...
<!-- Main content -->
				...
				<section class="content-header">
                    <label style="width:100%;text-align: center;"><label style="border:1px solid gray;border-radius: 5px;padding: 5px;padding-left: 20px;padding-right: 20px;font-size: 18px;">Standard Sales Report</label></label>
...
<%-- 									<option value="${location}" ${location == selectedLocation ? 'selected' : ''} id="${location}" >${location}</option> --%>
                  ...
                  <div class="row">
                 <a onclick="viewStandardSalesReport('standardSalesReport','0','','','${flowLocation}')" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                  <div class="row">
                  <a onclick="viewStandardSalesReport('standardSalesReport','0','','clear','${flowLocation}')" class="button"><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div> 
                  <div class="col-lg-12">
                  <br>
 ...
 <br><br>
		   ...
		   <input type="button" class="addBtn btn bg-olive btn-inline" onclick="viewStandardSalesReport('standardSalesReport','0','save','','${flowLocation}')"  style="font-size: 16px;" value="<spring:message code="save.label" />" />
		 </div> 
				                  </div>
				                    <div style="overflow: auto;white-space: nowrap;">
                                    <table id="standardSalesReport" class="table table-bordered table-striped">
                                        ...
                                        <tbody style="text-align: center;">
                                        	 ...
                                        	 <tr>
                                        	    ...
                                        	    <td>${items.storeLocation}</td>
                                        	 	...
                                        	 	<td>${items.billId}</td>
                                        	 	<td>${items.billType}</td>
                                        	 	<td>${items.noOfItems}</td>
              ...
              <div class="row">
               ...
               <input type="hidden" id="totalnum" value="${totalRecords}">
              	<c:if test="${index-1 == 0 && totalRecords >10}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewStandardSalesReport('standardSalesReport','${totalValue}','','','${flowLocation}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-10 >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="viewStandardSalesReport('standardSalesReport','${index - 11}','','','${flowLocation}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewStandardSalesReport('standardSalesReport',document.getElementById('pagination').value,'','','${flowLocation}')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
