...
$(document).ready(function(){
	...
	$('#creditNoteSearch').click(function(){
        ...
        return viewOutletCreditNoteReport('SalesCreditNoteReport','0','false','${flowLocation}');
    })
...
<!-- Main content -->
				...
				<section class="content-header">
                    <h1>
                      ...
                      </c:if>&nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;<spring:message code="credit.note.reports.label"/>
                    </h1>
  ...
  <div class="col-lg-12">
   ...
   <div class="col-lg-12" style=" background: #f4f4f4;    ">
              ...
              <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
	               ...
	               <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                  <a onclick="searchOutletCreditNoteReport('outletCreditNoteReport','0','NOPOP','','${flowLocation}')" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
          ...
          <div class="form-group col-lg-8 col-sm-6 col-xs-6" style="padding-left: 0px; padding-right: 0px;margin-left:50px">
												<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px; display: inline-block; padding: 4px 10px 28px 10px; background: #3c8dbc; cursor: pointer; margin-top: 19.5px; height: 25px; text-align: center; margin-bottom: 19px; width: 45%; margin-left: -30px;">
													<input type="button" class="iosclosebutton1"
														onclick="searchOutletCreditNoteReport('outletCreditNoteReport','0','','','${flowLocation}')"
														value="OK">
												</div>
          ...
          <div class="row">
                <div class="col-lg-12"><br></div>
				                    ...
				                    <div class="row">
				                       <div class="col-lg-1 col-xs-2">
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewOutletCreditNoteReport('','0','false');">
                     ...
                     <input type="button" class="btn bg-olive btn-inline  addBtn" onclick="viewOutletCreditNoteReport('outletCreditNoteReport','0','true','${flowLocation}');" value="SAVE"/>
                                    ...
                                    <table id="productstocks" class="table table-bordered table-striped">
                                     <thead style="background-color: #3c8dbc; color: #ffffff">
                                            <tr>
                                                ...
                                                <th>Bal &nbsp<spring:message code="amt.label" /></th> 
                                        ...
                                        <tbody style="text-align: center;">
                                           <c:forEach var="warehouseReport" items="${WarehouseReportObj.reportsList}" varStatus="theCount">
                                        	 <tr>
                                        	 	...
                                        	 	<td>${warehouseReport.billAmount}</td>
             ...
             <div class="row">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewOutletCreditNoteReport('','${totalValue}','false','${flowLocation}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewOutletCreditNoteReport('','${index - (maxRecords + 1)}','false','${flowLocation}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewOutletCreditNoteReport('',document.getElementById('pagination').value,'false','${flowLocation}')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
