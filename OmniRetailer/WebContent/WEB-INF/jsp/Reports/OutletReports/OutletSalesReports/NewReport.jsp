...
$(document).ready(function(){
	...
	$('#mySearch').click(function(){
        ...
        return viewOutletNewReport('outletNewReport','0',search,'','${flowLocation}');
    })
...
<!-- Main content -->
				...
				<section class="content-header">
                    <h1>
                      ...
                      </c:if>&nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;<spring:message code="price.override.report.label"/>
                    </h1>
                  ...
                  <div class="row">
                       ...
                       <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                        <label><spring:message code="zone.label"/></label>
                           <select class="form-control" id="outletZone" onchange="searchZonallocationsBasedOnZone('outletZone','outletLocation','${flowLocation}')">
...
<%-- 									<option value="${location}" ${location == selectedLocation ? 'selected' : ''} id="${location}" >${location}</option> --%>
                  ...
                  <div class="row">
                 <a onclick="searchOutletNewReport('outletNewReport','0','','','NOPOP','${flowLocation}')" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                  <div class="row">
                  ...
                  <br>
				                    ...
				                    <div class="row">
				                       <div class="col-lg-1 col-xs-2">
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewOutletNewReport('outletNewReport','0','','','${flowLocation}');">
                                     ...
                                     <thead style="background-color: #3c8dbc; color: #ffffff">
                                            <tr>
                                                ...
                                                <th><spring:message code="original.price.label" /></th>
                                                   <th><spring:message code="price.change.label" /></th>
                                                    <th>Reason</th>
                                                  <th><spring:message code="totalsalecost.label" /></th>
              ...
              <div class="row">
               ...
               <input type="hidden" id="totalnum" value="${totalRecords}">
              	<c:if test="${index-1 == 0 && totalRecords >10}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewOutletNewReport('outletNewReport','${totalValue}','','','${flowLocation}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-10 >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewOutletNewReport('outletNewReport','${index - 11}','','','${flowLocation}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewOutletNewReport('outletNewReport',document.getElementById('pagination').value,'','','${flowLocation}')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
          ...
          <div class="form-group col-lg-8 col-sm-6 col-xs-6" style="padding-left: 0px; padding-right: 0px;margin-left:50px">
												<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px; display: inline-block; padding: 4px 10px 28px 10px; background: #3c8dbc; cursor: pointer; margin-top: 19.5px; height: 25px; text-align: center; margin-bottom: 19px; width: 45%; margin-left: -30px;">
													<input type="button" class="iosclosebutton1"
														onclick="viewOutletNewReport('outletNewReport','0','','','${flowLocation}')"
														value="OK">
												</div>
...
<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px;">
 <input type="button" class="iosclosebutton1" onclick="viewOutletNewReport('outletNewReport','0','','save','${flowLocation}')"  value="Ok">
</div>
<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px;">
