 ...
 * Written By		        : Mythri.S
 * file name		        : Inventory Manager/Reports/salesReportsPriceVariation.jsp
 * file type		        : JSP
...
<div id="salevariation">
				<section class="content-header">
                    <h1>
                       <spring:message code="outlet_management.reports.label"/>&nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;<spring:message code="price.variation.label"/>&nbsp;<spring:message code="report.label"/>
                    </h1>
                   <%--  <ol class="breadcrumb">
              ...
              <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                     ...
                     <div class="row">
                       ...
                       <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select class="form-control" id="outletLocation" onchange="searchCategorybasedonlocation('outletLocation','outletCategory','');">
...
<%-- 									<option value="${location}" ${location == loc ? 'selected' : ''} id="${location}" >${location}</option> --%>
                  ...
                  <div class="row">
                  <a onclick="generateSalesPriceVariationReport('salesReportPriceVariation','0','${searchName}','NOPOP');" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
          ...
          <div class="form-group col-lg-8 col-sm-6 col-xs-6" style="padding-left: 0px; padding-right: 0px;margin-left:50px">
												<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px; display: inline-block; padding: 4px 10px 28px 10px; background: #3c8dbc; cursor: pointer; margin-top: 19.5px; height: 25px; text-align: center; margin-bottom: 19px; width: 45%; margin-left: -30px;">
													<input type="button" class="iosclosebutton1"
														onclick="generateSalesPriceVariationReport('salesReportPriceVariation','0','${searchName}','');"
														value="OK">
												</div>
...
<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px;">
 <input type="button" class="iosclosebutton1"  onclick="generateSalesPriceVariationReport('salesReportPriceVariation','0','save');"  value="Ok">
</div>
<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px;">
   ...
   <br/>
		...
		<%--  <input type="hidden" id="criteria" value="${criteria}"> --%>
          <div id="xReportsDisplay" style="">
            <%@ include file="viewPriceVariationReport.jsp" %>
          </div>
      </div>
    </div>
  </div>
