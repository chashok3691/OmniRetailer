 ...
 * Written By		        : Mythri.S
 * file name		        : Inventory Manager/Reports/salesReportsSupplierWise.jsp
 * file type		        : JSP
...
<div id="gensalereportcriteriawise">
				<section class="content-header">
                    <h1>
                      ...
                      </c:if>&nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;<spring:message code="supplier.wise.label"/>&nbsp;<spring:message code="report.label"/>
                    </h1>
                   <%--  <ol class="breadcrumb">
       ...
       <div class="box-body">    
        ...
        <div class="box-body table-responsive">
                       ...
                       <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                        <label><spring:message code="zone.label"/></label>
                           <select class="form-control" id="outletZone" onchange="searchZonallocationsBasedOnZone('outletZone','location','${flowLocation}')">
		                            ...
		                            <c:if test="${criteria != 'supplier' || criteria ne 'supplier'}">
         ...
         <label><spring:message code="supplier.name.label" /> <span style="color:red; font-size:2">*</span></label>
           <input type="text" class="form-control allField searchItems" name="supplier_name" style="background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;background-color: #fff;" id="searchSupplier" placeholder="<spring:message code="search.supplier.label" />" />
			<div class=services>
		    		<div class="items">
			...
			<input type="hidden" class="allField" name="supplier_Id" id="supplier_Id" value=""  />
              ...
              <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                 		<label><spring:message code="offer_start_date.label"/></label>
                	 	 <input class="form-control calendar_icon" readonly="readonly" style="background-color: white;" name="startDate"  value="${startdate}" id="startDate" size="20" type="text" onfocus="callCalender('startDate')" onclick="callCalender('startDate')" placeholder="DD/MM/YYYY"/>
	              </div>
	            </div>
	               ...
	               <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
	                   <label><spring:message code="offer_end_date.label"/></label>
	                 	  <input class="form-control calendar_icon" readonly="readonly" style="background-color: white;" value="${enddate}" name="endDate" id="endDate" size="20" type="text" onfocus="callCalender('endDate')" onclick="callCalender('endDate')" placeholder="DD/MM/YYYY"/>
		           </div>
		          </div>
                    </div>
                  </div>
                  <div class="col-lg-1" style="    width: 12%; background: #ccc; height: 147px; ">
   ...
   <br/>
        ...
        <div class="col-lg-12">
			                ...
			                <div class="col-lg-1 summaryBtn nopadding">
			                	...
			                	<img class="summaryImg" style="float: right;width: 35%;" src="${pageContext.request.contextPath}/images/summary.png" onclick="getreportsummary('supplier')" style="cursor: pointer;" >
        ...
        <div class="modal-footer" style="padding:0px;">
		 ...
		 <input type="hidden" id="criteria" value="${criteria}">
          <div id="xReportsDisplay" style="">
            <%@ include file="viewSuppliersReport.jsp" %>
          </div>
      </div>
    </div>
  </div>
