 ...
 * Written By		        : Mythri.S
 * file name		        : Inventory Manager/Reports/salesReportsDepartmentWise.jsp
 * file type		        : JSP
...
<div id="gensalereportcriteriawise">
				<section class="content-header">
                    <h1>
                      ...
                      &nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;<spring:message code="department.label"/>&nbsp;<spring:message code="report.label"/>
                    </h1>
                   <%--  <ol class="breadcrumb">
        ...
        <div class="modal-footer" style="padding:0px;">
		 ...
		 <input type="hidden" id="criteria" value="${criteria}">
          <div id="xReportsDisplay" style="">
            <%@ include file="viewDepartmentReport.jsp" %>
          </div>
      </div>
    </div>
  </div>
