 ...
 * file name		        : Reports/OutletReports/OutletSalesReports/eventSummaryReport.jsp
 * file type		        : JSP
...
$(document).ready(function(){
	...
	$('#mySearch').click(function(){
	    return viewEventsSummaryReport('eventsSummaryReport','0','outlet');
	})
	...
	$('#searchEvent').on('input',function(e){
	    if($(this).val().trim()==""){
	    	viewEventsSummaryReport('eventsSummaryReport','0','outlet');
	    }
	}); 
		});
           ...
           <div id="Success" style="text-align:center;color:blue;font-weight:bold;">${success}</div>
             ...
             <div class="box-body table-responsive">
              ...
              <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                  ...
                  <div class="row">
                  <a onclick="viewEventsSummaryReport('eventsSummaryReport','0','outlet');" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                  <div class="row">
                 ...
                 <%--    <label><spring:message code="startprice.label"/></label> --%>
                    ...
                    <div class="col-lg-10 col-xs-9 " style="margin-left: -17px; margin-right: 14px;">
                                                     <div class="wrapper">
                                                               <input type="text"  class="form-control" style="" value="${selectedsearchName}" id="searchEvent" placeholder="Search Events" />
                  ...
                  <div class="col-lg-1" style="padding-left: 0px;">
								                <input type="button" style="" class="btn bg-olive btn-inline  addBtn" onclick="viewEventsSummaryReport('eventsSummaryReport','0','outlet','true');" value="Save">
								          <input type="hidden" id="printeventsReport" value="${saveReport}">
								           </div>
                         ...
                         <tbody style="text-align: center;">
                            <c:forEach var="eventslist" items="${eventMastersList}"  varStatus="theCount">
                         	 <tr>
                                ...
                                <td>${eventslist.expectedSales}</td>
                                <td>${eventslist.profit}</td>
                                <td>${eventslist.actualSales}</td>
                             </tr>
                            </c:forEach>
...
<div class="col-lg-8"></div>
              ...
              <div class="row">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewEventsSummaryReport('eventsSummaryReport','${totalValue}','outlet');">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-2">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewEventsSummaryReport('eventsSummaryReport','${index - 11}','outlet');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${index-1 != 0 &&  totalValue != totalRecords}">
              		<div class="form-group col-lg-2">  
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewEventsSummaryReport('eventsSummaryReport','${index - 11}','outlet');"> ${index} - ${totalValue} of ${totalRecords} .
              		<input type="button" class='paginationButton' value="&#62;" onclick="return viewEventsSummaryReport('eventsSummaryReport','${totalValue}','outlet');">
              	</div> 
              	</c:if>
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">  
              		  <input type="button" onclick="viewEventsSummaryReport('eventsSummaryReport',document.getElementById('pagination').value,'outlet');" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				...
				<input type="hidden" id="printeventsSummaryURL" value="${printUrl}">
