...
$(document).ready(function(){
	...
	$('#searchVoucherID').click(function(){
        
        return viewSalesVoucherReports('salesVoucherIssueId','0','','${flowLocation}');
    })
    $('#searchSalesVoucher').keypress(function(e){
        if(e.which == 13){//Enter key pressed
            $('#searchVoucherID').click();//Trigger search button click event
        }
    });
          ...
          <div class="col-lg-11" style="padding: 10px 20px;width: 88%;background: #f1f1f1">
           <div class="row">
              ...
              <div class="col-lg-12" style="">
                	 	...
                	 	<input class="form-control calendar_icon form-group" readonly="readonly" value="${startdateVt}" style="background-color: white;" id="startDateSt" size="20" type="text" onfocus="callCalender('startDateSt')" onclick="callCalender('startDateSt')" placeholder="DD/MM/YYYY" />
	              </div>
	            </div>
...
<%-- 	              <input type="hidden" id="locationList" value="${locationList}"> --%>
	        ...
	        <div class="col-lg1-2 col-lg-3">
	               ...
	               <div class="col-lg-12" style="">
	                   <label><spring:message code="offer_end_date.label"/></label>
	                 	<input class="form-control calendar_icon form-group" readonly="readonly" value="${endDate}" style="background-color: white;" id="endDateSt" size="20" type="text" onfocus="callCalender('endDateSt')" onclick="callCalender('endDateSt')" placeholder="DD/MM/YYYY" />
		           </div>
		          </div>
          ...
          <div class="col-lg-1" style="padding-bottom: 4px;background: #D8D8D8;    width: 12%;">
                  ...
                  <div class="row">
                  <a onclick="viewSalesVoucherReports('salesVoucherIssueId','0','','${flowLocation}');" class="button" ><spring:message code="searchbutton.label" /></a>
                  </div>
          ...
          <br>
				                    ...
				                    <div class="row">
				                       <div class="col-lg-1 col-xs-2">
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewSalesVoucherReports('salesVoucherIssueId','0','','${flowLocation}');">
				                     ...
				                     <div class="wrapper">
				                      	 <input type="text"  class="form-control" style="" value="" id="searchSalesVoucher" placeholder="<spring:message code="search.sales.Voucher" />" />
											<button id="searchVoucherID" class="searchbutton"></button>
											<!-- <div class="services">
								    			<div class="items">
                     ...
                     <input type="button" class="btn bg-olive btn-inline  addBtn" onclick="viewSalesVoucherReports('salesVoucherIssueId','0','save','${flowLocation}')" value="SAVE"/>
                                    ...
                                    <table id="productstocks" class="table table-bordered table-striped">
                                     <thead style="background-color: #3c8dbc; color: #ffffff">
                                            <tr>
                                            	...
                                            	<th><div><spring:message code="transaction.date" /></div></th>
                                            	<th><div><spring:message code="transaction.voucher.number" /></div></th>
                                            	<th><div><spring:message code="transaction.coupon.amount" /></div></th>
                                            </tr>
                                        	</thead>
                                           ...
                                           <c:forEach var="CouponDetails" items="${salesReportList}" varStatus="Thecount">
                                        	 <tr>
                                        	 	...
                                        	 	<td>${CouponDetails.billId}</td>
                                        	 	<td>${CouponDetails.serailBillIdYearly}</td>
                                        	 	<td>${CouponDetails.transactionDateStr}</td>
												<td>${CouponDetails.couponNumber}</td>
												<td>${CouponDetails.paidAmount}</td>
             ...
             <div class="row" style="padding-right: 15px;">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewSalesVoucherReports('salesVoucherIssueId','${totalValue}','','${flowLocation}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-3" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewSalesVoucherReports('salesVoucherIssueId','${index - (maxRecords + 1)}','','${flowLocation}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-1" style="padding-right: 0px;">
              		  <input type="button" onclick="viewSalesVoucherReports('salesVoucherIssueId',document.getElementById('pagination').value,'','${flowLocation}')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
