    ...
    <div id="dialogboxfoot"></div>
				...
				<section class="content-header">
                    <h1>
                      ...
                      </c:if>&nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;<spring:message code="counter.wise.label"/>&nbsp;<spring:message code="report.label"/>
                    </h1>
...
<%-- 									<option value="${location}" ${location == loc ? 'selected' : ''} id="${location}" >${location}</option> --%>
                    ...
                    <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                      ...
                      <span id="cashierError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                    </div>
                     <div class="col-lg1-2 col-lg-2"></div>
        ...
        <%@ include file="savePopUp.jsp"%>
		 ...
		 <input type="hidden" id="flowlocations" value="${flowLocation}">
          <div id="xReportsDisplay" style="">
            <%@ include file="viewCounterWiseReport.jsp" %>
          </div>
      </div>
    </div>
  </div>
