 ...
 * Written By		        : Mythri.S
 * file name		        : Inventory Manager/Reports/salesReportsSectionWise.jsp
 * file type		        : JSP
...
<div id="gensalereportcriteriawise">
				<section class="content-header">
                    <h1>
                      ...
                      </c:if>&nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;<spring:message code="sectionwise.reports.label"/>&nbsp;<spring:message code="report.label"/>
                    </h1>
                   <%--  <ol class="breadcrumb">
              ...
              <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                     ...
                     <div class="row">
                       ...
                       <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select class="form-control" id="location" onchange="searchCategorybasedonlocation('location','productCategory','outletBrandId');">
   ...
   <br/>
        ...
        <div class="col-lg-12">
			                ...
			                <div class="col-lg-1 summaryBtn nopadding">
			                	...
			                	<img class="summaryImg" style="float: right;width: 35%;" src="${pageContext.request.contextPath}/images/summary.png" onclick="getreportsummary('section')" style="cursor: pointer;" >
        ...
        <div class="modal-footer" style="padding:0px;">
		 ...
		 <input type="hidden" id="criteria" value="${criteria}">
          <div id="xReportsDisplay" style="">
            <%@ include file="viewSectionReport.jsp" %>
          </div>
      </div>
    </div>
  </div>
