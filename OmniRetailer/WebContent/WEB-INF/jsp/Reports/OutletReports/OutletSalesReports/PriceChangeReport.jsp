...
$(document).ready(function(){
	...
	$('#mySearch').click(function(){
        ...
        return viewOutletPriceChangeReport('outletPriceChangeReport','0',search,'','','${flowLocation}');
    })
...
<!-- Main content -->
				...
				<section class="content-header">
                    <h1>
                      ...
                      </c:if>&nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;<spring:message code="price.change.report.label"/>
                    </h1>
...
<%-- 									<option value="${location}" ${location == selectedLocation ? 'selected' : ''} id="${location}" >${location}</option> --%>
                  ...
                  <div class="row">
                 <a onclick="viewOutletPriceChangeReport('outletPriceChangeReport','0','','','','${flowLocation}')" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                  <div class="row">
                  <a onclick="viewOutletPriceChangeReport('outletPriceChangeReport','0','','','clear','${flowLocation}')" class="button"><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div> 
                  <div class="col-lg-12">
                  <br>
 ...
 <br><br>
		   ...
		   <input type="button" class="addBtn btn bg-olive btn-inline" onclick="viewOutletPriceChangeReport('outletPriceChangeReport','0','','save','','${flowLocation}')"  style="font-size: 16px;" value="<spring:message code="save.label" />" />
		 </div> 
				                  </div>
                                    ...
                                    <table id="productstocks" class="table table-bordered table-striped">
                                     <thead style="background-color: #3c8dbc; color: #ffffff">
                                            <tr>
                                                ...
                                                <th>Mrp</th>
                                                  <th>Sale Price</th>
                                                  <th>Price Update From</th>
                                             
                                            </tr>
                                        </thead>
                                        <tbody style="text-align: center;">
                                            <c:forEach var="items" items="${warehousereport.itemReportList}" varStatus="theCount">
                                        	 <tr>
              ...
              <div class="row">
               ...
               <input type="hidden" id="totalnum" value="${totalRecords}">
              	<c:if test="${index-1 == 0 && totalRecords >10}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewOutletPriceChangeReport('outletPriceChangeReport','${totalValue}','','','','${flowLocation}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-10 >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewOutletPriceChangeReport('outletPriceChangeReport','${index - 11}','','','','${flowLocation}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewOutletPriceChangeReport('outletPriceChangeReport',document.getElementById('pagination').value,'','','','${flowLocation}')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
