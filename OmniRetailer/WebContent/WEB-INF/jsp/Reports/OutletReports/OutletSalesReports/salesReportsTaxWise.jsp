...
<div id="gensalereportcriteriawise">
				<section class="content-header">
                    <h1>
                      ...
                      </c:if>&nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;Tax Wise&nbsp;<spring:message code="report.label"/>
                    </h1>
                   <%--  <ol class="breadcrumb">
...
<%--          <div class="row">
         <div class="form-group col-lg-2" style="padding-left:2%;">
            <label><spring:message code="location.label" /></label>
        ...
        <%--   <br/>
		 ...
		 <input type="hidden" id="criteria" value="${criteria}">
          <div id="xReportsDisplay" style="">
            <%@ include file="viewTaxReport.jsp" %>
          </div>
      </div>
    </div>
  </div>
