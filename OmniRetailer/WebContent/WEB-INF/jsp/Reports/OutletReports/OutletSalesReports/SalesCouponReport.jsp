...
$(document).ready(function(){
	...
	$('#searchSalesID').click(function(){
        
        return viewSalesCouponReports('salesCouponIssueId','0','');
    })
    $('#searchSalesCoupon').keypress(function(e){
        if(e.which == 13){//Enter key pressed
            $('#searchSalesID').click();//Trigger search button click event
        }
    });
          ...
          <div class="col-lg-11" style="padding: 10px 20px;width: 88%;background: #f1f1f1">
           <div class="row">
              ...
              <div class="col-lg-12" style="">
	            ...
	            <%-- <input type="hidden" id="startDate" value="${startdateSt}"> --%>
<%-- 	              <input type="hidden" id="locationList" value="${locationList}"> --%>
          ...
          <div class="col-lg-1" style="padding-bottom: 4px;background: #D8D8D8;    width: 12%;">
                  ...
                  <div class="row">
                  <a onclick="viewSalesCouponReports('salesCouponIssueId','0','','${flowLocation}');" class="button" ><spring:message code="searchbutton.label" /></a>
                  </div>
          ...
          <br>
				                    ...
				                    <div class="row">
				                       <div class="col-lg-1 col-xs-2">
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewSalesCouponReports('salesCouponIssueId','0','','${flowLocation}');">
				                     ...
				                     <div class="wrapper">
				                      	 <input type="text"  class="form-control" style="" value="" id="searchSalesCoupon" placeholder="<spring:message code="search.sales.coupons" />" />
											<button id="searchSalesID" class="searchbutton"></button>
											<!-- <div class="services">
								    			<div class="items">
                     ...
                     <input type="button" class="btn bg-olive btn-inline  addBtn" onclick="viewSalesCouponReports('salesCouponIssueId','0','save','${flowLocation}');" value="SAVE"/>
                                    ...
                                    <table id="productstocks" class="table table-bordered table-striped">
                                     <thead style="background-color: #3c8dbc; color: #ffffff">
                                            <tr>
                                            	...
                                            	<th><div><spring:message code="transaction.coupon.number" /></div></th>
             ...
             <div class="row" style="padding-right: 15px;">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewSalesCouponReports('salesCouponIssueId','${totalValue}','','${flowLocation}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-3" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewSalesCouponReports('salesCouponIssueId','${index - (maxRecords + 1)}','','${flowLocation}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-1" style="padding-right: 0px;">
              		  <input type="button" onclick="viewSalesCouponReports('salesCouponIssueId',document.getElementById('pagination').value,'','${flowLocation}')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
