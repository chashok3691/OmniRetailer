 ...
 * file name		        : Inventory Manager/Billing/viewsalereports.jsp
 * file type		        : JSP
  ...
  <div id="home" class="tab-pane fade in active">
				                    <div class="row">
				                      <div id="errorMsg" class="errorMsg" style="text-align: center;color: red;font-size: 2;font-weight: bold;margin-bottom: 2px; margin-top: -10px">${errorMsg}</div>
				                       <div class="col-lg-1">
				                       	<label>Show</label> 
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="generateSalesReportCriteriaWise('${criteria}','validationCheck','0','','');">
