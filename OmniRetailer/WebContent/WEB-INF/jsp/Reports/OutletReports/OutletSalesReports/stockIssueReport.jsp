...
$('#searchissueReport').on('input',function(e){
	if($(this).val().trim()==""){
		viewStockIssueReport('stockissueReports','0','','clear','warehouse');
	}
});
...
<%-- 									<option value="${location}" ${location == selectedLocation ? 'selected' : ''} id="${location}" >${location}</option> --%>
                  ...
                  <div class="row">
                  <a onclick="viewStockIssueReport('stockissueReports','0','','clear','warehouse')" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
        ...
        <div class="modal-footer" style="padding:0px;">
         <!--  <input type="button" class="iosclosebutton" data-dismiss="modal" value="Close"/> -->
                  ...
                  <br>
       	 		 ...
       	 		 <input type="text"  class="form-control searchItems"  value="${searchName}" id="searchissueReport" placeholder="<spring:message code="search.purchase.orders.label" />"style="margin-top: 10px;    width: ;margin-left:;height:30PX;text-align: left;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" />
					<div class="services">
		    			<div class="items">
		     				<ul class="matchedStringUl searchissueReport" style=""></ul>
		   				</div>
					</div>
               ...
               <div id="example1_wrapper" class="dataTables_wrapper form-inline" role="grid" style="overflow-x: auto;width:100%;position: relative;white-space: nowrap;">
				         ...
				         <table id="example1" class="table table-bordered table-striped" >
                            <thead style="background-color: #a1dbf1 !important;">
                               <tr>
                                	<th style="border: 1px solid #444 !important;"><spring:message code="report.sno.label" /></th>
                                	 
                                	<th style=" border: 1px solid #444 !important;"><spring:message code="report.skuid.label" /></th>
                                    <th style="border: 1px solid #444 !important;"><spring:message code="product.name.table.label" /></th>
                                    <th style="border: 1px solid #444 !important;"><spring:message code="uom.label" /></th>
                                    <th style="border: 1px solid #444 !important;"><spring:message code="size.weight.label" /></th>
                                    <th style="border: 1px solid #444 !important;"><spring:message code="colour.label" /></th>
                                    <th style=" border: 1px solid #444 !important;"><spring:message code="issue.date.label" /></th>
                                	<th style=" border: 1px solid #444 !important;">Issue Location</th>
                                    <th style="border: 1px solid #444 !important;"><spring:message code="qty.label" /></th>
                                    <th style="border: 1px solid #444 !important;">Price</th>
                                    <th style="border: 1px solid #444 !important;">Cost</th> 
                                          </tr>
                            </thead>
                             ...
                             <c:forEach var="warehousereport" items="${warehousereport}" varStatus="thecount">
                          	 <tr>
                                 ...
                                 <td style="text-align: left;">${warehousereport.skuId}</td> 
                                  <td style="text-align: left;">${warehousereport.productName}</td> 
                                   <td style="text-align: left;">${warehousereport.uom}</td> 
                                    <td style="text-align: left;">${warehousereport.size}</td> 
                                   <td style="text-align: left;">${warehousereport.color}</td> 
                                   <td style="text-align: left;">${warehousereport.issueDate}</td> 
                                  <td style="text-align: left;">${warehousereport.issueLocation}</td> 
                                    <td>${warehousereport.quantity}</td> 
                                   <td>${warehousereport.price}</td> 
                                    <td>${warehousereport.cost}</td> 
               ...
               <input type="hidden" id="flowUnder" value="${flowUnder}">
              	<c:if test="${index-1 == 0 && totalRecords >10}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewStockIssueReport('stockissueReports','${totalValue}','','clear','warehouse')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-10 >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewStockIssueReport('stockissueReports','${index - 11}','','clear','warehouse');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewStockIssueReport('stockissueReports',document.getElementById('pagination').value,'','clear','warehouse')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
