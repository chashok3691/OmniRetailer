...
<%-- 									<option value="${location}" ${location == selectedLocation ? 'selected' : ''} id="${location}" >${location}</option> --%>
 ...
 <%-- <c:if test="${sessionScope.customerId == 'CID8995461'}">  --%>
 <c:choose>
 <c:when test="${type=='DSR'}">
  <li class="active"><a  data-toggle="tab" onclick="viewdsrReports('salesDsrReport','0','DSR');" href="#menu3">DSR </a></li>
 </c:when>
 <c:otherwise>
 <li><a  data-toggle="tab" onclick="viewdsrReports('salesDsrReport','0','DSR');" href="#menu3">DSR </a></li>
 </c:otherwise>
 </c:choose>
<%--   </c:if> --%>
</ul>
             ...
             <form action="#" method="post">
                 <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div id="example5_wrapper" class="dataTables_wrapper form-inline" role="grid" style="overflow-x:auto;width:100%">
				         <table id="example5" class="table table-bordered table-striped" style="    white-space: nowrap;">
                            <thead style="background-color: #ccc !important; color: #ffffff">
                               <tr>
                                	<th style="border: 2px solid #444 !important;"><spring:message code="report.sno.label" /></th>
                                    <th style="border: 2px solid #444 !important;"><spring:message code="location.label" /></th>
                                	<th style="border: 2px solid #444 !important;">Agg Total</th>
                                	<th style="border: 2px solid #444 !important;">Agg Total-Previous Day</th>
                                	<th style="border: 2px solid #444 !important;">Total Bills</th>
                                	<th style="border: 2px solid #444 !important;">Total Bills-Previous Day</th>
                                	
                                	<th style="border: 2px solid #444 !important;">FMCG Food</th>
                                	<th style="border: 2px solid #444 !important;">FMCG Non Food</th>
                                	<th style="border: 2px solid #444 !important;">General Merchandise</th>
                                	<th style="border: 2px solid #444 !important;">Stapless</th>
                                	<th style="border: 2px solid #444 !important;">Others</th>
                                	
                                	<th style="border: 2px solid #444 !important;">FMCG Food-Previous Day</th>
                                	<th style="border: 2px solid #444 !important;">FMCG Non Food-Previous Day</th>
                                	<th style="border: 2px solid #444 !important;">General Merchandise-Previous Day</th>
                                	<th style="border: 2px solid #444 !important;">Stapless-Previous Day</th>
                                	<th style="border: 2px solid #444 !important;">Others-Previous Day</th>
                                	
                                	<th style="border: 2px solid #444 !important;">Oil</th>
                                	<th style="border: 2px solid #444 !important;">Rice</th>
                                	<th style="border: 2px solid #444 !important;">SFD</th>
                                	<th style="border: 2px solid #444 !important;">Beverages</th>
                                	<th style="border: 2px solid #444 !important;">Ayur Star</th>
                                	<th style="border: 2px solid #444 !important;">Others</th>
                                	
                                	<th style="border: 2px solid #444 !important;">Oil-Previous Day</th>
                                	<th style="border: 2px solid #444 !important;">Rice-Previous Day</th>
                                	<th style="border: 2px solid #444 !important;">SFD-Previous Day</th>
                                	<th style="border: 2px solid #444 !important;">Beverages-Previous Day</th>
                                	<th style="border: 2px solid #444 !important;">Ayur Star-Previous Day</th>
                                	<th style="border: 2px solid #444 !important;">Others-Previous Day</th>
                           ...
                           <tbody style="text-align: center;">
                           <c:set var="catFoodTotal" value="0"></c:set>
                           <c:set var="catNonFoodTotal" value="0"></c:set>
                           <c:set var="catGMTotal" value="0"></c:set>
                           <c:set var="catStaplesTotal" value="0"></c:set>
                           <c:set var="catOthersTotal" value="0"></c:set>
                           
                           <c:set var="catFoodYDayTotal" value="0"></c:set>
                           <c:set var="catNonFoodYDayTotal" value="0"></c:set>
                           <c:set var="catGMYDayTotal" value="0"></c:set>
                           <c:set var="catStaplesYDayTotal" value="0"></c:set>
                           <c:set var="catOthersYDayTotal" value="0"></c:set>
                           
                           <c:set var="brandOilTotal" value="0"></c:set>
                           <c:set var="brandRiceTotal" value="0"></c:set>
                           <c:set var="brandsfdTotal" value="0"></c:set>
                           <c:set var="brandBeveragesTotal" value="0"></c:set>
                           <c:set var="brandAyustarTotal" value="0"></c:set>
                           <c:set var="brandOthersTotal" value="0"></c:set>
                           
                           <c:set var="brandOilYDayTotal" value="0"></c:set>
                           <c:set var="brandRiceYDayTotal" value="0"></c:set>
                           <c:set var="brandsfdYDayTotal" value="0"></c:set>
                           <c:set var="brandBeveragesYDayTotal" value="0"></c:set>
                           <c:set var="brandAyustarYDayTotal" value="0"></c:set>
                           <c:set var="brandOthersYDayTotal" value="0"></c:set>
                           
                             <c:forEach var="warehousereport" items="${warehousereport.reportsList}" varStatus="thecount">
                          	 <tr>
                                 <td>${thecount.index+index}
                                 </td>
                                 <td class="graph" id="locationDSR${thecount.index+index}">${warehousereport.store_location}</td> 
                                  <td>${warehousereport.totalPrice}</td> 
                                   <td>${warehousereport.totalPrice_yesterday}</td> 
                                    <td>${warehousereport.totalBillsCount}</td> 
                                     <td>${warehousereport.totalBillsCount_yesterday}</td> 
                                      <td>${warehousereport.cat_foodTotal}</td> 
                                       <td>${warehousereport.cat_nonFoodTotal}</td> 
                                       <td>${warehousereport.cat_gm}</td> 
                                       <td>${warehousereport.cat_staples}</td>
                                       <td>${warehousereport.cat_othersTotal}</td> 
                                       <td>${warehousereport.cat_foodTotal_yesterday}</td>
                                       <td>${warehousereport.cat_nonFoodTotal_yesterday}</td> 
                                       <td>${warehousereport.cat_gm_yesterday}</td>
                                       <td>${warehousereport.cat_staples_yesterday}</td> 
                                       <td>${warehousereport.cat_othersTotal_yesterday}</td>
                                       <td>${warehousereport.brand_oilTotal}</td> 
                                       <td>${warehousereport.brand_riceTotal}</td>
                                       <td>${warehousereport.brand_sfd}</td>
                                       <td>${warehousereport.brand_beveragesTotal}</td> 
                                       <td>${warehousereport.brand_ayustarTotal}</td>
                                       <td>${warehousereport.brand_othersTotal}</td>
                                       <td>${warehousereport.brand_oilTotal_yesterday}</td> 
                                       <td>${warehousereport.brand_riceTotal_yesterday}</td>
                                       <td>${warehousereport.brand_sfd_yesterday}</td>
                                       <td>${warehousereport.brand_beveragesTotal_yesterday}</td> 
                                       <td>${warehousereport.brand_ayustarTotal_yesterday}</td>
                                       <td>${warehousereport.brand_othersTotal_yesterday}</td>
                                       
                                       <c:set var="catFoodTotal" value="${warehousereport.cat_foodTotal+catFoodTotal}"></c:set>
                                       <c:set var="catNonFoodTotal" value="${warehousereport.cat_nonFoodTotal+catNonFoodTotal}"></c:set>
                                       <c:set var="catGMTotal" value="${warehousereport.cat_gm+catGMTotal}"></c:set>
                                       <c:set var="catStaplesTotal" value="${warehousereport.cat_staples+catStaplesTotal}"></c:set>
                                       <c:set var="catOthersTotal" value="${warehousereport.cat_othersTotal+catOthersTotal}"></c:set>
                                        
                                       <c:set var="catFoodYDayTotal" value="${warehousereport.cat_foodTotal_yesterday+catFoodYDayTotal}"></c:set>
                                       <c:set var="catNonFoodYDayTotal" value="${warehousereport.cat_nonFoodTotal_yesterday+catNonFoodYDayTotal}"></c:set>
                                       <c:set var="catGMYDayTotal" value="${warehousereport.cat_gm_yesterday+catGMYDayTotal}"></c:set>
                                       <c:set var="catStaplesYDayTotal" value="${warehousereport.cat_staples_yesterday+catStaplesYDayTotal}"></c:set>
                                       <c:set var="catOthersYDayTotal" value="${warehousereport.cat_othersTotal_yesterday+catOthersYDayTotal}"></c:set>
                                        
                                        <c:set var="brandOilTotal" value="${warehousereport.brand_oilTotal+brandOilTotal}"></c:set>
                                       <c:set var="brandRiceTotal" value="${warehousereport.brand_riceTotal+brandRiceTotal}"></c:set>
                                       <c:set var="brandsfdTotal" value="${warehousereport.brand_sfd+brandsfdTotal}"></c:set>
                                       <c:set var="brandBeveragesTotal" value="${warehousereport.brand_beveragesTotal+brandBeveragesTotal}"></c:set>
                                       <c:set var="brandAyustarTotal" value="${warehousereport.brand_ayustarTotal+brandAyustarTotal}"></c:set>
                                       <c:set var="brandOthersTotal" value="${warehousereport.brand_othersTotal+brandOthersTotal}"></c:set>
                                        
                                       <c:set var="brandOilYDayTotal" value="${warehousereport.brand_oilTotal_yesterday+brandOilYDayTotal}"></c:set>
                                       <c:set var="brandRiceYDayTotal" value="${warehousereport.brand_riceTotal_yesterday+brandRiceYDayTotal}"></c:set>
                                       <c:set var="brandsfdYDayTotal" value="${warehousereport.brand_sfd_yesterday+brandsfdYDayTotal}"></c:set>
                                       <c:set var="brandBeveragesYDayTotal" value="${warehousereport.brand_beveragesTotal_yesterday+brandBeveragesYDayTotal}"></c:set>
                                       <c:set var="brandAyustarYDayTotal" value="${warehousereport.brand_ayustarTotal_yesterday+brandAyustarYDayTotal}"></c:set>
                                       <c:set var="brandOthersYDayTotal" value="${warehousereport.brand_othersTotal_yesterday+brandOthersYDayTotal}"></c:set>
                               ...
                               <td></td>
                                <td></td>
                                 <td></td>
                             		...
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${catFoodTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${catNonFoodTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${catGMTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${catStaplesTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${catOthersTotal}</div></td>
                             		
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${catFoodYDayTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${catNonFoodYDayTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${catGMYDayTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${catStaplesYDayTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${catOthersYDayTotal}</div></td>
                             		
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandOilTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandRiceTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandsfdTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandBeveragesTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandAyustarTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandOthersTotal}</div></td>
                             		
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandOilYDayTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandRiceYDayTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandsfdYDayTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandBeveragesYDayTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandAyustarYDayTotal}</div></td>
                             		<td style="padding:3px;width: 160px;"><div id="" style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${brandOthersYDayTotal}</div></td>
