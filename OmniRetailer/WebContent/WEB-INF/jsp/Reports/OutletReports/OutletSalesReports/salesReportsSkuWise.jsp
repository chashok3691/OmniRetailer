...
<div id="gensalereportcriteriawise">
				<section class="content-header">
                    <h1>
                      ...
                      &nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;<spring:message code="sku.wise.label"/>&nbsp;<spring:message code="report.label"/>
                    </h1>
                   <%--  <ol class="breadcrumb">
   ...
   <div class="modal fade" id="myModalIos" role="dialog" tabindex="-1">
    <div class="modal-dialog iosmodeldialog">
      ...
      <div class="modal-content iospopup">
        ...
        <div class="modal-body">
       <div class="form-group col-lg-12" style="padding: 0px;font-size: 15px;width:115%">Are you sure,you want to save the  file
        ...
        <div class="modal-footer" style="padding:0px;">
		 ...
		 <input type="hidden" id="criteria" value="${criteria}">
          <div id="xReportsDisplay" style="">
            <%@ include file="viewSkuReport.jsp" %>
