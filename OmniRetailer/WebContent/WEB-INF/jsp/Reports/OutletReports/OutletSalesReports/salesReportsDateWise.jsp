 ...
 * Written By		        : Mythri.S
 * file name		        : Inventory Manager/Reports/salesReportsDateWise.jsp
 * file type		        : JSP
...
<div id="gensalereportcriteriawise">
				<section class="content-header">
                    <h1>
                      ...
                      &nbsp;<spring:message code="sales.reports.label"/>&nbsp;&#45;&nbsp;<spring:message code="date.wise.label"/>&nbsp;<spring:message code="report.label"/>
                    </h1>
     ...
     <!--     </div>
		 ...
		 <input type="hidden" id="criteria" value="${criteria}">
          <div id="xReportsDisplay" style="">
            <%@ include file="viewSalesReport.jsp" %>
          </div>
      </div>
    </div>
  </div>
