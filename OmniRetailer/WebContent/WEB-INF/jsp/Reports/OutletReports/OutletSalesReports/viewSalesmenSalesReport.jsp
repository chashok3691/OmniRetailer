...
$(document).ready(function(){
	...
	$('#mySearch').click(function(){
        ...
        return viewNewSalesmanCommission('outletSalesmanCommission','0','','${flowLocation}');
    })
	...
	callCalender('startDateSalesmen');
	callCalender('endDateSalesmen');
...
<div class="row">
  ...
  <div class="box box-primary">
      <div class="box-header" align="center" id="focusHead">
		<h3 class="box-title" >
         ...
         <div class="col-lg-11" style=" background: #f4f4f4;    padding: 10px 20px; width: 88%;">
              ...
              <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                	 	...
                	 	<input class="form-control calendar_icon form-group" readonly="readonly" value="${startdate}" style="background-color: white;" id="startDateSalesmen" size="20" type="text" onfocus="callCalender('startDateSalesmen')" onclick="callCalender('startDateSalesmen')" placeholder="DD/MM/YYYY" />
	              </div>
	            </div>
                        <div class="col-lg1-2 col-lg-2">
                   <%--     <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
...
<%-- 									<option value="${location}" ${location == loc ? 'selected' : ''} id="${location}" >${location}</option> --%>
	               ...
	               <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
	                   <label><spring:message code="offer_end_date.label"/></label>
	                 	<input class="form-control calendar_icon form-group" readonly="readonly" value="${enddate}" style="background-color: white;" id="endDateSalesmen" size="20" type="text" onfocus="callCalender('endDateSalesmen')" onclick="callCalender('endDateSalesmen')" placeholder="DD/MM/YYYY" />
		           </div>
		          </div>
                     <div class="col-lg1-2 col-lg-2">
                   <%--     <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
...
<%--                        <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                  ...
                  <div class="row">
                  <a onclick="searchNewSalesmanCommission('outletSalesmenSalesCommission','0','','NOPOP','${flowLocation}');" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
          ...
          <div class="form-group col-lg-8 col-sm-6 col-xs-6" style="padding-left: 0px; padding-right: 0px;margin-left:50px">
												<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px; display: inline-block; padding: 4px 10px 28px 10px; background: #3c8dbc; cursor: pointer; margin-top: 19.5px; height: 25px; text-align: center; margin-bottom: 19px; width: 45%; margin-left: -30px;">
													<input type="button" class="iosclosebutton1"
														onclick="searchNewSalesmanCommission('outletSalesmenSalesCommission','0','','','${flowLocation}');"
														value="OK">
												</div>
   ...
   <br/>
	 ...
	 <div>
				                 ...
				                 <div class="col-lg-1" style="margin-top:-18px" id="focusMax" >
				                       <label>Show</label> 
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewNewSalesmanCommission('outletSalesmenSalesCommission','0','','${flowLocation}');">
				                  ...
				                  <%--    <div class="wrapper">
	        	 		 <input type="text"  class="form-control" style="" value="${searchSaleCommissionItems}" id="searchSaleCommissionItems" placeholder="<spring:message code="search.salesman.label" />" />
						...
						<button id="mySearch" class="searchbutton"></button>
							...
							<input type="hidden" id="skuwise" value="${searchName}"></div> --%>
				                ...
				                <div class="col-lg-1" style="text-align: center;padding-left: 0px;">
               ...
               <input type="hidden" id="stockdownloadurl" value="${downloadurl}">
                     ...
                     <table id="commissionSales" class="table table-bordered table-striped">
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                             ...
                             <th><spring:message code="salesmen.id.label" /></th>
                              <th><spring:message code="salesmen.name.label" /></th>
                            ...
                            <%--    <th><spring:message code="shift.id.label"/></th> --%>
                              ...
                              <th ><spring:message code="sale.value.label" /></th>
                              <th><spring:message code="mrp.label" /></th>
                              <th ><spring:message code="discount.label" /></th>
                              <th><spring:message code="date.label"/></th>
                              <th><spring:message code="billing_counter.label"/></th>
                             </tr>
                        
                         </thead>
                         <tbody style="text-align: center;">
                            <c:forEach var="saleCommissionDetails" items="${salesReportList}" varStatus="theCount">
                         	 <tr>
                         	  <td>${theCount.count+index-1}</td>
                         	  <td>${saleCommissionDetails.store_location}</td>
                         	  
                         	  <td>${saleCommissionDetails.cashierId}</td>
                         	  <td>${saleCommissionDetails.cashierName}</td>
                         	  
                         	  <td>${saleCommissionDetails.billRef}</td>
                         	  <td>${saleCommissionDetails.serailBillIdYearly}</td>
                         	   <td>${saleCommissionDetails.status}</td>
                         	  <td>${saleCommissionDetails.skuId}</td>
                         	  <td>${saleCommissionDetails.style}</td>
                         	  <td>${saleCommissionDetails.department}</td>
                         	  <td>${saleCommissionDetails.brand}</td>
                         	  
                         	 <%--    <td>${saleCommissionDetails.hour}</td> --%>
                         	
                         	 <td>${saleCommissionDetails.quantity}</td>
                         	 <td>${saleCommissionDetails.totalCost}</td>
                         	 <td>${saleCommissionDetails.mrp}</td> 
                         	 <td>${saleCommissionDetails.discount}</td>           
                         	 <td>${saleCommissionDetails.date}</td>
                         	 <td>${saleCommissionDetails.counterId}</td>
                             </tr>
...
<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px;">
 <input type="button" class="iosclosebutton1"  onclick="viewNewSalesmanCommission('outletSalesmenSalesCommission','0','save','${flowLocation}');"  value="Ok">
</div>
<div class="col-lg-6 col-sm-6 col-xs-6" style="padding-left: 5px; padding-right: 5px;">
          ...
          <div class="row">
               ...
               <input type="hidden" id="totalnum" value="${totalRecords}">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewNewSalesmanCommission('outletSalesmenSalesCommission','${totalValue}','','${flowLocation}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;padding-left:35px">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewNewSalesmanCommission('outletSalesmenSalesCommission','${index - (maxRecords + 1)}','','${flowLocation}');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords-maxRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewNewSalesmanCommission('outletSalesmenSalesCommission',document.getElementById('pagination').value,'','${flowLocation}')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
