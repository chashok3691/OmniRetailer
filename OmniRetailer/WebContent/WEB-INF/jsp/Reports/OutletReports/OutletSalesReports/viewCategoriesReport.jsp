 ...
 * file name		        : Inventory Manager/Billing/viewCategoriesReport.jsp
 * file type		        : JSP
...
<div class="nav-tabs-custom">
 <ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#home" style="text-transform: capitalize;">Category Wise Report</a></li>
  ...
  <div class="">
                                <div class="box-body table-responsive">
				                    <div class="row">
				                     <input type="hidden" id="stockdownloadurl" value="${downloadurl}">
				                       <div class="col-lg-1">
				                       <label>Show</label> 
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="generateSalesReportCriteriaWise('category','','0','','${flowLocation}');">
		   ...
		   <input type="button" class="addBtn btn bg-olive btn-inline" onclick="generateSalesReportCriteriaWise('${criteria}','save','0','','${flowLocation}');" style="fontsize:16px;" value="<spring:message code="save.label" />" />
				                   ...
				                   <div style="overflow: auto;white-space: nowrap;">
                                    ...
                                    <table id="productstocks" class="condensed table table-bordered table-striped">
                                        ...
                                        <c:set var="dataExists" value="false"></c:set>
                                           ...
                                           <c:if test="${theCount.last}">
                                        	 ...
                                        	 <td>${theCount.count+index-1}</td>
                                            	...
                                            	<td>${salesReport.categoryName}</td>
                             ...
                             <td style="padding:3px;width: 160px;"><div style="white-space: nowrap;padding: 5px;background: #727272;"><font color="white"><spring:message code="totals.label" /></font></div></td>
                                                <td style="padding:3px;width: 160px;"><div  style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${categorySummery.totalQuantity}</div></td>
                                                <td style="padding:3px;width: 160px;"><div  style="white-space: nowrap;padding: 5px;background: #c1c1c1;">${categorySummery.totalPrice}</div></td>
                                           </tr>
                                          </c:if>
                                        </tbody>
                                    </table></div>
             <div class="row">
                  ...
                  <div id="menu1" class="tab-pane fade in ">
                              <h3 style="text-transform: capitalize;">Category Wise Graphical Report</h3>
                        <div class="row">
                        <div class="col-lg-12">
                ...
                <c:if test="${totalValue > 0}">
                 <input type="hidden" id="graphRecords" value="${maxRecords}"/>
             </c:if>
             </div>
             </div>
 ...
 <script src="${pageContext.request.contextPath}/js/plugins/datatables/jquery.dataTables.js" type="text/javascript"></script>
	 ...
	 var graphRecords;
		...
		var count=0;
			...
			$('#productstocks tbody tr td:nth-child(9)').each( function(){
		count++;
		if(count<=graphRecords)
