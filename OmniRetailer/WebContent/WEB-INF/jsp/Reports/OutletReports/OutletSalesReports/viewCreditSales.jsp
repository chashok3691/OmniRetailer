                                    ...
                                    <table id="productstocks" class="table table-bordered table-striped">
                                     <thead style="background-color: #3c8dbc; color: #ffffff">
                                            <tr>
                                                ...
                                                <th><spring:message code="due_amount.label" /></th>
                                            </tr>
                                        </thead>
                                        <tbody style="text-align: center;">
                                           <c:forEach var="salesReport" items="${billsList}" varStatus="theCount">
                                        	 <tr>
                                                <td>${salesReport.business_date}</td>
                                            	<td>${salesReport.billId}</td>
                                            	<td>${salesReport.serailBillIdYearly}</td>
                                                <td>${salesReport.counterId}</td>
                                                <td>${salesReport.phoneNumber}</td>
                                                <td>${salesReport.dueAmount}</td>
                                            </tr>
                                           </c:forEach>
                                        </tbody>
                                    </table>
         <%--     <div class="row">
           ...
           <%--             
              	...
              	<c:if test="${index-1 == 0 && totalRecords > maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="generateDueCollectionReport('${criteria}','','${index+maxRecords-1}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${index-1 != 0 &&  totalValue != totalRecords}">
              		<div class="form-group col-lg-2">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return generateDueCollectionReport('${criteria}','','${index - maxRecords-1}');"> ${index} - ${index+maxRecords-1} of ${totalRecords} .
              		<input type="button" class='paginationButton' value="&#62;" onclick="generateDueCollectionReport('${criteria}','','${index+maxRecords-1}')">
              	</div> 
              	</c:if>
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="generateDueCollectionReport('${criteria}','',document.getElementById('pagination').value)" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
              </div>   
