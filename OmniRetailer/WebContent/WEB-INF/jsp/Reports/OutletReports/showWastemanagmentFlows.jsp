                         ...
                         <br/>
                          <c:if test="${sessionScope.role == 'super admin'}">
                          	...
                          	<div class="col-lg-2 form-group" style="text-align: right;">
		                          	 <div style="text-align: center;width: 140px;height: 130px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="viewOutletDumpReport('outletDumpReport','0');" title="<spring:message code="dump.report.label" />">
		                          			<img src="${pageContext.request.contextPath}/images/garbage.png" style="margin-top: 10px;"><br><br>
		                          			<span><spring:message code="dump.report.label" /></span>
		                              </div>
	                          	 </div>
