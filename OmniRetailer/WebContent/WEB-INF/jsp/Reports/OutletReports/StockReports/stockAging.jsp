  ...
  <div class="box box-primary">
      <div class="box-header" align="center">
		<h2 class="box-title" style="font-size: 20px;" >
			<spring:message code="stockaging.label" />
		</h2>
		</div>
             <div class="box-body table-responsive">
              ...
              <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                  ...
                  <div class="row">
                  <a onclick="viewoutletstockAging('outletstockAging','0','outlet','menu');" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                  <div class="row">
                 ...
                 <div class="col-lg-1 col-xs-2">
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewoutletstockAging('outletstockAging','0','outlet','menu');">
           ...
           <div class="col-lg-2" style="float:right;padding-right:15px;margin-top:0px;padding-left:0px;width: 12%;">
            <input type="button" class="btn bg-olive btn-inline  addBtn" onclick="viewoutletstockAging('outletstockAging','0','outlet','save');" value="Save">
      ...
      <div id="example1_wrapper" class="table table-bordered table-striped" role="grid" style="overflow-x: auto;width:100%;position: relative;white-space: nowrap;">
                      ...
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                        ...
                        <th style="text-align: left;"><spring:message code="subcategory.label" /></th>
                         ...
                         <th><div><spring:message code="batchNo.label" /></div></th>
                               ...
                               <th><spring:message code="stockAging.expiredQty" /></th>
                                  <th><spring:message code="stockAging.unsoldQty" /></th>
                                 <th><spring:message code="stockAging.receiptQty" /></th>
                               <th><spring:message code="brand.label" /></th> 
                               <th><spring:message code="receiptDate.label" /></th>
                             <th><spring:message code="noofDays.label" /></th> 
                            	<th><spring:message code="soldvalue.label" /></th>
                           <th><spring:message code="unsoldvalue.label" /></th>
                            ...
                            <c:forEach var="stockDetails" items="${report}" varStatus="thecount">
                         	 <tr>
                                ...
                                <td>${stockDetails.department}</td>
                             	<td></td>
                             	<td></td>
                             	<td>${stockDetails.unSoldQty}</td>
                            	<td>${stockDetails.receivedAmt}</td>
                                <td>${stockDetails.brand}</td>
                                <td></td>
                              	<td></td>
                               	<td>${stockDetails.soldValue}</td>
                               	<td>${stockDetails.unSoldValue}</td>
              ...
              <div class="row">
              	<c:if test="${index-1 == 0 && totalRecords >10}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewoutletstockAging('outletstockaging','${totalValue}','outlet','menu');">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-10 >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewoutletstockAging('outletstockaging','${index - 11}','outlet','menu');"> ${index} - ${totalValue} of ${totalRecords} 
...
<div class="col-lg-6" style="float:right;">
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewoutletstockAging('outletstockAging',document.getElementById('pagination').value,'outlet','menu')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
