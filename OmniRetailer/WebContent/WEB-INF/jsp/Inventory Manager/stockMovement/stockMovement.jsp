 ...
 * Written By		        : Sahitya
 * file name		        : inventorymanager/Material Consumption/materialconsumption.jsp
 * file type		        : JSP
  ...
  <div class="box box-primary">
      <div class="box-header" align="center">
		<h2 class="box-title" style="font-size: 20px;" >
			<spring:message code="stockmovement.label" />
             ...
             <div class="box-body table-responsive">
              ...
              <div class="col-lg-12" style="padding-left:0px;padding-right: 0px;">
                  ...
                  <div class="row">
                  <a onclick="viewoutletstockMovement('outletstockMovement','0','outlet','menu');" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                  <div class="row">
                  <a onclick="viewoutletstockMovement('outletstockMovement','0','outlet','clear');" class="button"><spring:message code="clearbutton.label"/></a>
                  </div>
                  </div></div>
                    <div class="row">
                 ...
                 <%--    <label><spring:message code="startprice.label"/></label> --%>
                  ...
                  <div class="col-lg-12">
                    <div class="col-lg-1 col-xs-2">
				                      	<select class="form-control" id="maxRecords" style="margin-top: 10px" onchange="viewoutletstockMovement('outletstockMovement','0','outlet','menu')">
           ...
           <div class="col-lg-2" style="float:right;padding-right:0px;margin-top:10px;padding-left:5px;">
            <input type="button" class="btn bg-olive btn-inline  addBtn" onclick="viewoutletstockMovement('outletstockMovement','0','outlet','save');" value="Save" >
            <input type="hidden" id="stockdownloadurl" value="${url}">                         
                     ...
                     <table id="productstocks" class="table table-bordered table-striped">
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                             <tr>
                                ...
                                <th><div ><spring:message code="itemdesc.label" /></div></th>
                                <th><spring:message code="open.qty" /></th>
                                <th><spring:message code="clse.qty" /></th>
                               	<th><spring:message code="inward.qty" /></th>
                               	<th><spring:message code="sale.qty" /></th>
                               	<th><spring:message code="sale.value" /></th>
                               	<th><spring:message code="write.off" /></th>
                             </tr>
                         </thead>
                         <tbody style="text-align: center;">
                            <c:forEach var="stockDetails" items="${bomreports}" varStatus="thecount">
                         	 <tr>
                                ...
                                <td>${stockDetails.itemDescription}</td>
                                <td>${stockDetails.openQty}</td>
                                <td>${stockDetails.closeQty}</td>
                                <td>${stockDetails.inwardQty}</td>
                                <td>${stockDetails.saleQty}</td>
                                  <td>${stockDetails.saleValue}</td>
                                <td>${stockDetails.writeOffQty}</td>
                             </tr>
              ...
              <div class="row">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewoutletstockMovement('outletstockMovement','${totalValue}','outlet','menu');">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewoutletstockMovement('outletstockMovement','${index - (maxRecords + 1)}','outlet','menu');"> ${index} - ${totalValue} of ${totalRecords} 
...
<div class="col-lg-6" style="float:right;">
              	...
              	<c:if test="${(totalRecords-maxRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewoutletstockMovement('outletstockMovement',document.getElementById('pagination').value,'outlet','menu')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
