	            	...
	            	<div class=" col-md-12">
	            		 <div class="row">
		                   ...
		                   <div class="form-group col-md-4">
		                    ...
		                    <input type="text" onblur="criteria(this)" class="form-control"  readonly="readonly" id="deptName" value="${department.primaryDepartment}" placeholder="<spring:message code="enter.department.name.label" />" />
						   ...
						   <div class="form-group col-md-7">
		                    ...
		                    <input type="text" onblur="criteria(this)" class="form-control"  id="deptDesc" value="${department.departmentDescription}" placeholder="<spring:message code="enter.department.description.label" />" />
 ...
 --%>							   		<img style="cursor: pointer;width: 23px;" id="img1" onclick="deleteSubDepartment(this);" alt="" src="${pageContext.request.contextPath}/images/deleteIcon.png">
		...
		<div class="row">
       	  <div class="col-lg-12" style="text-align: center;">
           	<div class="buttons">
           	<input type="button" style="" class="btnCls" onclick="validateDepartment('edit');" value="<spring:message code="submit.label" />" />
       		 <%-- <a onclick="validateDepartment('edit');" class="button"><font size="2px">&nbsp;&nbsp;&nbsp;<spring:message code="submit.label" />&nbsp;&nbsp;&nbsp;</font></a> --%>
