 ...
 * file name		        : Inventory Manager/master/editOrganizationDepartment.jsp
 * file type		        : JSP
 * description				: The edit Organization form is displayed using this jsp.
 * Reviewed by              : Surya
 * */ -->
...
<meta charset="UTF-8">
	...
	<script src="${pageContext.request.contextPath}/js/masterDataManagement/genericMasters/organizationdepartmentMaster.js"></script>
	<style type="text/css">
	.col-xs-12 {
	 padding: 2% 25%;
	 } 
	            	...
	            	<div class=" col-md-12"> 
	            		 <div class="row">
		                   <div class="form-group col-md-4">
		                    ...
		                    <input type="text"  onblur="criteria(this)" class="form-control"  id="orgdeptId" value="${orgdepartment.deptId}" placeholder="<spring:message code="enter.organizationdepartment.id.label" />" readonly/>
						   ...
						   <div class="form-group col-md-4">
		                    ...
		                    <input type="text"  onblur="criteria(this)" class="form-control"  id="orgdeptName" value="${orgdepartment.deptName}" placeholder="<spring:message code="enter.organizationdepartment.name.label" />" />
						 ...
						 <div class="row">
		                   <div class="form-group col-md-4">
		                    ...
		                    <input type="text"  onblur="criteria(this)" class="form-control"  id="orgdeptDescription" value="${orgdepartment.deptDescription}" placeholder="<spring:message code="enter.organizationdepartment.description.label" />" />
						   ...
						   <div class="form-group col-md-4">
		                    ...
		                    <input type="text"  onblur="criteria(this)" class="form-control"  id="orgdeptParent" value="${orgdepartment.parentDept}" placeholder="<spring:message code="enter.organizationdepartment.parentdepartment.label" />" />
						 ...
						 <div class="row">	
		                   <div class="form-group col-md-4">
		                    ...
		                    <input type="email" class="form-control"  id="orgdeptEmail" value="${orgdepartment.deptEmail}" placeholder="<spring:message code="enter.organizationdepartment.email.label" />" />
       	  ...
       	  <div class="col-lg-12" style="text-align: center;">
           	<div class="buttons">
       		 	  <input type="button" class="btnCls buttonMargin" onclick="return viewOrganizationDepartmentMaster('organizationdepartmentMaster','0');" value="<spring:message code="cancel.label" />" />
       		 		...
       		 		<input type="button" style="" class="btnCls" onclick="validateOrganizationDepartment('edit');" value="<spring:message code="submit.label" />" />
       		 </div>
       		 </div>
         	</div>
        </div>
