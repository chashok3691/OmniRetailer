...
<div class="box box-primary">
      <div class="box-header" align="center">
               ...
               <h3  class="box-title" style="border:1px solid #3d3838;;font-weight: bold;padding:5px">Fleet Master - New</h3>
           </div>
        <div id="Error" class="Error" style="text-align: center;color: red;font-size: 2;font-weight: bold;margin-bottom: 10px; margin-top: -10px">${err}</div>
          ...
          <button class="btn btn-primary" style="float: right;" value="submit" onclick="validateFleetMaster('new');">Submit</button>
          </div>
          <div class="col-lg-2 col-xs-4">
		...
		<div class="box-body table-responsive">
          <div class="row">
              ...
              <div class="col-lg1-3 col-lg-3" >
               ...
               <input type="text" id="transporterId" name="transporterId" class="form-control" style="width:75%">
               ...
               <input type="text" id="transporterName" name="transporterName"  class="form-control" style="width:75%">
               ...
               <input type="text" id="gstNo" name="gstNo" class="form-control" onblur="validateGSTIN();" style="width:75%">
...
<div class="col-lg1-12 col-lg-12" style="margin-bottom: 10px;">
               ...
               <input type="number" id="phoneNo" name="phoneNo" class="form-control" style="width:75%">
...
<div class="col-lg1-12 col-lg-12" style="margin-bottom: 10px;">
               ...
               <input type="email" id="emailId" name="emailId" class="form-control" style="width:75%">
...
<div class="col-lg1-12 col-lg-12" style="margin-bottom: 10px;">
               ...
               <input type="text" id="panNumber" name="panNumber" class="form-control" style="width:75%">
...
<div class="col-lg1-12 col-lg-12" style="margin-bottom: 10px;">
               ...
               <input type="text" id="plotNo" class="form-control" style="width:75%">
...
<div class="col-lg1-12 col-lg-12" style="margin-bottom: 10px;">
               ...
               <input type="text" id="streetName" name="streetName" class="form-control" style="width:75%">
...
<div class="col-lg1-12 col-lg-12" style="margin-bottom: 10px;">
             ...
             <!--  <input type="text" id="loct" class="form-control" style="width:75%"> -->
                <select class="form-control" id="fleetLocation" id="fleetLocation" style="width:75%">
...
<div class="col-lg1-12 col-lg-12" style="margin-bottom: 10px;">
               ...
               <input type="text" id="city" name="city" class="form-control" style="width:75%">
			...
			<div class="col-lg1-12 col-lg-12" style="margin-bottom: 10px;">
               ...
               <input type="number" id="zipCode" name="zipCode" class="form-control" style="width:75%">
                      ...
                      <div class="table-responsive" style="padding-left: 15px !important;">
                                        ...
                                        <tbody style="text-align: center;">
                                            <c:forEach var="AddList" items="" varStatus="theCount">
                                            	<tr id="dynamicdiv${theCount.index+1}">
                                          	    ...
                                          	    <td id="vehicleNo${theCount.index+1}">${AddList.addressType}</td>
                                          	    <td id="vehicleDescription${theCount.index+1}">${AddList.plotNo}</td>
                                                <td id="vehicleType${theCount.index+1}">${AddList.streetName}</td>
                                                <td id="carryCapacity${theCount.index+1}">${AddList.location}</td>
                                                <input type="hidden" id="dateofPurchase${theCount.index+1}" value="${AddList.dateofPurchase}"/>
                                                <input type="hidden" id="vehicleOwner${theCount.index+1}" value="${AddList.vehicleOwner}"/>
                                                <input type="hidden" id="typeWO${theCount.index+1}" value="${AddList.typeWO}"/>
							        	...
							        	<c:otherwise>
							       	 	<td id="status${theCount.index+1}">InActive</td>
                                                ...
                                                <td id="status${theCount.index+1}">${AddList.city}</td>
