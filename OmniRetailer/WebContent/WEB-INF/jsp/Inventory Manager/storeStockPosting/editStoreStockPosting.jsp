...
$('#StockPosting').click(function(){
        ...
        return viewStoreStockPostingData('','0','${flowUnder}','${uploadReferenceId}','edit');
    })
   ...
   <%-- <div class="col-lg-1 col-xs-2">
                       ...
                       <%-- <div class="form-group col-lg-12" style="text-align:center;margin-bottom: 0.0%;margin-top: 2%;">
                                         <input type="hidden" id="desc"/>
											...
											<div class="services">
								    			<div class="items">
								     				<ul class="matchedStringUl stockUploading" style=""></ul>
								   				</div>
											</div>
  										 </div>  --%>
                     ...
                     <table id="StockUploadingList" class="table table-bordered table-striped" style="    margin-top: 1px !important;">
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                         ...
                         <tr id="dynamicdiv${theCount.count}">  
                           ...
                           <td id="stockqty${theCount.count}" contenteditable="true" onblur="addclassslNo('${theCount.count}')">${item.sku_physical_stock}</td>
         				   <td id="dumpqty${theCount.count}" contenteditable="true" onblur="addclassslNo('${theCount.count}')">${item.dumpQty}</td>
         ...
         <input type="hidden" id="verefcode" value="${StockPostingList[0].verification_code}">
		...
		<div class="row" style="margin-top: 10px;">
              	<c:if test="${index-1 == 0 && totalRecords >10}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewStoreStockPostingData('','${totalValue}','${flowUnder}','${StockPostingList[0].verification_code}','edit');">
              	</div>                                                                   
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-10 >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewStoreStockPostingData('','${index - 11}','${flowUnder}','${StockPostingList[0].verification_code}','edit');"> ${index} - ${totalValue} of ${totalRecords} 
              	...
              	<c:if test="${(totalRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewStoreStockPostingData('',document.getElementById('pagination').value,'${flowUnder}','${StockPostingList[0].verification_code}','edit');" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
				</div>
	...
	<%-- <div class="row" style="text-align: center;margin-top:50px">
						 <input type="button" class="btnCls" style=" " onclick="updateStoreStockUploading('update')" value="<spring:message code="submit.label" />" />
