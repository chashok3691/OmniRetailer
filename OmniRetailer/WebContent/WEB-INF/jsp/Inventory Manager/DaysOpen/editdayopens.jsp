 ...
 * Written By		        : Mythri
 * file name		        : Inventory Manager/DaysOpen/editdayopen.jsp
 * file type		        : JSP
    ...
    height: 15px;" checked id="mondayChkbox"><label><spring:message code="import.Select_Week_Days.Mon.label" /></label>&nbsp;	
                                 ...
                                 <div class=" form-group col-lg-11">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="mondayStartTime" value="${outletDayOpenresponse.monStartTimeStr}"/>
                               ...
                               <div class="address-group col-lg-11 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                  <input type="text" class="form-control timepicker" name="start_time" id="mondayEndTime" value="${outletDayOpenresponse.monEndTimeStr}"/>
    ...
    height: 15px;" checked id="tuesdayChkbox"><label><spring:message code="import.Select_Week_Days.Tue.label" /></label>&nbsp;	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-11 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="tuesdayStartTime" value="${outletDayOpenresponse.tueStartTimeStr}"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-11 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" class="form-control timepicker" name="start_time" id="tuesdayEndTime" value="${outletDayOpenresponse.tueEndTimeStr}"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
    ...
    height: 15px;" checked id="wednesdayChkbox"><label><spring:message code="import.Select_Week_Days.Wed.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-11 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                  <input type="text" class="form-control timepicker" name="start_time" id="wednesdayStartTime" value="${outletDayOpenresponse.wedStartTimeStr}"/>
                                               <!--  <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-11 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="wednesdayEndTime" value="${outletDayOpenresponse.wedEndTimeStr}"/>
                                              <!--   <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
    ...
    height: 15px;" ><spring:message code="import.Select_Week_Days.Thu.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-12 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" class="form-control timepicker" name="start_time" id="thursdayStartTime" value="${outletDayOpenresponse.thuStartTimeStr}"/>
                                               <!--  <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-11 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                               <input type="text" class="form-control timepicker" name="start_time" id="thursdayEndTime" value="${outletDayOpenresponse.thuEndTimeStr}"/>
    ...
    height: 15px;"  ><spring:message code="import.Select_Week_Days.Fri.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-11 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" class="form-control timepicker" name="start_time" id="fridayStartTime" value="${outletDayOpenresponse.friStartTimeStr}"/>
                                               <!--  <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-11 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="fridayEndTime" value="${outletDayOpenresponse.friEndTimeStr}"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
    ...
    height: 15px;" checked id="saturdayChkbox"><label><spring:message code="import.Select_Week_Days.Sat.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-11 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                  <input type="text" class="form-control timepicker" name="start_time" id="saturdayStartTime" value="${outletDayOpenresponse.satStartTimeStr}"/>
                                              <!--   <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-11 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" style="" class="form-control timepicker" name="start_time" id="saturdayEndTime" value="${outletDayOpenresponse.satEndTimeStr}"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
...
<div class="row" id="no-more-tables">
  ...
  <div class="table-responsive col-lg-12" id="data" style="margin-left:13.9px;">
                   <div class="col-lg-12">
                    <table border="1"  id="businessTable" style="width:98%;text-align:center;margin-top:-11px;" class="tablepr table table-bordered table-hover">
   ...
   <br>	<br><br><br>
		...
		<br>
       	  ...
       	  <br><br>
           	<div class="buttons">
       		 <a onclick="validateDayOpenForm('edit');" class="btnCls"><font >&nbsp;&nbsp;&nbsp;<spring:message code="submit.label" />&nbsp;&nbsp;&nbsp;</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
