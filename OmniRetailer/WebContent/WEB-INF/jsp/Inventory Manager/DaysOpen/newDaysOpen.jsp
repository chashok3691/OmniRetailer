 ...
 * Written By		        : Manasa
 * file name		        : Inventory Manager/DaysOpen/newDaysOpen.jsp
 * file type		        : JSP
 * description				: The new dayOpen is displayed using this jsp
 * */ -->
				  ...
				  <div class="form-group col-lg-2" >
                                 ...
                                 <select class="form-control" name="location" id="outletLocation" onchange="return changeInfoBasedOnLocation(this.options[this.selectedIndex].value);" >
                                   <c:forEach var="location" items="${workLocationsList}"> 
									 <option value="${location}" ${location == outletDayopen.outletLocation ? 'selected' : ''}>${location}</option>
								  </c:forEach>
							    </select>
		                                 </div> 
                               ...
                               <div class="address-group col-lg-11 col-xs-9 " style="margin-left:20px;white-space:nowrap;">
                                          ...
                                          <div class="form-group col-lg-12" style="padding-left:0px;">
                                             ...
                                             <c:forEach var="counter" items="${counterDetails}">
												<%-- <option value="${location}">${location}</option> --%>
												 <option value="${counter}" ${counter == outletDayopen.businessCounter ? 'selected' : ''}>${counter}</option>
											</c:forEach>
                                           </select>
    ...
    height: 15px;" checked id="mondayChkbox"><label><spring:message code="import.Select_Week_Days.Mon.label" /></label>&nbsp;	
                                 ...
                                 <div class=" form-group col-lg-10">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="mondayStartTime" value="${outletDayopen.monStartTimeStr}"/>
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                  <input type="text" class="form-control timepicker" name="start_time" id="mondayEndTime" value="${outletDayopen.monEndTimeStr}" />
    ...
    height: 15px;" checked id="tuesdayChkbox"><label><spring:message code="import.Select_Week_Days.Tue.label" /></label>&nbsp;	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="tuesdayStartTime" value="${outletDayopen.tueStartTimeStr}"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" class="form-control timepicker" name="start_time" id="tuesdayEndTime" value="${outletDayopen.tueEndTimeStr}"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
    ...
    height: 15px;" checked id="wednesdayChkbox"><label><spring:message code="import.Select_Week_Days.Wed.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="bootstrap-timepicker">
                                            <div class="input-group">                                            
                                                  <input type="text" class="form-control timepicker" name="start_time" id="wednesdayStartTime" value="${outletDayopen.wedStartTimeStr}"/>
                                            </div>
                                        </div>
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="wednesdayEndTime" value="${outletDayopen.wedEndTimeStr}"/>
                                              <!--   <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
    ...
    height: 15px;"  ><spring:message code="import.Select_Week_Days.Thu.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" class="form-control timepicker" name="start_time" id="thuStartTime" value="${outletDayopen.thuStartTimeStr}"/>
                                               <!--  <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                               <input type="text" class="form-control timepicker" name="start_time" id="thursdayEndTime" value="${outletDayopen.thuEndTimeStr}"/>
    ...
    height: 15px;" ><spring:message code="import.Select_Week_Days.Fri.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="fridayStartTime" value="${outletDayopen.friStartTimeStr}"/>
                                               <!--  <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                               <input type="text" class="form-control timepicker" name="start_time" id="fridayEndTime" value="${outletDayopen.friEndTimeStr}"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
    ...
    height: 15px;" checked id="saturdayChkbox"><label><spring:message code="import.Select_Week_Days.Sat.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                  <input type="text" class="form-control timepicker" name="start_time" id="saturdayStartTime"  value="${outletDayopen.satStartTimeStr}"/>
                                              <!--   <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" style="" class="form-control timepicker" name="start_time" id="saturdayEndTime" value="${outletDayopen.satEndTimeStr}"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
...
<div class="form-group col-lg-10">
 ...
 <input type="text" style="margin-left: 1pc;width: 100%;padding: 4px;" class=""  value="" id="businessDetails">
                                            <%-- 
 ...
 <div class="col-lg-2 col-sm-4 col-xs-2">
                 <a class="addButton">
                           ...
                           <input type="button" style="margin-left: -9px;padding: 5px;" class="btn bg-olive btn-inline addBtn" aria-hidden="true" id="addBusinessClass" onclick="addBusinessDetails();" value="<spring:message code="addnew.label" />">
                   </a>          
                   </div>
</div>
  ...
  <div class="table-responsive col-lg-12" id="data" style="margin-left:14px;">
                   <div class="col-lg-12">
                    <table border="1"  id="businessTable" style="width:94.99%;margin-top:-11px;" class="tablepr table table-bordered table-hover">
                      ...
                      <tbody  style="text-align: center;">
             		   	...
             		   	<c:forEach var="item" items="${outletDayopen.dayOpenChilds}" varStatus="theCount">
		             		   ...
		             		   <td><textarea id="businessTask${theCount.count}" onblur="criteria(this)" rows=1 style='resize:none;width: 100px;'>${item.businessTask}</textarea></td>
			              	   <%-- <td id="businessTask${theCount.count}">${item.businessTask}</td> --%>
			                   <td >
			                   <select  style='width:100px;height:25px;text-align:center' id="sequenceorder${theCount.count}"><option value="1" ${item.sequenceOrder == '1' ? 'selected' : ''}>1</option>
   ...
   <br>	<br><br><br>
		...
		<br>
       	  ...
       	  <br><br>
           	<div class="buttons">
       		 <a onclick="validateDayOpenForm('new');" class="btnCls"><font >&nbsp;&nbsp;&nbsp;<spring:message code="submit.label" />&nbsp;&nbsp;&nbsp;</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       		    <c:if test="${sessionScope.role == 'super admin'}"> 
       		    <a onclick="viewoutletdaysOpen('daysOpen','daysOpen','0','menu');" class="btnCls buttonMargin"><font>&nbsp;&nbsp;<spring:message code="cancel.label" />&nbsp;&nbsp;</font></a>
       		 	</c:if>
