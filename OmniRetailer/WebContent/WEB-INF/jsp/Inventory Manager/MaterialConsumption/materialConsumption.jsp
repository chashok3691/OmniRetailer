...
<%-- 									<option value="${location}" ${location == selectedLocation ? 'selected' : ''} id="${location}" >${location}</option> --%>
                  ...
                  <div class="row">
                  <a onclick="viewMaterialConsumption('outletMaterialConsumption','0','outlet','menu');" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                  <div class="row">
                 ...
                 <div class="col-lg-1 col-xs-2">
				                      	<select class="form-control" id="maxRecords" style="padding: 3px 4px;" onchange="viewMaterialConsumption('outletMaterialConsumption','0','outlet','menu')">
                     ...
                     <table id="productstocks" class="table table-bordered table-striped">
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                             <tr>
                                ...
                                <th><div ><spring:message code="uom.label" /></div></th>
                         	 ...
                         	 <tr>
                                ...
                                <tr  class="collapse rowone${thecount.count}">
                                            ...
                                            <%-- 	<td>${theCount1.count}</td> --%>
                                                ...
                                                <td id="skuId${stockRequests.itemId}${theCount.count}">${itemDetails.itemDescription}</td>
                                                <td>${itemDetails.uom}</td>
                                                 <td>${itemDetails.quantity}</td>
                                                <td>${itemDetails.openStock}</td>
                                                 <td>${itemDetails.closedStock}</td>
              ...
              <div class="row" style="padding-left:10px;padding-right:10px;">
              	<c:if test="${index-1 == 0 && totalRecords >maxRecords}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewMaterialConsumption('outletMaterialConsumption','${totalValue}','outlet','menu');">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-maxRecords >0}">
              				<div class="form-group col-lg-6" style="text-align: left;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewMaterialConsumption('outletMaterialConsumption','${index - (maxRecords + 1)}','outlet','menu');"> ${index} - ${totalValue} of ${totalRecords} 
...
<div class="col-lg-6" style="float:right;">
              	...
              	<c:if test="${(totalRecords-maxRecords)>0}">
              		...
              		<div class="col-lg-2" style="padding-right: 0px;">
              		  <input type="button" onclick="viewMaterialConsumption('outletMaterialConsumption',document.getElementById('pagination').value,'outlet','menu')" class="btn bg-olive btn-inline  addBtn" value="GO">
              		</div>
