                                   ...
                                   <div class="box-body">
									...
									<div class="row">
									 ...
									 <%--  <div class="form-group col-lg-4">
									  ...
									  <div class="form-group col-lg-4">
                                         ...
                                         <input type="text" class="form-control" name="location" id="workLocation" value="${outletDetails.location}" />
									  </div>
									   <div class="form-group col-lg-4">
                                        </div>
									</div>
									<div class="row">
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" name="fax" class="form-control number" id="fax" value="${outletDetails.fax}" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-4">
                                            <label><spring:message code="gps.latitude.label" /> <span class="requiredField">*</span></label>
                                             <input type="text" class="form-control" value="${outletDetails.gpsLatitude}" name="gpsLatitude" id="gpsLatitude" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.storename.label" />" />
                                    ...
                                    <div class="row">
                                       ...
                                       <%--    <label><spring:message code="start.time.label"/> <span class="requiredField">*</span></label>
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" name="minPayAmount" class="form-control" required id="amount" value="${outletDetails.minPayAmount}" />
