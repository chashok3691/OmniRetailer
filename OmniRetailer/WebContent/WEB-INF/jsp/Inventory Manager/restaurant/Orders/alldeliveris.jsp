...
<div class="row">
  ...
  <div class="box box-primary">
							...
							<h3 class="box-title">
								<spring:message code="doordeliveryorders.label" /> - <spring:message code="orders.label"/> 
							</h3>
				                    ...
				                    <div class="col-lg-3"></div>
				                      <div class="col-lg-6">
				                       <div class="row">
				                         ...
				                         <div class="col-lg-7">
				                        <select class="form-control" id="outletLocation" onchange="viewOrdersByPage('${orderType}','${status}');">
                                     ...
                                     <thead style="background-color: #3c8dbc; color: #ffffff">
                                        ...
                                        <tbody>
                                           <c:forEach var="orderDetails" items="${orderDetails}">
                                             ...
                                             <%--  <td><a style="color:#2e7ea7 !important;" href="#" onclick="viewOrderDetails('${orderDetails.orderReference}','${orderDetails.orderType}');"><spring:message code="view.label"/></a></td>
                                              --%>
                                             <%--   <c:choose> 
