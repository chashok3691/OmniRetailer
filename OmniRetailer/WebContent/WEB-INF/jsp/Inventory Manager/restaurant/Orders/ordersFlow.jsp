                    ...
                    <li><a href="#" onclick="return viewDashboard('inventorymanager');"><i class="fa fa-dashboard"></i><spring:message code="home.label" /></a></li>
                        ...
                        <li class="active"><a style="cursor: pointer;" onclick="showOrdersFlows();"><spring:message code="customer.label"/> <spring:message code="orders.label" /></a></li>
                          ...
                          <div class="row">
                          	...
                          	<div class="col-lg-2">
                          		<div style="text-align: center;width: 120px;height: 120px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="viewOrders('immediate','pending','pendingOrders')" title="<spring:message code="pending.bills.label" /> <spring:message code="orders.label" />">
                          	...
                          	<div class="col-lg-2" style="text-align: left;">
                          		<div style="text-align: center;width: 120px;height: 120px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="viewOrders('immediate','closed','fullfilledOrders')" title="<spring:message code="fullfilled.orders.label" /> <spring:message code="orders.label" />">
