 ...
 --%>
						...
						<div class="row" style="text-align: center;">
							...
							<input type="button" class="btn bg-olive btn-inline"
								onclick="viewOrdersByPage('${orderType}','${orderDetails.status}');"
								value="<spring:message code="back.label" />" />
								<%-- <c:if test="${orderDetails.status == 'pending'}">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" class="btn bg-olive btn-inline"
								onclick="editOrder('${orderDetails.orderReference}','${orderDetails.orderType}');"
