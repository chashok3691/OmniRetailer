...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 $(document).ready(function(){
	 /*  var dateTime = getCurrentDate();
	  ...
	  callCalender('restaurantStartDate');
	  callCalender('restaurantEndDate');
...
<!-- script for search booking Start -->
<!-- <script type="text/javascript">
...
$(".searchItems").bind('input', function () {
		 var searchName = $(this).val();
			...
			console.info("searchCategory >  "+searchCategory)
			 if(searchCategory == "bookingIds")
						searchBookingIds(searchName, searchCategory);
			 /* if(searchCategory == "editDealProduct")
				searchSuppliers(searchName, searchCategory); */
			}
		});

</script> -->
<!-- script for search booking End -->
...
<div class="row">
  ...
  <div class="box box-primary" style="height:1000px;">
                                <div class="box-header" >
                                    <h3 class="box-title"><spring:message code="all.takeaways.label" /></h3>
                                </div><!-- /.box-header -->
                                	...
                                	<div class="row" style="">
                                     <div class="form-group col-lg-3">
                                         <label><spring:message code="deal_start_date.label" /><span style="color:red; font-size:2">*</span></label>
                                            <input class="form-control calendar_icon" readonly="readonly" style="background-color: white;" name="startDate" id="restaurantStartDate" size="20" type="text" onfocus="callCalender('restaurantStartDate')" onclick="callCalender('restaurantStartDate')" placeholder="DD/MM/YYYY"/>
                                     ...
                                     <div class="form-group col-lg-3">
                                        ...
                                        <input class="form-control calendar_icon" readonly="readonly"  onchange="" style="background-color: white;" name="endDate" id="restaurantEndDate" size="20" type="text" onfocus="callCalender('restaurantEndDate')" onclick="callCalender('restaurantEndDate')" placeholder="DD/MM/YYYY"/>
				                    ...
				                    <div class="form-group col-lg-6">
                                     ...
                                     <br>
									  <div class="buttons" style="margin-bottom: 7px;">
		  				                <a onclick="return viewRestaurantTakeAways('takeAway');" class="button"><font size="2px">
	                                        	 ...
	                                        	 <td>${orderDetails.orderReference}</td>
	 											  ...
	 											  <c:when test="${orderDetails.status == 'pending'}">
													...
													<a style="color:#2e7ea7 !important;" href="#" onclick="editOrder('${orderDetails.orderReference}','${orderDetails.orderType}');"><spring:message code="edit.label"/></a></td>
	  												...
	  												<c:otherwise> --%><!-- viewRestaurantBookingInfo('${orderDetails.orderReference}','${orderDetails.storeLocation}'); -->
	    												<td><a style="color:#2e7ea7 !important;" href="#" onclick=""><spring:message code="view.label"/></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
													</td>
	  											<%-- 	</c:otherwise>
												</c:choose> --%>
