...
<span>Storege System Name : </span><input type="text" name = "editStorageSystem${systems.count }name" value="${storageSystems.storageSystemName}" class="form-control" id="editStorageSystem${systems.count }name">
