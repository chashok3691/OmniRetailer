...
<%-- 									  	<spring:message code="draw_warehouse_configuration.label" />
 --%>									  </div>
                                  	...
                                  	<input type="button" id="edit" style="position: relative;" class="btn bg-olive btn-inline" onclick="viewWarehouseData('${warehouse.warehouseId}','edit')" value="&nbsp;&nbsp;&nbsp;<spring:message code="edit.label" />&nbsp;&nbsp;&nbsp;" />
 ...
 --%>								  	<input type="button" class="btn bg-olive btn-inline" style="margin-left:1%; margin-right: 1%;width: 68px;position: relative;" onclick="getWareHouses('WarehouseConfigurations')" value="<spring:message code="cancel.label" />" />
								...
								<div class="row">
									    <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="warehouseName" id="warehouseName" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_name.label" />" value="${warehouse.warehouse_name}" readonly="readonly"/>
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="warehouseType" id="warehouseType" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_type.label" />" value="${warehouse.warehouse_type}" readonly="readonly"/>
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="mobileNumber" id="mobileNumber" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_phonenumber.label" />" value="${warehouse.phone_number}" readonly="readonly"/>
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="fax" id="fax" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_fax.label" />" value="${warehouse.fax}" readonly="readonly"/>
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                                            <select class="form-control" name="warehouseStatus" id="warehouseStatus" disabled="disabled">
                                             <option value="itemspecificdeal" ${warehouse.warehouse_status == "Enable" ? 'selected' : ''}>Enable</option>
                                            <option value="turnover" ${warehouse.warehouse_status  == "Disable" ? 'selected' : ''}>Disable</option>
                                            </select>
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="houseNo" id="houseNo" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_no.label" />" value="${warehouse.address_1}" readonly="readonly"/>
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="street" id="street" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_street.label" />" value="${warehouse.address_2}" readonly="readonly"/>
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="city" id="city" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_city.label" />" value="${warehouse.city}" readonly="readonly"/>
                                    ...
                                    <div class="row">
                                     <div class="form-group col-lg-4">
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" class="form-control" name="zip" id="zip" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_zip.label" />" value="${warehouse.zip}" readonly="readonly"/>
