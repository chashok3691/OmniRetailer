                ...
                <section class="content" style="background: none !important;">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab_1" data-toggle="tab" onclick="viewPurchaseOrder('all','procurement');"><spring:message code="purchase.order.label" /></a></li>
                                    <li><a href="#tab_2" onclick="viewProcurement('all','goodsReceipts');" data-toggle="tab"><spring:message code="receipts.label" /></a></li>
