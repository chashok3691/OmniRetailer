 ...
 * Written By		        : Mythri
 * file name		        : Inventory Manager/warehouse/procurement/newProcurementReceipt.jsp  kkk
 * file type		        : JSP
  ...
  <div class="col-lg-12">
				<div class="box box-primary">
						...
						<div class="row" style="text-align: center;">
							...
							<input type="button" class="btn bg-olive btn-inline" onclick="return viewProcurement('all','goodsReceipts');" style="margin-left:5%;" value="<spring:message code="cancel.label" />" />
						</div> 
				<br/>
