                                ...
                                <div class="box-body table-responsive" >
				                    <div class="row">
				                      ...
				                      <div class="col-lg-6">
				                       <div class="row">
				                         ...
				                         <div class="col-lg-7">
				                           <select class="form-control" id="outlet_location" onchange="viewProcurement('all','goodsReceipts');">
                                    ...
                                    <div class="row">
										<div class="buttons" style="margin-bottom: 7px;">
											...
											<a onclick="return viewProcurement('draft','goodsReceipts');" class="button"><font size="2px"><spring:message code="drafts.label" /></font></a>&nbsp;&nbsp;&nbsp;
											<a onclick="return viewProcurement('all','goodsReceipts');" class="button"><font size="2px"><spring:message code="all.receipts.label" /></font></a>
										</div>
									 </div>
