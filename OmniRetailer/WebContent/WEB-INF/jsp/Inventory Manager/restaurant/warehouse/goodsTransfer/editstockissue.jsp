...
<div class="row">
  <div class="col-lg-12">
				<div class="box box-primary">
                                ...
                                <br/>
                                <h3><spring:message code="edit.stockissue.label" /></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form">
                                    <div class="box-body">
                                       ...
                                       <div class="form-group col-lg-4">
                                            <label><spring:message code="shipped.from.label" /></label>
                                             ...
                                             <c:forEach var="location" items="${locationsList}">
												<option value="${location}" ${location == stockIssueDetails.shipped_from ? 'selected' : ''}>${location}</option>
											</c:forEach>
                                           </select>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-4">
                                             ...
                                             <div class="input-group">
	                                            ...
	                                            <input type="text" name="deliveryDate" id="date" required value="${stockIssueDetails.deliveryDate}" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
	                                        </div> <!-- /.input group -->
                                        ...
                                        <div class="form-group col-lg-4">
                                            <label><spring:message code="issuelocation.label" /></label>
                                             ...
                                             <c:forEach var="location" items="${locationsList}">
												<option value="${location}" ${location == stockIssueDetails.issue_to ? 'selected' : ''}>${location}</option>
											</c:forEach>
                                           </select>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" class="form-control" name="delivered_by" id="delivered" placeholder='<spring:message code="enter.name.label"/>' value="${stockIssueDetails.delivered_by}"/>
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" class="form-control" name="InspectedBy" id="inspected" placeholder='<spring:message code="enter.name.label"/>' value="${stockIssueDetails.inspectedBy}"/>
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" class="form-control" id="received" name="Received_by" placeholder='<spring:message code="enter.name.label"/>' value="${stockIssueDetails.received_by}"/>
 ...
 --%>  										 </div>
                                          ...
                                          <tbody>
                                             <c:forEach var="item" items="${stockIssueDetails.itemDetails}" varStatus="theCount">
                                              <tr id=dynamicdiv${theCount.count}>
                  								...
                  								<td id="Supplied${theCount.count}" >${item.issued }</td>
                  								...
                  								<td id=${fn:replace(itemList.item,' ','')}Supplied >${itemList.issued}</td>
                                    ...
                                    <br/> <br/>
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="form-group  col-lg-12">
                                            ...
                                            <textarea class="form-control" name="remarks" id="remarks" style="resize: none;" rows="2" placeholder="<spring:message code="enter.remarks.label" />" >${stockIssueDetails.remarks}</textarea>
 										 </div>
                                        <!--  <div class="col-lg-3"></div> -->
                                        </div>
                                        <br/>
						...
						<div class="row" style="text-align: center;">
						 <input type="button" class="btn bg-olive btn-inline" onclick="validateWarehouseStockIssue('stored','update','${stockIssueDetails.goods_issue_ref_num}','${stockIssueDetails.id_goods_issue}');" value="Submit" />
						<input type="button" class="btn bg-olive btn-inline" style="margin-left:5%;" onclick="validateWarehouseStockIssue('draft','update','${stockIssueDetails.goods_issue_ref_num}','${stockIssueDetails.id_goods_issue}');" value="<spring:message code="save.label" />" />
