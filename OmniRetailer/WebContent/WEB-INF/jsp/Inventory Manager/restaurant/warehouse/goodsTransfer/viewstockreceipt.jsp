 ...
 * Written By		        : Sahitya
 * file name		        : inventorymanager/warehouse/goodsTransfer/viewstockreceipt.jsp
 * file type		        : JSP
				...
				<div class="box box-primary">
                                ...
                                <form role="form">
                                    ...
                                    <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" class="form-control" readonly value="${stockReceiptDetails.shipped_from}"/>
                                     </div>
                                        
                                        <div class="form-group col-lg-4">
                                            <label><spring:message code="date.label" /></label>
                                            <input type="text" class="form-control" readonly value="${stockReceiptDetails.deliveryDate}"/>
                                        </div>
                                        
                                        <div class="form-group col-lg-4">
                                            <label><spring:message code="receiptlocation.label" /></label>
                                            <input type="text" class="form-control" readonly id="receipt_location" value="${stockReceiptDetails.receipt_location}"/>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" class="form-control" readonly value="${stockReceiptDetails.delivered_by}"/>
                                        </div>
                                        
                                        <div class="form-group col-lg-4">
                                            <label><spring:message code="inspected.label" /> <spring:message code="by.label" /></label>
                                            <input type="text" class="form-control" readonly value="${stockReceiptDetails.inspected_By}"/>
                                        </div>
                                        
                                        <div class="form-group col-lg-4">
                                            <label><spring:message code="received.label" /> <spring:message code="by.label" /> <span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" readonly value="${stockReceiptDetails.receivedBy}"/>
                                        </div>
                                     </div>
                                      ...
                                      <div class="table-responsive">
                                        <table id="productsList" class="table table-bordered table-hover">
                                          ...
                                          <tbody>
                                              <tbody>
                       <c:forEach var="itemList" items="${stockReceiptDetails.reciptDetails}">
             		   <tr>
              			<td>${itemList.item}</td>
                                    ...
                                    <br/> <br/>
                                     ...
                                     <div class="row">
                                         <div class="form-group  col-lg-12">
                                            ...
                                            <textarea class="form-control" style="resize: none;" readonly>${stockReceiptDetails.remarks}</textarea>
 										 </div>
						...
						<div class="row" style="text-align: center;">
							<input type="button" class="btn bg-olive btn-inline"
								onclick="getWarehouseStockReceiptsByLocation('all');"
