 ...
 * Written By		        : Sahitya
 * file name		        : inventorymanager/warehouse/goodsTransfer/newstockreceipt.jsp
 * file type		        : JSP
  ...
  <div class="col-lg-12">
				<div class="box box-primary">
						...
						<div class="row" style="text-align: center;">
						 <input type="button" class="btn bg-olive btn-inline" onclick="validateWarehouseStockReceipt('stored','new','','');" value="Submit" />
						<input type="button" class="btn bg-olive btn-inline" style="margin-left:5%;" onclick="validateWarehouseStockReceipt('draft','new','','');" value="<spring:message code="save.label" />" />
