 ...
 * Written By		        : Sahitya
 * file name		        : inventorymanager/warehouse/stockVerification/viewoutletproductstockverification.jsp
 * file type		        : JSP
				...
				<div class="box box-primary">
						...
						<div class="row" style="text-align: center;">
							<input type="button" class="btn bg-olive btn-inline"
								onclick="viewSpecificWarehouseProductStockVerification('${specificProductData.verification_code}');"
