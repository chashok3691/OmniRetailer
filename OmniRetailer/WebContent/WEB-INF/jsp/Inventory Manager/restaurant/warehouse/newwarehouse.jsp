									...
									<div class="row">
									  ...
									  <div class="form-group col-lg-4">
									     <label><spring:message code="location.label" /></label>
                                           <select class="form-control" name="location" id="workLocation" onchange="changeLocation()"> 
...
<%-- 									  	<spring:message code="draw_warehouse_configuration.label" />
 --%>									  </div>
                                  	...
                                  	<input type="button" id="edit" style="position: relative;" class="btn bg-olive btn-inline" onclick="showWarehouseConfiguration('save');" value="&nbsp;&nbsp;&nbsp;<spring:message code="next.label" />&nbsp;&nbsp;&nbsp;" />
