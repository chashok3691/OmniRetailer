                                ...
                                <form method="POST">
									...
									<!--   </div> -->
									  <div class="form-group col-lg-4">
									     <label><spring:message code="location.label" /></label>
                                           <select class="form-control" name="location" onchange="newRestaurantOutlet('','${type}')" id="workLocation">
                                    ...
                                    <div class="row">
									    <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" class="form-control" value="${outletDetails.gpsLongitude}" name="gpsLongitude" id="gpsLongitude" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.storename.label" />" />
                                        ...
                                        <div class="form-group col-lg-4">
                                            <label><spring:message code="gps.latitude.label" /> <span class="requiredField">*</span></label>
                                             <input type="text" class="form-control" name="gpsLatitude" value="${outletDetails.gpsLatitude}" id="gpsLatitude" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.storename.label" />" />
                                      ...
                                      <div class="form-group col-lg-4">
                                         <div class="bootstrap-timepicker">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="startTime" id="startTime" value="${outletDetails.startTimeStr}" />
                            ...
                            <!-- time Picker -->
                                       ...
                                       <div class="form-group col-lg-4">
                                        <div class="bootstrap-timepicker">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" name="endTime" class="form-control timepicker" id="endTime" value="${outletDetails.endTimeStr}"/>
                                                <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div>
                                            </div><!-- /.input group -->
                                          ...
                                          <table id="buildingtable" class="table table-bordered table-hover">
                                            ...
                                            <tbody style="text-align: center;">
                                            	<c:forEach var="facility" items="${outletDetails.facilitiesInfo}" varStatus="theCount">
													...
													<td id='facilityCategory${theCount.count}'>${facility.facilityCategory}</td>
