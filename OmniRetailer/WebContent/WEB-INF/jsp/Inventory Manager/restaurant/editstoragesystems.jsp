 ...
 * file name		        : inventorymanager/restaurant/editstoragesystems.jsp
 * file type		        : JSP
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>edit storage systems | Omni Retailer</title>
...
<%-- 												 <img src="${pageContext.request.contextPath}/images/directions.gif" style="height: 108px;float: right;">
 --%>												 <div id="editoutletdroppable" style="height: 500px;" onclick="">
												 ...
												 <%int count = 0; %>
												 <c:forEach var="table" items="${tableDetailsList}">
												...
												<div
													...
													id="table<%=count %>id" class="table<%=count %>class ui-draggable " title="">
													<img src="${pageContext.request.contextPath}/images/chair_2_64.png"
														...
														onclick="showGroceryStorageSystemDetails('table<%=count %>')">
														
														<div style="border: 1px solid rgb(204, 204, 204); width: 190px; position: absolute; margin-top: -15px; z-index: 999; background: rgb(204, 204, 204);"
													...
													<div id="table<%=count %>DetailsDiv">
														<div style="height: 450px; overflow-x: hidden;">
															<div>
																Table No 
																<input type="number" name="table<%=count %>tableNo" id="table<%=count %>tableNo" value="${table.tableNo}">
															</div>
															<br>
															<div>
																Table Status
																 <select name="table<%=count %>tableStatus"
																	...
																	style="width: 128px; display: inline;"
															...
															<div>
																Table Description
																<textarea name="table<%=count %>tableDescription"
																	id="table<%=count %>tableDescription">${table.tableDescription }</textarea>
																Picture <input type="file" name="table<%=count %>picture"
																	id="table<%=count %>picture" style="display: inline;" value="${table.picture }">
															</div'>
														</div>
													</div>
													<span>Actions : </span>
													...
													<img src="${pageContext.request.contextPath}/images/view.png"
														...
														style="display:; cursor: pointer; height: 33px; margin-left: 7px; margin-top: -7px;"
														data-toggle="modal" data-target="#myModal"
														title="View Storage System"
														onclick="viewStorageSystem('table<%=count %>','grocery_bayarea')"><img
														src="${pageContext.request.contextPath}/images/remove.png"
														id="table<%=count %>removeStorageSystem"
														style="display:; cursor: pointer; height: 29px; margin-left: 17px; margin-top: -6px;"
														onclick="removeGroceryStorageSystem('table<%=count %>')"
														title="Remove Storage System"><img
														src="${pageContext.request.contextPath}/images/ok.png"
														id="table<%=count %>saveStorageSystemDetails"
														style="display:; cursor: pointer; height: 23px; margin-left: 17px; margin-top: -4px;"
														onclick="saveGroceryStorageSystemDetails('table<%=count %>')"
														title="Save Storage System Details"><img
														src="${pageContext.request.contextPath}/images/cancel.png"
														id="table<%=count %>closeStorageSystemDetails"
														style="display:; cursor: pointer; height: 26px; margin-left: 18px; margin-top: -4px;"
      ...
      <div class="modal-content" style="width: 171%;margin-left: -98px;">
        ...
        <div class="modal-footer">
        	<input type="button" id="edit" style="position: relative;" class="btn bg-olive btn-inline" value="&nbsp;&nbsp;&nbsp;<spring:message code="save.label" />&nbsp;&nbsp;&nbsp;" onclick = "updateStorageSystemDetails()"/>
      		<input type="button" class="btn bg-olive btn-inline"  data-dismiss="modal" style="margin-left:1%; margin-right: 1%;width: 68px;position: relative;" value="<spring:message code="cancel.label" />"  onclick = "return viewRestaurantConfigurations('restaurantConfig');"/>
