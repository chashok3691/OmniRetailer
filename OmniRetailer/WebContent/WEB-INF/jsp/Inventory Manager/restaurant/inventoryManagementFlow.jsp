                        ...
                        <li class="active"><a style="cursor: pointer;" onclick="showInventoryManagementFlows();"><spring:message code="inventory.management.label"/></a></li>
                          ...
                          <div class="row">
                          	<div class="col-lg-2" style="text-align: right;">
                          		<div style="text-align: center;width: 120px;height: 120px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="viewOutletStocks('outletStocks','Normal Stock');" title="<spring:message code="stocks.label" />">
                          	...
                          	<div class="col-lg-2">
                          		<div style="text-align: center;width: 120px;height: 120px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="viewGoodsTransfers('outletGoodsTransfer','all');" title="<spring:message code="goods.transfer.label" />">
                          	...
                          	<div class="col-lg-2" style="text-align: left;">
                          		<div style="text-align: center;width: 120px;height: 120px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="viewOutletStockVerification('outletStockVerification');" title="<spring:message code="stock.verification.label" />">
                          	...
                          	<div class="col-lg-2">
                          		<div style="text-align: center;width: 120px;height: 120px;margin-left: 57px;border: 1px solid #CCCCCC;cursor: pointer;" onclick="viewProcurement('all','procurementReceipts');" title="<spring:message code="procurement.receipts.label" />">
                          			<img src="${pageContext.request.contextPath}/images/Receipts.gif" style="margin-top: 10px;"><br>
                          			<%-- <span><spring:message code="warehouse.label" /></span><br> --%>
                          			<span><spring:message code="procurement.receipts.label" /></span>
                          		</div>
                          	</div>
