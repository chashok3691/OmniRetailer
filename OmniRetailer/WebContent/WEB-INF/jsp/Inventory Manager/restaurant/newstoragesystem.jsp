 ...
 * Written By		        : Sahitya
 * file name		        : inventorymanager/retailoutlets/newstoragesystem.jsp
 * file type		        : JSP
...
<div class="row">
  <div class="col-lg-12">
				<div class="box box-primary">
                                ...
                                <br/>
                                <h3><spring:message code="newlayout.label" /></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form">
                                    <div class="box-body">
                                     ...
                                     <div class="row">
                                        <div class="form-group col-lg-4">
                                           ...
                                           <input name="location" type="text" class="form-control number" readonly required id="workLocation" value="${location}" />
                                        </div>
                                         <div class="form-group col-lg-4">
                                            <label><spring:message code="layoutname.label" /> <span class="requiredField">*</span></label>
                                            <input name="layoutName" type="text" class="form-control number" required id="layoutName" placeholder="<spring:message code="enter.layoutname.label" />"  />
                                         ...
                                         <div class="form-group col-lg-4">
                                            ...
                                            <input name="layoutDescription" type="text" class="form-control number" required id="layoutDesc" placeholder="<spring:message code="enter.layoutdesc.label" />"  />
	...
	<center id="deleteEle" style=";"><img src="${pageContext.request.contextPath}/images/del.png;" style="margin-top:10px;cursor: pointer;" title="Add New Table" onclick="deleteTable()" ><br>
	...
	<!-- for displa cart end  -->
						...
						<div class="row" style="margin:0px 0px 0px 35%;">
						 <input type="button" class="btn bg-olive btn-inline" onclick="validateLayout('new');" value="<spring:message code="save.label" />" />
						 <input type="button" class="btn bg-olive btn-inline" style="margin-left:5%;" onclick="viewConfigurations('');" value="<spring:message code="cancel.label" />" />
						</div>
									<br/>
                                    <div class="box-footer">
                                     <!--    <button type="submit" class="btn btn-primary">Submit</button> -->
                                    </div>
                                    <!-- These values are default and save as basic layout info when user clicks 'cancel' in this jsp -->
                                    <input type="hidden" id="samplelayoutName" value="simplelayout"/>
                                    <input type="hidden" required id="samplelayoutDesc" value="simplelayoutdesc"/>
                                   <!--  <input type="hidden" id="tableInfo" value='{"tablesList":[{"tableNumber":"table1","noOfChairs":"4","level":"1"},{"tableNumber":"table2","noOfChairs":"4","level":"1"}]}'/> -->
                                    <input type="hidden" id="tableInfo" value='{"tablesList":[]}'/>
                                     <!-- These values are default and save as basic layout info when user clicks 'cancel' in this jsp -->
                                     
                                     <!-- This field is used to receive layout info as json format from GUI then send to controller -->
