...
<section class="content">
 <div class="row">
  <div class="col-lg-12">
               	...
               	<div class="row">
                    ...
                    <div class="form-group col-lg-4">
                        <label><spring:message code="procurement.location.label" /></label>
                                    <input type="text" class="form-control" readonly="readonly" name="location" id="outlet_location" value="${procurementReceipt.location}" required />
                             </div>
				</div>
                           <div class="row">
                             <div class="form-group col-lg-4">
			...
			<input type="button" class="btn bg-olive btn-inline" onclick="return viewProcurement('all','procurementReceipts');" value="<spring:message code="cancel.label" />" />
			</div>  
		<br/>
