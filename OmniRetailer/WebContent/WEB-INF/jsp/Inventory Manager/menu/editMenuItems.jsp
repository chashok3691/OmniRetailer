...
<%--                      </c:forEach> --%>
    ...
    <div class="row" style="text-align: center;">
	 	<input type="button" class="btnCls" style="" onClick="validateMenuItems('edit');" value="<spring:message code="submit.label" />" />
		<input type="button" class="btnCls buttonMargin" style="" onclick="return getMenuItems('cancel');" value="<spring:message code="cancel.label" />" />
	</div>
	<br/>
	</div>
