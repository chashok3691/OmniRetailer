 ...
 * Written By		        : Sambaiah
 * file name		        : inventorymanager/Billing/exchangedDetails.jsp
 * file type		        : JSP
				...
				<div class="box box-primary">
					...
					<%-- 	<c:if test="${billcontent == 'billItems'}">
						...
						<div class="box-header" style="text-align: center">
                                <h3>${billId } <spring:message code="exchanged.item.label" /></h3>
                                </div>
					</div><!-- /.box-header -->
                                ...
                                <form>
                                    ...
                                    <div class="box-body">
                                    	<div class="row" style="text-align: right; margin-top: -65px;">
                                    		<c:if test="${flow != 'billSummary' }">
	                                    		<input type="button" class="btn bg-olive btn-inline" style="margin-left:2%;margin-right: 2%;position: relative;" onclick="viewBills('outletBilling','0','menu','${flow}');" value="<spring:message code="back.label" />" />
                                    		</c:if>
                                    		<c:if test="${flow == 'billSummary' }">
                                 ...
                                 <%--     </c:forEach> --%>
                                      ...
                                      <div class="table-responsive">
                                        <table id="exchangedList" class="table table-bordered table-hover">
                                ...
                                <!--   added by vinay -->
                                          ...
                                          <tbody style="text-align: center;">
					                       <c:forEach var="items" items="${billDetails.billExchangedItems}" varStatus="theCount">
					             		   <tr>
						             		    <td>${theCount.count}</td>
						                  		...
						                  		<td>${items.exchanged_bill_id}</td>
						                  		<td>${items.cost}</td>
						                <!--   added by vinay -->
						               
						                  		<c:set var ="price" value="${price+items.cost}"/>
						                  		 <fmt:formatNumber var="tax" type="number" maxFractionDigits="2" value="${tax+items.taxAmFloat }"/>
						  ...
						  <!-- added by vinay -->
								        <c:set var ="discount" value="${0}"/>
								         <c:forEach var="item" items="${billDetails.exchangeItemsList}">
					              			<c:set var ="discount" value="${discount+item.discountPrice}"/>
					              		   </c:forEach>
     </div>
     <br/> 
 							...
 							<div class="row">
                               <div class="form-group col-lg-8"></div>   
                                <div class="form-group col-lg-2" style="text-align: right;"> <label><spring:message code="exchange.item.value.lable" /></label></div>
                              <div class="form-group col-lg-2">
         
					              		   <fmt:formatNumber var="exchangeItemValue" type="number" maxFractionDigits="2" value="${price+discount}"/>
                                      <input type="text" class="form-control" name="shipmentCharges" readonly value="${exchangeItemValue}"/>
                         ...
                         <div class="row">
                               <div class="form-group col-lg-8"></div>   
                                <div class="form-group col-lg-2" style="text-align: right;"> <label><spring:message code="discounts.lable" /></label></div>
                              <div class="form-group col-lg-2">
                                      <input type="text" class="form-control" name="shipmentCharges" readonly value="${discount}"/>
                               </div>
                        </div>
                               <div class="row">
                               <div class="form-group col-lg-8"></div>   
                                <div class="form-group col-lg-2" style="text-align: right;"> <label><spring:message code="tax.label" /></label></div>
                              <div class="form-group col-lg-2">
                                      <input type="text" class="form-control" name="shipmentCharges" readonly value="${tax}"/>
                               </div>
                        </div>
                   
                         <div class="row">
                        <div class="col-lg-6"></div>
                         <div class="col-lg-6" style="width: 48.5%;background-color: #E1DFDF; height=34px">
								<div class="col-lg-8 " style="text-align: center;font-size: 18px;padding-top: 4px;">
								 <font color="#606060"> <label><spring:message code="net.exchange.amount.credit.lable"/></label></font>
								</div>
								<div class="col-lg-4 " style="width: 33%;padding-left: 30px;">
								
								<font color="white">
								<fmt:formatNumber var="priceTotal" type="number" minFractionDigits="2" maxFractionDigits="2" value="${billDetails.returnorExchangeAmt}"/>
								<input type="text"  readonly="readonly" style="background-color: #606060;text-align: center;font: -webkit-pictograph;font-size: 16px;width: 126%;height: 34px;border-bottom-width: 0px;border-right-width: 0px;border-top-width: 0px;border-left-width: 0px;padding-left: 0px;" id="totalCost" name="totalCost"  value="${priceTotal}">
								</font>
								</div>
								</div>
                     </div>
...
<div class="row" style="text-align: right; padding-top:6px;">
	<c:if test="${flow != 'billSummary' }">
		<input type="button" class="btn bg-olive btn-inline" style="margin-left:1%;margin-right: 2%;position: relative;" onclick="viewBills('outletBilling','0','menu','${flow}');" value="<spring:message code="back.label" />" />
	</c:if>
	<c:if test="${flow == 'billSummary' }">
