                                  ...
                                  <%--     <c:forEach var="billing" items="${billDetails.billing}"> --%>
                                    ...
                                    <div class="form-group col-lg-2">
                                           ...
                                           <%--  <input type="text" id="outletLocation" class="form-control" readonly value="${billDetails.store_location}"/> --%>
                                            ...
                                            <input type="text" class="form-control" id="customerName" readonly value="${billDetails.customerName}"/>
                                     </div>
                                     <div class="form-group col-lg-2">
                                           <label>Sync Status</label><br>
                                            <select class="form-control" readonly disabled id="billSyncStatus" style="">
                                       ...
                                       <label>GSTIN No</label>
                                           <input type="text" class="form-control" id="customerGstin" readonly value="${billDetails.customerGstin}"/>
                                        </div>
   ...
   <a onclick=""><blink><c:out value="${mySplit}"/></blink></a>
      ...
      <td>${items.discountId}</td>
                  	...
                  	<td>${items.itemDiscount}</td>
                  		...
                  		<%-- </c:choose> --%>
                  	<fmt:formatNumber  type="number" groupingUsed="false"  minFractionDigits="2" maxFractionDigits="2" value="${items.discountPrice}" var="discount"/>
                  		<%-- <c:set value="${items.itemUnitPrice-items.itemDiscount}" var="soldPrice"/> --%>
                  		<td>${discount}</td>
                  		<fmt:formatNumber type="number" groupingUsed="false" minFractionDigits="2" maxFractionDigits="2" value="${items.itemUnitPrice-((items.itemDiscount+items.discountPrice)/(items.quantity))}" var="soldPrice" />
                  		<td>${items.itemUnitPrice}</td>
                  		<td>${items.taxCost}</td>
                    ...
                    <fmt:formatNumber var="soldCost" groupingUsed="false" type="number" minFractionDigits="2" maxFractionDigits="2" currencySymbol="$" value="${(items.itemUnitPrice)}" />
       ...
       Deal / Offer Name
        ...
        <br/>
						...
						<div class="row" style="text-align: right;">
							<c:if test="${flow != 'billSummary' }">
                        		<div class="col-lg-1" style="float:right">
                        		<input type="button" class=" addBtn btn bg-olive btn-inline" style="margin-left:1%;margin-right: 1.4%;margin-top:7px;position: relative;" onclick="viewBills('outletBilling','0','menu','${flow}');" value="<spring:message code="back.label" />" />
                       		</div>
                       		</c:if>
                       		<c:if test="${flow == 'billSummary' }">
                        	<div class="col-lg-1" style="float:right">
                        		<input type="button" class="addBtn btn bg-olive btn-inline" style="margin-left:1%;margin-right: 1.4%;position: relative;margin-top:7px" onclick="return viewBillSummary('${billDetails.business_date}','0','${criteria}','false');" value="<spring:message code="back.label" />" />
                       		</div>
                       		</c:if>
						</div>
						<%-- </c:forEach> --%>
