                                ...
                                <form id="newShipment" method="post" >
                                    <div class="box-body">
                                   	...
                                   	<div class="row">
                                     	...
                                     	<div class="form-group col-lg-3">
                                          ...
                                          <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" name="shipmentDate" id="date" required value="${shipmentBean.shipmentDate}" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                        </div><!-- /.input group -->
                                      ...
                                      <div class="row">
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="shipmentAgency" value="${shipmentBean.shipmentAgency}" id="shipmentAgency" required  placeholder="<spring:message code="enter.shipmentAgency.label" />" />
                                         ...
                                         <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="inspectedBy" id="inspectedBy" value="${shipmentBean.inspectedBy}" placeholder="<spring:message code="enter.inspectedBy.label" />" />
                                         ...
                                         <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="shippedBy" id="shippedBy" value="${shipmentBean.shippedBy}"  placeholder="<spring:message code="enter.shippedBy.label" />"  />
                                    ...
                                    <div class="form-group col-lg-3">
                                      ...
                                      <div class="row">
                                      	<div class="form-group col-lg-3" style="margin-top: -19px;">
                                            ...
                                            <input type="text" class="form-control" id="shipDno" name="shipmentDoorNo" value="${shipmentBean.shipmentDoorNo}" placeholder="<spring:message code="enter.shipement_address_doorNo.label" />"/>
                                    	...
                                    	<div class="form-group col-lg-3" style="margin-top: -19px;">
                                            ...
                                            <input type="text" class="form-control" id="shipStreet" name="shipmentStreet" value="${shipmentBean.shipmentStreet}" placeholder="<spring:message code="enter.shipment_street.label" />"/>
                                      	...
                                      	<div class="form-group col-lg-3" style="margin-top: -19px;">
                                            ...
                                            <input type="text" class="form-control" id="shipLoc" name="shipmentLocation" value="${shipmentBean.shipmentLocation}" placeholder="<spring:message code="enter.shipment_location.label" />"/>
                                       	...
                                       	<div class="form-group col-lg-3" style="margin-top: -19px;">
                                            ...
                                            <input type="text" class="form-control" id="shipCity" name="shipmentCity" value="${shipmentBean.shipmentCity}" placeholder="<spring:message code="enter.shipment_city.label" />"/>
                                      ...
                                      <div class="row">
                                      	<div class="form-group col-lg-3" >
                                            ...
                                            <input type="text" class="form-control" value="${shipmentBean.rfidTagNo}" name="rfidTagNo" placeholder="<spring:message code="enter.rfidTagNo.label" />"/>
                                    	</div>
                                    	<div class="form-group col-lg-3" >
                                            <label><spring:message code="gatePassRef.label" /></label>
                                            <input type="text" class="form-control" value="${shipmentBean.gatePassRef}" name="gatePassRef" placeholder="<spring:message code="enter.gatePassRef.label" />"/>
                                     	</div>
                                     	<div class="form-group col-lg-3" >
                                     	...
                                     	<div class="row">
                                      	<div class="form-group col-lg-6">
                                            ...
                                            <textarea class="form-control" style="resize: none;" name="packagesDescription" placeholder="<spring:message code="enter.packagesDescription.label" />">${shipmentBean.packagesDescription}</textarea>
                                     	</div>
                                     	<div class="form-group  col-lg-6">
                                         	<label><spring:message code="remarks.label" /></label>
                                            <textarea class="form-control" style="resize: none;" name="remarks" id="remarks" rows="2" placeholder="<spring:message code="enter.remarks.label" />" >${shipmentBean.remarks}</textarea>
 										 </div>
                                      </div> 
                                   ...
                                   <div class="row">
                                    <div class="form-group col-lg-6"></div>
                                     ...
                                     <div class="form-group col-lg-3">
                                            <input type="text" class="form-control" name="tax" id="orderTax" value="${shipmentBean.tax}"/>
                                     </div>   
                                   </div>
                                   <div class="row">
                                     <div class="form-group col-lg-6">
                                    ...
                                    <div class="form-group col-lg-3">
                                            <input type="text" class="form-control" name="shipmentCost" id="shipmentCharges" value="${shipmentBean.shipmentCost}"/>
                                     </div>
                                   </div> 
                                    <div class="row">
