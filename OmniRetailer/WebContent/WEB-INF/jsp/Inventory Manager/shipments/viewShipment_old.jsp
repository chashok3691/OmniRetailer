                                   	...
                                   	<div class="row">
                                     	...
                                     	<div class="form-group col-lg-3">
                                          ...
                                          <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" name="shipmentDate" id="date" readonly="readonly" value="${shipmentBean.orderShippedDateStr}" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                        </div><!-- /.input group -->
                                      ...
                                      <div class="row">
                                    	...
                                    	<div class="form-group col-lg-3" style="margin-top: -19px;">
                                      	...
                                      	<div class="form-group col-lg-3" style="margin-top: -19px;">
                                            ...
                                            <input type="text" class="form-control" id="shipLoc" readonly="readonly" name="shipmentLocation" value="${shipmentBean.location}" placeholder="<spring:message code="enter.shipment_location.label" />"/>
