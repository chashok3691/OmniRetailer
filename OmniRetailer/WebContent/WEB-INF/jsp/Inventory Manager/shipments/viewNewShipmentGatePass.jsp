 ...
 * Written By		        : Vamsi V
 * file name		        : inventorymanager/shipments/viewNewShipGatePass.jsp
 * file type		        : JSP
 * description				: The viewNewShipGatePass form is displayed using this jsp
 * */ -->
...
<meta charset="UTF-8">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/controller.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/gatePass/gatePass.js"></script>
...
<div class="row">
  <div class="col-lg-12">
				<div class="box box-primary">
                 ...
                 <div class="row">
	                 ...
	                 <div class="row" style="margin-bottom:12px;">
		                ...
		                <input type="hidden" id="edit" value="${operation}"/>
	                ...
	                <c:forEach var="location" items="${locationsList}">
	                 ...
	                 <div class="row" style="margin-bottom:10px;">
		                ...
		                <div class="form-group col-lg-7 col-xs-8" style="">
		                <c:if test="${operation == 'edit'}">
		                   <input type="text" class="form-control" name="carreircompany" id="carreircompany" value="${warehouseGatepassobj.destination}" readonly="readonly"/>
						</c:if>
						<c:if test="${operation != 'edit'}">
						 <input type="text" class="form-control" name="carreircompany" id="carreircompany" value="${warehouseGatepassobj.destination}"/>
						</c:if>	
	                 ...
	                 <div class="row" style="margin-bottom:10px;">
		                ...
		                <div class="form-group col-lg-7 col-xs-8" style="">
							<input type="text" class="form-control" name="personName" id="personName" value="${warehouseGatepassobj.checkedBy}" placeholder=""/>
	                 ...
	                 <div class="row" style="margin-bottom:10px;">
		                ...
		                <div class="form-group col-lg-7 col-xs-8" style="">
		                <c:if test="${operation != 'edit'}">
							 <input class="form-control calendar_icon"  style="background-color: white;width:50%;" name="returnDateStr" id="returnDateStr" size="20" type="text" value="${warehouseGatepassobj.startDateStr}" onfocus="callCalender('returnDateStr')" onclick="callCalender('returnDateStr')" placeholder="DD/MM/YYYY"/>
						</c:if>
						<c:if test="${operation == 'edit'}">
						 <input class="form-control calendar_icon" readonly="readonly"  style="background-color: white;width:50%;" name="returnDateStr" id="returnDateStr" size="20" type="text" value="${warehouseGatepassobj.startDateStr}"  placeholder="DD/MM/YYYY" />
						</c:if>
	                 ...
	                 <div class="row" style="margin-bottom:10px;">
		                ...
		                <div class="form-group col-lg-7 col-xs-8" style="">
		                <c:if test="${operation != 'edit'}">
							<div class="bootstrap-timepicker" style="width:50%;">
                ...
                <div class="row" style="margin-bottom:10px;">
                    ...
                    <div class="form-group col-lg-7 col-xs-8" style="">
                    	<input type="text" class="form-control" name="vehicleNumber" id="vehicleNumber" value="${warehouseGatepassobj.salesOrderRef}" placeholder=""/>
                ...
                <div class="row" style="margin-bottom:10px;">
                    ...
                    <div class="form-group col-lg-7 col-xs-8" style="">
					<input type="text" class="form-control" name="loadedBy" id="loadedBy" value="${warehouseGatepassobj.issuedBy}" placeholder=""/>
                ...
                <div class="row" style="margin-bottom:10px;">
	                ...
	                <div class="form-group col-lg-7 col-xs-8" style="">
						<input type="number" class="form-control" name="gateNo" id="gateNo" value="${warehouseGatepassobj.shipmentOrderRef}" placeholder="" style="width:40%;"/>
		...
		<br>
				...
				<div class="row" style="text-align: right;">
					...
					<c:if test="${type == 'new'}">
				       <input type="button" class="btn bg-olive btn-inline btnCls " style="margin-right: 1%;" onclick="return createShipmentGatePass('${warehouseGatepassobj.gatePassRef}','','');" value="<spring:message code="submit.label" />" />
				    </c:if>
				    <c:if test="${type != 'new'}">
				       <input type="button" class="btn bg-olive btn-inline btnCls " style="margin-right: 1%;" onclick="return createShipmentGatePass('${warehouseGatepassobj.gatePassRef}','','');" value="<spring:message code="submit.label" />" />
				    </c:if>
				    <c:if test="${sessionScope.role == 'super admin'}">
				    	<input type="button" class="btn bg-olive btn-inline btnCls buttonMargin" onclick="viewShipmentReturn('','0')" value="<spring:message code="cancel.label" />" />
				    </c:if>
				    <c:if test="${sessionScope.role != 'super admin'}">
	        			...
	        			<c:if test="${flowUnder == 'warehouse'}">
		        			<c:forEach var="accessControl" items="${sessionScope.warehouseSalesOrder}">
	                           <c:if test="${accessControl.appDocument == 'WarehouseShipmentGatePass' && accessControl.write == true && accessControl.read == false }">
									<input type="button" class="btn bg-olive btn-inline btnCls buttonMargin" onclick="return viewNewShipmentGatePass('shipmentgatepass','${status}');" value="<spring:message code="cancel.label" />" />
							  </c:if>
							</c:forEach>
							<c:forEach var="accessControl" items="${sessionScope.warehouseSalesOrder}">
	                           <c:if test="${accessControl.appDocument == 'WarehouseShipmentGatePass' && accessControl.read == true && accessControl.write == true }">
									<input type="button" class="btn bg-olive btn-inline btnCls buttonMargin" onclick="viewShipmentGatePass('shipmentgatepass','0');" value="<spring:message code="cancel.label" />" />
							  </c:if>
							</c:forEach>
	        			</c:if>
	        		</c:if>
