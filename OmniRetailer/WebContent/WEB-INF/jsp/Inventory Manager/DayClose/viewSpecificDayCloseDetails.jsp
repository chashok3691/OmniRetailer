 ...
 * Written By		        : Manasa
 * file name		        : Inventory Manager/DaysOpen/viewSpecificDayCloseDetails.jsp
 * file type		        : JSP
 * description				: The day close details is displayed using this jsp
 * */ -->
				  ...
				  <div class="form-group col-lg-2" >
                               ...
                               <div class="address-group col-lg-10 col-xs-9 " style="margin-left:20px;white-space:nowrap">
                                          ...
                                          <div class="form-group col-lg-12" style="padding-left:0px;">
                                             ...
                                             <select class="form-control" name="businessCounter" id="businessCounter" disabled="disabled">
    ...
    height: 15px;" checked><label><spring:message code="import.Select_Week_Days.Mon.label" /></label>&nbsp;	
                                 ...
                                 <div class=" form-group col-lg-10">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="mondayStartTime" value="${outletDayCloseresponse.monStartTimeStr}" disabled="disabled"/>
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                  <input type="text" class="form-control timepicker" name="start_time" id="mondayEndTime" value="${outletDayCloseresponse.monEndTimeStr}" disabled="disabled"/>
    ...
    height: 15px;" checked><label><spring:message code="import.Select_Week_Days.Tue.label" /></label>&nbsp;	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="tuesdayStartTime" value="${outletDayCloseresponse.tueStartTimeStr} " disabled="disabled"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" class="form-control timepicker" name="start_time" id="tuesdayEndTime" value="${outletDayCloseresponse.tueEndTimeStr}" disabled="disabled"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
    ...
    height: 15px;" checked><label><spring:message code="import.Select_Week_Days.Wed.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                  <input type="text" class="form-control timepicker" name="start_time" id="wednesdayStartTime" value="${outletDayCloseresponse.wedStartTimeStr}" disabled="disabled"/>
                                               <!--  <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="wednesdayEndTime" value="${outletDayCloseresponse.wedEndTimeStr}" disabled="disabled"/>
                                              <!--   <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
    ...
    height: 15px;" ><spring:message code="import.Select_Week_Days.Thu.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" class="form-control timepicker" name="start_time" id="thursdayStartTime" value="${outletDayCloseresponse.thuStartTimeStr}" disabled="disabled"/>
                                               <!--  <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                               <input type="text" class="form-control timepicker" name="start_time" id="thursdayEndTime" value="${outletDayCloseresponse.thuEndTimeStr}" disabled="disabled"/>
    ...
    height: 15px;" ><spring:message code="import.Select_Week_Days.Fri.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="fridayStartTime" value="${outletDayCloseresponse.friStartTimeStr}" disabled="disabled"/>
                                               <!--  <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                               <input type="text" class="form-control timepicker" name="start_time" id="fridayEndTime" value="${outletDayCloseresponse.friEndTimeStr}" disabled="disabled"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
    ...
    height: 15px;" checked><label><spring:message code="import.Select_Week_Days.Sat.label" /></label>	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                  <input type="text" class="form-control timepicker" name="start_time" id="saturdayStartTime" value="${outletDayCloseresponse.satStartTimeStr}" disabled="disabled"/>
                                              <!--   <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" style="" class="form-control timepicker" name="start_time" id="saturdayEndTime" value="${outletDayCloseresponse.satEndTimeStr}" disabled="disabled"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
    ...
    height: 15px;" checked id="sundayChkbox"><label><spring:message code="batchOperations.batch_timings.week_days.Sun.label" /></label>&nbsp;	
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="start_time" id="sundayStartTime" value="${outletDayCloseresponse.sunStartTimeStr}" disabled="disabled"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
                               ...
                               <div class="address-group col-lg-10 col-xs-10 ">
                                            ...
                                            <div class="input-group">                                            
                                                 <input type="text" class="form-control timepicker" name="start_time" id="sundayEndTime" value="${outletDayCloseresponse.sunEndTimeStr}" disabled="disabled"/>
                                                <!-- <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div> -->
                                            </div><!-- /.input group -->
		...
		<br>
       	  ...
       	  <br><br>
           	<div class="buttons">
       		 ...
       		 <a onclick="viewoutletdaysClose('daysClose','daysClose','0','menu');" class="btnCls"><font>&nbsp;&nbsp;<spring:message code="cancel.label" />&nbsp;&nbsp;</font></a>
       		 </c:if>
