 ...
 * Written By		        : Manasa
 * file name		        : Inventory Manager/DaysOpen/viewDaysClose.jsp
 * file type		        : JSP
 * description				: The dayclose details table is displayed using this jsp
 * */ -->
...
$('#searchDepartmentMaster').on('input',function(e){
	if($(this).val().trim()==""){
		viewoutletdaysClose('daysClose','daysClose','0','menu')
	}
});
});
...
<div class="row">
  ...
  <div class="box box-primary">
                      <div class="box-body table-responsive">
		               ...
		               <div class="col-lg-11">
		        	 		 <input type="text"  class="form-control searchItems searchBar"  value="" id="searchDepartmentMaster" placeholder="<spring:message code="search.day.close" />" />
								<div class="services">
					    			<div class="items">
					     				<ul class="matchedStringUl dayClose" style=""></ul>
					   				</div>
								</div>
                     ...
                     <c:forEach var="accessControl" items="${sessionScope.outletManagement}">
                          <c:if test="${accessControl.appDocument == 'DaysClose' && accessControl.write == true}"> 
					
							 <div class="col-lg-1" style="padding-left: 0px;float: right;">
								                <input type="button" style="" class="btn bg-olive btn-inline addBtn" onclick="return newdaysClose('daysclose');" value="<spring:message code="addnew.label" />">
								           </div>
                         ...
                         <tbody style="text-align: center;">
                          ...
                          <c:forEach  var="itemList" items="${outletdayopenResponse}"  varStatus="theCount">
                            ...
                            <input type="hidden"  id="businessCounter" value="${itemList.businessCounter}" >
                                 ...
                                 <a style="color:#2e7ea7 !important;cursor: pointer;" onclick="return viewEditDayClose('${itemList.businessCounter}','${itemList.outletLocation}','','view')">View</a>&nbsp;&nbsp;&nbsp;
                                  <a style="color:#2e7ea7 !important;cursor: pointer;" onclick="return viewEditDayClose('${itemList.businessCounter}','${itemList.outletLocation}','','edit')">Edit</a>&nbsp;&nbsp;&nbsp;
                               <a style="color:#2e7ea7 !important;cursor: pointer;" onclick="return deleteDayClose('${itemList.businessCounter}','${itemList.outletLocation}')">Delete</a>&nbsp;&nbsp;&nbsp;
                                  <%-- <c:if test="${sessionScope.role == 'super admin'}"> 
                ...
                <div class="row">
              	<c:if test="${index-1 == 0 && totalRecords >10}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="searchDaysClose('','','${totalValue}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-10 >0}">
              				<div class="form-group col-lg-12" style="text-align: right;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return searchDaysClose('','','${index - 11}');"> ${index} - ${totalValue} of ${totalRecords} 
