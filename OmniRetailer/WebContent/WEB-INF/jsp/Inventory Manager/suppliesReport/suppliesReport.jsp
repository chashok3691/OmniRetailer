...
<%--                            		 <option value=""><spring:message code="ALL.label"/></option> --%>
                  ...
                  <div class="row">
                  <a onclick="viewoutletSuppliersMovement('outletSuppliersMovement','0','outlet','menu');" class="button"><spring:message code="searchbutton.label"/></a>
                  </div>
                  <div class="row">
                      ...
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                             <tr>
                                <th><div><spring:message code="sl.no.label" /></div></th>
                                	<th style="width:40px!importtant"><spring:message code="created.date.label" /></th>
                                <th><spring:message code="location.label" /></th>
                                <th><div ><spring:message code="itemcode.label" /></div></th>
                                <th style="text-align: left;"><spring:message code="itemdesc.label" /></th>
                              	 <th style="width: 98px !important;"><spring:message code="ean.label" /></th>
                         ...
                         <tbody style="text-align: center;">
                           ...
                           <%-- <c:if test="${dataExists == 'true'}">
                                           	<tr>
                                           	        <c:set var="suppliedQty" value="${bigDecimal}"  />
                                           	         <c:set var="receivedQty" value="${bigDecimal}" />
                                           	         <c:set var="costTotal" value="${bigDecimal}" />
                                           	     
                                           	 <c:forEach var="suppliedQty" items="${bomreports}" >
                                           	 <c:set var="suppliedQty" value="${suppliedQty+((suppliesReport.suppliedQty))}" scope="page" />
                                           	 <c:set var="receivedQty" value="${receivedQty+((suppliesReport.receivedQty))}" scope="page" />
                                           	 <c:set var="costTotal" value="${costTotal+((suppliesReport.cost))}" scope="page" />
