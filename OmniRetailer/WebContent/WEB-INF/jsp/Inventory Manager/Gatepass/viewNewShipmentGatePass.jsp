  ...
  <div class="col-lg-12">
		...
		<br>
				...
				<div class="row" style="">
					...
					<div class="form-group col-lg-12 col-xs-6" style="    margin-left: 4%;">
					<input type="hidden" id="flowUnder" value="${flowUnder}">
					<c:if test="${type == 'new'}">
				       <input type="button" class="btn bg-olive btn-inline btnCls buttonMargin" style="" onclick="return createShipmentGatePass('${warehouseGatepassobj.gatePassRef}','','');" value="<spring:message code="submit.label" />" />
				    </c:if>
				    <c:if test="${type != 'new'}">
				       <input type="button" class="btn bg-olive btn-inline btnCls buttonMargin" style="" onclick="return createShipmentGatePass('${warehouseGatepassobj.gatePassRef}','','');" value="<spring:message code="submit.label" />" />
				    </c:if>
