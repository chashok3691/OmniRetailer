  ...
  <div class="box box-primary">
                                	...
                                	<div class="row">
				                      ...
				                      <div class="col-lg-6">
				                       <div class="row">
				                         ...
				                         <div class="col-lg-7">
				                            <select class="form-control" id="outletLocation" onchange="viewStockVerificationReport('','0');">
                                        ...
                                        <tbody style="text-align: center;">
                                           <c:forEach var="verificationDetails" items="${verificationDetailsList}">
                                            <tr>
                                            	...
                                            	<td>${verificationDetails.description}</td>
               ...
               <div class="row">
              	<c:if test="${index-1 == 0 && totalRecords >10}">
              		...
              		<input type="button" class='paginationButton' value="&#62;" onclick="viewStockVerificationReport('','${totalValue}')">
              	</div>
              	</c:if>
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-10 >0}">
              				<div class="form-group col-lg-12" style="text-align: right;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewStockVerificationReport('','${index - 11}');"> ${index} - ${totalValue} of ${totalRecords} 
