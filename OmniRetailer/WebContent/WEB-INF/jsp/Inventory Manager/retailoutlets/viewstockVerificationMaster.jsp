             ...
             <div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 20px; margin-top: -20px">${success}</div>
                  ...
                  <div class="row">
                       ...
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select class="form-control" id="outletLocation" disabled="disabled">
	                            ...
	                            <c:forEach var="location" items="${locationsList}">
						 		...
						 		<option value="${location}" ${location == whstockverifiObj.location ? 'selected' : ''} disabled="disabled" id="location" >${location}</option>
						 		</c:forEach>
	                        </select>
                      </div>
                      </div>
                      <div class="col-lg1-4 col-lg-4">
                       ...
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select class="form-control" id="outletCategory" disabled="disabled">
                           		 <option value=""><spring:message code="ALL.label"/></option>
	                            <c:forEach var="categoryList" items="${categoryList}">
									<option value="${categoryList.categoryName}" ${categoryList.categoryName == whstockverifiObj.productcategory ? 'selected' : ''} disabled="disabled" id="${categoryList.categoryName}" >${categoryList.categoryName}</option>
						 		</c:forEach>
	                        </select>
                      </div>
                      </div>
                    <div class="col-lg1-4 col-lg-4">
                     <div class="col-lg-2"></div>
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select class="form-control" id="outletBrandId"  disabled="disabled">
                           		 <option value=""><spring:message code="ALL.label"/></option>
	                            <c:forEach var="brandsList" items="${brandsList}">
									<option value="${brandsList}" ${brandsList == whstockverifiObj.brand ? 'selected' : ''} id="${brandsList}"  disabled="disabled" >${brandsList}</option>
						 		</c:forEach>
	                        </select>
                      </div>
                      </div>
                    ...
                    <div class="col-lg1-4 col-lg-4">
                     <div class="col-lg-2"></div>
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select class="form-control" id="outletDepartmentId"  disabled="disabled">
                           		 <option value=""><spring:message code="ALL.label"/></option>
                       ...
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select class="form-control" id="outletSubcategory" disabled="disabled">
                           		 <option value=""><spring:message code="ALL.label"/></option>
	                            <c:forEach var="subCategoryDetailsList" items="${subCategoryDetailsList}">
									<option value="${subCategoryDetailsList.subcategoryName}" ${subCategoryDetailsList.subcategoryName == whstockverifiObj.subcategory ? 'selected' : ''} id="${subCategoryDetailsList.subcategoryName}"  disabled="disabled">${subCategoryDetailsList.subcategoryName}</option>
						 		</c:forEach>
	                        </select>
                      </div>
                      </div>
                       ...
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select class="form-control" id="outletDepartmentId"  disabled="disabled">
                           		 <option value=""><spring:message code="ALL.label"/></option>
	                            <c:forEach var="departmentList" items="${departmentList}">
									<option value="${departmentList.primaryDepartment}" ${departmentList.primaryDepartment == selectedLocation ? 'selected' : ''} disabled="disabled" id="${departmentList.primaryDepartment}" >${departmentList.primaryDepartment}</option>
						 		</c:forEach>
	                        </select>
                      </div>
                    </div></div>
                     ...
                     <div class="row">
                	 	...
                	 	<input class="form-control calendar_icon form-group" disabled="disabled" value="${whstockverifiObj.verificationStartDateStr}" disabled="disabled" style="background-color: white;" id="from" size="20" type="text" onfocus="callCalender('from')" onclick="callCalender('from')" placeholder="DD/MM/YYYY" />
	              </div>
	            </div>
                    <div class="col-lg-4">
                     <div class="col-lg-2"></div>
		           ...
		           <div class="bootstrap-timepicker">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" value="${whstockverifiObj.startTime}" disabled="disabled" name="startTime" id="startTime"/>
                      ...
                      <div class="col-lg1-4 col-lg-4">
                	 	...
                	 	<input class="form-control" name="approved_by" id="approvedBy" disabled="disabled" placeholder="Enter Name" type="text" value="${whstockverifiObj.approvedBy}">
	              </div>
	            </div>
	               ...
	               <div class="col-lg-5" style="padding-left:0px;padding-right: 0px;">
	                   <label><spring:message code="offer_end_date.label"/></label>
	                 	<input class="form-control calendar_icon form-group" disabled="disabled" readonly="readonly" value="${whstockverifiObj.verificationEndDateStr}" style="background-color: white;" id="to" size="20" type="text" onfocus="callCalender('to')" onclick="callCalender('to')" placeholder="DD/MM/YYYY" />
		           </div>
		          </div>
		          ...
		          <div class="col-lg-5" style="padding-left:0px;padding-right: 0px;">
		           <div class="bootstrap-timepicker">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" disabled="disabled" value="00:00:00" name="startTime" id="startTime"/>
                                                <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div>
                                            </div><!-- /.input group -->
                  ...
                  <div class="">
                    <div class="form-group col-lg-12" style="padding-left: 5.2%;padding-right: 5.2%">
	                                ...
	                                <textarea  rows="5" class="form-control" style="resize:none;" id="description" value="" disabled="disabled" name="eventDescription"  >${whstockverifiObj.description}</textarea>
                    ...
                    <c:if test="${sessionScope.role != 'super admin' && flowUnder == 'warehouse'}">
			           <c:forEach var="accessControl" items="${sessionScope.warehouseStockmanagement}">
			                <c:if test="${accessControl.appDocument == 'WarehouseStockVerification' && accessControl.write == true && accessControl.read == true}">
			                	<input type="button" class="btn bg-olive btn-inline btnCls" style="margin-left:-90%" onclick="viewStockVerification('${productStockVerificationDetails.verification_code}','0','warehouse','menu');" value="<spring:message code="cancel.label"/>">
		                	</c:if>
		                </c:forEach>
		             </c:if>
