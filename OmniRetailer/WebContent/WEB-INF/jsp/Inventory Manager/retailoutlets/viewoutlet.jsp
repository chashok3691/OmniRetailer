  ...
  <div class="col-lg-12">
				<div class="box box-primary">
						 ...
						 <c:if test="${sessionScope.role == 'super admin'}">
							<input type="button" id="submit" class="btnCls" style="margin-right: 25px"  onclick="editOutlet();" value='&nbsp;&nbsp;&nbsp;<spring:message code="edit.label" />&nbsp;&nbsp;&nbsp;' />
						</c:if>
						 <c:forEach var="accessControl" items="${sessionScope.outletManagement}">
	                       <c:if test="${accessControl.appDocument == 'Configuration' && accessControl.write == true}"> 
						 	<input type="button" id="submit"   class="btnCls" style="margin-right: 2%;"  onclick="editOutlet();" value='&nbsp;&nbsp;&nbsp;<spring:message code="edit.label" />&nbsp;&nbsp;&nbsp;' />
						   </c:if>
						</c:forEach>
						...
						<input type="button" class="btnCls" style="margin-right: 2%;" onclick="viewConfigurations('outletConfigurations','0')" value="<spring:message code="cancel.label" />" />
                                   ...
                                   <div class="box-body" style=" opacity: 1.5; pointer-events: none;">
									...
									<div class="row">
									 <%--  <div class="form-group col-lg-4">
									  ...
									  <div class="form-group col-lg-3">
                                         ...
                                         <input type="text" class="form-control" name="location" id="workLocation" value="${outletDetails.locationId}" readonly/>
									  </div>
									  <div class="form-group col-lg-5">
									  <label><spring:message code="organisation.name.label" /></label>
									   <input type="text"  value="${outletDetails.companyName}" class="form-control"  name="organizationName" id="organizationName" placeholder="<spring:message code="enter.organization.name" />" disabled />
									  </div>
									  
									  <%--  <div class="col-lg-2" style="margin-top: 19px">  <label><spring:message code="authorize.label" />:</label></div> --%>
									 
									<%--    <div class="form-group col-lg-7" style="height:25px;">
									   <label><spring:message code="authorize.label" />:</label>
                                    <div class="" title="Signature Image" id="signature_image" style="text-align: center;width:96px;height:60px;margin-top: 5px;">
									  ...
									  <label class="myFile" id="logo1_label"></label>
									    ...
									    <div class="form-group col-lg-4 allignment">
                                         ...
                                         <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text" class="form-control" value="${outletDetails.street}" name="storeName" id="street" placeholder="" />
                                            <span id="storeError" style="text-align:right;color:red;font-weight:bold;"></span>
                                        </div>
                                         <div class="form-group col-lg-4 allignment">
                                         ...
                                         <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text" class="form-control" value="${outletDetails.gpsLongitude}" name="gpsLongitude" id="gpsLongitude"  placeholder="<spring:message code="enter.storelocation.label" />" />
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="form-group col-lg-4 allignment">
                                            ...
                                            <select class="form-control" id="warehouseId" >
												 <option value="${outletDetails.warehouseId}" >${outletDetails.warehouseId}</option>
                                        ...
                                        <label><spring:message code="maxcash.label" /> <span class="requiredField">*</span></label>
                                         <input type="text"  name="maximumCashLimit"  readonly="readonly" value="${outletDetails.maximumCashLimit}" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" required id="maximumCashLimit" placeholder="<spring:message code="maxcash.label" />" />
                                    ...
                                    <div class="form-group col-lg-2 " style="width:10%;    padding-left: 5px;">
                                        <label><spring:message code="max_bill.label" /> <span class="requiredField">*</span></label>
                                         <input type="text"  name="b2cMaxValue" readonly="readonly" value="${outletDetails.b2cMaxValue}" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" required id="b2cMaxValue" placeholder="<spring:message code="max_bill.label" />" />
                                         <span id="LimitError" style="text-align:right;color:red;font-weight:bold;white-space:nowrap"></span>
                                    </div>
...
<%-- 		                                  		<option value="false" ${'false' == outletDetails.remoteMonitoring ? 'selected' : ''} >No</option> --%>
                                ...
                                <div class="form-group col-lg-2 allignment">
									<label><spring:message code="created.date.label" /></label>
                                           ...
                                           <input class="form-control calendar_icon" readonly="readonly" style="background-color: white;" value="${outletDetails.createdDatestr}" name="deliveryDate" id="createddate" size="20" type="text" onfocus="callCalender('createddate')" onclick="callCalender('createddate')" placeholder="DD/MM/YYYY"/>
                                ...
                                <div class="form-group col-lg-2 allignment">
									<label><spring:message code="updated.date.label" /></label>
                                           ...
                                           <input class="form-control calendar_icon" readonly="readonly" style="background-color: white;" name="deliveryDate" id="updatedddate" size="20" type="text" onfocus="callCalender('updatedddate')" onclick="callCalender('updatedddate')" value="${outletDetails.updatedDatestr}" placeholder="DD/MM/YYYY"/>
									...
									<label><spring:message code="suspend.Reason.label" /></label>
                                           <input class="form-control calendar_icon" readonly="readonly" style="background-color: white;" value="${outletDetails.suspendReason}"  name="suspendReason"  id="suspendReason" size="20" type="text"  />
                                       
								</div>
								<div class="form-group col-lg-2 allignment">
                                   <label>FSSAI Number</label>
                                     <input class="form-control" readonly="readonly" style="background-color: white;" name="fssaiNumber"  id="fssaiNumber" value="${outletDetails.fssaiNumber}" size="20" type="text"  />
                               ...
                               <br>
                                 <div class="row">
                                   ...
                                   <br>
                                   <div class="row seven-cols" style="padding-left:15px;">
                                                                <table class="table" style="margin-bottom: 0px; width:98.9%">
											    <thead style="background-color: #ececec !important; color: #ffffff ">
											      <tr>
...
<!--                                         <div class="form-group col-lg-1 col-md-1 col-sm-1" style="">  -->
                                          ...
                                          <div class="radio">
                                           <label>
                                             <input type="text" name="ftpPasword" id="ftpPasword" value="${outletDetails.password}" placeholder="Password" 
											   ...
											   <div class="row seven-cols" style="padding-left:15px;">
                                 <table class="table" style="margin-bottom: 0px; width:22%">
											    <thead style="background-color: #ececec !important; color: #ffffff ">
											      <tr>
                                   ...
                                   <div class="radio">
                                       ...
                                       <td style=" width:13.9%; border-right: 2px solid #ccc;">
                                        <div class="radio">
                                          <input type="number" name="priceListCount" id="priceListCount" readonly value="${outletDetails.priceListCount}">
                                         </div>
                                      </td>
                            ...
                            <!--/..added by manasa  -->       
                                    ...
                                    <div class="col-lg-12" >
                                     ...
                                     <textarea class="form-control" width="100%" style="width: 100%; height: 100px;resize:none;" id="instructions" readonly="readonly">${outletDetails.instructions}</textarea>
                                    </div>
                                    </div>   
