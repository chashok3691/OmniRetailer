                                          ...
                                          <tbody style="text-align: center;">
                                             ...
                                             <tr id=dynamicdiv${theCount.count}>
                                             	<td class="slno">${theCount.count}</td>
              									...
              									<input type="hidden" id="productBatchNo${theCount.count}" value="${item.productBatchNo}"/>
              								   ...
              								   <input type='hidden' id="trackingRequired${theCount.count}" class="trackingRequired" value="${item.trackingRequired}"/>
              									...
              									<input type="hidden" id="mrpPrice${theCount.count}" value="${item.price}"/>
...
<%--                   								<td id="Desc${theCount.count}" >${item.description}</td>
 --%>                  								<td id="UOM${theCount.count}" >${item.uom}</td>
                  								<td class='Price' id="Price${theCount.count}" >${item.cost/item.supplied}</td>
                  								<c:choose>
                  ...
                  <div class="box-body table-responsive">
					...
					<c:if test="${sessionScope.role != 'super admin' && flowUnder == 'warehouse'}">
		           	   <c:forEach var="accessControl" items="${sessionScope.warehouseStockmanagement}">
		                	<c:if test="${accessControl.appSubDocument == 'WarehouseStockReceipts' && accessControl.write == true}">
		                	<input type="button" class="btnCls buttonMargin" style="" onclick="searchStockReceipts('','all','0');" value="<spring:message code="cancel.label" />" />
		                	</c:if>
		                </c:forEach>
		             </c:if> 
