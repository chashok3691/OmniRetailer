...
<div class="row">
  <div class="col-lg-12">
				<div class="box box-primary">
							...
							<a style="float:right;color:#2e7ea7 !important;cursor: pointer;margin-top: 20px;" data-toggle="modal" data-target="#myModal"><u>Help</u></a>                              
										    ...
										    <div class="modal-dialog">
										      ...
										      <div class="modal-content">
										        ...
										        <div class="modal-body">
										          <p><b>Business Category:</b> TechnoLabs Retail Cloud platform supports more than one retail vertical.
													You may select the type of Outlet Business.  For a given organization, there can be more than one type business.
													</p>
										          <br>
										          <p><b>Secured/Periphery:</b> You can exercise option to control and secure the Mobile Device(s) at the outlet. Periphery 
										          needs to be entered in meters. A secured device will work with in the radius entered in the Periphery field. In other 
										          words the Mobile Device cease to work if it is taken beyond of the periphery value entered.</p>
										          <p><b>Remote Monitoring:</b> This flag enables the remote monitoring of an outlet. This is subjected to Licensing and Hardware 
										          installed at the Outlet level. You can monitor the below parameters.</p>
										          <ul style="list-style: none;">
										          <li>1) Foot falls</li>
												  <li>2) POS device monitoring/tracking.</li>
												  <li>3) Video Streaming</li>
												  <li>4) Other sensors monitoring</li>													
										          </ul>
										          <p><b>Min E-Pay Amount:</b> You can decide the min amount that can be paid using Card or other electronic payment.</p> 
												  <p><b>Franchise/Company Owned:</b>  You need to mention if the Outlet is of type Franchise.  Our Cloud Platform, Omni Retailer, has the capability to organize the stores into multiple Franchise/Organizations.  Franchise owner can see their data whereas Company can see the data of every location.</p>
												  <p><b>Stock Verification Type:</b>  Omni Retailer platform supports stock verification at Outlet level. You can control and monitor the stock verification right from the main office. For more details on stock verification process , you can go through stock verification flow under Inventory Management.</p>
                                             	  <p><b>Warehouse:</b></p>
						...
						<br>
						 <input type="button" id="submit" class="btnCls" style="margin-right: 25px" onclick="validateOutlet('new');" value="&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="next.label" />&nbsp;&nbsp;&nbsp;&nbsp;" />
						 <!-- <input type="submit" class="btn bg-olive btn-inline" style="margin-left:5%;" onclick="" value="Reset" /> -->
						 <c:if test="${sessionScope.role == 'super admin'}">
						<input type="button" class="btnCls"  style="margin-right: 2%;" onclick="return viewConfigurations('configurations','0');" value="<spring:message code="cancel.label" />" />
					</c:if>
					<c:forEach var="accessControl" items="${sessionScope.outletManagement}">
                         <c:if test="${accessControl.appDocument == 'Configuration' && accessControl.write == true && accessControl.read == true}">
						<input type="button" class="btnCls" style="margin-right: 2%;"  onclick="viewConfigurations('outletConfigurations','0');" value="<spring:message code="cancel.label" />" />
									...
									<!--   </div> -->
									  <div class="form-group col-lg-3 allignment">
            ...
            <%-- <img class="thumbnail companyimage" id="dealBanner_thumbnail" alt="No Image" src="data:image/jpeg;base64,${denominationMasterResponse.denominationImage}" style=""/> --%>
									...
									<div class="row">
									    <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text"  onblur="criteriaSlashes(this)" class="form-control" value="${outletDetails.storeName}" name="storeName" id="storename" placeholder="<spring:message code="enter.storename.label" />" />
                                         ...
                                         <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text"  onblur="criteriaSlashes(this)" class="form-control" value="${outletDetails.street}" name="storeName" id="street" placeholder="<spring:message code="enter.road.street.label" />" />
                                         ...
                                         <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text"  onblur="criteriaSlashes(this)" class="form-control" value="${outletDetails.locality}" name="storeName" id="locality" placeholder="<spring:message code="enter.locality.label" />" />
                                         ...
                                         <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text"  onblur="criteriaSlashes(this)" class="form-control" value="${outletDetails.gpsLongitude}" name="gpsLongitude" id="gpsLongitude"  placeholder="<spring:message code="enter.storelocation.label" />" />
                                        ...
                                        <div class="form-group col-lg-4 allignment">
                                            <label><spring:message code="gps.latitude.label" /> <span class="requiredField">*</span></label>
                                             <input type="text"  onblur="criteriaSlashes(this)" class="form-control" name="gpsLatitude" value="${outletDetails.gpsLatitude}" id="gpsLatitude" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.storelocation.label" />" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-4 allignment">
                                            <label><spring:message code="email.label" /> <span class="requiredField">*</span></label>
                                             <input type="text" class="form-control" name="email" value="${outletDetails.email}" id="emailIDinOutlet"  placeholder="<spring:message code="enter.email.lable"/> "/>
				                            <span id="emailIDinOutletError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                                        </div>
                                         <div class="form-group col-lg-4 allignment">
                                    ...
                                    <div class="form-group col-lg-4 allignment">
                                            <label><spring:message code="phone.label" /> <span class="requiredField">*</span></label>
                                             <div class="row">
				                                ...
				                                <%--   <c:set var="dataParts" value="${fn:split(outletDetails.phone, '-')}" /> --%>
				                                   <c:set var="dataParts" value="${fn:split(outletDetails.phone, '-')}" />
				                                  
				                                  <div class="col-lg-7 col-md-8 col-sm-8 col-xs-8" style="padding-left: 0px">
				                                  	<input type="text"  onblur="criteriaSlashes(this)"class="form-control" placeholder="<spring:message code="supplier.enter.phone.label" />" value="${dataParts[1]}" id="phoneNumber" size="15" onBlur="validateMobileNumber()" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
				                                  </div>
                                        ...
                                        <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text" name="fax" value="${outletDetails.fax}" class="form-control number" id="fax" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="Alternate Number" />
                            ...
                            <!-- time Picker -->
                                     ...
                                     <div class="form-group col-lg-4 " style="width:15%;">
                                         ...
                                         <input type="text"  onblur="criteria(this)" name="minPayAmount" value="${outletDetails.minPayAmount}" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" required id="amount" placeholder="<spring:message code="amount.label" />" />
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="form-group col-lg-2 " style="width:10%;    padding-left: 5px;">
                                        ...
                                        <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text"  onblur="criteriaSlashes(this)" name="gstIn" value="${outletDetails.gstIn}" id="gstIn" class="form-control" placeholder="<spring:message code="enter.gstin.no.label"/>" />
                                        </div>
...
<%--                                             	<option value="true" ${'true' == outletDetails.remoteMonitoring ? 'selected' : ''} >Yes</option> --%>
<%-- 		                                  		<option value="false" ${'false' == outletDetails.remoteMonitoring ? 'selected' : ''} >No</option> --%>
                                              <option value="true" ${outletDetails.dayStartSync == true ? 'selected' : ''}>Yes</option>
		                                  	  <option value="false" ${outletDetails.dayStartSync == false ? 'selected' : ''}>No</option>
		                                	</select>
                                         </div>
                                      </div>
                                ...
                                <div class="form-group col-lg-2 allignment">
									<label><spring:message code="created.date.label" /></label>
                                           <input class="form-control calendar_icon" disabled="disabled" readonly="readonly" style="background-color: white;" value="${outletDetails.createdDatestr}" name="createddate" id="createddate" size="20" type="text" onfocus="callCalender('createddate')" onclick="callCalender('createddate')" placeholder="DD/MM/YYYY"/>
                                ...
                                <div class="form-group col-lg-2 allignment">
									<label><spring:message code="suspend.Reason.label" /></label>
                                           <input class="form-control calendar_icon"  style="background-color: white;" name="suspendReason"  id="suspendReason" size="20" type="text"  />
                                       
								</div>
								
								<div class="form-group col-lg-2 allignment">
									<label>FSSAI Number</label>
                                     <input class="form-control"  style="background-color: white;" name="fssaiNumber"  id="fssaiNumber" size="20" type="text"  />
                               ...
                               <br>
                                 <div class="row">
                                   ...
                                   <td class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc; width: 9.6%;"> 
                                            ...
                                            <div class="radio">
                                               ...
                                               <div class="radio">
                                                <label style="white-space: nowrap;">
                                                   <input type="radio" name="outletType" value="Super Market" ${outletDetails.outletType=='Super Market'?'checked':''}> <spring:message code="super.market.label"/>
                                                </label>
                                            </div>
                                    ...
                                    <td class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc; width: 10.12%;">
                                      ...
                                      <%--    <label><spring:message code="mobilesecurity.label" /></label> --%>
                                   	...
                                   	<td class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 12.5%;"> 
                                   ...
                                   <table class="table" style="margin-bottom: 0px; width:98.8%">
    								...
    								<%-- Added by vasudeva Reddy --%>
                                     ...
                                     <td class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 8.2%"> 
                                         ...
                                         <div class="radio">
                                           <label>
                                             <input type="text" name="minimumOrderValue" id="minimumOrderValue" value="0" placeholder="" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
                                   ...
                                   <table class="table" style="margin-bottom: 0px; width:13.8%">
											    <thead style="background-color: #ececec !important; color: #ffffff ">
											      <tr>
											        <!-- <th> <label>Outlet Good Receipt Note</label></th> -->
                                       ...
                                       <td class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 8.2%;"> 
                                         <div class="radio">
                                           <label>
                                             <input type="radio" name="posStockDisplay" id="posStockDisplay" value="true" > <spring:message code="yes.label"/>
                                           </label>
                                         </div>
                                         <div class="radio">
                                           <label><input type="radio" name="posStockDisplay" id="posStockDisplay" value="false" ><spring:message code="no.label"/></label>
                                         </div>
                                      </td>
                                        ...
                                        <td class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 8.2%;"> 
                                         <div class="radio">
                                           <label>
                                             <input type="radio" name="billOtp" id="billOtp" value="true" > <spring:message code="yes.label"/>
                                           </label>
                                         </div>
                                         <div class="radio">
                                           <label><input type="radio" name="billOtp" id="billOtp" value="false" ><spring:message code="no.label"/></label>
                                         </div>
                                      </td>
                                      ...
                                      <td class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 8.2%"> 
                                         ...
                                         <div class="radio">
                                           <label>
                                             <input type="text" name="expectedDeliveryTime" id="expectedDeliveryTime" value="0" placeholder="" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
                                                 style="padding-left: 5px;width: 100px;"/>
                                           </label>
                                         </div>
                                         </td>
                               ...
                               <br>
                                ...
                                <div class="row">
                                       ...
                                       <div class="row seven-cols" style="padding-left:15px;">
                                        ...
                                        <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 13.3%;"> 
                                      ...
                                      <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 12.9%"> 
                                        <%--  <label><spring:message code="discount.taxation.label" /></label> --%>
                                         ...
                                         <div class="radio">
                                           <label style="white-space: nowrap;"><input type="radio" name="discountCalculatedOn" checked value="Discounted Price" ${outletDetails.discountCalculatedOn=='Discounted Price'?'checked':''}><spring:message code="discountedprice.label"/></label>
                                         </div>
                                      </div>
                                      <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 13.3%"> 
                                        <%--  <label><spring:message code="discount.taxation.label" /></label> --%>
                                         <div class="radio">
                                           <label>
                                             <input type="radio" name="discountTaxation" checked value="Inclusive" ${outletDetails.discountTaxation=='Inclusive'?'checked':''}> <spring:message code="procurement.shipmentCost.inclusive"/>
                                           </label>
                                         </div>
                                         <div class="radio">
                                      ...
                                      <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 14.8%"> 
                                     ...
                                     <%--     <label><spring:message code="campaign.pref.label" /></label> --%>
                                       ...
                                       <div class="row seven-cols" style="padding-left:15px;">
                                        ...
                                        <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 12.6%"> 
                                      ...
                                      <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 11.2%"> 
                                      ...
                                      <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 13.1%"> 
                                      ...
                                      <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 12.56%"> 
                                         ...
                                         <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 5.9%"> 
                                        ...
                                        <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 17.56%"> 
                                       ...
                                       <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 14.23%" > 
                                      ...
                                      <td class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 11.2%"> 
                                         ...
                                         <div class="radio">
                                           <label>
                                             <input type="text" name="stockMaintainDays" id="stockMaintainDays" value="1" placeholder="Days" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
                                                 style="padding-left: 5px;width: 100px;"/>
                                           </label>
                                         </div>
                                 ...
                                 <table class="table" style="margin-bottom: 0px; width:99%">
											    <thead style="background-color: #ececec !important; color: #ffffff ">
											      <tr>
												      ...
												      <th style="width: 14%;"><label><spring:message code="credit.note.label" /></label></th>
												      <th style="width: 14%;"><label><spring:message code="creditnote.expirydays.label" /></label></th>
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-1" style="">
                                      <%-- <label><spring:message code="returns.label" /></label> --%>
                                         ...
                                         <div class="form-group col-lg-7 col-md-7 col-sm-5" style="padding-left:0px;margin-left:32px">   
                                             <select class="form-control" id="Days" style="margin-top: 8px;padding:0px;" >
                                      ...
                                      <td class="form-group col-lg-1 col-md-1 col-sm-1" style=" width:8.50%;border-right: 2px solid #ccc;"> 
                                         ...
                                         <div class="radio">
                                           <label  style="white-space: normal;"><input type="radio" name="returnMode" value="creditNote" ${outletDetails.returnMode=='creditNote'?'checked':''}><spring:message code="creditnote.label" /></label>
                                         </div>
                                          <div class="radio">
                                           <label><input type="radio" name="returnMode" checked value="both" ${outletDetails.returnMode=='both'?'checked':''}><spring:message code="both.label" /></label>
                                         </div>
                                      </td>
                                      ...
                                      <td class="form-group col-lg-1 col-md-1 col-sm-1" style=" width:13.9%; border-right: 2px solid #ccc;"> 
                                        ...
                                        <%--  <label><spring:message code="exchangemode.label" /></label> --%>
                                         ...
                                         <div class="radio">
                                          ...
                                          <div class="radio">
                                           <label><input type="radio" name="exchangeMode" checked value="both" ${outletDetails.exchangeMode=='both'?'checked':''}><spring:message code="both.label" /></label>
                                         </div>
                                      </td>
                                      </tr>
                                      </tbody>
                                 ...
                                 <table class="table" style="margin-bottom: 0px; width:99%">
                                       ...
                                       <td class="form-group col-lg-1 col-md-1 col-sm-1" style=" width:13.9%; border-right: 2px solid #ccc;" > 
                                        <%--  <label><spring:message code="barcodetype.label" /></label> --%>
                                         ...
                                         <div class="radio">
                                           <label><input type="radio" name="barcodeType" checked value="both" ${outletDetails.barcodeType=='both'?'checked':''}><spring:message code="both.label" /></label>
                                         </div>
                                      </td>
                                      
				<td style=" width:13.9%; border-right: 2px solid #ccc;">                                        <%--  <label ><spring:message code="enforce_denominations.label" /></label> --%>
                                         <div class="radio">
                                           <label>
                                         ...
                                         <td style=" width:13.9%; border-right: 2px solid #ccc;">                                         <%-- <label><spring:message code="enforce_void_items_reason.label" /></label> --%>
                                         <div class="radio">
                                           <label>
...
<td style=" width:13.9%; border-right: 2px solid #ccc;">                                         <%-- <label><spring:message code="edit.price.label" /></label> --%>
                                         <div class="radio">
                                           <label>
...
<td>                                         <%-- <label><spring:message code="card.info.lable" /></label> --%>
                                         <div class="radio">
                                           <label>
             ...
             <div class="row seven-cols" style="padding-left:15px;">
                                 <table class="table" style="margin-bottom: 0px; width:97.7%">
                                      ...
                                      <td style=" width:13.9%; border-right: 2px solid #ccc;">                                        
                                        <div class="radio">
                                           <label>
                                             <input type="text" name="ftpIp" id="ftpIp" value="" placeholder="IP Address" 
                                                 style="padding-left: 5px;width: 135px;"/>
                                           </label>
                                         </div>
                                          <div class="radio">
                                           <label>
                                             <input type="text" name="ftpPort" id="ftpPort" value="" placeholder="Port" 
                                       ...
                                       <td>                                        
                                        <div class="radio">
                                           <label>
                                             <input type="text" name="ftpUserId" id="ftpUserId" value="" placeholder="User ID" 
                                                 style="padding-left: 5px;width: 150px;"/>
                                           </label>
                                         </div>
                                          <div class="radio">
                                           <label>
                                             <input type="text" name="ftpPasword" id="ftpPasword" value="" placeholder="Password" 
