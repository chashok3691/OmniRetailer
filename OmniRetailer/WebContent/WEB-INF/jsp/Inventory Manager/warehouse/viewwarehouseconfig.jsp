...
<div class="row">
  ...
  <div class="box box-primary">
								...
								<c:if test="${sessionScope.role == 'super admin'}">
									<input type="button" id="edit" style="" class="btnCls " onclick="viewWarehouseData('${wareHouse.warehouseId}','edit','${id}')" value="&nbsp;&nbsp;&nbsp;<spring:message code="edit.label" />&nbsp;&nbsp;&nbsp;" />
								</c:if>
...
<%-- 								  	<input type="button" id="edit"  class="btn bg-olive btn-inline" style="margin-left:1%;width: 68px;position: relative;" onclick="cleareStorageSystems('clear');" value="<spring:message code="storage_systems_clear.label" />" />
 --%>								  	<input type="button" class="btnCls " style="margin-left: 5%;" onclick="getWareHouses('${id}','0')" value="<spring:message code="cancel.label" />" />
									</div> 
									</div>  
									 <br> 
				                    ...
				                    <div  class="row">
				                      ...
				                      <label style="font-family: Calibri;color: gray;"><spring:message code="location.label" /><span class="requiredField">*</span></label>
                                         ...
                                         <input  type="text" disabled="disabled" readonly class="form-control" name="workLocation" id="workLocation"   value="${wareHouse.warehouseLocation}" readonly="readonly"  />
				                      ...
				                      <%-- <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control" name="mobileNumber" id="mobileNumber" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_phonenumber.label" />" value="${wareHouse.phone_number}"/>
                                             <div class="row" style="margin-left:1px">
				                                  ...
				                                  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="padding: 0px">
				                                  	<input type="text" class="form-control"  disabled="disabled" value="${wareHouse.phone_number}" placeholder="<spring:message code="enter.customer_contact_num.label" />" id="phoneNumber" size="15" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
				                                  </div>
                                           ...
                                           <%--  <input type="text" class="form-control" name="mobileNumber" id="mobileNumber" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_phonenumber.label" />" value="${wareHouse.phone_number}"/> --%>
                                             <div class="row" >
                                              <div class="col-lg-5 col-md-4 col-sm-4 col-xs-4">
				                                  	<select class="form-control" readonly disabled="disabled"  style="padding: 6px 8px;" id="defaultCountry" title="India - IN &#013;USA - US &#013;UK - GB &#013;Australia - AU">
				                                  ...
				                                  <div class="col-lg-7 col-md-8 col-sm-8 col-xs-8" style="padding: 0px;width: 50%;">
				                                  	<input type="text" readonly disabled="disabled" class="form-control"   value="" placeholder="<spring:message code="enter.customer_contact_num.label" />" id="phoneNumber" size="15" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
				                                  </div>
				                                  <input type="hidden" class="form-control" name="mobileNumber" id="mobileNumber"  value=""/>
				                                   <input type="hidden" id="output" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" readonly disabled="disabled" class="form-control"  name="houseNo" id="houseNo" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_no.label" />" value="${wareHouse.address_1}"/>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" readonly disabled="disabled" class="form-control"  name="locality" id=locality value="${wareHouse.locality}" 	placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="locality.label" />" />
...
<%--                                             <input type="text" class="form-control" name="country" id="country" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_country.label" />" />
 --%>                                           
                                          <input  id="country" readonly disabled="disabled" name ="country" class="form-control"  value="${wareHouse.country}"   />
  <%-- 
				                      ...
				                      <label style="font-family: Calibri;color: gray;"><spring:message code="new_warehouse_name.label" /> <span class="requiredField">*</span></label>
                                            <input type="text" readonly disabled="disabled" class="form-control"  name="warehouseName" id="warehouseName" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_name.label" />" value="${wareHouse.warehouse_name}"/>
				                      ...
				                      <div class="col-lg-8 leftPadding">
                                            ...
                                            <input type="text" class="form-control" readonly disabled="disabled" name="emailid"  value="${wareHouse.email}" id="emailid"  placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="emailid.label" />" value=""/>
                                        </div> 
                                        </div>
				                      ...
				                      <div class="col-lg-12 leftPadding">
                                            ...
                                            <input type="text" class="form-control" readonly disabled="disabled"  name="street" id="street"  placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="street.name.label" />" value="${wareHouse.address_2}"/>
				                      ...
				                      <div class="col-lg-12 leftPadding">
                                          <div class="col-lg-4 leftPadding22">
                                            ...
                                            <input type="text" class="form-control" readonly disabled="disabled" name="city" id="city" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_city.label" />" value="${wareHouse.city}"/>
                                      ...
                                      <input  id ="state" class="form-control" readonly disabled="disabled" name="state"  value="${wareHouse.state}"   />
                                            ...
                                            <input type="text" readonly disabled="disabled" class="form-control"  name="zip" id="zip" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_zip.label" />" value="${wareHouse.zip}"/>
										...
										<div class="col-lg-6 leftPadding22" style="white-space: nowrap;">
                                            ...
                                            <input type="text" readonly disabled="disabled" class="form-control"  value="${wareHouse.gpsLongitude}" name="gpsLongitude" id="gpsLongitude" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.storename.label" />" />
                                       ...
                                       <div class="col-lg-6" style="white-space: nowrap;padding: 0px;">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="gps.latitude.label" /> <span class="requiredField">*</span></label>
                                             <input type="text" readonly disabled="disabled" class="form-control"  value="${wareHouse.gpsLatitude}" name="gpsLatitude" id="gpsLatitude" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.storename.label" />" />
				                     ...
				                     <div class="form-group row">
                                            ...
                                            <input type="text" readonly disabled="disabled" class="form-control"  name="warehouseType" id="warehouseType" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_type.label" />" value="${wareHouse.warehouse_type}"/>
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                                           <select class="form-control" readonly disabled="disabled"  name="posenabled" id="posenabled">
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                                           <select class="form-control" readonly disabled="disabled"  name="remoteMonitoring" id="remoteMonitoring">
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                                            <select class="form-control" readonly disabled="disabled" name="devicessecured" disabled="disabled" id="devicessecured">
                                          ...
                                          <input type="text" readonly disabled="disabled" class="form-control " disabled="disabled" style="width:40px" id="radius" name="radius" value="${wareHouse.radius}"  >
                                        ...
                                        <div class="form-group row">
                                          <div class="col-lg-11 nopadding" style="white-space: nowrap;">
                                           ...
                                           <input type="text" readonly disabled="disabled" class="form-control timepicker"  name="starttime" id="starttime" value="${wareHouse.startTimeStr}" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="starttime.label" />" />
                                          ...
                                          <div class="col-lg-6" style="padding: 0px;">
                                            ...
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="endtime.label" /></label>
                                             <input type="text" readonly disabled="disabled" class="form-control timepicker"  name="endtime" id="endtime" value="${wareHouse.endTimeStr}" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="endtime.label" />" />
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                                          <select class="form-control" readonly disabled="disabled"  name="isittestwarehouse" id="isittestwarehouse">
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                                           <select class="form-control" readonly disabled="disabled"  name="isitfranchise" id="isitfranchise">
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                                             <select class="form-control" readonly disabled="disabled" name="Pickedlist" id="Pickedlist">
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                                            <select class="form-control" readonly disabled="disabled" name="Storagesystemsenabled" id="Storagesystemsenabled">
                                        ...
                                        <div class="form-group row"> 
                                         <div class="col-lg-10 leftPadding" style="">
                                            ...
                                            <input class="form-control calendar_icon" readonly disabled="disabled" type="text" value="${wareHouse.createdDateStr}" id="CreateDate"  onfocus="callCalender('CreateDate')"  size="20" onclick="callCalender('CreateDate')" placeholder="DD/MM/YYYY" />
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                                            <select class="form-control" readonly disabled="disabled" name="warehouseStatus" id="warehouseStatus">
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                                            <select class="form-control" readonly disabled="disabled" onchange="mainwarehousefn(this);" name="isitdistribution" id="isitdistribution">
...
<%--                                             <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
 --%>                      <input  type="text" class="form-control" readonly disabled="disabled" name="workLocation" id="workLocation"   value="${wareHouse.mainWarehouse}"   />
                                        ...
                                        <div class="form-group row">
									     <div class="col-lg-11 leftPadding">
                                            ...
                                            <input type="text" readonly disabled="disabled" class="form-control" name="gstin" id="gstin" value="${wareHouse.gstin}" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="gst.in" />" />
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-11 leftPadding" style="">
                                          <label style="font-family: Calibri;color: gray;"><spring:message code="updated.date.label" /> </label>
                                             <input  class="form-control calendar_icon" type="text" readonly disabled="disabled"  value="${wareHouse.updatedDateStr}" id="UpdateDate"  onfocus="callCalender('UpdateDate')"  size="20" onclick="callCalender('UpdateDate')"   placeholder="DD/MM/YYYY" />
                                        </div>
                                        </div>
				                     ...
				                     <div class="row">
									  ...
									  <div class="form-group col-lg-4">
									   ...
									   <div class="form-group col-lg-5">
                                          <label style="font-family: Calibri;color: gray;"><spring:message code="new_warehouse_name.label" /> <span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" disabled="disabled" name="warehouseName" id="warehouseName" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_name.label" />" value="${wareHouse.warehouse_name}"/>
                                            <span id="warehouseNameErr" style="text-align:right;color:red;font-weight:bold;"></span>
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-5">
                                              <label style="font-family: Calibri;color: gray;"><spring:message code="emailid.label" /></label>
                                            <input type="text" class="form-control" disabled="disabled" name="emailid"  value="${wareHouse.email}" id="emailid"  placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="emailid.label" />" value=""/>
                                        </div>  
				                     </div>
				                     ...
				                     <div class="row">
                                        <div class="form-group col-lg-4">
                                            ...
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="new_plot_no.label" /> <span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" disabled="disabled" name="houseNo" id="houseNo" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_no.label" />" value="${wareHouse.address_1}"/>
                                            <span id="houseNoErr" style="text-align:right;color:red;font-weight:bold;"></span>
                                        ...
                                        <div class="form-group col-lg-8">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="street.name.label" /><span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" disabled="disabled"  name="street" id="street"  placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="street.name.label" />" value="${wareHouse.address_2}"/>
                                            <span id="streetErr" style="text-align:right;color:red;font-weight:bold;"></span>
                                        </div>  
                                        </div>
				                      ...
				                      <div class="row">
                                        <div class="form-group col-lg-4" style="margin-top:-12px">
                                             ...
                                             <label style="font-family: Calibri;color: gray;"><spring:message code="locality.label" /> <span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" disabled="disabled" name="locality" id=locality value="${wareHouse.locality}" 	placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="locality.label" />" />
                                            <span id="localityErr" style="text-align:right;color:red;font-weight:bold;"></span>
                                        </div>
                                        <div class="form-group col-lg-8" style="padding:0px;margin-top: -12px">
                                           ...
                                           <div class="form-group col-lg-4">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="new_warehouse_city.label" /> <span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" disabled="disabled" name="city" id="city" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_city.label" />" value="${wareHouse.city}"/>
                                            <span id="cityErr" style="text-align:right;color:red;font-weight:bold;"></span>
                                        </div>      
                                             <div class="form-group col-lg-4" >
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="new_warehouse_state.label" /> <span class="requiredField">*</span></label>
                                              
                                      <input  id ="state" class="form-control" name="state"  value="${wareHouse.state}" readonly="readonly"  />
                                             ...
                                             <div class="form-group col-lg-4" >
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="new_warehouse_zip.label" /> <span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" disabled="disabled" name="zip" id="zip" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_zip.label" />" value="${wareHouse.zip}"/>
                                            <span id="zipErr" style="text-align:right;color:red;font-weight:bold;"></span>
                                        </div>
                                        </div>
                                        </div>
                                          ...
                                          <div class="row">
									    <div class="form-group col-lg-2" style="margin-top:-28px;white-space: nowrap;padding:0px;margin-left:16px">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="gps.longitude.label" /> <span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" disabled="disabled" value="${wareHouse.gpsLongitude}" name="gpsLongitude" id="gpsLongitude" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.storename.label" />" />
                                            <span id="gpsLongitudeError" style="text-align:right;color:red;font-weight:bold;"></span>
                                        </div>
                                         <div class="form-group col-lg-2"></div>
                                        <div class="form-group col-lg-2" style="margin-top:-28px;white-space: nowrap;padding:0px">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="gps.latitude.label" /> <span class="requiredField">*</span></label>
                                             <input type="text" class="form-control" disabled="disabled" value="${wareHouse.gpsLatitude}" name="gpsLatitude" id="gpsLatitude" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.storename.label" />" />
				                            <span id="gpsLatitudeError" style="text-align:right;color: red;font-size: 2;font-weight: bold;"></span>
                                        </div>
                                          ...
                                          <input  id="country"  name ="country" class="form-control"  value="${wareHouse.country}" readonly="readonly"  />
									    ...
									    <div class="form-group col-lg-3" style="margin-top:-12px">
                                             <label style="font-family: Calibri;color: gray;"><spring:message code="created.date.label" /></label>
                                            <input class="form-control calendar_icon" disabled="disabled" type="text" value="${wareHouse.createdDateStr}" id="CreateDate" "  onfocus="callCalender('CreateDate')"  size="20" onclick="callCalender('CreateDate')" placeholder="DD/MM/YYYY" />
                                        	
                                        </div>
                                         <div class="form-group col-lg-1"></div>
                                        <div class="form-group col-lg-3" style="margin-top:-12px">
                                          <label style="font-family: Calibri;color: gray;"><spring:message code="updated.date.label" /> </label>
                                             <input  class="form-control calendar_icon" type="text"  disabled="disabled" value="${wareHouse.updatedDateStr}" id="UpdateDate"   	onfocus="callCalender('UpdateDate')"  size="20" onclick="callCalender('UpdateDate')"   placeholder="DD/MM/YYYY" />
                                        </div>
				                     ...
				                     <div class="row">
				                                <div class="form-group col-lg-4">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="new_business_type.label" /> <span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" disabled="disabled" name="warehouseType" id="warehouseType" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_type.label" />" value="${wareHouse.warehouse_type}"/>
                                            <span id="warehouseTypeErr" style="text-align:right;color:red;font-weight:bold;"></span>
                                        </div>
                                         ...
                                         <div class="form-group col-lg-3" style="white-space: nowrap;">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="isit.test.warehouse.label" /> </label>
                                            <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
                                          <select class="form-control" disabled="disabled"  name="isittestwarehouse" id="isittestwarehouse">
											<option value="true" ${wareHouse.testWarehouse == true ? 'selected' : ''}>Yes</option>
		                                  	  <option value="false" ${wareHouse.testWarehouse == false ? 'selected' : ''}>No</option>
										</select>
                                         ...
                                         <div class="form-group col-lg-4">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="new_warehouse_status.label" /> <span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
                                            <select class="form-control" disabled="disabled" name="warehouseStatus" id="warehouseStatus">
                                             <option value="Enable"${wareHouse.warehouse_status == true ? 'selected' : ''}>Enable</option>
                                             <option value="Disable"${wareHouse.warehouse_status == false ? 'selected' : ''}>Disable</option>
                                             </select>
                                            <span id="statusErr" style="text-align:right;color:red;font-weight:bold;"></span>
									...
									<div class="row">
									 <div class="form-group col-lg-3">
                                             <label style="font-family: Calibri;color: gray;"><spring:message code="pos.enabled.label" /> </label>
                                            <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
                                           <select class="form-control" disabled="disabled" name="posenabled" id="posenabled">
												<option value="true" ${wareHouse.posEnabled == true ? 'selected' : ''}>Yes</option>
		                                  	  <option value="false" ${wareHouse.posEnabled == false ? 'selected' : ''}>No</option>
										</select>
                                        ...
                                        <div class="form-group col-lg-1"></div>   
                                          ...
                                          <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
                                           <select class="form-control" disabled="disabled"  name="isitfranchise" id="isitfranchise">
												<option value="true" ${wareHouse.itFranchise == true ? 'selected' : ''}>Yes</option>
		                                  	  <option value="false" ${wareHouse.itFranchise== false ? 'selected' : ''}>No</option>
                                         ...
                                         <div class="form-group col-lg-4" style="white-space: nowrap;">
                                             <label style="font-family: Calibri;color: gray;"><spring:message code="isit.distribution.center" /> <span class="requiredField">*</span></label>
                                            <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
                                            <select class="form-control" disabled="disabled" name="isitdistribution" id="isitdistribution">
												<option value="true" ${wareHouse.itDistributionCenter == true ? 'selected' : ''}>Yes</option>
		                                  	  <option value="false" ${wareHouse.itDistributionCenter == false ? 'selected' : ''}>No</option>
										</select>
                                        </div>    
									...
									<div class="row">
									    ...
									    <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
                                           <select class="form-control" disabled="disabled" name="remoteMonitoring" id="remoteMonitoring">
												<option value="true" ${wareHouse.remoteMonitoring == true ? 'selected' : ''}>Yes</option>
		                                  	  <option value="false" ${wareHouse.remoteMonitoring == false ? 'selected' : ''}>No</option>
										</select>
                                          ...
                                          <div class="form-group col-lg-4" style="white-space: nowrap;">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="Picked.list.enabled" /> </label>
                                            <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
                                             <select class="form-control" disabled="disabled" name="Pickedlist" id="Pickedlist">
												<option value="true" ${wareHouse.authorizedPicklist == true ? 'selected' : ''}>Yes</option>
		                                  	  <option value="false" ${wareHouse.authorizedPicklist == false ? 'selected' : ''}>No</option>
										</select>
                                         ...
                                         <div class="form-group col-lg-4" style="white-space: nowrap;">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="main.warehouse" /> </label>
                                            <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
                      <input  type="text" class="form-control" name="workLocation" id="workLocation"   value="${wareHouse.mainWarehouse}" readonly="readonly"  />
									...
									<div class="row">
									 ...
									 <div class="form-group col-lg-4">
									  <div class="form-group col-lg-8" style="padding:0px">
                                          ...
                                          <div class="form-group col-lg-4" style="white-space: nowrap;">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="Storagesystems.enabled" /></label>
                                            <input type="text" class="form-control" name="warehouseStatus" id="warehouseStatus" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="new_warehouse_status.label" />" />
                                            <select class="form-control" disabled="disabled" name="Storagesystemsenabled" id="Storagesystemsenabled">
												<option value="true" ${wareHouse.storageSystemEnabled == true ? 'selected' : ''}>Yes</option>
		                                  	  <option value="false" ${wareHouse.storageSystemEnabled == false ? 'selected' : ''}>No</option>
										</select>
                                         ...
                                         <div class="form-group col-lg-4">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="gst.in" /> </label>
                                            <input type="text" class="form-control" disabled="disabled" name="gstin" id="gstin" value="${wareHouse.gstin}" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="gst.in" />" />
				                     ...
				                     <div class="row" style="margin-left:-16px">
                                          ...
                                          <div class="form-group col-lg-4"  style="white-space: nowrap;padding: 0px;margin-left: 17px;">
                                            ...
                                            <div class="bootstrap-timepicker">
                                             <label style="font-family: Calibri;color: gray;"><spring:message code="starttime.label" /></label>
                                           <input type="text" class="form-control timepicker" disabled="disabled" name="starttime" id="starttime" value="${wareHouse.startTimeStr}" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="starttime.label" />" />
                                          ...
                                          <div class="form-group col-lg-6" style="padding-left: 0px;">
                                           <div class="bootstrap-timepicker">
                                            <label style="font-family: Calibri;color: gray;"><spring:message code="endtime.label" /></label>
                                             <input type="text" class="form-control timepicker" disabled="disabled" name="endtime" id="endtime" value="${wareHouse.endTimeStr}" placeholder="<spring:message code="warehouse_enter.label" />&nbsp;<spring:message code="endtime.label" />" />
                                    ...
                                    <br>
                                     ...
                                     <div class="row">
                                       ...
                                       <div class="row seven-cols" style="padding-left:15px;pointer-events: none;">
