  ...
  <div class="col-lg-12">
				<div class="box box-primary">
							...
							<a style="float:right;color:#2e7ea7 !important;cursor: pointer;margin-top: 20px;" data-toggle="modal" data-target="#myModal"><u>Help</u></a>                              
                                <h3 class="box-title" style="padding :5px;  border:1px solid  #808080;">New Warehouse POS</h3>
						...
						<br>
						 <input type="button" id="submit" class="btnCls" style="margin-right: 25px" onclick="validateWareHousePOS('new');" value="&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="createNewArrivals.button.save" />&nbsp;&nbsp;&nbsp;&nbsp;" />
						 <!-- <input type="submit" class="btn bg-olive btn-inline" style="margin-left:5%;" onclick="" value="Reset" /> -->
						 <c:if test="${sessionScope.role == 'super admin'}">
						<input type="button" class="btnCls"  style="margin-right: 2%;" onclick="return getWareHousespos('WarehousePOSs','0');" value="<spring:message code="cancel.label" />" />
					</c:if>
					<c:forEach var="accessControl" items="${sessionScope.outletManagement}">
						...
						<input type="button" class="btnCls" style="margin-right: 2%;"  onclick="getWareHousespos('WarehousePOSs','0');" value="<spring:message code="cancel.label" />" />
						</c:if>
					</c:forEach>
						</div>
									...
									<!--   </div> -->
									  <div class="form-group col-lg-4 allignment">
									     <label><spring:message code="location.label" /></label>
                                           <select class="form-control" name="location" id="workLocation" onchange="warehouseidset();">
                                             <c:forEach var="location" items="${warehouses}" > 
												 <option value="${location.warehouseLocation}-${location.warehouseId}" ${selectedLocation == location.warehouseLocation ? 'selected' : ''}>${location.warehouseLocation}-${location.warehouseId}</option>
            ...
            <%-- <img class="thumbnail companyimage" id="dealBanner_thumbnail" alt="No Image" src="data:image/jpeg;base64,${denominationMasterResponse.denominationImage}" style=""/> --%>
									...
									<div class="row">
									    <div class="form-group col-lg-4 allignment">
                                            <label><spring:message code="warehouse_name.label" /></label>
                                            <input type="text"  onblur="criteria(this)" class="form-control" value="${outletDetails.storeName}" name="storeName" readonly="readonly" id="storename" placeholder="<spring:message code="enter.storename.label" />" />
                                         ...
                                         <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text"  onblur="criteria(this)" class="form-control" value="${outletDetails.street}" name="storeName" id="street" placeholder="<spring:message code="enter.road.street.label" />" />
                                         ...
                                         <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text"  onblur="criteria(this)" class="form-control" value="${outletDetails.locality}" name="storeName" id="locality" placeholder="<spring:message code="enter.locality.label" />" />
                                         ...
                                         <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text"  onblur="criteria(this)" class="form-control" value="${outletDetails.gpsLongitude}" name="gpsLongitude" id="gpsLongitude"  placeholder="<spring:message code="enter.storelocation.label" />" />
                                        ...
                                        <div class="form-group col-lg-4 allignment">
                                            <label><spring:message code="gps.latitude.label" /> <span class="requiredField">*</span></label>
                                             <input type="text"  onblur="criteria(this)" class="form-control" name="gpsLatitude" value="${outletDetails.gpsLatitude}" id="gpsLatitude" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" placeholder="<spring:message code="enter.storelocation.label" />" />
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="form-group col-lg-4 allignment">
                                           ...
                                           <!--  <select class="form-control" id="warehouseId" disabled >
		                                  		  	...
		                                  		  	<input type="text" readonly="readonly" class="form-control" id="warehouseId" value=""/>
                                            <span id="categoryError" style="text-align:right;color:red;font-weight:bold;"></span>
                                        </div>
                                         <div class="form-group col-lg-4 " style="width:15%;">
                                        ...
                                        <div class="form-group col-lg-4 allignment">
                                            ...
                                            <input type="text"  onblur="criteria(this)" name="gstIn" value="${outletDetails.gstIn}" id="gstIn" class="form-control" placeholder="<spring:message code="enter.gstin.no.label"/>" />
                                        </div>
...
<%-- 		                                  		<option value="false" ${'false' == outletDetails.remoteMonitoring ? 'selected' : ''} >No</option> --%>
                               ...
                               <br>
                                 <div class="row">
                                   ...
                                   <div class="row seven-cols" style="padding-left:15px;">
                                   <table class="table" style="margin-bottom: 0px; width:23.8%">
											    <thead style="background-color: #ececec !important; color: #ffffff ">
											      <tr>
                                ...
                                <div class="row">
                                      ...
                                      <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 12.9%"> 
                                        <%--  <label><spring:message code="discount.taxation.label" /></label> --%>
                                         ...
                                         <div class="radio">
                                           <label><input type="radio" name="discountCalculatedOn" checked value="Discounted Price" ${outletDetails.discountCalculatedOn=='Discounted Price'?'checked':''}><spring:message code="discountedprice.label"/></label>
                                         </div>
                                      </div>
                                      <div class="form-group col-lg-1 col-md-1 col-sm-1" style="border-right: 2px solid #ccc;width: 13.3%"> 
                                        <%--  <label><spring:message code="discount.taxation.label" /></label> --%>
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-1" style="">
                                      <%-- <label><spring:message code="returns.label" /></label> --%>
                                         ...
                                         <div class="form-group col-lg-7 col-md-7 col-sm-5" style="padding-left:0px;margin-left:32px">   
                                             <select class="form-control" id="returnDays" style="margin-top: 8px;padding:0px;" >
...
<!--                                        <div class="form-group col-lg-1 col-md-1 col-sm-1"style="border-right: 2px solid #ccc; width:15.00%;">  -->
                                         <label><spring:message code="bill_cancel_reason.label" /></label>
                                           ...
                                           <select class="form-control" id="expiryDays" style="margin-top: 5px;" >
		                                  	<c:forEach begin="0" end="30" varStatus="loop">
		                                  		 <option value="${loop.index}" ${loop.index == outletDetails.creditNoteExpiryDays ? 'selected' : ''}>${loop.index}</option>
											</c:forEach>
		                                    </select>
                                        </td	>
                                      ...
                                      <td class="form-group col-lg-1 col-md-1 col-sm-1" style=" width:13.9%; border-right: 2px solid #ccc;"> 
                                        <%--  <label><spring:message code="exchanges.label" /></label> --%>
                                         ...
                                         <div class="form-group col-lg-7 col-md-7 col-sm-5" style="padding-left:0px;margin-left:32px">   
                                             <select class="form-control" id="exchangeDays" style="margin-top: 8px;padding:0px;" >
		                                  	<c:forEach begin="0" end="100" varStatus="loop">
...
<td style=" width:13.9%; border-right: 2px solid #ccc;">                                         <%-- <label><spring:message code="card.info.lable" /></label> --%>
                                         <div class="radio">
                                           <label>
            ...
            <br>
             ...
             <div class="row seven-cols" style="padding-left:15px;">
                                 ...
                                 <table class="table" style="margin-bottom: 0px; width:24%">
                                   ...
                                   <div class="radio">
                                           <label>
                                             <input type="radio" name="billOTP" value="true" ${outletDetails.billOTP=='true'?'checked':''}> <spring:message code="yes.label"/>
                                           </label>
                                         </div>
                                         <div class="radio">
                                           <label><input type="radio" name="billOTP" value="false" ${outletDetails.billOTP=='false'?'checked':''}><spring:message code="no.label"/></label>
                                         </div>
                                      </td>   
											      </tr>
                                  ...
                                  <%--  <div class="row">
                           		...
                           		<%-- <div class="row">
									    <div class=" col-lg-3">
                                            ...
                                            <input type="text"  onblur="criteria(this)" class="form-control" name="buildingName" id="buildingName" />
