             ...
             <div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 20px; margin-top: -20px">${success}</div>
                  <input type="hidden" id="flowUnder" value="${flowUnder}">
                    <input type="hidden" id="verification_code" value="${verificationcode}">
                     <input type="hidden" id="master_verification_code" value="${productStockVerificationItemDetailsList.masterVerificationCode}">
                 <%--  <div class="row">
	             ...
	             <div class="col-lg1-3 col-lg-3">
                	 	...
                	 	<input class="form-control" name="approved_by" onblur="criteria(this)" id="approvedBy" placeholder="Enter Name" type="text" value="${ productStockVerificationItemDetailsList.verified_by}" >
	              </div>
	            </div>
	             ...
	             <div class=" col-lg-4">
                                ...
                                <div class=" col-lg-4" style="padding-left: 0px;">
                                            ...
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="startTime" id="startTime" value="${ productStockVerificationItemDetailsList.startTime}"/>
                                            </div><!-- /.input group -->
                                        </div><!-- /.form group -->
                                         </div>
                                ...
                                <div class=" col-lg-4" style="padding-left: 0px;">
                                           ...
                                           <label><spring:message code="end.time.label"/></label>
                                            <div class="input-group">                                            
                                                <input type="text" class="form-control timepicker" name="endTime" id="endTime" value="${ productStockVerificationItemDetailsList.endTime}"/>
                                            </div><!-- /.input group -->
                                        </div><!-- /.form group -->
                       ...
                       <div class="row">
                                     ...
                                     <c:forEach var="productStockVerificationItemDetails" items="${productStockVerificationItemDetailsList.itemsList}" varStatus="theCount">
                                      <tr id="dynamicdiv${theCount.count}">
                                         ...
                                         <td id="slno${theCount.count}" class="slno">${theCount.count}</td>
                                         <input type="hidden" value="${productStockVerificationItemDetails.s_no}" id="sno${theCount.count}">
                                       	...
                                       	<td id="OpenStock${theCount.count}">${productStockVerificationItemDetails.openStock}</td>
                                      		<td id="Supplied${theCount.count}">${productStockVerificationItemDetails.skuCostPrice}</td>
                                      			<td id="ActualQty${theCount.count}">${productStockVerificationItemDetails.skuCostPrice}</td>
                                      				<td id="Dump${theCount.count}" contenteditable='true'>${productStockVerificationItemDetails.dumpQty}</td>
                     ...
                     <input type="button" class="btnCls" onclick="validateVerification('edit');" class="run" value="<spring:message code="submit.label"/>">
                 
                  
                   
                    
                      <input type="button" class="btnCls buttonMargin" onclick="viewWarehouseStockVerification('outletStockVerification','0','${flowUnder}','menu','${productStockVerificationItemDetailsList.masterVerificationCode}','');" value="<spring:message code="cancel.label" />" >
