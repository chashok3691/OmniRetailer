                                        ...
                                        <tbody style="text-align: center;">
                                           <c:forEach var="productStockVerificationDetails" items="${productStockVerificationDetailsList}">
                                            <tr>
                                            	...
                                            	<td> <a style="color:#2e7ea7 !important;cursor: pointer;" onclick="viewSpecificStockVerification('${productStockVerificationDetails.verification_code}','0');"><spring:message code="view.label"/> <spring:message code="reports.label"/></a> 
                                        ...
                                        <tbody style="text-align: center;">
                                           <c:forEach var="productStockVerificationDetails" items="${productStockVerificationDetailsList}">
                                            <tr>
                                            	...
                                            	<%-- <td>${productStockVerificationDetails.remarks}</td> --%>
                                            	<td><a style="color:#2e7ea7 !important;cursor: pointer;" onclick="viewEditWarehouseStockVerification('${productStockVerificationDetails.verification_code}','0')" ><spring:message code="view.stock.verification" /></a> &nbsp;
                                             <a style="color:#2e7ea7 !important;cursor: pointer;" onclick="viewWarehouseStockVerification('warehouseStockVerification','0','warehouse','menu','${productStockVerificationDetails.verification_code}');"><spring:message code="view.verfification.label"/></a> 
                                            	</td>	
                                            </tr>
                                          </c:forEach>
                                        </tbody>
               ...
               <div class="row">
              	...
              	<c:if test="${totalValue == totalRecords}">
              			<c:if test="${totalValue-10 >0}">
              				<div class="form-group col-lg-12" style="text-align: right;">
              		<input type="button" class='paginationButton' value="&#60;" onclick="return viewStockVerification('','${index - 11}');"> ${index} - ${totalValue} of ${totalRecords} 
