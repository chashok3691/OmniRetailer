...
<div class="row">
  <div class="col-lg-12">
  <div class="box box-primary" disabled="disabled">
		...
		<br>
             ...
             <div id="Success" class="Error" style="text-align: center;color: blue;font-size: 2;font-weight: bold;margin-bottom: 20px; margin-top: -20px">${success}</div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg1-3 col-lg-3">
                       ...
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select readonly class="form-control" id="outletCategory" onchange="searchSubCategories('outletCategory','outletSubcategory')">
                    ...
                    <div class="col-lg1-3 col-lg-3">
                     <div class="col-lg-2"></div>
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select readonly class="form-control" id="outletBrandId"  >
                           		 <option value=""><spring:message code="ALL.label"/></option>
	             ...
	             <div class="col-lg1-3 col-lg-3">
                	 	...
                	 	<input class="form-control" readonly name="approved_by" id="approvedBy"  placeholder="Enter Name" type="text" value="${whstockverifiObj.approvedBy}">
	              </div>
	            </div>
                    ...
                    <div class="col-lg1-3 col-lg-3">
                     <div class="col-lg-2"></div>
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select readonly class="form-control" id="outletDepartmentId"  >
                           		 <option value=""><spring:message code="ALL.label"/></option>
                       ...
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                           ...
                           <select readonly class="form-control" id="outletSubcategory" >
                           		 <option value=""><spring:message code="ALL.label"/></option>
                       ...
                       <div class="col-lg-8" style="padding-left:0px;padding-right: 0px;">
                          <%--  <label><spring:message code="model.label"/></label>
                           <select readonly class="form-control" id="outletDepartmentId"  >
	                        ...
	                        <label>Group</label>
                       		<select class="form-control" readonly disabled name="outletProductGroup" id="outletProductGroup" onclick="selectProductGroupOnly();">
		             ...
		             <label><spring:message code="status.label"/></label>
		               <%-- 
                                           ...
                                           <!--  <option value="Write Off">Write Off</option> -->
                                            ...
                                            <select readonly class="form-control" style="height:30px;" name="searchType" id="searchType" onchange="searchStocks('','','0');">
		           ...
		           <div class="bootstrap-timepicker">
                     ...
                     <div class="row">
                       ...
                       <div style="padding-left:0px;">  
                	 	...
                	 	<input class="form-control calendar_icon form-group" readonly  value="${whstockverifiObj.verificationStartDateStr}"  style="background-color: white;" id="from" size="20" type="text" onfocus="callCalender('from')" onclick="callCalender('from')" placeholder="DD/MM/YYYY" />
                                        </div>
                                        </div>
	                 	...
	                 	<input class="form-control calendar_icon form-group" readonly   value="${whstockverifiObj.verificationEndDateStr}" style="background-color: white;" id="to" size="20" type="text" onfocus="callCalender('to')" onclick="callCalender('to')" placeholder="DD/MM/YYYY" />
                                        </div>
                                        </div></div></div></div>
                       ...
                       <div style="padding-left:0px;">  
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="address-details col-lg-6 col-xs-8">
                                          <label><spring:message code="starttime.label"/> <span class="requiredField">*</span></label>
                	 <div class="input-group"> 
                	 <input type="text" class="form-control timepicker" readonly   name="startTime" id="startTime" value="${whstockverifiObj.startTimeStr }"/>
                                       <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div></div>
                                        </div>
                                        ...
                                        <div class="address-details col-lg-6 col-xs-8">
                                           <label><spring:message code="endtime.label"/> <span class="requiredField">*</span></label>
	                 	   <div class="input-group"> 
	                 	  <input type="text" class="form-control timepicker" readonly value="" name="startTime" value="${whstockverifiObj.endTimeStr }" id="endTime"/>
                                      <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div></div>
                                        </div>
   ...
   <div class="col-lg-1"></div>
      ...
      <div class="col-lg-1" readonly >
     <label class="checkbox-inline" style="margin-top:-2px;margin-left:-96px;">
      <c:if  test="${whstockverifiObj.isPeriodic == 'true'}"> 
     <input type="checkbox"  name="repetitive"  id="repetitive"  checked style="margin-top:0px;zoom: 1.5;" > </c:if>
                    ...
                    <c:if test="${sessionScope.role != 'super admin' && flowUnder == 'outlet'}">
			           <c:forEach var="accessControl" items="${sessionScope.outletStockVerification}">
			                <c:if test="${accessControl.appSubDocument == 'OutletStockVerification' && accessControl.write == true && accessControl.read == true}">
			                	 <a class="btnCls" onclick="viewStockVerification('outletStockVerification','0','outlet','menu','');"><spring:message code="cancel.label"/></a>
		                	</c:if>
		                </c:forEach>
		             </c:if>
                    ...
                    <c:if test="${sessionScope.role != 'super admin' && flowUnder == 'warehouse'}">
			           <c:forEach var="accessControl" items="${sessionScope.warehouseStockmanagement}">
			                <c:if test="${accessControl.appDocument == 'WarehouseStockVerification' && accessControl.write == true && accessControl.read == true}">
			                	<input type="button" class=" btnCls" style="" onclick="viewStockVerification('warehouseStockVerification','0','warehouse','menu','');" value="<spring:message code="cancel.label"/>">
		                	</c:if>
		                </c:forEach>
		             </c:if>
