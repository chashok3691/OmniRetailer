  ...
  <div class="col-lg-12">
				<div class="box box-primary">
                                ...
                                <form>
                                   ...
                                   <div class="row" style="text-align: right; margin-top: -27px;">
                                    <div id="Error" style="text-align:center;color:red;font-weight:bold;">${err}</div>
										<%-- <input type="button" id="edit" style="visibility: hidden;width: 54px;position: relative;" class="btn bg-olive btn-inline" onclick="editOrder('warehouse');" value=" <spring:message code="edit.label" /> " /> --%>
										<input type="button" class="btn bg-olive btn-inline" style="margin-left:2%; margin-right: 1%;position: relative;" onclick="viewWarehouseOrders('${orderDetails.orderStatus}','wshipmentOrders','0');" value="<spring:message code="back.label" />" />
                                    ...
                                    <div class="row">
                                     <div class="form-group col-lg-3"></div>
                                      ...
                                      <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="saleLocation" id="warehouseLocation" readonly value="${orderDetails.saleLocation}"/>
                                     </div>
                                      <div class="form-group col-lg-3"></div>
                                     </div>
                              ...
                              <div class="row">
                                     ...
                                     <div class="form-group col-lg-3">
                                            <input type="text" class="form-control" readonly name="orderTax" id="totalTax" value="${orderDetails.orderTax}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"/>
                                     </div>
                                   </div> 
                             <div class="row">
                                     <div class="form-group col-lg-6"></div>   
						...
						<div class="row" style="text-align: right;">
							<%-- <input type="button" id="edit1" style="visibility: hidden;width: 54px;" class="btn bg-olive btn-inline" onclick="editOrder('warehouse');" value="<spring:message code="edit.label" />" /> --%>
							<input type="button" class="btn bg-olive btn-inline" style="margin-left:2%; margin-right: 1%;" onclick="viewWarehouseOrders('${orderDetails.orderStatus}','wshipmentOrders','0');" value="<spring:message code="back.label" />" />
						</div>
						<br/>
