  ...
  <div class="col-lg-12">
				<div class="box box-primary">
						 ...
						 <c:if test="${sessionScope.role == 'super admin'}">
							<input type="button" id="submit" class="btnCls" style="margin-right: 25px"  onclick="viewWarehouseposData('${wareHouseDetails.warehouseId}','${wareHouseDetails.location}','edit','${id}');" value='&nbsp;&nbsp;&nbsp;<spring:message code="edit.label" />&nbsp;&nbsp;&nbsp;' />
						</c:if>
						 <c:forEach var="accessControl" items="${sessionScope.outletManagement}">
	                       <c:if test="${accessControl.appDocument == 'Configuration' && accessControl.write == true}"> 
						 	<input type="button" id="submit"   class="btnCls" style="margin-right: 2%;"  onclick="viewWarehouseposData('${wareHouseDetails.warehouseId}','${wareHouseDetails.location}','edit','${id}');" value='&nbsp;&nbsp;&nbsp;<spring:message code="edit.label" />&nbsp;&nbsp;&nbsp;' />
						   </c:if>
						</c:forEach>
...
<%-- 		                                  		<option value="false" ${'false' == wareHouseDetails.remoteMonitoring ? 'selected' : ''} >No</option> --%>
                                ...
                                <div class="form-group col-lg-2 allignment">
									<label><spring:message code="created.date.label" /></label>
                                           <input class="form-control calendar_icon"  readonly="readonly" style="background-color: white;" value="${wareHouseDetails.createdDateStr}" name="createddate" id="createddate" size="20" type="text" onfocus="callCalender('createddate')" onclick="callCalender('createddate')" placeholder="DD/MM/YYYY"/>
