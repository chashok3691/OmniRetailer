...
<!-- Main content -->
				...
				<section class="content-header">
                    <h1>
                        <spring:message code="apparel_warehouse_configuration.label"/>
                    </h1>
                    <ol class="breadcrumb">
                    <li><a href="#" onclick="return viewDashboard('inventorymanager');"><i class="fa fa-dashboard"></i><spring:message code="home.label" /></a></li>
                        <li><a href="#" onclick="showWarehouseFlows('warehouseDetails')"><spring:message code="warehouse.management.label"/></a></li>
                      <li> <a href="#" onclick="getWareHouses('WarehouseConfigurations','0')"><spring:message code="warehouses.label"/></a></li>
                    <li> <span id="workLocation">${location}</span><spring:message code="apparel_warehouse_configuration.label"/></li>
                    </ol>
                </section>
...
<div class="row">
  ...
  <div class="box box-primary">
                                <div class="box-header" >
                                    <h3 class="box-title"><span id="workLocation">${location}</span>  &nbsp;&nbsp;&nbsp;&nbsp; <spring:message code="apparel_warehouse_configuration.label" /></h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
									...
									<%-- <div class="row">
									 ...
									 --%>
                                  	...
                                  	<input type="button" id="edit" style="position: relative;" class="btn bg-olive btn-inline" onclick="saveGroceryWarehouse();" value="&nbsp;&nbsp;&nbsp;<spring:message code="save.label" />&nbsp;&nbsp;&nbsp;" />
								   ...
								   --%>	<input type="button" class="btn bg-olive btn-inline" style="margin-left:1%; margin-right: 1%;width: 68px;position: relative;" onclick="viewConfigurations('outletConfigurations','grocery')" value="<spring:message code="cancel.label" />" />
                                		...
                                		<input type="hidden" value="${warehouseidcreated}" id="warehouseidcreated">
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
        	...
        	<div id="model_main_div">
        		...
        		<div id="model_main_div_toolbar">
         			...
         			<input type='text' name='searchProduct' id='addSearchProduct' placeholder = 'Search Product..' class="searchItems">
         				<div class="services">
							<div class="items">
								<ul class="matchedStringUl storageWSkus" style="width: 25% !important;"></ul>
							</div>
						</div>
         			<br><br>
