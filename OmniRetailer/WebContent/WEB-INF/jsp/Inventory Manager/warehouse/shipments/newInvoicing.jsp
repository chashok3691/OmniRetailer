...
<div class="row">
  <div class="col-lg-12">
                ...
                <div class="form-group col-lg-6" style="margin-bottom:4%;margin-left: -5%;">
                 <select class="form-control form-group" id="from" >
                ...
                <div class="form-group col-lg-7" style="margin-left: -5%;">
					<input type="text" class="form-control" name="address" id="address_streetname" value="${locationsList[0].address}" placeholder="<spring:message code="enter.street.name.label"/>"/>
                ...
                <div class="form-group col-lg-7"style="margin-left: -5%;">
					<input type="text" class="form-control" name="location" id="address_city" value="${locationsList[0].city}" placeholder="<spring:message code="enter.city.label"/>"/>
                ...
                <div class="form-group col-lg-7" style="margin-left: -5%;">
					<input type="text" class="form-control" name="street" id="address_countryname" value="${locationsList[0].country}" placeholder="<spring:message code="enter.country.name"/>"/>
                ...
                <input type="text" class="form-control searchItems clearError" placeholder="<spring:message code="warehouse.invoices.orderref.label"/>" style="height:30PX;!important;background:url(/OmniRetailer/images/search.png) no-repeat;background-position:right;" name="orderRef" id="orderRef" value="${quoteObj.orderId}">
                ...
                <c:set var="invoicedt" value="${quoteObj.invoiceDate}" scope="page" />
                </c:if>
                <c:if test="${operation == 'edit'}">
                <c:set var="invoicedt" value="${quoteObj.invoice_Date}" scope="page" />
                </c:if>
					 <input class="form-control calendar_icon"  style="background-color: white;width:60%;" name="orderDate" id="orderDate" size="20" type="text" value="${invoicedt}" onfocus="callCalender('orderDate')" onclick="callCalender('orderDate')" placeholder="DD/MM/YYYY"/>
                ...
                <div class="form-group col-lg-7" style="margin-left: -5%;">
                <c:if test="${operation == 'edit'}">
                <c:if test="${quoteObj.streetName != ''}">
                <c:set var="packs" value="," />
                </c:if>
                 </c:if>
					<input type="text" class="form-control" name="billTo" id="billTo" value="${quoteObj.buildingNo}${packs}${quoteObj.streetName}" placeholder="<spring:message code="invoice.dNo.streetName.label"/>"/>
                ...
                <div class="form-group col-lg-7" style="margin-left: -5%;">
					<input type="text" class="form-control" name="billTo1" id="billTo1" value="${quoteObj.city}" placeholder="<spring:message code="enter.city.label"/>"/>
                ...
                <div class="form-group col-lg-7" style="margin-left: -5%;">
					<input type="text" class="form-control" name="billTo2" id="billTo2" value="${quoteObj.country}" placeholder="<spring:message code="enter.country.name"/>"/>
				...
				<div class="form-group col-lg-7" style="margin-left: -5%;">
					<input type="text" class="form-control" style="width:60%;" onkeypress='return numerics(event);' name="street" id="billTo3" value="${quoteObj.zip_code}" placeholder="<spring:message code="enter.zipcode.label"/>"/>
					<span id="streetError" style="text-align: right; color: red; font-size: 2; font-weight: bold;"></span>
				</div>                    
                </div>                     
                </div>   
		...
		<div class="services">
          ...
          <div class="form-group col-lg-3" style="    width: 26%;">
             ...
             <div class="row">
                       ...
                       <c:forEach var="itemList" items="${quoteObj.invoiceItems}" varStatus="theCount">
                       ...
                       <c:forEach var="itemList" items="${itemObj}" varStatus="theCount">
             		    <tr id='dynamicdiv${theCount.count}' style='margin-top:5px;text-align:center;'>
    	                    	...
    	                    	<td id='itemCode${theCount.count}'>${itemList.itemId}</td>
	  	 						<td id='itemDesc${theCount.count}'>${itemList.itemDescription}</td>
	  	 						<td id='uom${theCount.count}'>${itemList.unitOfMeasurement}</td>
	  	 						<td contenteditable="true" ><input type='number' style="text-align:center;width:75px;"  class='Received' id='Received${theCount.count}' onBlur='changePack(this);' value="${itemList.quantity}" /></td>
	  	 						<td contenteditable="true"  ><input type='number' style="text-align:center;width:75px;" id='packets${theCount.count}' value='' /></td>
	  	 						<td id='price${theCount.count}'>${itemList.price}</td>
             ...
             <div class="form-group col-lg-6"></div>
					...
					<c:if test="${type == 'new'}">
				       <input type="button" class="btn bg-olive btn-inline btnCls" style="margin-right: 25%;" onclick="return createInvoices('winvoice','','${quoteObj.invoiceId}') ;" value="<spring:message code="submit.label" />" />
				    </c:if>
				    <c:if test="${type != 'new'}">
				       <input type="button" class="btn bg-olive btn-inline btnCls" style="margin-right: 25%;" onclick="return createInvoices('winvoice','','${quoteObj.invoiceId}');" value="<spring:message code="submit.label" />" />
				    </c:if>
				    <c:if test="${sessionScope.role == 'super admin'}">
				    	<input type="button" class="btn bg-olive btn-inline btnCls" onclick="viewInvoicing('winvoice','0')" value="<spring:message code="cancel.label" />" />
				    </c:if>
				    <c:if test="${sessionScope.role != 'super admin'}">
