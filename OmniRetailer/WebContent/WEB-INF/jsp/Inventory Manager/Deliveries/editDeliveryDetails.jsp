...
$(document).ready(function(){
	...
	changeTotalCost();
	 $('#custDno').on('input',function(e){
		 if($("#billDno").val().trim() == $(this).val().slice(0,-1))
         	$("#billDno").val($(this).val());
		 if($("#shipDno").val().trim() == $(this).val().slice(0,-1))
         	$("#shipDno").val($(this).val());
     });
	
	 $('#custStreet').on('input',function(e){
         if($("#billStreet").val().trim() == $(this).val().slice(0,-1))
		 	$("#billStreet").val($(this).val());
         if($("#shipStreet").val().trim() == $(this).val().slice(0,-1))
         	$("#shipStreet").val($(this).val());
     });
	 $('#custLoc').on('input',function(e){
		 if($("#billLoc").val().trim() == $(this).val().slice(0,-1))
         	$("#billLoc").val($(this).val());
         if($("#shipLoc").val().trim() == "")
		 	$("#shipLoc").val($(this).val());
     });
	 $('#custCity').on('input',function(e){
         if($("#billCity").val().trim() == $(this).val().slice(0,-1))
		 	$("#billCity").val($(this).val());
         if($("#shipCity").val().trim() == $(this).val().slice(0,-1))
  ...
  <div class="col-lg-12">
				<div class="box box-primary">
                                ...
                                <form>
                                  ...
                                  <div class="row" style="text-align: right; margin-top: -27px;">
                                   <div id="Error" style="text-align:center;color:red;font-weight:bold;">${err}</div>
                                  	<input type="button" id="edit" style="position: relative;" class="btn bg-olive btn-inline" onclick="updateOrder('submitted','edit');" value="<spring:message code="submit.label" />" />
								  	<input type="button" id="edit"  class="btn bg-olive btn-inline" style="margin-left:1%;width: 68px;position: relative;" onclick="updateOrder('draft','edit');" value="<spring:message code="save.label" />" />
								  	<input type="button" class="btn bg-olive btn-inline" style="margin-left:1%; margin-right: 1%;width: 68px;position: relative;" onclick="viewOrders('${orderDetails.orderStatus}','OutletShipment','0',${type});" value="<spring:message code="cancel.label" />" />
                                     ...
                                     <div class="form-group col-lg-3"></div>
                                      ...
                                      <input type="hidden" id="type" value="${type}">
                                            <label><spring:message code="sales_location.label" /></label>
                                     		<select class="form-control" id="outletLocation" name="saleLocation" onchange="getTaxes();">
                                   ...
                                   <div class="row">
                                         ...
                                         <div class="form-group col-lg-6">
                                         	...
                                         	<input type="text"  class="form-control searchItems" id="searchItems" style="height:30PX;border-radius: 6px !important;background:url(${pageContext.request.contextPath}/images/search.png) no-repeat;background-position:right;" />
											<div class="services">
								    			<div class="items">
						...
						<div class="row" style="text-align: right;">
							<input type="button" id="edit"  class="btn bg-olive btn-inline" onclick="updateOrder('submitted','edit');" value="<spring:message code="submit.label" />" />
							<input type="button" id="edit"  class="btn bg-olive btn-inline" style="margin-left:1%;width: 68px;" onclick="updateOrder('draft','edit');" value="<spring:message code="save.label" />" />
							<input type="button" class="btn bg-olive btn-inline" style="margin-left:1%;margin-right: 1%;" onclick="viewOrders('${orderDetails.orderStatus}','OutletShipment','0',${type});" value="<spring:message code="cancel.label" />" />
						</div>
						<br/>
