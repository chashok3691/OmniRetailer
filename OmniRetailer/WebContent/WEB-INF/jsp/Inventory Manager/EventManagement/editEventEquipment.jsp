	...
	if($("#statusoftheevents").val() !="Approved" || noOfDaysstart < -1 || noOfDaysend > 0 ){
		...
		for(var i = 1; i<11;i++){
			$("#submitEventEquipment"+i).css("display","none");
			 $("#ErrorEquipment"+i).html("Note: Equipment can be added only one day before the Approved Event.");
			}
	}
      ...
      <div class="box-header" align="center">
		<h3 class="box-title" style="padding :5px;  border:1px solid  #808080;font-weight: bold;">
			Equipment Issue
             ...
             <div class="box-body table-responsive"  id="eventequipmenteditable">
         <div class="row">
...
<input type="button" class="btnCls" style="padding: 4px 12px; !important" id="submitEventEquipment${equPageCount}" onclick="createEventEquipment('edit','${equPageCount}');" value="<spring:message code="submit.label" />" />	
</c:if>
