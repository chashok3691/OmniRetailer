...
$(document).ready(function(){
	debugger;
	callCalender('EventstartEquipment1');
  ...
  <div class="box box-primary">
      <div class="box-header" align="center">
		<h3 class="box-title" style="padding :5px;  border:1px solid  #808080;font-weight: bold;">
		 ...
		 <div id="ErrorEquipment" style="text-align:center;color:red;font-weight:bold;">Configure Event to Access Equipment</div>
           <div id="SuccessEquipment" style="text-align:center;color:blue;font-weight:bold;">${successEquipment}</div>
...
<c:forEach var="location1" items="${locationsList}">
  ...
  <label><spring:message code="customer.newfeedback.emptyspace"/></label>
                       <input class="form-control" readonly="readonly"
											style="background-color: white;" name="EventstartEquipment1"
											id="EventstartEquipment1" size="20" type="text"
											value=""
											onfocus="callCalender('EventstartEquipment1')"
											onclick="callCalender('EventstartEquipment1')" placeholder="DD/MM/YYYY"  />
   ...
   <div class="col-lg-4"></div>
    <div class="col-lg-4">
              ...
              <div class="col-lg-12" >
                    ...
                    <input type="text" class="form-control"  onkeyup="EquipmentMulSearch('1')" id="searchEquipment1" placeholder="Search Equipmemnt" style="height:30PX;margin-bottom: 0px;background:url(/OmniRetailer/images/search.png) no-repeat;background-position:right;">
                   
                   <div class="services">
						    				<div class="items">
						     				<ul class="matchedStringUl eventEquipment1" style=""></ul>
						   					</div>
										</div>
                    </div>
         ...
         <div class="col-lg-12">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline" role="grid" style="overflow-x: auto;width:100%;position: relative;white-space: nowrap;max-height: 400px;min-height: 200px;">
                     ...
                     <table id="EventEquipment1" class="table table-bordered table-striped" style="    margin-top: 1px !important;">
                    ...
                    <div class="row" style="text-align: right; margin-right: 25px;margin-top:50px">
							<input type="button" class="btnCls" style="padding: 4px 12px; !important"
								onclick="createEventEquipment('new');"
