                      ...
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                         ...
                         <c:when test="${fn:length(eventMastersList.eventEquipmentReturnDetails)>0}">
                          <c:forEach var="inventories" items="${eventMastersList.eventEquipmentReturnDetails}"  varStatus="theCount">
                             <tr>
                             	...
                             	<td><input id="EquClosureIssue${theCount.count}" type="number" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57"   min="0" value="${inventories.issueQuantity}" style="text-align: center;" readonly="readonly"></td>
                         	 	<td><input id="EquClosureReturn${theCount.count}" type="number" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57"   min="0" value="${inventories.returnQuantity}" style="text-align: center;" ></td>
                         ...
                         <c:forEach var="inventories" items="${eventMastersList.eventEquipmentDetails}"  varStatus="theCount">
                             <tr>
                             	...
                             	<td><input id="EquClosureIssue${theCount.count}" type="number" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57"   min="0" value="${inventories.equipmentQuantity}" style="text-align: center;" readonly="readonly"></td>
                         	 	<td><input id="EquClosureReturn${theCount.count}" type="number" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57"   min="0" value="${inventories.equipmentQuantity}" style="text-align: center;" onchange="validateEquReturnQty('${theCount.count}')"></td>
...
<%-- 							 <input type="button" class="btnCls" style="padding: 4px 12px; !important;pointer-events:all" onclick="PrintEventDetails('${eventRef}','${eventMastersList.eventStatus}','view','');" value="Print" /> 
