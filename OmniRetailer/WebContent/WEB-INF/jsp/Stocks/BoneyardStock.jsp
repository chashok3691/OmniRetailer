 ...
 * Written By		        : Sahitya
 * file name		        : inventorymanager/retailoutlets/Boneyard.jsp
 * file type		        : JSP
	...
	debugger;
	 var packTotal = [];
	   ...
	   $('.packQty').each( function(){
		...
		if(totalPack < 0) totalPack = totalPack * (-1);
		...
		$('#totalPackQty').text(parseFloat(totalPack+0.00).toFixed(2));
		 ...
		 var StockTotal = [];
		   ...
		   $('.stockQty').each( function(){
			...
			if(totalStock < 0) totalStock = totalStock * (-1);
				 ...
				 var saleTotal = [];
				   ...
				   $('.salePrice').each( function(){
					...
					for (var i = 0; i < saleTotal.length; i++) {
						totalSale = parseFloat(totalSale) + parseFloat(saleTotal[i]);
					}
					if(totalSale < 0) totalSale = totalSale * (-1);

					$('#totalSalePrice').text(parseFloat(totalSale+0.00).toFixed(2));
                 ...
                 <%--    <label><spring:message code="startprice.label"/></label> --%>
                  ...
                  <input type="hidden" id="stockType" value="${stockType}">
                   <input type="hidden" id="flowUnder" value="${flowUnder}">
                                        <div> <div id="example1_wrapper" class="dataTables_wrapper form-inline" role="grid" style="overflow-x: auto;width:100%;position: relative;white-space: nowrap;">
                     ...
                     <table id="productstocks" class="table table-bordered table-striped">
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                             <tr>
                             	...
                             	<th class="sticky-col second-col stickyheader" style="background-color: #a1dbf1 !important;"><spring:message code="location.label" /></th>
								<th class="sticky-col third-col stickyheader" style="background-color: #a1dbf1 !important;"><spring:message code="date.label" /></th>
								<th class="sticky-col fourth-col stickyheader" style="background-color: #a1dbf1 !important;"><spring:message code="skuid.label" /></th>
								<th class="sticky-col fifth-col stickyheader" style="background-color: #a1dbf1 !important;"><spring:message code="itemdesc.label" /></th>
                         ...
                         <tbody style="text-align: center;">
                            <c:forEach var="stockDetails" items="${skuDetailsList}">
                         	 <tr>
                                ...
                                <td class='sticky-col second-col' style='background: #f9f9f9;'>${stockDetails.location}</td>
								<td class='sticky-col third-col' style='background: #f9f9f9;'>${stockDetails.dateStr}</td>
								<td class='sticky-col fourth-col' style='background: #f9f9f9;'>${stockDetails.skuID}</td>
								
								<td class='sticky-col fifth-col' style='background: #f9f9f9;'>${stockDetails.description}</td>
								...
								<td class="salePrice">${stockDetails.salePrice}</td>
                           ...
                           <td></td>
                                       ...
                                       <td></td>
                                       <td style="padding:3px;width: 160px;"><div id="totalSalePrice" style="white-space: nowrap;padding: 5px;background: #c1c1c1;"></div></td>
