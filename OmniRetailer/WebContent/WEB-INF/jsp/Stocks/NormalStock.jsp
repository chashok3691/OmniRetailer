                    ...
                    <input type="hidden" id="stockType" value="${stockType}">
                     ...
                     <table id="productstocks" class="table table-bordered table-striped">
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                             <tr>
                                <th class="sticky-col first-col stickyheader" style="background-color: #a1dbf1 !important;"><div><spring:message code="sl.no.label" /></div></th>
                             
                             	<th class="sticky-col second-col stickyheader" style="background-color: #a1dbf1 !important;"><spring:message code="skuid.label" /></th>
                             	<th class="sticky-col third-col stickyheader" style="background-color: #a1dbf1 !important;" >Plu code</th>
                             	<th class="sticky-col fourth-col stickyheader" style="background-color: #a1dbf1 !important;text-align: left;" ><spring:message code="description.label" /></th>
                            ...
                            <c:forEach var="stockDetails" items="${skuDetailsList}" varStatus="theCount">
                         	 <tr>
                                <td class="sticky-col first-col" style='background: #f9f9f9;' >${stockDetails.slNo}</td>
                             	...
                             	<td class='sticky-col third-col' style='background: #f9f9f9;' >${stockDetails.pluCode}</td>
                                <td class='sticky-col fourth-col' style='background: #f9f9f9;text-align: left;' >${stockDetails.description}</td>
                                ...
                                <td style="">${stockDetails.color}</td>
                                <td style="">${stockDetails.size}</td>
                                <td style="">${stockDetails.productBatchNumber}</td>
                                  <td style="">${stockDetails.expiryDateStr}</td>
                                <td style="">${stockDetails.measurementRange}</td>
                                <td style="">${stockDetails.productRange}</td>
