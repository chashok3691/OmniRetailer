 ...
 * Written By		        : Sahitya
 * file name		        : inventorymanager/retailoutlets/OrderedStock.jsp
 * file type		        : JSP
                     ...
                     <table id="productstocks" class="table table-bordered table-striped">
                      <thead style="background-color: #3c8dbc; color: #ffffff">
                             <tr>
                             	...
                             	<th class="sticky-col second-col stickyheader" style="background-color: #a1dbf1 !important;"><spring:message code="order_on.label" /></th>
                             	<th class="sticky-col third-col stickyheader" style="background-color: #a1dbf1 !important;"><spring:message code="delivery_date.label" /></th>
                             	<th class="sticky-col fourth-col stickyheader" style="background-color: #a1dbf1 !important;"><spring:message code="skuid.label" /></th>
                             	<th class="sticky-col fifth-col stickyheader" style="background-color: #a1dbf1 !important;"><spring:message code="description.label" /></th>
                         ...
                         <tbody style="text-align: center;">
                            <c:forEach var="stockDetails" items="${skuDetailsList}">
                         	 <tr>
                         	 	...
                         	 	<td class='sticky-col second-col' style='background: #f9f9f9;'>${stockDetails.orderDate}</td>
                             	<td class='sticky-col third-col' style='background: #f9f9f9;'>${stockDetails.deliveryDate}</td>
                               ...
                               <td>${stockDetails.ean}</td>
                                ...
                                <td class="stockQty">${stockDetails.stockQty}</td>
                                 <fmt:formatNumber var="itemPrice" type="number" minFractionDigits="2" maxFractionDigits="2" value="${stockDetails.price}" />
                                <td>${itemPrice}</td>
 								<td class="stockVal">${stockDetails.stockValue}</td>                 
 								                <fmt:formatNumber var="totalCost" type="number" minFractionDigits="2" maxFractionDigits="2" value="${stockDetails.totalCost}" />
